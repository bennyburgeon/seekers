...
if($records!=NULL)
{
	foreach($records as $key => $result){ ?>
		<tr class="odd gradeX">
			<td>
			  <?php echo $result['firstname']?><br> 
			<!--   History:<a href="javascript:;" title="Get last history" onclick="get_calls_history(<?php echo $result['job_id'];?>);"  id="get_calls_job_app" class="btn btn-info btn-xs"> [View]</a><br> -->
			  </td>
            ...
            <td <?php if($result['total_offered']>0)echo 'bgcolor="#E3E3E3"';?>><?php echo $result['total_offered_rejected']?></td>            
