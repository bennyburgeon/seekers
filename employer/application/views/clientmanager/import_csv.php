	...
	<!-- BEGIN PAGE CONTENT -->
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<?php echo $this->config->site_url()?>/clientmanager"><?php echo $module_head?></a>
            ...
            <div class="col-md-3"></div>
				<div class="col-md-6 ">
					...
					<div class="portlet light">
                        ...
                        <form role="form" action="<?php echo $this->config->site_url();?>/clientmanager/import_csv"  enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate1();"> 
                       ...
                       <div class="form-body">  
                     	...
                     	<div class="form-actions">
                                ...
                                <button class="btn default" type="button" onClick="window.location='<?php echo $this->config->site_url();?>/clientmanager';">Cancel</button>
