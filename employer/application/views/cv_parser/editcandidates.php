...
<table class="hori-form">
    ...
    <a href="<?php echo $this->config->site_url();?>/cv_parser" class="attach-subs subs pull-right">Listing</a>
    <a href="<?php echo $this->config->site_url();?>/cv_parser/profile_entry/<?php echo $candidate_id; ?>" class="attach-subs subs pull-right">Raw Data</a>
    ...
    <tbody>
            ...
            <h2 class="srevHd">Personal Details</h2>
                ...
                <tr>
                    ...
                    <!--<a href="<?php echo $this->config->site_url();?>/cv_parser/summary/<?php echo $formdata['candidate_id'] ?>" class="attach-subs subs">Done</a>-->
                    </span>
                    </td>
                </tr>
            </form>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo $this->config->site_url();?>/cv_parser/editfiles" enctype="multipart/form-data"> 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="" name=""   action="<?php echo site_url('cv_parser/profile_completion'); ?>/<?php echo $candidate_id ?>" > 
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/cv_parser/show_cv_photo/',
...
//BEGIN FILE DETAILS
	   ...
	   $('#candidate_form5').submit(function(evt){
		...
		//if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo $this->config->site_url();?>/cv_parser/editfiles",
                data:formData,
                cache:false,
                contentType: false,
                processData: false,
...
function profile_complete() 
{
	...
	$.ajax({
		type: "post",
		url: "<?php echo site_url('cv_parser/check_profile_complete'); ?>"+'/'+candidateId,
...
$( document ).ready(function() {
   ...
   $('#edit_candidate').click(function(){
		...
		if(isContactValid) {
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/editCandidate'); ?>",
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
...
//CONTACT DETAILS VALIDATION AND SUBMIT
   ...
   $('#edit_candidate1').click(function(){
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/editCandidateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PASSPORT DETAILS
   ...
   $('#edit_candidate2').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/editPassportDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN SKILLS AND CERTIFICATE
   $('#edit_candidate7').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/editSkillCertificateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
...
*/	    return true;
   ...
   $('#save_candidate3').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/addEducationDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PANNING JOB DEATILS
   ...
   $('#edit_candidate8').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/editJobChangeDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE EDUCATION
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/deleteEducationDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { edu_id:edu_id},
				success: function(json){
					try{		
...
//BEGIN JOB DETAILS
   ...
   $('#edit_candidate4').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/addJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE JOB
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('cv_parser/deleteJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { job_id:job_id},
				success: function(json){
					try{		
...
//BEGIN DELETE PHOTO
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('cv_parser/photo_delete'); ?>"+'/'+candidateId,
			cache: false,				
...
//BEGIN DELETE CV
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('cv_parser/cv_delete'); ?>"+'/'+candidateId,
			cache: false,				
...
$('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/cv_parser/getstate/',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/cv_parser/getcity/',
...
$('#city_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/cv_parser/getlocation/',
 ...
 $('#organization').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/cv_parser/get_all_organisation', type: "GET", data:{organization: $('#organization').val()},dataType: "json", success:function(data) 																																							   {
		 if (data == null) 
		 {
 ...
 $('#designation').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/cv_parser/get_all_designation', type: "GET", data:{designation: $('#designation').val()},dataType: "json", success:function(data) {
     if (data == null) {
      $(".ui-autocomplete").hide();
     } else {
      response(data);
 ...
 $('#responsibility').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/cv_parser/get_all_responsibility', type: "GET", data:{responsibility: $('#responsibility').val()},dataType: "json", success:function(data) {
     if (data == null) {
      $(".ui-autocomplete").hide();
     } else {
      response(data);
