...
<a href="<?php echo base_url();?>index.php/visatype/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
<!-- 
	...
	<div class="checker">
    	<span>
            ...
            <!-- <input type="checkbox" name="checkbox[]" id="checkbox" value="<?php echo $result['visa_type_id']?>" class="checkboxes"> --> 
                            ...
                            <a href="<?php echo base_url();?>index.php/visatype/edit/<?php echo $result['visa_type_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                            <!-- 
			<a href="<?php echo base_url();?>index.php/visatype/delete/<?php echo $result['visa_type_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
            -->
                            </td>
                        </tr>
