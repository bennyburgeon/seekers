...
<tr>
<th>
	<a href="<?php echo $this->config->site_url();?>/complaint_report?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';}?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Complaints</a></th>
</tr>
</thead>
<tbody>
...
<?php 
    ...
    <td>
	<?php echo $result["ticket_title"]; ?><br><br>
    <?php echo substr($result['ticket_description'],0,50);?><br><br>
   	<?php echo $result['ticket_status_name'];?><br><br>
	<?php echo $result['ticket_priority_name'];?>
    </td>
    </tr>
    <?php }
  }else{?>
...
$(document).ready(function()
{
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/complaint_report?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>/complaint_report?limit='+limits;
	});
