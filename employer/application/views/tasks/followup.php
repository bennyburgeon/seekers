				 			  ...
				 			  <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-4">
								  	<div class="input-icon">
															...
															<input type="text" readonly id="date" name="date" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="<?php echo date("Y-m-d"); ?>" value="<?php echo date("Y-m-d"); ?>" size="16" class="form-control date-picker">
														</div>
								...
								<div class="form-group">
                                  ...
                                  <div class="col-md-4">
								  	<div class="input-icon">
															<i class="fa fa-calendar"></i>
															<input type="text" readonly id="due_date" name="due_date" value="" placeholder="yyyy-mm-dd" size="16" class="form-control date-picker">
														</div>
                                  </div>
                                 </div>
