...
<div class="profile_top_left">Summary &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url();?>index.php/jobs_sourcer/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobs_sourcer/send_mass_mail/<?php echo $formdata['job_id'];?>">Mass Email</a>	&nbsp;&nbsp;&nbsp; ||&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobs_sourcer/add_candidate/<?php echo $formdata['job_id'];?>">Add New Candidate</a>	&nbsp;&nbsp;&nbsp; ||</div>  
  ...
  <tbody>
    <tr>
      ...
      <div style="float:left">CV Source:<a href="javascript:;" title="CV Source"  id="cv_source" class="btn btn-info btn-xs"><?php if($candidate['lead_source']==1)echo 'Recruiter';if($candidate['lead_source']==2)echo 'Web/Social Media';if($candidate['lead_source']==3)echo 'Vendor';if($candidate['lead_source']==4)echo 'Mobile';if($candidate['lead_source']==5 || $candidate['lead_source']=='')echo 'Source not updated';?></a></div>
        ...
        <a href="javascript:;" title="Short List this candidate"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/shortlist_jquery/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="shortlisted_candidate" class="btn btn-info btn-xs"> Short List </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobs_sourcer/addinterview_jqery"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/addinterview_jqery" />
