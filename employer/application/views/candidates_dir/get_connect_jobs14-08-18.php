...
<table width="100%" border="1">
  <tbody>
    ...
    <tr>
      <td  width="60%" align="left" valign="top"><form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/candidates_apps/apply_for_interview" id="job_assignment_form" name="assignment_form">
...
?>
          ...
          <input type="checkbox" disabled name="interview_id[]" value="<?php echo $val['interview_id'];?>">
          <?php }else{?>
          <input type="checkbox" name="interview_id[]" value="<?php echo $val['interview_id'];?>">
          <?php } ?>
          &nbsp;<?php echo $val['job_title'];?><br>
          <?php } ?>
          <br>
          <br>
          <input type="button" value="Add To These Jobs" data-url="<?php echo $this->config->site_url();?>/candidates_apps/apply_for_interview" id="save_job_app_button" >
        </form></td>
