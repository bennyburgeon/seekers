          ...
          <table class="tool-table" border="1">
            <tbody>
              <tr>
                ...
                <td><?php echo form_dropdown('func_id', $department_list, $func_id,' id="func_id"  style="width:110px"');?></td>
                <td><?php echo form_dropdown('desig_id', $roles_list, $desig_id,' id="desig_id"  style="width:125px"');?></td>
                ...
                <td><?php echo form_dropdown('cur_job_status',  $job_status_list, $cur_job_status,' id="cur_job_status" style="width:75px"');?></td>
              </tr>
              <tr>
                <td><?php echo form_dropdown('city_id', $city_list, $city_id,' id="city_id"  style="width:130px"');?></td>
                <td><?php echo form_dropdown('pref_city_id', $pref_city_list, $pref_city_id,' id="pref_city_id"  style="width:110px"');?></td>
                <td><input class="form-control" type="text" name="search_name" id="search_name" value="<?php echo $search_name;?>" 
                    placeholder="Name" style="width: 125px;"></td>
                <td><?php echo form_dropdown('expected_ctc_to',  $expected_ctc_to_array, $expected_ctc_to,' id="expected_ctc_to" style="width:100px"');?></td>
                <td><?php echo form_dropdown('notice_period_to',  $notice_period_to_array, $notice_period_to,' id="notice_period_to" style="width:160px"');?></td>
                ...
                <td><?php echo form_dropdown('course_id',  $edu_course_list, $course_id,' id="course_id_edu" style="width:135px"');?></td>
    ...
    ?>
              <tr class="odd gradeX">
                ...
                <td><?php if($result['photo']!=''){?>
                  ...
                  <?php } ?></td>
                <td><strong style="color: #337ab7; text-decoration: none;"><?php echo $result['first_name']?></strong></a> 
            ...
            --> 
                  ...
                  <br>
                  Last CTC Udate:
                  <?php if(isset($result['ctc_updated_on'])  && $result['ctc_updated_on']!='0000-00-00') echo ($result['ctc_updated_on']!='0000-00-00' && $result['ctc_updated_on']!='') ? date('d-m-Y', strtotime($result['ctc_updated_on'])) : 'Not Updated';?>
                  <br>
                  Last Profile Udate:
                  <?php if(isset($result['status_updated_on'])  && $result['status_updated_on']!='0000-00-00')echo ($result['status_updated_on']!='0000-00-00' && $result['status_updated_on']!='') ? date('d-m-Y', strtotime($result['status_updated_on'])) : 'Not Updated';?>
                  <br>
                  Current CTC: <b><?php echo $this->config->item('currency_symbol');?>&nbsp;<?php echo number_format($result['current_ctc'],2);?></b> / Month&nbsp; || &nbsp;
                  Expected CTC: <b><?php echo $this->config->item('currency_symbol');?>&nbsp;<?php echo number_format($result['expected_ctc'],2);?> </b> / Month&nbsp; || &nbsp;
                  ...
                  <!-- rms_base_url --> 
                  <a href="<?php echo $this->config->item('rms_base_url'); ?>uploads/client_cvs/<?php echo $result['client_cv_file'];?>" class="btn btn-danger btn-xs" target="_blank" title="View Profile">Download CV</a>
                  <?php } ?>
                  <?php if($result['client_cv_file']!=''){?>
