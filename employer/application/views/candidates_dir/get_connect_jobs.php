...
?>
      ...
      ?>
        CTC Updated on:
        <?php  if(isset($job_search['ctc_updated_on']) && $job_search['ctc_updated_on']!='0000-00-00') echo ($job_search['ctc_updated_on']!='0000-00-00' && $job_search['ctc_updated_on']!='') ? date('d-m-Y', strtotime($job_search['ctc_updated_on'])) : '';?>
        <br>
        Total Experience:
