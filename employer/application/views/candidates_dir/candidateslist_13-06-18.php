...
<!-- 
        ...
        <table class="tool-table" border="1">
            <tbody>
                ...
                <tr>
                    <td><?php echo form_dropdown('job_cat_id', $industry_list, $job_cat_id,' id="job_cat_id" style="width:150px"');?></td>                  
                    <td><?php echo form_dropdown('func_id', $department_list, $desig_id,' id="func_id"  style="width:150px"');?></td>                    
                    <td><?php echo form_dropdown('desig_id', $roles_list, $desig_id,' id="desig_id"  style="width:150px"');?></td>			
                    <td><?php echo form_dropdown('city_id', $city_list, $city_id,' id="city_id"  style="width:150px"');?></td>
                    <td><?php echo form_dropdown('pref_city_id', $pref_city_list, $pref_city_id,' id="pref_city_id"  style="width:150px"');?></td>                 <td><input class="form-control" type="text" name="search_name" id="search_name" value="<?php echo $search_name;?>" 
...
<table class="tool-table new">
    ...
    ?>
		...
		<?php if($result['photo']!=''){?><img height="31" width="31" src="<?php echo $this->config->item('rms_base_url').'uploads/photos/'.$result['photo'];?>"><?php }else{ ?> 
        ...
        <img height="31" width="31" src="<?php echo $this->config->item('rms_base_url').'uploads/photos/no_photo.png';?>">
           ...
           <br>
            ...
            <br> Last CTC Udate: <?php if(isset($result['ctc_updated_on'])  && $result['ctc_updated_on']!='0000-00-00')echo $result['ctc_updated_on'];else echo 'Not Updated'?>
            <br> Last Profile Udate: <?php if(isset($result['status_updated_on'])  && $result['status_updated_on']!='0000-00-00')echo $result['status_updated_on'];else echo 'Not Updated'?>                        <br>
<br>
             ...
             || 
             <!-- rms_base_url -->
             <a href="<?php echo site_url().'/jobs/download_cv_file/'.$result['candidate_id'];?>" class="btn btn-danger btn-xs" target="_blank" title="View Profile">Download CV</a>
