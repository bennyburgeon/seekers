...
<a href="<?php echo base_url();?>index.php/jobs_ov/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;	
<!-- 
||
&nbsp;&nbsp;&nbsp;
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobs_ov/add_candidate/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
...
<table width="90%" border="1" bordercolor="#f4f4f4" align="center">
  <tbody>
    ...
    <tr>
      ...
      <td align="left" valign="middle"><input type="text" name="mobile" placeholder="Mobile" id="mobile" maxlength="11" value="" width="200px;" /></td>
    </tr>
    <tr>
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobs_ov/import_from_other_jobs/';?><?php echo $formdata['job_id'];?>" method="post" enctype="multipart/form-data">
