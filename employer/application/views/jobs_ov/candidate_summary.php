...
<html>
<head>
<link rel="shortcut icon" href="../ov_jobs_ov/images/fav.ico">
<meta charset="utf-8">
...
<div class="col-md-12">
        ...
        <tr>        
            <td colspan="2" align="center" valign="top">
                <table width="95%" border="1" cellspacing="3" cellpadding="3">
                      ...
                      <tr>
                        <td colspan="8"><?php echo $val['responsibility'];?></td>
                      </tr>
    ...
    <tr>
        ...
        <thead>
          ...
          <!--    <td width="25%"> <a href="<?php // echo base_url(); ?>index.php/jobs_ov/shortlist/<?php //echo $formdata['job_id'];?>/?app_id=<?php //echo $candidate['job_app_id'];?>"> Short List </a> | <a href="<?php //echo base_url(); ?>index.php/jobs_ov/reovecandidate/<?php // echo $candidate['job_app_id'];?>/?app_id=<?php //echo $formdata['job_id'];?>&candidate_id=<?php //echo $candidate['candidate_id'];?>">Delete Application</a></td>-->
