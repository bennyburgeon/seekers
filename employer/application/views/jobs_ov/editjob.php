...
<form action="<?php echo $this->config->site_url();?>/jobs_ov/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
