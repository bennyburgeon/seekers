                ...
                <div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3><?php echo $page_head;?></h3></div>
                    ...
                    <div class="table-tech specs hor">
                            <table class="hori-form">
                                <tbody>
                                    <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo $this->config->site_url();?>/candidates_list/addCandidate"> 
...
-->                                                        
                                        ...
                                        <tr>
                                            ...
                                            data-url="<?php echo $this->config->site_url();?>/candidates_list/addCandidate" />
                                            <a href="<?php echo $this->config->site_url();?>/candidates_list" class="attach-subs subs">Back</a></span></td>
...
function check_email()
{
	var pattern=/^([a-zA-Z0-9_.-])+@([a-zA-Z0-9_.-])+\.([a-zA-Z])+([a-zA-Z])+/;
		...
		if(!pattern.test($('#username').val())){
			...
			$.ajax({
				type: "post",
				url: "<?php echo $this->config->site_url();?>/candidates_list/check_email",
				cache: false,				
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) 
						{
                            ...
                            window.location.href = "<?php echo site_url('candidates_list/summary'); ?>" +'/'+ id;
