		  ...
		  ?>
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
               ...
               <!-- &nbsp;&nbsp;    Share In:
                <button style="border-radius: 4px;font-weight: 100; height: 28px;width:78px;border: none; background-color:#337ab7">
                <a onClick="window.open('https://www.facebook.com/dialog/share?app_id=423035301924997&display=popup&href=<?php echo $this->config->base_url();?>home/job_details?job_id=<?php echo md5($job['job_id']); ?>','sharer','toolbar=0,status=0,width=550,height=300');" caption="<?php echo $job['job_title']; ?>" title="<?php echo strip_tags($job['desired_profile']); ?>" href="javascript: void(0)"><span style="color:white"><i class="icon-facebook"></i> Share</span></a>
                </button>-->
              </div>
            </div>
            <?php } }else{ ?>
