...
<div class="profile_top_left">Summary &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url();?>index.php/jobs_assessment/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobs_assessment/add_candidate/<?php echo $formdata['job_id'];?>">Add New Candidate</a>&nbsp;&nbsp;&nbsp; ||</div>  
...
<!--         
  ...
  <a href="javascript:;" onclick="candidate_cv(<?php echo $candidate['candidate_id'];?>);" id="download_cv" data-url="<?php echo base_url();?>index.php/jobs_assessment/download_cv/<?php echo $candidate['candidate_id']?>" title="View CV" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i> CV</a>
  <?php }else{ ?>
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="calls_form" name="calls_form"> 
                    ...
                    <input type="hidden" name="job_app_id"  id="call_job_app_id" value="">    
                     ...
                     <input type="hidden" name="cur_ctc" value="0"/>
                     <input type="hidden" name="exp_ctc" value="0"/>
                     <input type="hidden" name="exp_years" value="0"/>
                     <input type="hidden" name="notice_period" value="0"/>
...
function candidate_profile(job_id){
	...
	$('#show_candidate_profile').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobs_assessment/candidate_profile/"+job_id,
			method: "POST",
  			data: { job_id : job_id },
		    dataType: "html",
			success: function(data) 
