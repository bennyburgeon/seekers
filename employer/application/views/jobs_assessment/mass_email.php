...
<form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>index.php/jobs_assessment/send_mass_mail/<?php echo $postdata['job_id'];?>"> 
