...
<div class="row">
<div class="col-sm-12 pages"><a href="<?php echo $this->config->site_url();?>/location">Location</a> / <?php echo $page_head;?> </span></div>
</div>
<div class="row">
<div class="col-sm-12">
<div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3>edit location form</h3></div>
...
<div class="table-tech specs hor">
    <table class="hori-form">
        <tbody>
            <form action="<?php echo $this->config->site_url();?>/location/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
            <?php echo form_hidden('location_id', $formdata['location_id']); ?>
            
                <tr>
                    <td>Country</td>
                    <td>
                    <select class="form-control input-large" id="country_id" name="country_id">                                    
                ...
                <tr>
                    ...
                    <option value="<?php echo $key;?>" <?php echo ($key == $formdata['city_id'] ? 'selected="selected"' : ''); ?>><?php echo $city;?></option>
                    <?php } ?>
                    </select>
                    </td>                               
                </tr>
                ...
                <tr>
                    <td>Location Name</td>
                    <td>
                    <input type="text" id="locaton_name" name="locaton_name" value="<?php echo $formdata['location_name'];?>" 
                    placeholder="" class="form-control hori" /></td>
                </tr>
                
                <tr>
                    <td>Zip Code</td>
                    <td>
                    <input type="text" id="locaton_name" name="zipcode" value="<?php echo $formdata['zipcode'];?>" placeholder="" class="form-control hori" />
                    </td>
                </tr>
