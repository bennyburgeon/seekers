...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/admin_leave_self/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<input type="date" maxlength="5" placeholder="" class="form-control hori" id="date_from" name="date_from" value="<?php echo $formdata['date_from']; ?>">
</td>
</tr>
<tr>
<td>To Date</td>
<td>
<input type="date" maxlength="5" placeholder="" class="form-control hori" id="date_to" name="date_to" value="<?php echo $formdata['date_to']; ?>">
</td>
</tr>
<tr>
<td>Type</td>
