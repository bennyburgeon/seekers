...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/worklevel/add" class="form-horizontal form-bordered"  method="post" id="frmcert" name="frmcert" onSubmit="return validate();" enctype="multipart/form-data"> 
    <tr>
