...
<a href="<?php echo $this->config->site_url();?>/contact" class="attach-subs subs">Done</a></span></td>
</tr>
...
$( document ).ready(function() {
   ...
   $('#save_candidate2').click(function(){
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('contact/addPassportDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('contact/loadEducationhtml'); ?>" +'/'+ candidateId;
...
var dataStringprop = $("#candidate_form2").serialize();
	$.ajax({
				type: "post",
				url: "<?php echo site_url('contact/skip_step3'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('contact/loadEducationhtml'); ?>" +'/'+ id;
                            $("#step1").load(site_url, function() {
                                //alert("success step2");
                            });
						}
