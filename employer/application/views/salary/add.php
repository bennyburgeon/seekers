...
<tbody>
   <form action="<?php echo $this->config->site_url();?>/salary/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
    <tr>
    <td>saalry Amount</td>
    <td><input class="form-control hori" type="text" name="salary_amount" value="<?php echo $formdata['salary_amount'];?>" placeholder="Enter Salary Name" id="salary_amount"></td>
    </tr>
