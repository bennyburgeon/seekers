...
<a href="<?php echo base_url();?>index.php/salary/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<div class="checker"><span><input type="checkbox" class="group-checkable" id="selectall"></span></div>
                            ...
                            <th>
                                    <a href="<?php echo $this->config->site_url();?>/salary?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';}?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Salary Name</a></th>
                            <th>&nbsp;</th>
	...
	<div class="checker">
    	<span>
    		<input type="checkbox" name="checkbox[]" id="checkbox" value="<?php echo $result['salary_id']?>" class="checkboxes">
                            ...
                            <td><?php echo $result['salary_amount']?></td>
                            <td><?php echo $result['salary_desc']?></td>
                            <td class="center">
                            
                            <a href="<?php echo base_url();?>index.php/salary/edit/<?php echo $result['salary_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
