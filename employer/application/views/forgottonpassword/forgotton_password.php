...
<title><?php echo $this->config->item('web_site'); ?></title>
</head>
<body>
<!--top-section-->
<div class="top">
...
<input type="email" class="form-control logins"  id="email" name="email">
...
<footer class="login_footer">Company Name || Email: info@globespan.co.in</footer>
<!--scripts-->
...
{
	if(document.forget_pass.email.value=='')
	{
		alert('Please enter email');
		document.forget_pass.email.focus();
		return false;
	}
	else{
		$('#forgotpwd').submit();
