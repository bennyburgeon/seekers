...
<form name="quick_form" action="<?php echo base_url().'index.php/jobsmanager/add_candidate/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobsmanager/import_from_other_jobs/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
