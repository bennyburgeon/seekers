...
<form action="<?php echo $this->config->site_url();?>/jobsmanager/add" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
    <tr>
      <td>Priority</td>
