                ...
                <table class="hori-form">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="<?php echo $this->config->site_url();?>/candidates_apps" class="attach-subs subs">Done</a>
                            </span>
                            </td>
                        </tr>
                    </tbody>
...
$( document ).ready(function() {
   ...
   $('#save_candidate3').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_apps/addEducationDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('candidates_apps/loadJobhtml'); ?>" +'/'+ candidateId;
...
var dataStringprop = $("#candidate_form3").serialize();
	$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_apps/skip_step2'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('candidates_apps/loadJobhtml'); ?>" +'/'+ id;
                            $("#step1").load(site_url, function() {
                                //alert("success step2");
                            });
						}
