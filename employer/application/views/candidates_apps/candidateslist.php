      ...
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          <div class="right-btns"> 
            <!--<a href="<?php// echo base_url();?>candidates_apps/add" class="attach-subs tools"><img src="<?php// echo base_url('assets/images/plus.png');?>">Add New</a>--> 
...
--> 
          ...
          <form id="searchForm" method="get" action="<?php echo $this->config->site_url()?>candidates_apps/">
            <!-- 
                    ...
                    placeholder="Email" style="width: 120px;">
                    
                    
                    <input class="form-control" type="text" name="search_mobile" id="search_mobile" value="<?php echo $search_mobile;?>" 
                   placeholder="Mobile" style="width: 120px;">
                   -->
            <table class="tool-table" border="1">
              <tbody>
                <tr>
                  <td><?php echo form_dropdown('job_cat_id', $industry_list, $job_cat_id,' id="job_cat_id" style="width:120px"');?></td>
                  <td><?php echo form_dropdown('func_id', $department_list, $desig_id,' id="func_id"  style="width:120px"');?></td>
                 
                  
                  
                  <td><?php echo form_dropdown('expected_ctc_from',  $expected_ctc_from_array, $expected_ctc_from,' id="expected_ctc_from" style="width:120px"');?></td>
                  <td><?php echo form_dropdown('notice_period_from',  $notice_period_from_array, $notice_period_from,' id="notice_period_from" style="width:120px"');?></td>
                  
                  <td><?php echo form_dropdown('level_id',  $edu_level_list, $level_id,' id="level_id" style="width:120px"');?></td>
                 <td><?php echo form_dropdown('total_experience_from',  $total_experience_from_array, $total_experience_from,' id="total_experience_from" style="width:120px"');?></td>
                    <td></td>
                </tr>
                <tr>
                  <td><?php echo form_dropdown('job_folder_id',  $job_folders, $job_folder_id,' id="job_folder_id" style="width:120px"');?></td>
                    <td><?php echo form_dropdown('desig_id', $roles_list, $desig_id,' id="desig_id"  style="width:120px"');?></td>
                 
                 
                  
                  <td><?php echo form_dropdown('expected_ctc_to',  $expected_ctc_to_array, $expected_ctc_to,' id="expected_ctc_to" style="width:120px"');?></td>
                  <td><?php echo form_dropdown('notice_period_to',  $notice_period_to_array, $notice_period_to,' id="notice_period_to" style="width:120px"');?></td>
                  
                  <td><?php echo form_dropdown('course_id',  $edu_course_list, $course_id,' id="course_id_edu" style="width:120px"');?></td>
                    <td><?php echo form_dropdown('total_experience_to',  $total_experience_to_array, $total_experience_to,' id="total_experience_to" style="width:120px"');?></td>
                 <td></td>
                </tr>
                  <tr>
                  ...
                  <td><?php echo form_dropdown('country_id', $country_list, $country_id,' id="country_id"  style="width:120px" ');?></td>
                      <td><?php echo form_dropdown('state_id', $state_list, $state_id,' style="width:120px"  id="state_id" ');?></td>
                     
                       <td><?php echo form_dropdown('city_id', $city_list, $city_id,' id="city_id"  style="width:120px"');?></td>
            ...
            <table class="tool-table new">
              <thead>
                <tr role="row" class="heading">
                  ...
                  <th width="1144"><a href="<?php echo $this->config->site_url()?>candidates_apps?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&limit=<?php echo $limit;?>&search_name=<?php echo $search_name;?>&search_email=<?php echo $search_email;?>&search_mobile=<?php echo $search_mobile;?>&rows=<?php echo $rows;?>"> Name</a></th>
    ...
    ?>
                <tr class="odd gradeX">
                  ...
                  <td><?php if($result['photo']!=''){?>
                    <img height="31" width="31" src="<?php echo $this->config->item('photo_physical_url').$result['photo'];?>">
                    <?php }else{ ?>
                    <img height="31" width="31" src="<?php echo $this->config->item('photo_physical_url'); ?>no_photo.png">
                    <?php } ?></td>
                  ...
                  <strong style="color: #5b80c5;"> <a href="<?php echo base_url();?>candidates_apps/summary/<?php echo md5($result['candidate_id']);?>" title="View Profile" target="_blank"> <?php echo $result['first_name']?></a> || <?php echo $result['username'];?> || <?php echo $result['mobile'];?></strong> 
                    <?php } else { ?>
            ...
            <?php if($result['cv_file']==''){?>
             ...
             <a href="<?php echo base_url();?>candidates_apps/summary/<?php echo $result['candidate_id']?>" target="_blank" title="Client CV not uploaded" id="open_candidate_profile" class="btn btn-danger btn-xs">CV Not Uploaded</a>
<br>
             <?php } ?>
           ...
           --> 
                   ...
                   Current CTC /Lakhs: <b><?php echo number_format($result['current_ctc'],0);?></b>&nbsp; || &nbsp;
                  Expected CTC /Lakhs: <b><?php echo number_format($result['expected_ctc'],0);?></b>&nbsp; || &nbsp;
           ...
           <a href='javascript:;'  onclick="add_interview(<?php echo $result['candidate_id'];?>,<?php echo $result['job_app_id'];?>,<?php echo $result['job_id'];?>);" class="btn btn-primary btn-xs">Schedule Interview</a> 
            ...
            <b>=></b><a href="javascript:;" onclick="select_candidate(<?php echo $result['candidate_id'];?>,<?php echo $result['job_app_id'];?>);" class="btn btn-primary btn-xs">Int. Select </a>
             ...
             <?php }elseif($result['app_status_id']==5 ){ ?>
              <?php echo 'Int. Scheduled'; ?>&nbsp;||&nbsp; <b>=></b> <?php echo 'Int. Rejected'; ?>
              
            <?php }elseif($result['app_status_id']==6 ){ ?>
             <?php echo 'Int. Scheduled'; ?>&nbsp;||&nbsp; <b>=></b> <?php echo 'Int. Selected'; ?>
 ...
 <?php echo 'Int. Scheduled'; ?>&nbsp;||&nbsp; <b>=></b> <?php echo 'Int. Selected'; ?>&nbsp; ||&nbsp; <b>=> </b> <?php echo 'Offer Issued'; ?>
            ...
            <?php }elseif($result['app_status_id']==8 ){ ?>
             <?php echo 'Int. Scheduled'; ?>&nbsp;||&nbsp; <b>=></b> <?php echo 'Int. Selected'; ?>&nbsp; ||&nbsp; <b>=></b> <?php echo 'Offer Issued'; ?> &nbsp;||&nbsp; <b>=></b> <?php echo 'Offer Rejected'; ?>
             
            <?php }elseif($result['app_status_id']>=9 ){ ?>
             <?php echo 'Int. Scheduled'; ?>&nbsp;||&nbsp; <b>=></b> <?php echo 'Int. Selected'; ?>&nbsp; ||&nbsp; <b>=> </b> <?php echo 'Offer Issued'; ?> &nbsp;||&nbsp; <b>=></b> <?php echo 'Offer Accepted'; ?>
            <?php } ?><br><br />
            ...
            <?php if($result['cv_file']!=''){?>
                     <a href="javascript:;" class="btn btn-warning btn-xs" title="View Profile" onclick="open_client_cv_doc(<?php echo $result['candidate_id'];?>);"> View CV</a> || 
                      <a style="height: 22px; padding-top: 1px;" href= "<?php echo $this->config->item('cv_path').$result['cv_file'];?>" target="_blank" class="btn btn-info btn-sm">Download CV</a>
                    <?php } ?> 
...
|| <a href="javascript:;" title="Shortlist Candidates, see the list of jobs" onclick="connect_with_jobs(<?php echo $result['candidate_id'];?>);"  id="manage_shortlists" class="btn btn-info btn-xs">Swap Interview</a> ||
                    
                    
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>candidates_apps/edit_interview/?job_app_id=<?php echo $result['job_app_id'];?>&candidate_id=<?php echo $result['candidate_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change Time</a>
                    <?php } ?>
                    </td>
                  ...
                  <form class="form-horizontal form-bordered"  method="post" id="reject_interview_form" name="interview_form" action="<?php echo base_url(); ?>candidates_apps/reject_interview">
                    ...
                    <table class="hori-form">
                      <tbody>
                        ...
                        <tr>
                          <td>Notes</td>
                          <td><textarea name="reject_notes" cols="40" rows="10" id="reject_notes" style="width:400px;height:120px;"></textarea></td>
                        </tr>
                        <tr>
                          <td colspan="2"><span class="click-icons">
...
<div class="modal fade" id="myModal_reject" role="dialog" aria-labelledby="enquiry-modal-label">
 ...
 <script type="text/javascript">
	...
	jQuery('#city_idd').append('<option value="">Select City</option');
			
	if($('#country_id').val()=='')return;

		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_apps/getstate/',
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_apps/getcity2/',
		  ...
		  beforeSend:function(){
                ...
                jQuery('#city_idd').html('');
				jQuery('#city_idd').append('<option value="">Loading...</option');
		  },
		  ...
		  success:function(data){
			  if(data.success==true)
			  {
				  ...
				  {
					  if(index=='')
						 jQuery('#city_idd').append('<option value="'+ index +'" selected="selected">' + value + '</option');
					 else
						 jQuery('#city_idd').append('<option value="'+ index +'">' + value + '</option');
				 });
			  }else
			  {
			  	alert(data.success);
       ...
       // alert($('#level_id').val());
		...
		if($('#level_id').val()=='')return;
			$.ajax({
			  ...
			  data: { level_study: $('#level_id').val(),int_val:0},
			  dataType: 'json',
	...
	function open_client_cv(candidate_id)
{
	$('#show_client_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>candidates_apps/client_cv/?view="+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
