  ...
  <div class="container">
    <div class="details clearfix">
      <div class="client left">
        <h2 class="title"><?php echo $this->config->item('powered_by')?></h2>
        <p> <?php echo $this->config->item('powered_by_address')?><br>
          <?php echo $this->config->item('powered_by_address1')?> </p>
      </div>
      <div class="data right">
        <div class="title">Invoice <?php echo "FST".$invoice['payment_id'];?></div>
        <div class="date"> Date of Invoice: <?php echo date('d-m-Y',strtotime($invoice['date']));?><br>
          <br>
          
          <!--Due Date: 30/06/2014--> 
          
        </div>
        <div class="date"> Transaction ID: <?php echo $invoice['txnid'];?><br>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      ...
      <tbody>
        <tr>
          <td class="desc"><h3><?php echo $user_details['contact_name']; ?></h3>
            <?php echo $user_details['company_name']; ?></td>
          
          <!--<td class="qty">30</td>

						<td class="unit">₹<?php //echo number_format($items['invoice_amount'],2); ?></td>-->
...
<center>
  <input class="myPrntbtn phone-button" type="button" value="Print" onclick="window.print();" target="_blank" >
  <!--<input class="myPrntbtn phone-button" type="submit" value="Login" onclick="myFunction()" target="_blank" >-->
  <a style="padding-top: 3px; padding-bottom: 5px; font-size: 17px;" href="<?php echo base_url(); ?>payment_process" class="myPrntbtn phone-button"><b>Back</b></a>
</center>
</body>
</html>
<script>
