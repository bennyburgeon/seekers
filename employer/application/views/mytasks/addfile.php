                        ...
                        <div class="tab-content">
                        	...
                        	<div class="widget">
                                 <div class="widget-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?php echo $this->config->site_url();?>/mytasks/addfile/?tsk=<?php echo $tskid; ?>" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
