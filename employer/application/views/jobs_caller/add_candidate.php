...
<a href="<?php echo base_url();?>index.php/jobs_caller/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	&nbsp;&nbsp;&nbsp;
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobs_caller/add_candidate/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobs_caller/import_from_other_jobs_caller/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
