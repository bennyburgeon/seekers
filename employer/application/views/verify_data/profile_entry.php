...
<table class="hori-form">
    ...
    <a href="<?php echo $this->config->site_url();?>/verify_data" class="attach-subs subs">Back</a>
    </div>
<tbody>
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo site_url('verify_data/editCandidate'); ?>/<?php echo $candidate_id ?>" > 
...
<!--<a href="<?php echo $this->config->site_url();?>/verify_data/summary/<?php echo $formdata['candidate_id'] ?>" class="attach-subs subs">Done</a>-->
</span>
</td>
</tr>
</form>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form1" name="candidate_form1" action="<?php echo site_url('verify_data/update_profile_personal'); ?>/<?php echo $candidate_id ?>" > 
...
<tbody>
  ...
  <tr>
<td colspan="2"><?php if(isset($formdata['profile_list']['1']))echo $this->ckeditor->editor('cv_file1',$formdata['profile_list']['1']);else echo $this->ckeditor->editor('cv_file1')?> &nbsp;</td>
</tr>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form2" name="candidate_form2" action="<?php echo site_url('verify_data/update_profile_address'); ?>/<?php echo $candidate_id ?>" > 
...
<tr>
  <td><?php if(isset($formdata['profile_list']['2']))echo $this->ckeditor->editor('cv_file2',$formdata['profile_list']['2']);else echo $this->ckeditor->editor('cv_file2')?> &nbsp; </td>
  </tr>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form3" name="candidate_form3" action="<?php echo site_url('verify_data/update_profile_education'); ?>/<?php echo $candidate_id ?>" > 
...
<tbody>
  	...
  	<tr>
    <td> <?php if(isset($formdata['profile_list']['3']))echo $this->ckeditor->editor('cv_file3',$formdata['profile_list']['3']);else echo $this->ckeditor->editor('cv_file3')?>   &nbsp; </td>
        </tr>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="<?php echo site_url('verify_data/update_profile_profession'); ?>/<?php echo $candidate_id ?>">
...
<tr>
  <td> <?php if(isset($formdata['profile_list']['4']))echo $this->ckeditor->editor('cv_file4',$formdata['profile_list']['4']);else echo $this->ckeditor->editor('cv_file4')?> &nbsp;</td>
  </tr>
<tr>
<td id="step4-msg">
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo site_url('verify_data/update_profile_language'); ?>/<?php echo $candidate_id ?>"> 
...
<td>
<?php if(isset($formdata['profile_list']['5']))echo $this->ckeditor->editor('cv_file5',$formdata['profile_list']['5']);else echo $this->ckeditor->editor('cv_file5')?>
</td>
</tr>
...
<div class="table-tech specs hor">
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form6" name="candidate_form6" action="<?php echo site_url('verify_data/update_profile_tech_skills'); ?>/<?php echo $candidate_id ?>"> 
...
<td>
<?php if(isset($formdata['profile_list']['6']))echo $this->ckeditor->editor('cv_file6',$formdata['profile_list']['6']);else echo $this->ckeditor->editor('cv_file6')?>
</td>
</tr>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form7" name="candidate_form7" action="<?php echo site_url('verify_data/update_profile_certification'); ?>/<?php echo $candidate_id ?>">
...
<td>
<?php if(isset($formdata['profile_list']['7']))echo $this->ckeditor->editor('cv_file7',$formdata['profile_list']['7']);else echo $this->ckeditor->editor('cv_file7')?>
</td>
</tr>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form8" name="candidate_form8" action="<?php echo site_url('verify_data/update_profile_projects'); ?>/<?php echo $candidate_id ?>"> 
...
<td>
<?php if(isset($formdata['profile_list']['8']))echo $this->ckeditor->editor('cv_file8',$formdata['profile_list']['8']);else echo $this->ckeditor->editor('cv_file8')?>
</td>
</tr>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form9" name="candidate_form9" action="<?php echo site_url('verify_data/update_profile_sports'); ?>/<?php echo $candidate_id ?>"> 
...
<td>
<?php if(isset($formdata['profile_list']['9']))echo $this->ckeditor->editor('cv_file9',$formdata['profile_list']['9']);else echo $this->ckeditor->editor('cv_file9')?>
</td>
</tr>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form10" name="candidate_form10" action="<?php echo site_url('verify_data/update_profile_social'); ?>/<?php echo $candidate_id ?>"> 
...
<td>
<?php if(isset($formdata['profile_list']['10']))echo $this->ckeditor->editor('cv_file10',$formdata['profile_list']['10']);else echo $this->ckeditor->editor('cv_file10')?>
</td>
</tr>
...
<a href="<?php echo site_url('verify_data'); ?>" class="attach-subs tools"><img src="http://localhost/recruitment-hub/admin/assets/images/plus.png">Back to Listing</a>
</div>-->
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="" name=""   action="<?php echo site_url('verify_data/profile_completion'); ?>/<?php echo $candidate_id ?>" > 
...
<input type="submit" class="attach-subs tools" value="Done" id="" style="width:180px;">
        | 
        &nbsp;&nbsp;&nbsp;<a href="<?php echo site_url('verify_data'); ?>" class="attach-subs tools">
...
$( document ).ready(function() {
   ...
   $('#edit_candidate').click(function(){
		...
		if(isContactValid) {
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/editCandidate'); ?>",
				cache: false,				
				data: dataStringprop,
   ...
   $('#edit_candidate1').click(function(){
	   for ( instance in CKEDITOR.instances )
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_personal'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PASSPORT DETAILS
   ...
   for ( instance in CKEDITOR.instances )
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_address'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
for ( instance in CKEDITOR.instances )
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_education'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
   ...
   $('#save_candidate4').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_profession'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate5').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_language'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate6').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_tech_skills'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate7').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_certification'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate8').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_projects'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate9').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_sports'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate10').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/update_profile_social'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
