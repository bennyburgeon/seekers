...
<tr>
<td>&nbsp;<?php if(isset($profile_list['1']))echo html_entity_decode($profile_list['1']);?></td>
</tr>
</table>
</div>
...
<div class="table-tech specs hor">
  ...
  <h2 class="srevHd">Address</h2>
    ...
    <table align="right"  border="0">
        <tr>
        <td>&nbsp;<?php if(isset($profile_list['2']))echo html_entity_decode($profile_list['2']);?></td>
        </tr>
    </table>
    </div>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="frm_profile_status" name="frm_profile_status"   action="<?php echo site_url('verify_data/update_profile_status'); ?>/<?php echo $candidate_id ?>" > 
  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id ?>">
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="frm_profile_assessment" name="frm_profile_assessment"   action="<?php echo site_url('verify_data/update_profile_assessment'); ?>/<?php echo $candidate_id ?>" > 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="" name=""   action="<?php echo site_url('verify_data/process_completed'); ?>/<?php echo $candidate_id ?>" > 
  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id ?>">
...
//BEGIN category and functional area
   $('#edit_category').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/editCategory'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
...
$('#update_contract').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/add_contract_details'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
$('#update_lang').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/add_lang_details'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
 ...
 //onchange of job_category
	...
	$('#multiple_category').change(function() 
	{
		...
		if($('#multiple_category').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/verify_data/getfunction_multiple/',
