...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/company_leads/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<tr>
    ...
    <a href="<?php echo $this->config->site_url();?>/company_leads" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
