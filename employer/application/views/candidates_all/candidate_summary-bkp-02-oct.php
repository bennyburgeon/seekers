				 ...
				 <?php foreach($education_details as $key => $val){?>
                  <tr>
                    ...
                    <td><?php echo $val['mark_percentage'];?></td>
                     ...
                     <td><a href="<?php echo base_url().'index.php/candidates_all/delete_candidate_edu/?id='.$val['eucation_id'];?>&candidate_id=<?php echo $candidate_id;?>" class="btn btn-danger btn-xs">Delete</a></td>
         		 </tr>
  			     <?php } ?>
                </tbody>
		  	</table> 
        ...
        <td colspan="2" align="center" valign="top" class="borderTopNone">
            <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
                  ...
                  <tr>
                   ...
                   <td><a href="<?php echo base_url().'index.php/candidates_all/delete_candidate_contract/?';?>candidate_id=<?php echo $candidate_id?>" id="delete_candidate_followup" >Delete</a></td>
                  </tr>
   ...
   <!----------------Followup Details---------------------------->
	...
	?>		 	
								...
								<tr>
									...
									<td><a href="<?php echo base_url().'index.php/candidates_all/delete_candidate_followup/?id='.$val['candidate_follow_id']?>&candidate_id=<?php echo $candidate_id?>" id="delete_candidate_followup" >Delete</a></td>
         		 				</tr>;
				<?php } ?>
    ...
    <thead>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td width="10%"><a href="<?php echo base_url(); ?>index.php/candidates_all/remove_job_app/?job_id=<?php echo $job['job_id'];?>&candidate_id=<?php echo $candidate_id;?>"></a>Delete App</td>
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/candidates_all/get_candidate_education/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/candidates_all/get_candidate_professional/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/candidates_all/get_present_contract/',
