          ...
          <!--contenttitle-->
                ...
                <div class="tableoptions">
                 <button class="deletebutton radius3" title="table1" id="del_records" onClick="confirm_delete();">Delete Selected</button>&nbsp;
                  ...
                  <button class="radius3" onClick="window.location='<?php echo base_url();?>index.php/candidates_all/add'">Add New</button>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb">
			...
			?>
                        <tr>
                            ...
                            <td class="center"><a href="<?php echo base_url();?>index.php/candidates_all/edit/<?php echo $result['candidate_id']?>" class="edit">Edit</a> &nbsp;|&nbsp; <a href="<?php echo base_url();?>index.php/candidates_all/delete/<?php echo $result['candidate_id']?>" class="delete" onClick="return alert_delete();">Delete</a></td>
                        </tr>
