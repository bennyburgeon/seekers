               ...
               <form class="form-horizontal form-bordered"  method="post" id="update_candidate_profile" name="update_candidate_profile" action="<?php echo $this->config->site_url();?>/candidates_all/update_candidate_profile/<?php echo $candidate_id;?>" onSubmit="return validate_profile_form();"> 
                ...
                <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                 <input type="hidden" name="last_name" value="">
                    ...
                    <td>Age</td>
                     <td colspan="3"><input style="width:50px;" placeholder="Age"  type="text"  name="age" value="<?php echo $formdata['age']?>" id="age"></td>
                    </tr>
                    -->
                    ...
                    <tr>
                    <td>Skills</td>
                     <td colspan="3"> <input style="width:200px;" placeholder="Skills."  type="text"  name="skills" value="<?php echo $formdata['skills']?>" id="skills"> </td>
                     
                    </tr>

                    <tr>
                     <td>Other Details</td>
                     <td colspan="3"><input style="width:400px;" placeholder="Other Details."  type="text"  name="fee_comments" value="<?php echo $formdata['fee_comments']?>" id="fee_comments"></td>
                    </tr>
