...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="update_education_frm" action="<?php echo $this->config->site_url();?>/candidates_all/update_education/" name="update_education_frm" onSubmit="return update_edu_validate();" > 
...
<tr>
<td>University</td>
<td> <input placeholder="University" style="width:300px;"   type="text"  name="univ_name" value="<?php echo $formdata['univ_name']?>" id="univ_name"> </td>
</tr>
	...
	{	
		...
		if($('#upd_level_id').val()=='')return;
			...
			$.ajax({
			  ...
			  data: { level_study: $('#upd_level_id').val(),int_val:1},
			  dataType: 'json',
