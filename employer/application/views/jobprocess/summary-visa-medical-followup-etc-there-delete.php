                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/cert_attest" />
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/jobprocess/get_visa_details/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/jobprocess/get_cert_attest/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/jobprocess/get_visa_document/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/jobprocess/get_medical_details/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/jobprocess/get_ticket_details/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/jobprocess/get_ticket_followup/',
