...
<tbody>
   ...
   <form action="<?php echo $this->config->site_url();?>/vendors/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
  <?php echo form_hidden('vendor_id', $formdata["vendor_id"]);?>
