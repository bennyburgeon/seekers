						  ...
						  <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
								...
								<td width="100%" colspan="2" align="left" valign="top" style="font:Normal 15px Arial, Helvetica, sans-serif; color:#000; padding:8px 0px 6px 4px; line-height:22px;"><p><strong>
...
Please click on "view" against each candidate to get the CV displayed. Our consultant's evaluation and interview report is given also given in all the profiles.  
<br><br>
At the end of each CV displayed, there are options to select your feedback on the candidate. Also, there is option to suggest interview dates for candidates you are shortlisting. Your feedback, comments, if any, may be mentioned in the space given. 
<br><br>
 <p><strong><?php echo $job_role_name;?></strong><br>  <br>
                               ...
                               <?php } ?>
								...
								<?php echo $text_after_table;?>
                                 ...
                                 <strong> <?php echo $from_name;?></strong><br>
                                  ...
                                  <br>
                                  <br><img src="<?php echo base_url(); ?>assets/images/logo.png" /><br>
