...
<div class="profile_top">
  <div class="profile_top_left"> <a href="<?php echo base_url();?>index.php/jobs/manage/<?php echo $formdata['job_id'];?>">Summary</a>&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; 
    Search Candidates &nbsp;&nbsp;&nbsp;|| 
    <!-- 
&nbsp;&nbsp;&nbsp;
...
<table border="0" cellpadding="3" cellspacing="3" width="100%">
  <tbody>
    <tr>
      <td align="center" valign="top"> Search Candidates Database [Candidates alrady considered for this application list will not listed here.]</td>
    </tr>
     <tr>
          ...
          <table width="100%" border="1">
            <tbody>
              <tr>
                  ...
                  <td><input type="text" name="search_name" id="search_name" value="<?php echo $search_name;?>" 
                    placeholder="Name" ></td>
                    
                    <td><input type="text" name="search_email" id="search_email" value="<?php echo $search_email;?>" 
                  ...
                  <td><select class="form-control" id="cur_job_status" name="cur_job_status" style="width: 130px;">
                      ...
                      <option <?php if($cur_job_status==7)echo 'selected="selected"';?> value="7">Call after this month</option>
                        <option <?php if($cur_job_status==8)echo 'selected="selected"';?> value="8">job seeking / active</option>
                    </select>
                    </td>
              ...
              <!--     <select onchange="myFunction();" id="parent">
                        ...
                        <?php }?>
                        </select> $postdata['level_id'] -->
                    <?php echo form_dropdown('level_id', $edu_level_list, $level_id, 'style="width:150px;" id="level_id"');?></td>
                       
                <td width="15%" align="left" valign="middle"><?php echo form_dropdown('course_id', $edu_course_list, $course_id, 'id="course_id_edu" style="width:200px;" ');?></td>
                <td width="19%" align="left" valign="middle">
                <!-- 
                <select name="multiple_skill"  multiple="multiple"  class="js-example-basic-multiple-cert"  id="multiple_skill" style="width:200px;">
...
<select   name="exp_years_max"  style="width:100px;">
                ...
                <td width="13%" align="left" valign="middle"><input class="form-control" type="text" name="any_keywords" id="any_keywords" value="<?php echo $any_keywords;?>" placeholder="Any Keywords" style="width: 100px;;">
                </td>
                <td width="13%" align="left" valign="middle"><input class="form-control" type="text" name="all_keywords" id="search_name" value="<?php echo $all_keywords;?>" placeholder="All Keywords" style="width: 100px;"></td>
                -->
                ...
                <tr>
                   ...
                   <td><?php echo form_dropdown('job_folder_id',  $job_folders, $job_folder_id,'class="form-control " id="job_folder_id" style="width:150px"');?></td>
                    ...
                    &nbsp;&nbsp; <a style="background-color: #2980b9;" href="<?php echo base_url();?>index.php/jobs/search_candidate/<?php echo $id; ?>" class="attach-subs tools"> Reset </a>    
                </td>
    ...
    <tr>
      <td align="center" valign="top"><br>
        ...
        <form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>index.php/jobs/search_candidate/<?php echo $postdata['job_id'];?>">
          ...
          <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
            ...
            <thead>
              <tr>
                <th colspan="7" align="right"><button name="add_to_job" value="1"  title="table1">Shortlist</button>
                  
                  <!-- 
             | <button name="invite_to_job" value="1"  title="table1">Send Email</button>
             --> </th>
                <th width="10%" align="right"> Total - <?php echo $total_rows;?></th>
              </tr>
              <tr>
                ...
                <th class="head0">Current CTC</th>
                <th class="head0">Exp. CTC</th>
			...
			?>
              <tr>
                ...
                <td><?php echo $result['first_name'].' '.$result['last_name'];?> &nbsp;
                  <?php if(($result['candidate_id']==$result['emailed']) && $result['emailed']!=''){?>
                  &nbsp;&nbsp;&nbsp;<a href="javascript:;" title="Emailed." class="btn btn-info btn-xs">Emailed </a>
                  <?php } ?></td>
                <td><?php echo $result['username']?></td>
                <td><?php echo $result['total_experience']?></td>
                <td class="center"><?php echo $result['current_ctc']?></td>
                <td class="center"><?php echo $result['expected_ctc']?></td>
                <td class="center"><?php echo $result['notice_period']?></td>
                <td class="center"><a href="javascript:;" title="Add to Applications"  data-url="<?php echo base_url(); ?>index.php/jobs/add_candidate_to_job/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_candidate_to_job" class="btn btn-info btn-xs"> Add to Job </a> | 
