...
<tr>
    ...
    <tr>
     <td>Job Skills</td>
        <td><?php echo form_dropdown('skill_id[]', $skill_list, $formdata['skill_id'],'class="form-control hori" id="skill_id" multiple style="height:100px;"');?>
        </td>
    </tr>
...
// get functional area based on industry.
