...
<a href="<?php echo base_url();?>index.php/candidates_ctc/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
</div>
...
<table class="tool-table new">
    ...
    ?>
        ...
        <tr class="odd gradeX">
            ...
            <td>			
            <a href="<?php echo base_url();?>index.php/candidates_ctc/summary/<?php echo $result['candidate_id']?>" target="_blank" class="views" title="View"> <strong><?php echo $result['first_name']?></strong></a> 
...
function add_consultant_feedback(candidate_id){
	...
	$('#show_consultant_feedback').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/candidates_ctc/open_consultant_feedback/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
...
function add_candidate_notes(candidate_id){
	...
	$('#show_all_notes').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/candidates_ctc/get_all_notes/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
