    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <div class="gragh-area"> 
          ...
          <h3>Recent Applications List</h3>
        ...
        <td><a href="<?php echo $this->config->item('site_url');?>candidates_apps/summary/<?php echo md5($val['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $val['first_name'];?></a></td>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($val['candidate_id']); ?>" title="View Profile" target="_blank" title="View Profile"><?php echo $val['first_name'];?></a></td>
