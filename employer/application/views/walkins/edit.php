...
<tbody>
   ...
   <form action="<?php echo $this->config->site_url();?>/walkins/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
...
<tr>
  ...
  <input type="text"  class="form-control hori" placeholder="Enter text" value="<?php echo $formdata["interview_date_from"] ?>"  name="interview_date_from" id="interview_date_from">
...
<tr>
  ...
  <input type="text"  class="form-control hori" placeholder="Enter text" value="<?php echo $formdata["interview_date_to"] ?>"  name="interview_date_to" id="interview_date_to">
...
<tr>
 ...
 <?php echo form_dropdown('interview_time_from', $time_array, $formdata['interview_time_from'],'class="form-control hori" id="interview_time_from"');?>
...
<tr>
  ...
  <td>
  <?php echo form_dropdown('interview_time_to', $time_array, $formdata['interview_time_to'],'class="form-control hori" id="interview_time_to"');?> 
...
<tr>
  <td>Report At</td>
  <td>
   <?php echo form_dropdown('report_time', $time_array, $formdata['report_time'],'class="form-control hori" id="report_time"');?> 
...
<td><input type="text" class="form-control" placeholder="List of materials need to take for interview" value="<?php echo $formdata["materials"] ?>"  name="materials" id="materials"></td>
    ...
    <td colspan="2"> <?php echo form_upload(array('name'=>'file_name','class'=>'smallinput', ''));?>
    </td>
    </tr>
...
<tr>
  ...
  <a href="<?php echo $this->config->site_url();?>/walkins" class="attach-subs subs">Cancel</a>
  </span>
  </td>
</tr>
</form>
