    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          ...
          <div class="right-btns"> <a href="<?php echo base_url();?>index.php/walkins/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> <a href="#" id="deleteall" class="attach-subs tools"><img src="<?php echo base_url('assets/images/deletes_new.png');?>">Delete</a> </div>
          <table class="tool-table">
          <tbody>
          <form id="searchForm">
            <tr>
              <td><input class="form-control" type="text" name="searchterm" id="search_term" placeholder="Search..." style="width: 185px;"></td>
...
// if($_SESSION['company_session']== $result['user_id']) { ?>
                <tr class="odd gradeX">
                  ...
                  <td><?php echo $result["job_title"]; ?><br>
                    ...
                    Date From:<strong><?php echo $result["interview_date_from"]; ?> To <?php echo $result["interview_date_to"]; ?></strong>,  Time From:<strong><?php echo $result["interview_time_from"]; ?> To <?php echo $result["interview_time_to"]; ?></strong><br>
                  ...
                  <td><?php if($result['int_status']=='1'){?>
                    ...
                    <?php } ?></td>
                  <td><a href="<?php echo base_url();?>index.php/walkins/edit/<?php echo $result['interview_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a></td>
                </tr>
                <?php
}}else{?>
                <tr>
