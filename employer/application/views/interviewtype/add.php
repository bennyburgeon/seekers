...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li><a href="<?php echo $this->config->site_url();?>/interviewtype">Interview Type</a>
                            ...
                            <li><a href="#">Add Interview Type</a></li>
      </ul>
</div>

<div class="row">
<div class="col-sm-12">
<div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3>Add Interview Type</h3></div>
...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/interviewtype/add" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();">
    <tr>
