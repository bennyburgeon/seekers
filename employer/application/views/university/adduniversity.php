...
<tbody>
      <form action="<?php echo $this->config->site_url();?>/university/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
    <tr>
    ...
    <tr>
    <td>Address</td>
    <td><input  name="univ_address"  id="univ_address" class="form-control hori " type="text" value="<?php echo $formdata['univ_address'];?>"></td>
    </tr>
    <tr>
    <td>Country</td>
    ...
    <td>Logo</td>
     <td> 
     <?php echo form_upload(array('name'=>'univ_logo','class'=>'form-data'));?>     </td>
    </tr>
    ...
    <tr>
    <td>University Profile</td>
    <td>
   <!-- <textarea name="univ_details" id="main_cont" rows="40" cols="40" ><?php echo $formdata['univ_details'];?></textarea>-->
   <?php echo $this->ckeditor->editor('univ_details',$formdata['univ_details']);?>    </td>
    </tr>
