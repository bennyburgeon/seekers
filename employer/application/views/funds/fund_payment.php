  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="table-tech specs">
        <div class="right-btns"> <a href="<?php echo base_url();?>jobs/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> 
          <!-- 
...
-->: </div>
          ...
          <table class="tool-table new">
            <thead>
              <tr role="row" class="heading">
                <th width="61"><div class="checker"><span>#<!-- <input type="checkbox" class="group-checkable" id="selectall">--></span></div></th>
                <th width="580"><a href="<?php echo $this->config->site_url()?>jobs?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>
        &rows=<?php echo $rows;?>">Job Title</a></th>
                <th width="110">Posted On</th>
                <th width="99">Expires</th>
                <th width="191">Actions </th>
              </tr>
            </thead>
            <tbody>
              <?php 
	if($records!=NULL)
	{
		foreach($records as $result){ ?>
              <tr class="odd gradeX">
                <td><div class="checker"> <span> UNC-<?php echo $result['job_id']?> </span> </div></td>
                <td><a href="<?php echo base_url();?>jobs/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job"><?php echo $result['job_title']?></a><br>
                  ...
                  <?php if($result['job_status']==0) echo "Waiting or Approvel"; ?>
                  <?php if($result['job_status']==1) echo "Active"; ?></td>
             ...
             || 
              --> 
                 ...
                 || <a href="<?php echo base_url();?>jobs/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job">View Applications</a></td>
              </tr>
              <?php
	}}else{?>
              <tr>
