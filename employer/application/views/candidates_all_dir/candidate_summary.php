...
<ul>
    <li><a href="<?php echo $this->config->site_url();?>/candidates_all_dir/add" >Add New</a></li>
    <li><a href="<?php echo $this->config->site_url();?>/candidates_all_dir" >List All</a></li>
    <li><!-- <a href="<?php echo base_url();?>index.php/candidates_all_dir/candidate_delete/<?php echo md5($detail_list['candidate_id']);?>">Delete this profile</a>--></li>
</ul>
          ...
          <tr>
            ...
            <?php } ?> </td>
                    ...
                    <?php if(is_array($candidate_locations)){?>                
                      <tr>
                        <td colspan="4">Preferred Locations:                   
                      <?php echo implode(',',$candidate_locations);?>                    
                        </td>
                      </tr>
					<?php 				
                    }									
                    ...
                    <?php if(is_array($candidate_industries)){?>                
                      <tr>
                        <td colspan="4">Industry:                   
                      <?php echo implode(',',$candidate_industries);?>                    
                        </td>
                      </tr>
					<?php 				
                    }									
                    ...
                    <?php if(is_array($candidate_functional_areas)){?>                
                      <tr>
                        <td colspan="4">Functional Areas:                   
                      <?php echo implode(',',$candidate_functional_areas);?>                    
                        </td>
                      </tr>
					<?php 				
                    }									
                    ...
                    <?php if(is_array($candidate_roles)){?>                
                      ...
                      <?php echo implode(',',$candidate_roles);?>                    
                        </td>
                      </tr>
					<?php 				
                    }									
...
<table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    <td width="22%">
                      ...
                      <a href="<?php echo site_url().'/candidates_all_dir/delete_photo/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Photo?');" style="color:#0033FF">Delete Photo</a>&nbsp;&nbsp;</span> 
                    ...
                    <td width="78%"><form class="form-horizontal form-bordered"  method="post" id="upload_cv_photo_frm" name="upload_cv_photo_frm" action="<?php echo $this->config->site_url();?>/candidates_all_dir/upload_cv_photo/<?php echo $formdata['candidate_id'];?>" enctype="multipart/form-data"> 
        	...
        	<div id="success"></div>
                  ...
                  <tr>
                    <td colspan="2">
                    <!-- 
                                <a href="<?php echo base_url().'index.php/candidates_all_dir/print_cv/'.$candidate_id;?>" target="_blank" class="btn btn-info btn-sm">Print CV</a> -->
                ...
                <a href="<?php echo site_url().'/candidates_all_dir/delete_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Candidate CV?');" class="btn btn-danger btn-sm">Delete Candidate CV</a> 
                ...
                <a href="<?php echo site_url().'/candidates_all_dir/delete_client_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Client CV?');" class="btn btn-danger btn-sm">Delete Client CV</a> <?php } ?> 
...
<td colspan="2" align="center" valign="top" class="borderTopNone"> 
				 ...
				 <?php foreach($education_details as $key => $val){?>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url().'index.php/candidates_all_dir/delete_candidate_edu/?id='.$val['eucation_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
                     
                     <a href="javascript:void();" data-url="<?php echo base_url().'index.php/candidates_all_dir/loadEditEducationhtml/?edu_id='.$val['eucation_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_edu" class="btn btn-info btn-xs">Edit This</a>
                     </td>
         		 </tr>
        ...
        <td colspan="2" align="center" valign="top">
         ...
         <table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    ...
                    <a href="<?php echo base_url().'index.php/candidates_all_dir/delete_candidate_prof/?id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> ||
                    
                      <!--    
                       <a href="<?php echo base_url().'index.php/candidates_all_dir/summary/'.$candidate_id.'/?edit_job=1&job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile_url" class="btn btn-info btn-xs">Edit</a>  
                    
                       
                    
                    update with editor
                    -->
                       <a href="javascript:void();" data-url="<?php echo base_url().'index.php/candidates_all_dir/loadEditJobhtml/?job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile" class="btn btn-info btn-xs">Edit Profession</a>  
        ...
        <td colspan="2" align="center" valign="top" class="borderTopNone">
            <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
                  ...
                  <tr>
                   ...
                   <td><a href="<?php echo base_url().'index.php/candidates_all_dir/delete_candidate_contract/?';?>candidate_id=<?php echo $candidate_id?>" id="delete_candidate_followup" >Delete</a></td>
                  </tr>
    ...
    <tr>
            ...
            <thead>
             	 ...
             	 <tbody>
                        ...
                        <td width="5%"><?php if($job['applied']==1) { echo "<span class='btn btn-success btn-xs disabled'>Applied</span>"; }else{?> <a href="<?php echo $this->config->site_url();?>/candidates_all_dir/apply_job/<?php echo $candidate_id;?>/<?php  echo $job['job_id'];?>" title="Click here to apply job." class="btn btn-primary btn-xs"> Apply </a><?php } ?></td>
...
<li id="tab_2btn">Send Message</li>
    ...
    <form action="<?php echo $this->config->site_url();?>/candidates_all_dir/manage_email/<?php echo $candidate_id;?>" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onsubmit="return email_validate();" >  
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="update_candidate_profile" name="update_candidate_profile" action="<?php echo $this->config->site_url();?>/candidates_all_dir/update_candidate_profile/<?php echo $candidate_id;?>" onSubmit="return validate_profile_form();"> 
                ...
                <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                 <input type="hidden" name="last_name" value="">
                    ...
                    <td>DoB</td>
                     <td colspan="3">
                     <input style="width:200px;" type="text" readonly name="date_of_birth" id="datepicker2" class="datepicker"                                 value="<?php echo $formdata['date_of_birth'];?>" placeholder="DoB">
                                            </td>
                    </tr>
            ...
            <td>Industry</td>
            <td colspan="3">	
            <?php echo form_dropdown('job_cat_id', $industries_list, array_keys($candidate_industries),'class="form-control" id="job_cat_id"');?>
            </td>
            </tr>
            ...
            <td colspan="3">	
            <?php echo form_dropdown('func_id', $functional_list, array_keys($candidate_functional_areas),'class="form-control" id="func_id"');?>
            </td>
            </tr>
                ...
                <tr>
 				...
 				<td colspan="3">
                	<?php echo form_dropdown('desig_id', $roles_list, array_keys($candidate_roles),'class="form-control" id="desig_id"');?>               
                    </td>
 				</tr>
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="edu_history_frm" name="edu_history_frm" action="<?php echo $this->config->site_url();?>/candidates_all_dir/edu_history_2/<?php echo $candidate_id;?>" onSubmit="return candidate_validate();"> 
                <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                    <table class="hori-form">
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="job_history_frm" name="job_history_frm" action="<?php echo $this->config->site_url();?>/candidates_all_dir/job_history_2/<?php echo $candidate_id;?>" onSubmit="return job_validate();" > 
	<table class="hori-form">
			<tbody>
      ...
      <div class="modal-body">
        ...
        <div class="notes">
        	...
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="candidate_validate" name="candidate_validate" action="<?php echo $this->config->site_url();?>/candidates_all_dir/lang_history_2/<?php echo $candidate_id;?>">
...
<form class="form-horizontal form-bordered"  method="post" id="skill_form" name="skill_form" action="<?php echo $this->config->site_url();?>/candidates_all_dir/skills_2/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
<form class="form-horizontal form-bordered"  method="post" id="cert_form" name="cert_form" action="<?php echo $this->config->site_url();?>/candidates_all_dir/add_certification/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
<form class="form-horizontal form-bordered"  method="post" id="cert_form" name="cert_form" action="<?php echo $this->config->site_url();?>/candidates_all_dir/followup/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
    ...
    <div class="notess">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="edit_category_frm" name="edit_category_frm" action="<?php echo $this->config->site_url();?>/candidates_all_dir/editCategory/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
<div class="modal fade" id="primaryModal" role="dialog" aria-labelledby="enquiry-modal-label">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="edit_skill_form" name="edit_skill_form" action="<?php echo $this->config->site_url();?>/candidates_all_dir/editSkills/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
<form class="form-horizontal form-bordered"  method="post" id="add_contract_form" name="add_contract_form" action="<?php echo $this->config->site_url();?>/candidates_all_dir/add_contract_details/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
<!--SCRIPT FOR EDUCATION MODAL END-->
	...
	$('#multiple_category').change(function() 
	{
		...
		if($('#multiple_category').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/candidates_all_dir/getfunction_multiple/',
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/candidates_all_dir/download_cv_content/"+candidate_id,
			method: "POST",
