...
-->
    ...
    ?>
            ...
            --> 
                  ...
                  <br>
                  Last Profile Udate:
                  <?php if(isset($result['status_updated_on'])  && $result['status_updated_on']!='0000-00-00')echo $result['status_updated_on'];else echo 'Not Updated'?><br>
                 ...
                 <!-- DoB: <br>
                  ...
                  <br>-->
                   ...
                   <?php if($result['company_phone']!=''){?>
                   <a href="javascript:;" class="btn btn-danger btn-xs">Shortlisted</a>
                            <?php } else { ?>
