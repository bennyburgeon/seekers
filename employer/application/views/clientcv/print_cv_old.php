  ...
  <table width="100%" border="0">
    <tbody>
      ...
      <tr>
        ...
        <td>
		<?php if(isset($feedback['feedback_domain'])&& $feedback['feedback_domain']!='')echo $feedback['feedback_domain'];else echo 'Not Updated';?>
        </td>
      </tr>
...
if($personal['cv_file']!='')
			{
				$out_put_str='';
 				$file_name='http://<?php echo $this->config->item('websites'); ?>hr.in/rms/uploads/cvs/'.$personal['cv_file'];
