  ...
  <div id ="step2" style="margin-top: 10px;">
    <div class="specs hor">
      <div class="container">
        ...
        <h4>
          <?php //echo $job_details['job_title'];?>
        </h4>
        <div class="line"></div>
      </div>
    </div>
    ...
    <table width="100%" border="0">
      <tbody>
        <tr>
          ...
          <td width="22%"><?php if($personal['age']>1)echo $personal['age'].' Years';else echo 'Not Updated';?>
            &nbsp; |
            <?php if($personal['date_of_birth']!='' && $personal['date_of_birth']!='0000-00-00')echo date("d, M Y", strtotime($personal['date_of_birth']));else echo 'Not Updated';?></td>
          <td width="15%" class="label_values" >Current Salary</td>
          <td width="14%">
<?php if(isset($personal['current_ctc']) && $personal['current_ctc']!=''){ echo $this->config->item('currency_symbol')." ".number_format((double)$job_search['current_ctc'],2);}else{ echo 'not updated';}?></td>
          <td width="25%" rowspan="8"><?php if(file_exists('uploads/photos/'.$personal['photo']) && $personal['photo']!=''){?>
            <span id="imgTab2"><img src="<?php echo base_url().'uploads/photos/'.$personal['photo'];?>" style="width:158px;height:100px;"><br />
            </span>
            <?php }else{ ?>
        ...
        <tr>
          ...
          <td  >
            <?php if(isset($personal['expected_ctc']) && $personal['expected_ctc']!=''){ echo $this->config->item('currency_symbol')." ".number_format((double)$personal['expected_ctc'],2);}else{ echo 'not updated';}?></td>
        </tr>
        <tr>
          ...
          <td>
            <?php if(isset($personal['notice_period']) && $personal['notice_period']!=0){ echo $personal['notice_period'].'&nbsp; Days';}else{ echo 'not updated';}?></td>
        </tr>
        <tr>
          ...
          <td>
              <?php if(isset($personal['total_experience']) && $personal['total_experience']!=0){ echo $personal['total_experience'].'&nbsp; Years';}else{ echo 'not updated';}?>
             </td>
        </tr>
        <tr>
          ...
          <td><?php if(isset($personal['current_location']) && $personal['current_location']!=0){ echo $personal['current_location'];}else{ echo 'not updated';}?></td>
        </tr>
        <tr>
          ...
          <td><?php if(isset($personal['visa_type']) && $personal['visa_type']!=0){ echo $personal['visa_type'];}else{ echo 'not updated';}?></td>
        </tr>
        <tr>
...
-->
  ...
  <?php } ?>
  <?php if($skills_primary!=''){?>
  <div class="container">
    <h5>Primary Skills</h5>
    <table width="100%" border="0" cellpadding="5" cellspacing="5">
      <tbody>
        <tr>
          <td width="24%" class="label_values" ><strong>Primary Skills</strong></td>
          <td width="76%"><strong><?php echo $skills_primary;?></strong></td>
        </tr>
      </tbody>
    </table>
    <div class="line"></div>
  ...
  <?php } ?>
  <?php if($skills_secondary!=''){?>
  <div class="container">
    <h5>Supporting Skills</h5>
    <table width="100%" border="0" cellpadding="5" cellspacing="5">
      <tbody>
        <tr>
          <td width="24%" class="label_values" ><strong>Supporting Skills</strong></td>
          <td width="76%"><strong><?php echo $skills_secondary;?></strong></td>
        </tr>
      </tbody>
    </table>
    <div class="line"></div>
  ...
  <div class="container">
    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="5">
      <tbody>
        <tr>
          <td width="24%" class="label_values" ><strong>Certifications</strong></td>
          <td width="76%"><strong><?php echo $certifications;?></strong></td>
        </tr>
      </tbody>
    </table>
    <div class="line"></div>
...
?>
        <tr>
          ...
          <td><strong><?php echo $item['course'];?></strong></td>
          <td><strong>Finance</strong></td>
          <td><strong><?php echo $item['univ'];?></strong>&nbsp;</td>
          <td><strong><?php echo $item['edu_country'];?></strong></td>
          <td><strong><?php if($item['edu_year']!=''){ echo $item['edu_year']; } else { echo 'Not Updated'; }?></strong></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>
...
if($personal['cv_file']!='')
			{
				$out_put_str='';
 				$file_name=$this->config->item('website').'/rms/uploads/cvs/'.$personal['cv_file'];
    ...
    <table width="100%" border="0">
      <tbody>
        <tr>
          ...
          <td width="76%"><?php if(isset($feedback['feedback_general'])&& $feedback['feedback_general']!='')echo $feedback['feedback_general'];else echo 'Not Updated';?></td>
        </tr>
        <tr>
          <td class="label_values" ><strong>Industry Experience</strong></td>
          <td><?php if(isset($feedback['feedback_industry'])&& $feedback['feedback_industry']!='')echo $feedback['feedback_industry'];else echo 'Not Updated';?></td>
        </tr>
        <tr>
          <td class="label_values" ><strong>Education</strong></td>
          <td><?php if(isset($feedback['feedback_education'])&& $feedback['feedback_education']!='')echo $feedback['feedback_education'];else echo 'Not Updated';?></td>
        </tr>
        <tr>
          <td class="label_values" ><strong>Skills</strong></td>
          <td><?php if(isset($feedback['feedback_skills'])&& $feedback['feedback_skills']!='')echo $feedback['feedback_skills'];else echo 'Not Updated';?></td>
        </tr>
        <tr>
          <td class="label_values"><strong>Salary</strong></td>
          <td ><?php if(isset($feedback['feedback_salary'])&& $feedback['feedback_salary']!='')echo $feedback['feedback_salary'];else echo 'Not Updated';?></td>
        </tr>
        <tr>
          <td class="label_values" ><strong>Others</strong></td>
          <td><?php if(isset($feedback['feedback_domain'])&& $feedback['feedback_domain']!='')echo $feedback['feedback_domain'];else echo 'Not Updated';?></td>
        </tr>
      </tbody>
    </table>
  </div>
