...
<?php echo form_hidden('user_id', $_SESSION['company_session']);?>
<tbody>
<tr>
<td>First name</td>
<td>
...
<tr>
<td>Email Address</td>
<td><input type="text" placeholder="Enter Email" value="<?php echo $formdata["email"] ?>"  name="email" id="email" class="form-control hori" readonly>	</td>
</tr>
<tr>
  <td>User name</td>
