...
<tbody>
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo site_url('candidates_all/editCandidate'); ?>/<?php echo $candidate_id ?>" > 
...
<!--<a href="<?php echo $this->config->site_url();?>/candidates_all/summary/<?php echo $formdata['candidate_id'] ?>" class="attach-subs subs">Done</a>-->
</span>
</td>
</tr>
</form>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form1" name="candidate_form1" action="<?php echo site_url('candidates_all/update_profile_personal'); ?>/<?php echo $candidate_id ?>" > 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form2" name="candidate_form2" action="<?php echo site_url('candidates_all/update_profile_address'); ?>/<?php echo $candidate_id ?>" > 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form3" name="candidate_form3" action="<?php echo site_url('candidates_all/update_profile_education'); ?>/<?php echo $candidate_id ?>" > 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="<?php echo site_url('candidates_all/update_profile_profession'); ?>/<?php echo $candidate_id ?>">
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo site_url('candidates_all/update_profile_language'); ?>/<?php echo $candidate_id ?>"> 
...
<div class="table-tech specs hor">
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form6" name="candidate_form6" action="<?php echo site_url('candidates_all/update_profile_tech_skills'); ?>/<?php echo $candidate_id ?>"> 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form7" name="candidate_form7" action="<?php echo site_url('candidates_all/update_profile_certification'); ?>/<?php echo $candidate_id ?>">
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form8" name="candidate_form8" action="<?php echo site_url('candidates_all/update_profile_projects'); ?>/<?php echo $candidate_id ?>"> 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form9" name="candidate_form9" action="<?php echo site_url('candidates_all/update_profile_sports'); ?>/<?php echo $candidate_id ?>"> 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form10" name="candidate_form10" action="<?php echo site_url('candidates_all/update_profile_social'); ?>/<?php echo $candidate_id ?>"> 
...
$( document ).ready(function() {
   ...
   $('#edit_candidate').click(function(){
		...
		if(isContactValid) {
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/editCandidate'); ?>",
				cache: false,				
				data: dataStringprop,
   ...
   $('#edit_candidate1').click(function(){
	   for ( instance in CKEDITOR.instances )
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_personal'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PASSPORT DETAILS
   ...
   for ( instance in CKEDITOR.instances )
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_address'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
for ( instance in CKEDITOR.instances )
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_education'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
   ...
   $('#save_candidate4').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_profession'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate5').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_language'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate6').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_tech_skills'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate7').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_certification'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate8').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_projects'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate9').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_sports'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
   ...
   $('#edit_candidate10').click(function(){
	   ...
	   for ( instance in CKEDITOR.instances )
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_mgmt/update_profile_social'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
