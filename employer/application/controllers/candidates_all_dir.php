<?php class Candidates_all_dir extends CI_Controller 
{
	...
	{	
		...
		$this->data['rows']='';
		$this->load->model('candidates_alldirmodel');
		...
		if($this->input->get('total_experience'))
		{
			$this->data['total_experience']=$this->input->get('total_experience');
		}

		if($this->input->post('total_experience'))
		{
			$this->data['total_experience']=$this->input->post('total_experience');
		}
		...
		$this->data['total_rows']= $this->candidates_alldirmodel->record_count($this->data['search_email'],$this->data['search_name'],$this->data['search_mobile'],$this->data['cur_job_status'],$this->data['reg_status'],$this->data['skills'],$this->data['level_id'],$this->data['course_id'],$this->data['spcl_id'],$this->data['exp_years'],$this->data['lead_source'],$this->data['job_folder_id'],$this->data['job_cat_id'],$this->data['func_id'], $this->data['desig_id'], $this->data['city_id'], $this->data['pref_city_id'], $this->data['total_experience_from'], $this->data['total_experience_to'], $this->data['expected_ctc_from'], $this->data['expected_ctc_to'], $this->data['notice_period_from'], $this->data['notice_period_to']);
			
		$this->data['cur_page']=$this->router->class;
		
		$config['base_url'] = $this->config->item('base_url')."candidates_all_dir/?sort_by=".$this->data['sort_by']."&limit=".$this->data['limit']."&search_name=".$this->data['search_name']."&search_email=".$this->data['search_email']."&search_mobile=".$this->data['search_mobile']."&"."cur_job_status=".$this->data['cur_job_status']."&reg_status=".$this->data['reg_status']."&skills=".$this->data["skills"]."&level_id=".$this->data["level_id"]."&course_id=".$this->data["course_id"]."&spcl_id=".$this->data["spcl_id"]."&exp_years=".$this->data["exp_years"]."&lead_source=".$this->data['lead_source']."&job_folder_id=".$this->data['job_folder_id']."&job_cat_id=".$this->data['job_cat_id']."&func_id=".$this->data['func_id']."&desig_id=".$this->data['desig_id']."&city_id=". $this->data['city_id']."&pref_city_id=".$this->data['pref_city_id']."&total_experience_from=".$this->data['total_experience_from']."&total_experience_to=".$this->data['total_experience_to']."&expected_ctc_from=".$this->data['expected_ctc_from']."&expected_ctc_to=".$this->data['expected_ctc_to']."&notice_period_from=".$this->data['notice_period_from']."&notice_period_to=".$this->data['notice_period_to'];
		...
		$this->data["records"] = $this->candidates_alldirmodel->get_list($this->data['start'],$this->data['limit'],$this->data['search_email'],$this->data['search_name'],$this->data['search_mobile'],$this->data['sort_by'],$this->data['cur_job_status'],$this->data['reg_status'],$this->data['skills'],$this->data['level_id'],$this->data['course_id'],$this->data['spcl_id'],$this->data['exp_years'],$this->data['lead_source'],$this->data['job_folder_id'],$this->data['job_cat_id'],$this->data['func_id'], $this->data['desig_id'], $this->data['city_id'], $this->data['pref_city_id'], $this->data['total_experience_from'], $this->data['total_experience_to'], $this->data['expected_ctc_from'], $this->data['expected_ctc_to'], $this->data['notice_period_from'], $this->data['notice_period_to']);
			
		$this->load->model('candidates_alldirmodel'); 
		
		$this->data['page_head']= 'Search Candidates';		
		$this->data['formdata']=array('admin_id' =>'');
		$this->data['admin_users_lists']= $this->candidates_alldirmodel->get_admin_users_lists();
		$this->data['all_jobs_list']= $this->candidates_alldirmodel->all_jobs_list();
		
		$this->data["reg_status_list"] = $this->candidates_alldirmodel->reg_status_list();
		
		// Technical Skils		
		$this->data['skill_list']=$this->candidates_alldirmodel->get_parent_skills();
		...
		if(!empty($skill))
		{
			...
			$this->data['child_skills']	=	$this->candidates_alldirmodel->get_child_skills($res1[0]['skill_id']);
		}

		//Education details
		$this->data["edu_level_list"] = $this->candidates_alldirmodel->edu_level_list();
		...
		{
			$this->data["edu_course_list"]  = array('' => 'Qualification');
		}

		$this->data["city_list"]                  = $this->candidates_alldirmodel->city_list();
		$this->data["pref_city_list"]             = $this->candidates_alldirmodel->pref_city_list();
		$this->data["industry_list"]              = $this->candidates_alldirmodel->industries_list();
		$this->data["department_list"]            = $this->candidates_alldirmodel->functional_list();
		$this->data["roles_list"]                 = $this->candidates_alldirmodel->fill_roles();
		...
		$expected_ctc_to_array=array(''  =>  'CTC To', '10000'  =>  'INR 10000', '15000'  =>  'INR 15000', '20000'  =>  'INR 20000', '25000'  =>  'INR 25000', '30000'  =>  'INR 30000', '35000'  =>  'INR 35000', '40000'  =>  'INR 40000', '45000'  =>  'INR 45000', '50000'  =>  'INR 50000', '55000'  =>  'INR 55000', '60000'  =>  'INR 60000', '60000'  =>  'INR 60000', '65000'  =>  'INR 65000', '70000'  =>  'INR 70000');
		 ...
		 $notice_period_from_array=array(''  =>  'Notice Period From', '10'  =>  '10 DAYS',  '15'  =>  '15 DAYS', '20'  =>  '20 DAYS', '30'  =>  '30 DAYS', '45'  =>  '45 DAYS', '60'  =>  '60 DAYS', '75'  =>  '75 DAYS', '90'  =>  '90 DAYS');
		 $this->data["notice_period_from_array"]  =$notice_period_from_array; 
		 
		$notice_period_to_array=array(''  =>  'Notice Period To', '15'  =>  '15 DAYS', '20'  =>  '20 DAYS', '30'  =>  '30 DAYS', '45'  =>  '45 DAYS', '60'  =>  '60 DAYS', '75'  =>  '75 DAYS', '90'  =>  '90 DAYS');
		...
		$this->data['job_folders']=$this->candidates_alldirmodel->get_job_folders();
		$this->data['job_status_list']=$this->candidates_alldirmodel->get_job_status();
		
		
		$this->data["edu_spec_list"] = $this->candidates_alldirmodel->edu_spec_list();
		$this->data["years_list"] = $this->candidates_alldirmodel->years_list();
		
		$this->load->view('public_include/header',$this->data);
		$this->load->view('candidates_all_dir/candidateslist',$this->data);				
		$this->load->view('public_include/footer',$this->data);	
	}
	...
	{	
		...
		$this->data['job_folders']                =$this->candidates_alldirmodel->get_job_folders();
		$this->data['job_status']                 =$this->candidates_alldirmodel->get_job_status();
		
		$this->data["edu_course_list"]            = $this->candidates_alldirmodel->edu_course_list();
		...
		$this->data["years_list"]                 = $this->candidates_alldirmodel->years_list();
		$this->data["months_list"]                = $this->candidates_alldirmodel->months_list();	
		
		$this->data['page_head']= 'Add Candidate';
		$this->load->view('public_include/header',$this->data);
		$this->load->view('candidates_all_dir/addcandidates',$this->data);	
		$this->load->view('public_include/footer',$this->data);
	}
	...
	function addCandidate(){
		...
		{ 
			...
			$id = $this->candidates_alldirmodel->insert_candidate_record();
			if ($id != '') { 			
				...
				if(isset($_FILES['cv_file'])){
					...
					{       				
						...
						if ($this->upload->do_upload('cv_file'))
						{
							...
							$this->candidates_alldirmodel->insert_files($dataArr);
									$cv_file=1;
						}
					}
				}	
	...
	function update_candidate_profile()
	{
		if( $this->input->post('candidate_id')!='')
		{
			...
			$this->candidates_alldirmodel->update_candidate_record($candidate_id,$data_profile,$data_job);
			$this->candidates_alldirmodel->update_role_designation($candidate_id, $this->input->post('desig_id'));
			$this->candidates_alldirmodel->update_job_location($candidate_id, $this->input->post('pref_city_id'));	
			$this->candidates_alldirmodel->update_industry($candidate_id, $this->input->post('job_cat_id'));	
			$this->candidates_alldirmodel->update_functional_area($candidate_id, $this->input->post('func_id'));		
					
			redirect('candidates_all_dir/summary/'.$candidate_id.'?upd=1');
		}else
		{
			echo 'Invalid Data';
			exit();
	...
	function summary($candidate_id)
	{
		...
		$this->data["formdata"]               = $this->candidates_alldirmodel->get_single_record($candidate_id);		

		$this->data["formdata"]['desig_id']      = $this->candidates_alldirmodel->get_role($candidate_id);
		$this->data["formdata"]['func_id']       = $this->candidates_alldirmodel->get_functional_area($candidate_id);
		$this->data["formdata"]['job_cat_id']    = $this->candidates_alldirmodel->get_industry($candidate_id);
		
		$this->data['job_folders']            = $this->candidates_alldirmodel->get_job_folders();
		$this->data['visa_type_list']         = $this->candidates_alldirmodel->visa_type_list();
		$this->data['job_status']             = $this->candidates_alldirmodel->get_job_status();

		$this->data["roles_list"]          = $this->candidates_alldirmodel->fill_roles();
		
		$this->data['candidate_languages']    = $this->candidates_alldirmodel->candidate_languages($candidate_id);
		$this->data['education_details']      = $this->candidates_alldirmodel->education_deatils($candidate_id);
		
		$this->data['job_history']            = $this->candidates_alldirmodel->job_list($candidate_id);
		$this->data['followup_history']       = $this->candidates_alldirmodel->get_followup_detail($candidate_id);
		
		$this->data['all_calls']              = $this->candidates_alldirmodel->all_calls($candidate_id);
	
		$this->data['all_messages']           = $this->candidates_alldirmodel->all_messages($candidate_id);
		$this->data['all_notes']              = $this->candidates_alldirmodel->all_notes($candidate_id);
	
		$this->data['candidate_skill']        = $this->candidates_alldirmodel->candidate_skills($candidate_id);
		
		//candidate doamin knowledge
		$this->data['candidate_domain']       = $this->candidates_alldirmodel->candidate_domains($candidate_id);
		$this->data['admin_user_list']        =$this->candidates_alldirmodel->admin_user_list();
		//Certification 
		
		$this->data['cerifications']          =$this->candidates_alldirmodel->get_cert();
		$candidate_certifications             = $this->candidates_alldirmodel->candidate_certifications($candidate_id);
		...
		$this->data['candidate_questionnaire_summary'] = $this->candidates_alldirmodel->get_survey_result($candidate_id);
		$this->data['candidate_files_summary']         = $this->candidates_alldirmodel->get_files($candidate_id);
		$this->data['candidate_complaints_summary']    = $this->candidates_alldirmodel->ticket_list($candidate_id);

		//Job Search details(candidate_job_serach)
		$this->data['job_search'] = $this->candidates_alldirmodel->job_search($candidate_id);		

		$this->data['skill_list']=$this->candidates_alldirmodel->get_parent_skills();
		
		$candidate_skills = $this->candidates_alldirmodel->candidate_skills($candidate_id);
		...
		//all child skills		
		$this->data['all_child_skills']	=	$this->candidates_alldirmodel->child_skills();
		
		//Edit Language Modal
		//Language Deatils
		$this->data['lang_list']=$this->candidates_alldirmodel->get_language_set();
		$candidate_languages =$this->candidates_alldirmodel->candidate_languages($candidate_id);
		
		$this->data['candidate_locations'] =$this->candidates_alldirmodel->candidate_locations($candidate_id);
		$this->data['candidate_industries'] =$this->candidates_alldirmodel->candidate_industries($candidate_id);
		$this->data['candidate_functional_areas'] =$this->candidates_alldirmodel->candidate_functional_areas($candidate_id);
		$this->data['candidate_roles'] =$this->candidates_alldirmodel->candidate_roles($candidate_id);
		...
		$this->data["edu_level_list"]   = $this->candidates_alldirmodel->edu_level_list();
		$this->data["edu_years_list"]   = $this->candidates_alldirmodel->edu_years_list();
		...
		$this->data["edu_spec_list"] = $this->candidates_alldirmodel->edu_spec_list();
		$this->data["edu_univ_list"] = $this->candidates_alldirmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidates_alldirmodel->edu_course_type_list();
		//Job History Modal
		
		//employment
		$this->data["industries_list"] = $this->candidates_alldirmodel->industries_list();
		$this->data["functional_list"] = $this->candidates_alldirmodel->functional_list();
		$this->data["roles_list"]      = $this->candidates_alldirmodel->fill_roles();

		$this->data["country_list"] 	= $this->countrymodel->country_list();
		$this->data["nationality_list"] 	= $this->countrymodel->country_list();
		$this->data["current_location_list"] 	= $this->candidates_alldirmodel->city_list();		
		
		$this->data["currecy_list"] = $this->candidates_alldirmodel->currency_list();
		$this->data["years_list"] = $this->candidates_alldirmodel->years_list();
		$this->data["months_list"] = $this->candidates_alldirmodel->months_list();	
		
			
		//suggested jobs to candidate		
		$this->data['suggested_jobs']=$this->candidates_alldirmodel->get_suggested_jobs($candidate_id);	
		//applied jobs of candidate		
		$this->data['applied_jobs']=$this->candidates_alldirmodel->get_job_list($candidate_id);
		//shortlisted jobs
		$this->data['shortlisted']=$this->candidates_alldirmodel->get_shortlisted($candidate_id);
		//interview scheduled jobs
		$this->data['interview_list']=$this->candidates_alldirmodel->get_interview_list($candidate_id);
		//selected jobs
		$this->data['jobs_selected']=$this->candidates_alldirmodel->jobs_selected($candidate_id);
		//offer letters issued
		$this->data['offer_letters_issued']=$this->candidates_alldirmodel->offer_letters_issued($candidate_id);		
		//offer accepted
		$this->data['offer_accepted']=$this->candidates_alldirmodel->offer_accepted($candidate_id);
		//invoice genereted
		$this->data['invoice_generated']=$this->candidates_alldirmodel->invoice_generated($candidate_id);
		//all child skills		
		$this->data['all_child_skills']	=	$this->candidates_alldirmodel->child_skills();
		//present contract details
		$this->data['contract']=$this->candidates_alldirmodel->get_contract_detail($candidate_id);
...
/*--------------------------------------------------------------------------*/		
	//category 
		$category = $this->candidates_alldirmodel->get_cat_fun_list($candidate_id);
	...
	// funcional area
		$function = $this->candidates_alldirmodel->get_cat_fun_list($candidate_id);
...
//primary_skills
		$candidate_skills_primary = $this->candidates_alldirmodel->candidate_skills_primary($candidate_id);
...
//secondary skills
		$candidate_skills_secondary = $this->candidates_alldirmodel->candidate_skills_secondary($candidate_id);
...
//Language Deatails pms_candidate_language
		$this->data['lang_details'] = $this->candidates_alldirmodel->get_lang_details($candidate_id);
...
/*--------------------------------------------------------------------------*/
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('candidates_all_dir/summary/'.$candidate_id);
		}
		...
		$this->load->view("public_include/header",$this->data);
		//$this->load->view("public_include/candidate_sidebar",$this->data);
		
		$this->load->view("candidates_all_dir/candidate_summary",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
...
//Loading Models
		...
		$this->data["formdata"] = $this->candidates_alldirmodel->get_single_record($id);
	
//Certification and Technical Skilss
		
		$this->data['cerifications']=$this->jobsmodel->get_cert();
		$candidate_certifications = $this->candidates_alldirmodel->candidate_certifications($id);
...
//skills
		...
		$candidate_skills = $this->candidates_alldirmodel->candidate_skills($id);
		...
		$this->data['domain']=$this->candidates_alldirmodel->get_domain();
		$candidate_domain = $this->candidates_alldirmodel->get_domain_details($id);
...
//Planning Job Change Details
		$this->data["formdata8"] = $this->candidates_alldirmodel->job_search($id);
...
//Language Deatils
		$this->data['lang_list']=$this->candidates_alldirmodel->get_language_set();
		$candidate_certifications =$this->candidates_alldirmodel->candidate_languages($id);
...
//Contact Details
		...
		$this->data["formdata3"] = $this->candidates_alldirmodel->get_address_single_record($id);
		...
		$this->data["country_list"] = $this->candidates_alldirmodel->country_list();
		$this->data["formdata4"] = $this->candidates_alldirmodel->get_passport_single_record($id);
		...
		$this->data["edu_spec_list"]        = $this->candidates_alldirmodel->edu_spec_list();
		$this->data["edu_univ_list"]        = $this->candidates_alldirmodel->edu_univ_list();
		$this->data["edu_coll_list"]        = $this->candidates_alldirmodel->edu_coll_list();
		$this->data["edu_course_type_list"] = $this->candidates_alldirmodel->edu_course_type_list();
		$this->data["formdata5"]            = $this->candidates_alldirmodel->get_education_single_record($id);
...
//Job Details
		$this->data["industries_list"] = $this->candidates_alldirmodel->industries_list();
		$this->data["industry_list"] = $this->candidates_alldirmodel->industry_list();
		$this->data["functional_list"] = $this->candidates_alldirmodel->functional_list();
		$this->data["currecy_list"] = $this->candidates_alldirmodel->currency_list();
		$this->data["years_list"] = $this->candidates_alldirmodel->years_list();
		$this->data["months_list"] = $this->candidates_alldirmodel->months_list();
		$this->data["formdata6"] = $this->candidates_alldirmodel->get_job_single_record($id);
...
//FILE DEATILS
		$this->data['survey_result']=$this->candidates_alldirmodel->get_survey_result($id);
		$this->data["formdata7"] = $this->candidates_alldirmodel->get_file_single_record($id);
		...
		// fetch profile data
		$this->data["formdata"]['profile_list'] = $this->candidates_alldirmodel->profile_list($id);
		
		$this->data["edu_view"]	=	$this->educationDetails($id);
		$this->data["job_view"]	=	$this->jobDetails($id);
		
		$this->load->view('public_include/header',$this->data);
		$this->load->view('candidates_all_dir/editcandidates_auto_complete',$this->data);	
		$this->load->view('public_include/footer',$this->data);
	}
	...
	{
		$this->load->model('candidates_alldirmodel');  
		$this->data["personal"] = $this->candidates_alldirmodel->get_single_record($id);
		$file_text='';
	...
	function loadContacthtml($id) {
		...
		$this->data["religion_list"]    = $this->candidates_alldirmodel->religion_list();
        ...
        $this->load->view('candidates_all_dir/addcontactdetail', $this->data);
    }
	
	function skip_step2($candidateId){
		$this->load->model('candidates_alldirmodel');
		//$this->candidates_alldirmodel->insert_contact_detail_skip($candidateId);		
	...
	function addCandidateDetail($candidateId)
	{
		...
		$id  = $this->candidates_alldirmodel->insert_contact_detail($candidateId);
		$uid = $this->candidates_alldirmodel->update_contact_detail($candidateId);
	...
	function loadPassporthtml($id){
		...
		$this->load->model('candidates_alldirmodel');
		$this->load->model('visatypemodel');
		$this->data["formdata"]=$this->candidates_alldirmodel->get_passport_details($id);
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidates_alldirmodel->country_list();
		$this->load->view('candidates_all_dir/addpassportdetail', $this->data);
	}
	...
	function addPassportDetail($candidateId){
		$this->load->model('candidates_alldirmodel');
		$uid = $this->candidates_alldirmodel->update_passport_detail($candidateId);
		$status = array("STATUS" => "1");
		echo json_encode($status);
	}
	...
	function loadEducationhtml($id){
		...
		$this->data["edu_univ_list"] = $this->candidates_alldirmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidates_alldirmodel->edu_course_type_list();
		$this->load->view('candidates_all_dir/addeducationdetail',$this->data);
	}
	
	function skip_step4($candidateId){
		$this->load->model('candidates_alldirmodel');
		//$this->candidates_alldirmodel->insert_education_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function addEducationDetail($candidateId)
	{
		...
		$id  = $this->candidates_alldirmodel->insert_education_detail($data);
	...
	function loadJobhtml($id){
		...
		$this->data["years_list"] = $this->candidates_alldirmodel->years_list();
		$this->data["months_list"] = $this->candidates_alldirmodel->months_list();
		$this->load->view('candidates_all_dir/addjobdetail', $this->data);
	}
	
	function skip_step5($candidateId){
		$this->load->model('candidates_alldirmodel');
		//$this->candidates_alldirmodel->insert_job_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	{
		$this->load->model('candidates_alldirmodel');
		$id  = $this->candidates_alldirmodel->insert_job_detail($candidateId);
		$uid = $this->candidates_alldirmodel->update_job_detail($candidateId);
	...
	function loadFilehtml($id)
	{
		...
		$this->data['candidate_id'] = $id;
		$this->load->model('candidates_alldirmodel');
		$this->load->view('candidates_all_dir/addfiledetail', $this->data);
	}
	...
	function upload_cv_photo($candidate_id)
	{
		...
		if($candidate_id!='')
		{
			...
			redirect('candidates_all_dir/summary/'.$this->input->post('candidate_id'));
		}else
		{
			redirect('candidates_all_dir');
		}		
	}
	...
	function connect_with_jobs(){
		...
		{			
			...
			$this->data['candidate_profile']=$this->candidates_alldirmodel->get_single_profile($this->data['candidate_id']);
			$this->data["jobs_list"] = $this->candidates_alldirmodel->fill_job_list($this->data['candidate_id']);
			
			$this->data['candidate_locations'] =$this->candidates_alldirmodel->candidate_locations($this->data['candidate_id']);
			$this->data['candidate_industries'] =$this->candidates_alldirmodel->candidate_industries($this->data['candidate_id']);
			$this->data['candidate_functional_areas'] =$this->candidates_alldirmodel->candidate_functional_areas($this->data['candidate_id']);
			$this->data['candidate_roles'] =$this->candidates_alldirmodel->candidate_roles($this->data['candidate_id']);
			$this->data['job_search'] = $this->candidates_alldirmodel->job_search($this->data['candidate_id']);
		}		
		
		$this->data['page_head'] = 'Jobs List';	
		$this->load->view('candidates_all_dir/get_connect_jobs',$this->data);			
	}
	...
	function update_job_vacancy()
	{
		...
		if($this->input->post("candidate_id")!='')
		{
			...
			{	
				...
				{
					$this->candidates_alldirmodel->update_job_vacancy($candidate_id,$val);	
				}
...
function profile_completion($candidateId)
	{ 
		...
		redirect('candidates_all_dir/?upd=1');
	...
	function editCandidate(){
		...
		$this->load->model('candidates_alldirmodel');
        $this->candidates_alldirmodel->update_candidate_record($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditContacthtml($id){
        ...
        $this->load->view('candidates_all_dir/editcontactdetail', $this->data);

	}
	
	function editCandidateDetail($candidateId){
		$this->load->model('candidates_alldirmodel');
        $this->candidates_alldirmodel->edit_contact_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function loadEditPassporthtml($id){
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidates_alldirmodel->country_list();
		$this->data["formdata"] = $this->candidates_alldirmodel->get_passport_single_record($id);
		$this->load->view('candidates_all_dir/editpassportdetail', $this->data);
	}
	
	function editPassportDetail($candidateId)
	{
		$this->load->model('candidates_alldirmodel');
        $this->candidates_alldirmodel->edit_passport_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditEducationhtml()
	{
		...
		$this->data["edu_univ_list"] = $this->candidates_alldirmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidates_alldirmodel->edu_course_type_list();
		$this->data["formdata"] = $this->candidates_alldirmodel->get_education_single_record($this->data['edu_id']);
		...
		$data=$this->load->view('candidates_all_dir/editeducationdetail',$this->data,true);
		echo $data;
		exit();
	}
...
//EDUCATION DETAILS
	function educationDetails($id)
	{
		...
		$edu_level = $this->candidates_alldirmodel->edu_level_list();
		
		$course = $this->candidates_alldirmodel->edu_course_list();

		$spec = $this->candidates_alldirmodel->edu_spec_list();


		
		$results = $this->candidates_alldirmodel->get_education_details($id);
		$form_data	=	array();
		...
		$education_details_view	=	$this->load->view('candidates_all_dir/education_details',$this->data,true);
	...
	function update_education()
	{
		...
		$this->candidates_alldirmodel->update_education($data,$this->input->post('edu_id'),$this->input->post('candidate_id'));
//        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
		redirect('candidates_all_dir/summary/'.$this->input->post('candidate_id').'?edu_upd=1');
        //echo json_encode($status);
	}
	...
	{
		$this->load->model('candidates_alldirmodel');
        $this->candidates_alldirmodel->edit_education_detail($candidateId);
	...
	{
		$this->load->model('candidates_alldirmodel');
        $this->candidates_alldirmodel->edit_job_change_detail($candidateId);
		 $this->candidates_alldirmodel->edit_passport_num_type($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditJobhtml()
	{
		...
		$this->data["years_list"] = $this->candidates_alldirmodel->years_list();
		$this->data["months_list"] = $this->candidates_alldirmodel->months_list();
		$this->data["formdata"] = $this->candidates_alldirmodel->get_job_single_record($this->data['job_profile_id']);
		...
		$output_string=$this->load->view('candidates_all_dir/editjobdetail', $this->data,true);
		echo $output_string;
	}
...
//JOB DETAILS
	function jobDetails($id)
	{
		...
		$industry_list = $this->candidates_alldirmodel->industry_list();
		$functional_list = $this->candidates_alldirmodel->functional_list();

		
		$results = $this->candidates_alldirmodel->get_job_details($id);
		$form_data	=	array();
		...
		$job_details_view	=	$this->load->view('candidates_all_dir/job_details',$this->data,true);
	...
	function add_consultant_feedback($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			$this->candidates_alldirmodel->add_consultant_feedback($data,$this->data['candidate_id']);
			redirect('candidates_all_dir/');
		}
		exit();
	}
	...
	{
		$this->load->model('candidates_alldirmodel');
		$this->data["package_list"]         = $this->candidates_alldirmodel->fill_package();
		$this->data['candidate_id']         =$this->input->post('candidate_id');
		$this->data['feedback']             =$this->candidates_alldirmodel->get_consultant_feedback($this->data['candidate_id']);
		$output_html                        =$this->load->view('candidates_all_dir/consultant_feedback',$this->data,true);	
		echo $output_html;
	}
	...
	function add_candidates_notes($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			$this->candidates_alldirmodel->add_candidates_notes($data);
			redirect('candidates_all_dir/');
		}
		exit();
	}
	...
	function get_all_notes($candidate_id)
	{
		$this->load->model('candidates_alldirmodel');
		$this->data['candidate_id']         = $this->input->post('candidate_id');
		$this->data['note_list']            =$this->candidates_alldirmodel->select_all_notes($this->data['candidate_id']);
		$output_html                        = $this->load->view('candidates_all_dir/all_notes',$this->data,true);	
		echo $output_html;
	}
	...
	function update_job_details()
	{
        ...
        $job_profile_id=$this->candidates_alldirmodel->update_job_details($data,$job_profile_id,$candidate_id);
		
		redirect('candidates_all_dir/summary/'.$candidate_id.'?prof_upd=1');
	...
	function loadEditFilehtml($id){
		...
		$this->load->model('candidates_alldirmodel');
		$this->data['survey_result']=$this->candidates_alldirmodel->get_survey_result($id);
		$this->data["formdata"] = $this->candidates_alldirmodel->get_file_single_record($id);	

		$this->load->view('candidates_all_dir/editfiledetail', $this->data);
	}
    ...
    {    
        ...
        {
			$this->load->view('public_include/header',$this->data);    
			$this->load->view('candidates_all_dir/import_csv',$this->data);                
			$this->load->view('public_include/footer',$this->data);        
        }
        else
        {
				...
				if($res['username'] != '')
				{
						...
						$result	=	$qry->row_array(); 
							...
							if(empty($result))
							{
								...
								$id = $this->candidates_alldirmodel->insert_csv_records($data);
								...
								$this->candidates_alldirmodel->insert_csv_edu($data1);
								...
								$this->candidates_alldirmodel->insert_csv_job($data2);
								...
								{								
									...
									$this->candidates_alldirmodel->insert_csv_skills($data3);
								}
								...
								{								
									...
									$this->candidates_alldirmodel->insert_csv_cert($data4);
								}
								...
								{								
									...
									$this->candidates_alldirmodel->insert_csv_domain($data5);
								}
								...
								{								
									...
									$this->candidates_alldirmodel->insert_csv_lang($data6);
								}
								...
								$this->candidates_alldirmodel->insert_csv_job_search($data7);						
			...
			redirect('candidates_all_dir/?csv=1');
        }  
    ...
    {    
        ...
        {
			//$this->load->view('public_include/header',$this->data);    
			$this->load->view('candidates_all_dir/import_csv_linkedin',$this->data);                
			//$this->load->view('public_include/footer',$this->data);        
        }
        else
        {
			...
			redirect('candidates_all_dir/import_csv_linkedin/?csv=1');
        }  
    }
		...
		foreach($result as $key => $val)
		{
				...
				if(trim($val['organization']!=''))
				{
					...
					}else
					{
						...
						$company_id=$this->candidates_alldirmodel->insert_csv_company($company_list);
					}
    ...
    {    
		...
		foreach($result as $key => $val)
		{
			...
			{				
				...
				$this->candidates_alldirmodel->insert_csv_job($job_profile);																
				$this->db->query("delete from pms_candidate_new where candidate_id=".$val['candidate_id']);							
			}
		}
...
/*				$data=array(
    ...
    {    
		...
		$this->load->view('public_include/header',$this->data);    
		$this->load->view('candidates_all_dir/import_xml',$this->data);                
		$this->load->view('public_include/footer',$this->data);        
	...
	function candidate_view($candidate_id)
	{
		...
		$this->data['detail_list'] = $this->candidates_alldirmodel->detail_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('candidates_all_dir/candidate_view/'.$this->input->post('candidate_id'));
		}

		$this->data['list']               =$this->candidates_alldirmodel->follow_record($candidate_id);
		$this->data['note_list']          =$this->candidates_alldirmodel->notes_record($candidate_id);		
		$this->data['coe_list']           =$this->candidates_alldirmodel->coe_list($candidate_id);
		$this->data['visa_approval_list'] =$this->candidates_alldirmodel->visa_approval_list($candidate_id);

		$this->data['interview_list']     =$this->candidates_alldirmodel->interview_record($candidate_id);
		$this->data['aplication_list']    =$this->candidates_alldirmodel->aplication_record($candidate_id);
		
		$this->data['interview_status_list']=$this->candidates_alldirmodel->interview_status_list();		
		
		$this->data['app_list']           =$this->candidates_alldirmodel->aplication_list($candidate_id);
		$this->data['app_list_coe']       =$this->candidates_alldirmodel->select_aplication_coe($candidate_id);
		$this->data['admin_user_list']    =$this->candidates_alldirmodel->admin_user_list();
		$this->data['interview_type_list']=$this->candidates_alldirmodel->interview_type_list();
		$this->data['university_list']    =$this->candidates_alldirmodel->university_list();
		$this->data['campus_list']        =array('' => 'Select Campus');
		$this->data['intake_list']        =$this->candidates_alldirmodel->intake_list();
		$this->data['course_list']        =array('' => 'Select Course');;
		$this->data['level_list']         =$this->coursemodel->fill_levels();
		$this->data['status_list']        =$this->candidates_alldirmodel->status_list();

		$this->load->view("public_include/header",$this->data);
		$this->load->view("public_include/candidate_sidebar",$this->data);
		$this->load->view("candidates_all_dir/candidate_view",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
	...
	function remove_job_app()
	{
		...
		{
			$this->candidates_alldirmodel->remove_job_app($this->input->get('candidate_id'),$this->input->get('job_id'));
			redirect('candidates_all_dir/summary/'.$this->input->get('candidate_id').'?upd=1');
		}else
		{
			echo 'No Details';
		}
	...
	function candidate_programs($candidate_id)
	{
		...
		// update suggestion logic from here
			$this->candidates_alldirmodel->update_suggestion_module($this->input->post('candidate_id'), $this->input->post('campus_id'), $this->input->post('course_id'), $this->input->post('total_semester'), $this->input->post('fee_per_semester'), $this->input->post('annual_tution_fee'), $this->input->post('total_tution_fee'),$this->input->post('candidate_course_id'));
		// end here	
					
			redirect('candidates_all_dir/candidate_programs/'.$this->input->post('candidate_id').'/?upd=1');
		}
...
if($this->input->get('education')!='')
		...
		if($this->input->get('course_id')!='')
		{
			...
			$this->data['single_application']['app_details']=$this->candidates_alldirmodel->create_program_name($this->data['single_application']['course_id']);
		}					
		...
		$this->data['aplication_list']=$this->candidates_alldirmodel->aplication_record($candidate_id); // application lists - 	
		$this->data['detail_list'] = $this->candidates_alldirmodel->detail_list($candidate_id); // candidate details
		$this->data['university_list']=$this->candidates_alldirmodel->university_list(); // university list		
		$this->data['intake_list']=$this->candidates_alldirmodel->intake_list(); // intake list 		
		$this->data['level_list']=$this->coursemodel->fill_levels(); // education levels
		$this->data['status_list']=$this->candidates_alldirmodel->status_list(); // application process status list
		$this->data['campus_list']=array('' => 'Select Campus');
		$this->data['course_list']=array('' => 'Select Course');

		if($this->data['single_application']['univ_id']>0)
			$this->data['campus_list']=$this->candidates_alldirmodel->campus_list($this->data['single_application']['univ_id']);
		if($this->data['single_application']['level_study']>0)
			$this->data['course_list']=$this->candidates_alldirmodel->course_list_level($this->data['single_application']['level_study']);
			
		$this->data['candidate_qualification_list']=$this->candidates_alldirmodel->candidate_qualification_list($candidate_id); 
		// candidate's qualification for higher studies
		// edit mode		
		if($this->input->get('app_id')!='')
		{
			$this->data['single_application']=$this->candidates_alldirmodel->select_aplication_record($this->input->get('app_id'));
			if(count($this->data['single_application'])>0)
			{
				if($this->data['single_application']['univ_id']>0)$this->data['campus_list']=$this->candidates_alldirmodel->campus_list($this->data['single_application']['univ_id']);
				if($this->data['single_application']['level_study']>0)$this->data['course_list']=$this->candidates_alldirmodel->course_list_level($this->data['single_application']['level_study']);
		...
		// update program		
		$this->load->view("public_include/header",$this->data);
		$this->load->view("candidates_all_dir/candidate_programs",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
	...
	function aplication()
	{
		...
		$this->data['aplication_list']=$this->candidates_alldirmodel->select_aplication_record($id);		
	...
	function candidate_coe($candidate_id)
	{
		...
		$this->editor($path, $width);
		$this->load->view("public_include/header",$this->data);
		$this->load->view("candidates_all_dir/candidate_coe",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
	...
	function candidate_visa($candidate_id)
	{
		...
		$this->data['visa_approval_list']=$this->candidates_alldirmodel->visa_approval_list($candidate_id);
		$this->data['app_list_coe']=$this->candidates_alldirmodel->select_aplication_visa($candidate_id);
...
// Manage Email & SMS
	function email_sms($candidate_id)
	{
		...
		$this->load->model('candidates_alldirmodel');
		$this->data['detail_list'] = $this->candidates_alldirmodel->detail_list($candidate_id);
		$this->data['email_sms_list']=$this->candidates_alldirmodel->email_sms_list($candidate_id);
		...
		if($this->input->post('send_type')!='')
		{
			...
			redirect('candidates_all_dir/email_sms/'.$candidate_id);
		}
		$this->data['error']="Fill subject and email content to send to the candidate.";
		$this->load->view("public_include/header",$this->data);
		$this->load->view("public_include/candidate_sidebar",$this->data);
		$this->load->view("candidates_all_dir/candidate_email_sms",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
// Schedule an interview
	function interview(){
		...
		$id=$this->db->insert_id();
		$this->load->model('candidates_alldirmodel');
		$this->data['interview_list']=$this->candidates_alldirmodel->select_interview_record($id);
	...
	function tickets($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['detail_list'] = $this->candidates_alldirmodel->detail_list($candidate_id);
			...
			$this->data['ticket_list']=$this->candidates_alldirmodel->ticket_list($candidate_id);
			...
			if($this->input->post('send_type')!='')
			{
				...
				$id=$this->db->insert_id();
				redirect('candidates_all_dir/tickets/'.$candidate_id);
			}
			...
			$this->load->view("public_include/header",$this->data);
			$this->load->view("public_include/candidate_sidebar",$this->data);
			$this->load->view("candidates_all_dir/candidate_complaints",$this->data);
			$this->load->view("public_include/footer",$this->data);
	}
	...
	function invoice($candidate_id)
	{
		...
		$this->data['education_details'] = $this->candidates_alldirmodel->education_deatils($candidate_id);
		$this->data['job_history'] = $this->candidates_alldirmodel->job_list($candidate_id);
		$this->data['all_counselor'] = $this->candidates_alldirmodel->all_counselor($candidate_id);
		$this->data['candidate_counselor'] = $this->candidates_alldirmodel->candidate_counselor($candidate_id);
		...
		foreach($this->input->post('admin_id') as $key => $val)
		{
			...
			$this->load->view("public_include/header",$this->data);
			$this->load->view("candidates_all_dir/candidate_invoice",$this->data);
			$this->load->view("public_include/footer",$this->data);
		}	
	}
	...
	function cvfile($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidates_alldirmodel->cvfile_list($candidate_id);
		...
		if($this->input->post('cvfile')!=''){
			...
			redirect('candidates_all_dir/cvfile/'.$candidate_id);
			$path = '../js/ckfinder';
			$width = '100%';
			$this->editor($path, $width);
			$this->load->view("public_include/header",$this->data);
			$this->load->view("candidates_all_dir/candidate_cvfile",$this->data);
			$this->load->view("public_include/footer",$this->data);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
	...
	function job_history($candidate_id)
	{
		...
		$this->data['cv_fileist']=$this->candidates_alldirmodel->job_list($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('candidates_all_dir/job_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("public_include/header",$this->data);
			$this->load->view("public_include/candidate_sidebar",$this->data);
			$this->load->view("candidates_all_dir/candidate_job_history",$this->data);
			$this->load->view("public_include/footer",$this->data);
		}	
	}
	...
	function edu_history($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidates_alldirmodel->education_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			redirect('candidates_all_dir/edu_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("public_include/header",$this->data);
			$this->load->view("public_include/candidate_sidebar",$this->data);
			$this->load->view("candidates_all_dir/candidate_edu_history",$this->data);
			$this->load->view("public_include/footer",$this->data);
		}	
	}
	...
	function lang_history($candidate_id)
	{
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidates_alldirmodel->country_list();
		$this->data["formdata"] = $this->candidates_alldirmodel->get_passport_single_record($candidate_id);
		...
		//Language Deatils
		$this->data['lang_list']=$this->candidates_alldirmodel->get_language_set();
		$candidate_certifications =$this->candidates_alldirmodel->candidate_languages($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			   ...
			   $this->candidates_alldirmodel->edit_passport_detail($this->input->post('candidate_id'));
			   redirect('candidates_all_dir/lang_history/'.$this->input->post('candidate_id'));
		}
		else
		{
			$path = '../js/ckfinder';
			...
			$this->load->view("public_include/header",$this->data);
			$this->load->view("public_include/candidate_sidebar",$this->data);
			$this->load->view("candidates_all_dir/candidate_lang_history",$this->data);
			$this->load->view("public_include/footer",$this->data);
	...
	function questionnaire($candidate_id)
	{
		...
		$this->data['candidate_id']=$candidate_id;
		$this->load->model('candidates_alldirmodel');
		$this->data['survey_result']=$this->candidates_alldirmodel->get_survey_result($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('candidates_all_dir/questionnaire/'.$this->input->post('candidate_id').'?cv_file='.$cv_file.'&photo_file='.$photo_file);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->data['error']="Please update language skills here";
			$this->load->view("public_include/header",$this->data);
			$this->load->view("candidates_all_dir/candidate_questionnaire",$this->data);
			$this->load->view("public_include/footer",$this->data);
		}	
	}
...
// tech skills
	...
	function skills($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('candidates_all_dir/skills/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['skill_list']=$this->candidates_alldirmodel->get_skill_set();
		$this->data['skill_list_current']=$this->candidates_alldirmodel->get_skill_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->candidates_alldirmodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->candidates_alldirmodel->job_list($candidate_id);
		...
		$this->load->view("public_include/header",$this->data);
		$this->load->view("public_include/candidate_sidebar",$this->data);
		$this->load->view("candidates_all_dir/candidate_skills",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
	...
	function add_certification($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->candidates_alldirmodel->insert_cert_details($this->input->post('candidate_id'));
			redirect('candidates_all_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
	...
	function skills_2($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->candidates_alldirmodel->insert_skill_details($this->input->post('candidate_id'));
			redirect('candidates_all_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
...
function certifications($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('candidates_all_dir/certifications/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['certifications_list']=$this->candidates_alldirmodel->get_certifications_set();
		$this->data['certifications_list_current']=$this->candidates_alldirmodel->get_certifications_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->candidates_alldirmodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->candidates_alldirmodel->job_list($candidate_id);
		...
		$this->load->view("public_include/header",$this->data);
		$this->load->view("public_include/candidate_sidebar",$this->data);
		$this->load->view("candidates_all_dir/candidate_certifications",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
	...
	function followup()
	{
		...
		if(isset($_POST['candidate_id']))
		{
			...
			/*$this->data['single_list']=$this->candidates_alldirmodel->select_record($id);
		
			$dataArr = $this->load->view('candidates_all_dir/candidatefollowup_list', $this->data,TRUE);
			echo $dataArr;
			exit();
	...
	$id=$this->db->insert_id();
	$this->load->model('candidates_alldirmodel');
	$this->data['note_list']=$this->candidates_alldirmodel->select_notes_record($id);
	$dataArr = $this->load->view('candidates_all_dir/candidatenotes_list', $this->data,TRUE);
	echo $dataArr;
	...
	function visa_approval(){
		...
		$this->db->insert('pms_candidate_applications',$data);
		 $id=$this->db->insert_id();
		$this->load->model('candidates_alldirmodel');
		$this->data['aplication_list']=$this->candidates_alldirmodel->select_aplication_coe($id);
		$dataArr = $this->load->view('candidates_all_dir/candidate_aplication_list', $this->data,TRUE);
		echo $dataArr;
		exit();	
		$query = $this->db->query("SELECT *  FROM  pms_candidate where candidate_id =".$_POST['candidate_id']);
			$row = $query->row_array();
	...
	function drop(){
		...
		$this->load->model('candidates_alldirmodel');
		 $this->candidates_alldirmodel->drop_record($candidate_follow_id);
		$dataArr = $this->load->view('candidates_all_dir/candidate_view');
		echo $dataArr;
	}
	...
	function cvfile_drop(){
		...
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->cvfile_drop_record($cvfile_id);		          
	}
	...
	function drop_job_item()
	{
		$job_profile_id=$this->input->post('job_profile_id');
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->drop_job_item($job_profile_id);
	}
	...
	function deleteJobDetail($candidateId)
	{
		$job_id=$this->input->post('job_id');
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->drop_job_item($job_id);
		$view	=	$this->jobDetails($candidateId);
...
//DELETE EDUCATION DETAILS
	function deleteEducationDetail($candidateId)
	{
		...
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->drop_edu_item($edu_id);
		$view	=	$this->educationDetails($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId,"VIEW"=>$view);
        echo json_encode($status);
	}
	function drop_email_sms_item()
	{
		...
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->drop_email_sms_item($email_sms_id);
	}
	...
	function drop_ticket_item()
	{
		...
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->drop_ticket_item($ticket_id);
	}
		
	function drop_edu_item(){
		$eucation_id=$this->input->post('eucation_id');
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->drop_edu_item($eucation_id);
	}	
	...
	function drop_notes(){
		...
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->note_drop_record($candidate_note_id);
		$dataArr = $this->load->view('candidates_all_dir/candidate_view');
		echo $dataArr;
	 ...
	 function drop_interviews(){
		...
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->interview_drop_record($interview_id);
		$dataArr = $this->load->view('candidates_all_dir/candidate_view');
		echo $dataArr;
	 ...
	 function drop_aplication(){
		 $app_id=$_POST['app_id'];
		$this->load->model('candidates_alldirmodel');
		$this->candidates_alldirmodel->aplication_drop_record($app_id);
		$dataArr = $this->load->view('candidates_all_dir/candidate_view');
		echo $dataArr;
	...
	function candidate_file($candidate_id)
	{
	   ...
	   if($this->input->post('title')!='')
	   {
			 ...
			 if(isset($_FILES['photo']))
			 {
					...
					{
						$this->load->model('candidates_alldirmodel');
						$id=$this->candidates_alldirmodel->insert_file($candidate_id);
						redirect('candidates_all_dir/candidate_file/'.$this->input->post('candidate_id'));
					}
			}
		}
		$this->data['file_list']=$this->candidates_alldirmodel->file_list($candidate_id);
		$this->load->view("public_include/header",$this->data);
		$this->load->view("public_include/candidate_sidebar",$this->data);
		$this->load->view("candidates_all_dir/manage_files",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
...
/*			echo '<pre>';
		...
		$this->load->view("candidates_all_dir/csv_data_import",$this->data);
		$this->load->view("public_include/footer",$this->data);
	}
	   ...
	   if($this->input->post('title')!='')
	   {
		 if(isset($_FILES['photo']))
		 {
					if(!$candidate_id='')
					{
						$this->load->model('candidates_alldirmodel');
						$id=$this->candidates_alldirmodel->insert_file($candidate_id);
						$this->data['upload_list']=$this->candidates_alldirmodel->get_one_record($id);
						$replay=$this->load->view("candidates_all_dir/upload_file",$this->data,TRUE);
						echo $replay;
					}
					else
					{
						redirect("candidates_all_dir/candidate_file");
					}
				}
			else{
				 echo "Choose file";
	...
	function img_update(){
	 ...
	 if(isset($_FILES['photo'])){
						  $this->load->model('candidates_alldirmodel');
						   $this->candidates_alldirmodel->update_file($candidate_id);
	
							 $this->data['single_file']=$this->candidates_alldirmodel->get_one_file($candidate_id);
		...
		function deletefile1()
	{
		...
		if(!empty($id))
		{
			          ...
			          $this->load->model('candidates_alldirmodel');
					   $this->candidates_alldirmodel->delete_file($id);
					    $this->data['delete_file']=$this->candidates_alldirmodel->delete_one_file($id);
						
                           echo $this->data['delete_file']['photo'];  //$replay=$this->load->view("candidates_all_dir/delete_file",$this->data,TRUE);
					         //echo $replay;
	...
	function delete_cv($id)
	{
		if(!empty($id))
		{
			...
			redirect("candidates_all_dir/summary/".$id."?del_cv=1");
		}else
		{
			redirect("candidates_all_dir/summary/".$id);
		}
	}
	...
	function candidate_delete($id)
	{
		...
		if(!empty($id))
		{
			$this->candidates_alldirmodel->candidate_delete($id);
			redirect('candidates_all_dir/?del=1');
		}
	}
...
//onchange get function	
	...
	{		
		...
		{
			$data=array();
			$data["function_list"] = $this->candidates_alldirmodel->function_list_by_category($_POST['category_id']);
			$function	='';
...
//onchange getlocation
	...
	public function assign_job()
	{
		...
		{
			$id = $this->candidates_alldirmodel->add_to_job($candidatesArr[$i],$job_id);
		}
		echo $id;
		exit;
	}
...
// email ends here	
	...
	{
		if($id=='')redirect('candidates_all_dir');
		if($this->input->get('reg_status')=='')redirect('candidates_all_dir');
		$this->db->query("update pms_candidate set reg_status=".$this->input->get('reg_status')." where candidate_id=".$id);
		redirect('candidates_all_dir?status=1');
	}
	...
	function delete_photo($id)
	{
		if(!empty($id))
		{
			...
			redirect("candidates_all_dir/summary/".$id."?del_photo=1");
		}else
		{
			redirect("candidates_all_dir/summary/".$id);
		}
...
//APPLY JOB
	function apply_job($candidateId,$jobId)
	{
		...
		{
		$this->load->model('candidates_alldirmodel');
        $this->candidates_alldirmodel->apply_job($candidateId,$jobId);
		}
		redirect("candidates_all_dir/summary/".$candidateId);
	}
	
	function editSkillCertificateDetail($candidateId)
	{ 
		$this->load->model('candidates_alldirmodel');
	 	$id  = $this->candidates_alldirmodel->insert_skill_details($candidateId);
		
		$id  = $this->candidates_alldirmodel->insert_cert_details($candidateId);
		
		$id  = $this->candidates_alldirmodel->insert_domain_details($candidateId);
...
// email to candidate
	...
	{		
		...
		{
			$data=array();
			$function_list = $this->candidates_alldirmodel->function_list_by_category_multiple($_POST['category_id']);
...
//EDIT Category and functional area
	...
	{
		$this->load->model('candidates_alldirmodel');
	 	$id  = $this->candidates_alldirmodel->insert_functional($candidateId);
		redirect('candidates_all_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
	}	
...
//EDIT PRIMARY AND SECONDARY SKILLS
	...
	{
		$this->load->model('candidates_alldirmodel');
	 	$id  = $this->candidates_alldirmodel->insert_skills($candidateId);
		redirect('candidates_all_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
...
//Add Contract Details
	...
	function add_contract_details($candidateId){
		$this->load->model('candidates_alldirmodel');
		$uid = $this->candidates_alldirmodel->add_contract_detail($candidateId);
		redirect('candidates_all_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
	}
	...
	function print_cv($id=null)
	{
		...
		$this->data["personal"] = $this->candidates_alldirmodel->get_single_record($id);
		$this->data['address'] = $this->candidates_alldirmodel->get_address($id);
		$this->data['education'] = $this->candidates_alldirmodel->education_list($id);
		$this->data['job_details'] = $this->candidates_alldirmodel->get_job_details($id);
		$this->data['language_skills'] = $this->candidates_alldirmodel->candidate_languages($id);
		$this->data['tech_skills'] = $this->candidates_alldirmodel->candidate_skills($id);
		$this->data['certification'] = $this->candidates_alldirmodel->candidate_certifications($id);
		$this->data['domain'] = $this->candidates_alldirmodel->candidate_domains($id);
		$this->data['sports'] = $this->candidates_alldirmodel->candidate_sports($id);
		$this->data['social'] = $this->candidates_alldirmodel->candidate_social($id);
		$this->data['contract'] = $this->candidates_alldirmodel->get_contract_detail($id);
		$this->data['formdata'] = $this->candidates_alldirmodel->get_lang_details($id);

		$this->data["profile_list"] = $this->candidates_alldirmodel->profile_list($id);
					

		//$this->load->view('public_include/header',$this->data);
		$this->load->view('candidates_all_dir/print_cv',$this->data);	
		//$this->load->view('public_include/footer',$this->data);
	}
...
//GET CANDIDATE EDUCATION
	function get_candidate_education()
	{
		...
		$education_details = $this->candidates_alldirmodel->education_deatils($candidate_id);
			...
			$html2='<td colspan="2" align="center" valign="top" class="borderTopNone"> 
					 ...
					 foreach($education_details as $key => $val)
					 {
						...
						$html2.='<tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_all_dir/delete_candidate_edu/?id='.$val['eucation_id'].'" id="delete_candidate_edu" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate education	
	...
	function get_candidate_professional()
	{
		...
		$job_history = $this->candidates_alldirmodel->job_list($candidate_id);
					...
					<table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
					 ...
					 {	
						...
						$html2.=' <tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_all_dir/delete_candidate_prof/?id='.$val['job_profile_id'].'" id="delete_candidate_prof" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate Professional details	
	...
	function get_present_contract()
	{
		...
		$contract = $this->candidates_alldirmodel->get_contract_detail($candidate_id);
		...
		if(!empty($contract))
		{
			...
			$html2.=' <tr>
							...
							<td>'. $status.'</td>   
							<td><a href="javascript:;"  data-url="'.base_url().'candidates_all_dir/delete_candidate_contract/?id='.$contract['candidate_id'].'" id="delete_candidate_contract" >Delete</td>
						</tr>';
...
// Manage Email 
	...
	function client_cv_doc()
	{
		...
		{			
			$candidate_id    =   $this->input->post('candidate_id');
			$this->data["personal"] = $this->candidates_alldirmodel->get_candidate_profile($candidate_id);
		...
		function add_company()
	{
		...
		if($this->input->post('candidate_id')!='' && $this->input->post('company_name')!='' && $this->input->post('company_phone')!='' && $this->input->post('company_email')!='')
		{
			$data=array(
			    'candidate_id'          => $this->input->post('candidate_id'),
			...
			$job_id=$this->candidates_alldirmodel->add_company($data,$this->input->post('candidate_id'));	
