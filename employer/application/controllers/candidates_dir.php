				...
				if($res['username'] != '')
				{
						...
						$result	=	$qry->row_array(); 
							...
							if(empty($result))
							{
								...
								$this->candidatesdirmodel->insert_csv_edu($data1);
								...
								{								
									...
									$this->candidatesdirmodel->insert_csv_skills($data3);
								}
								...
								{								
									...
									$this->candidatesdirmodel->insert_csv_cert($data4);
								}
								...
								{								
									...
									$this->candidatesdirmodel->insert_csv_domain($data5);
								}
								...
								{								
									...
									$this->candidatesdirmodel->insert_csv_lang($data6);
								}
								...
								$this->candidatesdirmodel->insert_csv_job_search($data7);						
...
// Manage Email 
		...
		function client_cv_doc()
	{
		...
		{			
			...
			{
				$out_put_str='';
 				 $file_name=base_url().'../rms/uploads/client_cvs/'.$this->data["personal"]['client_cv_file'];
