...
function editor($path,$width) {
	 ...
	 
	 {
		...
		$config['base_url'] = $this->config->item('base_url')."admin/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
	...
	function add()
	{
		...
		{ 
			...
			{ 
				$id = $this->adminmodel->insert_record();
	...
	{
		$this->data['page_head'] = 'Edit Users';
		if($_SESSION['company_session']==$this->input->post('admin_id')) redirect('admin');
	...
	function delete($id='')
	{
		if($_SESSION['company_session']==$id) redirect('admin');
		if($id!='')
		{
