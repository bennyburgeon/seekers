...
class JSON
	...
	''					a dictionary where the key holds the property name and the value its value. Example of a reflect function within a User class which has first_name and last_name properties
	''					<code>
	''					<%
	''					function reflect()
	''					.	set reflect = server.createObject("scripting.dictionary")
	''					.	reflect.add "first_name", first_name
	''					.	reflect.add "last_name", last_name
	''					end function
	''					% >
	''					</code>
