var Inbox = function () {
    ...
    var loadInbox = function (el, name) {
     var url= baseurl+"index.php/inbox/inbox_view";
    ...
    var loadMessage = function (el, name, resetMenu) {
		...
		var url= baseurl+"index.php/inbox/inbox_load_msg";
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: baseurl+"assets/global/plugins/jquery-file-upload/server/php/",
            autoUpload: true
        });
    ...
    var loadCompose = function (el) {
        var url = baseurl+"index.php/inbox/inbox_compose";
    ...
    var loadReply = function (el) {
       ...
       // var url = 'inbox_reply.html?messageid=' + messageid;
        var url=baseurl+"index.php/inbox/inbox_reply?messageid=' + messageid";
