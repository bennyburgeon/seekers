            ...
            <table class="tool-table">
              <tbody>
                <tr>
                      ...
                      <td width="70%"><input type="text" name="searchterm" id="searchterm" placeholder="Search Job" class="form-control" style="width:300px;"></td>
                  
                  <td width="30%"><a href="#" class="se-reset"><img src="<?php echo base_url('assets/images/search.png');?>" id="search"></a></td>
                </tr>
              </tbody>
            </table>
          </form>
...
if($records!=NULL)
{
	foreach($records as $result){ ?>
                <tr class="odd gradeX">
                  ...
                  <td><strong><font color="#3366CC"><?php echo $result['job_title']?></font></strong></td>
