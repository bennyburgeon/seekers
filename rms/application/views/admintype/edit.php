...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li class="active">Admin Type Edit </li>
      </ul>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
   <form action="<?php echo $this->config->site_url();?>/admintype/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
  <input type="hidden" name="type_id" value="<?php echo $formdata["type_id"];  ?>" />
<tr>
<td>Admin Type</td>
<td><input type="text" id="type_name" name="type_name" value="<?php echo $formdata["type_name"];  ?>" placeholder="Admin  Type Name" class="form-control hori" /></td>
</tr>
