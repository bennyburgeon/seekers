 ...
 <tbody>
	...
	if($records!=NULL)
	{
		...
		<tr class="odd gradeX">
			...
			<td><a target="_blank" href="<?php echo base_url();?>index.php/jobs/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job"><?php echo $result['job_title']?></a><br>
            ...
            <td>
              ...
              <a href="<?php echo base_url();?>index.php/jobs/changestat/<?php echo $result['job_id'];?>?job_status=<?php if($result['job_status']=='0')echo '1';else echo '0';?>" onClick="return confirm('Are you sure, list this job ?');" class="btn btn-danger btn-xs"><?php if($result['job_status']=='0')echo 'List';else echo 'Unlist';?>
                
                <?php }else if($result['job_status']=='1'){?>
                
                <a href="<?php echo base_url();?>index.php/jobs/changestat/<?php echo $result['job_id'];?>?job_status=<?php if($result['job_status']=='0')echo '1';else echo '0';?>" onClick="return confirm('Are you sure, unilist this job ?');" class="btn btn-primary btn-xs"><?php if($result['job_status']=='0')echo 'List';else echo 'Unlist';?>
           ...
           <td>
             <a href="<?php echo base_url();?>index.php/jobs/edit/<?php echo $result['job_id']?>" class="views" title="Edit">Edit</a>
             <!-- 
             ...
             || 
             <a href="<?php echo base_url();?>index.php/jobs/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job">Manage</a>
             
             || <a href="javascript:;" title="Assign this to Recruiter or Vendor" onclick="assign_requirement(<?php echo $result['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs/assign_requirement/?job_id=<?php echo $result['company_id'];?>"  id="assign_requirement" class="btn btn-info btn-xs"> Assign</a>
