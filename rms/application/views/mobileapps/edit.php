...
<tbody>
   ...
   <form action="<?php echo $this->config->site_url();?>/mobileapps/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
  <?php echo form_hidden('obj_id', $formdata["obj_id"]);?>
...
<tr>
<td>Contact Name</td>
<td><input type="text" class="form-control" placeholder="Contact Name" value="<?php echo $formdata["obj_contact_name"] ?>"  name="obj_contact_name" id="obj_contact_name"></td>
</tr>
<tr>
<td>Contact Phone</td>
