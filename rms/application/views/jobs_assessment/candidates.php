          ...
          <table width="100%" border="1">
            <tbody>
              ...
              <!--     <select onchange="myFunction();" id="parent">
                ...
                <td width="15%" align="left" valign="middle"><?php echo form_dropdown('course_id', $edu_course_list, $postdata['course_id'], 'id="course_id_edu" style="width:200px;" ');?></td>
...
<!--             
            <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>index.php/jobs_assessment/send_jd/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a>&nbsp;
