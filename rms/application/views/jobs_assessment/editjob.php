...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li><a href="<?php echo $this->config->site_url();?>/jobs_assessment">Jobs</a>
...
<form action="<?php echo $this->config->site_url();?>/jobs_assessment/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
 <?php echo form_hidden('job_id', $formdata['job_id']);?>
    ...
    <a href="<?php echo $this->config->site_url();?>/jobs_assessment" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
