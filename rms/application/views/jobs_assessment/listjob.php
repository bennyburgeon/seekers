...
<table class="tool-table new">
 <thead>
	<tr role="row" class="heading">
		...
		<th width="687"><a href="<?php echo $this->config->site_url()?>/jobs?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>
        &rows=<?php echo $rows;?>">Job Title</a></th>
		<th width="102">Posted On</th>	
		<th width="89">Expires</th>
