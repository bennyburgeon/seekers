...
<span>
<a href="<?php echo $this->config->site_url()?>/courses">Courses</a></span> / <span>Add Course</span></div>
</div>
...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/courses/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
