...
<a href="<?php echo $this->config->site_url();?>/verify_data" >Back</a></span></td>&nbsp;&nbsp;|
<a href="<?php echo base_url();?>index.php/verify_data/candidate_delete/<?php echo md5($detail_list['candidate_id']);?>">Delete this profile</a>	&nbsp;&nbsp;&nbsp;
</div>
            ...
            <table width="95%" border="0" cellspacing="1" cellpadding="1">
                ...
                Number of Children: <?php echo $detail_list['children'];?></td>
                  ...
                  <tr>
                    <td colspan="2"><br />
                <br />
                <?php if($detail_list['cv_file']!=''){?><a href="<?php echo base_url().'uploads/cvs/'.$detail_list['cv_file'];?>" target="_blank" style="color:#0033FF">Download CV</a> &nbsp;||&nbsp;<a href="<?php echo site_url().'/verify_data/delete_cv/'.$candidate_id.'/';?>" style="color:#0033FF">Delete CV</a> <?php } ?> </td>
                  </tr>
                  
                  <tr><td colspan="2">
                  
                   <?php if($detail_list['photo']!=''){?><span id="imgTab2"><img src="<?php echo base_url().'uploads/photos/'.$detail_list['photo'];?>" class="profile_img" style="width:158px;height:100px;"><br /><br /><a href="<?php echo site_url().'/verify_data/delete_photo/'.$candidate_id.'/';?>" style="color:#0033FF">Delete Photo</a>&nbsp;&nbsp;</span> <?php } ?> 
...
<table width="95%" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr>
    <td colspan="2" align="left" valign="top">
		<form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo $this->config->site_url();?>/verify_data/upload_cv_photo/<?php echo $detail_list['candidate_id'];?>" enctype="multipart/form-data"> 
...
<!--START Profile Completion and Profile assessment-->  
	...
	<tr>
    	...
    	<br>
    	<form class="form-horizontal form-bordered"  method="post" id="summary" name="summary" action="<?php echo $this->config->site_url();?>/verify_data/summary/<?php echo $candidate_id;?>" onSubmit="return summary_validate();"> 
...
<tr>
    ...
    <table border="1" cellpadding="3" cellspacing="3" width="95%">
      <tbody>
        ...
        <tr>
            <td width="13%"><a href="<?php echo base_url(); ?>index.php/verify_data/summary/<?php echo $invoice['candidate_id'];?>/" target="_blank">
...
<tr>
  ...
  <td align="left" valign="top"><br>
     <br>
    <form class="form-horizontal form-bordered"  method="post" id="summary1" name="summary1" action="<?php echo $this->config->site_url();?>/verify_data/summary/<?php echo $candidate_id;?>" onSubmit="return summary_validate1();"> 
    <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="<?php echo $this->config->site_url();?>/verify_data/edu_history_2/<?php echo $candidate_id;?>" onSubmit="return candidate_validate();"> 
                <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                    <table class="hori-form">
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="<?php echo $this->config->site_url();?>/verify_data/job_history_2/<?php echo $candidate_id;?>" onSubmit="return job_validate();" > 
	<table class="hori-form">
			<tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p id="deletemessage"></p>
           ...
           <form class="form-horizontal form-bordered"  method="post" id="candidate_validate" name="candidate_validate" action="<?php echo $this->config->site_url();?>/verify_data/lang_history_2/<?php echo $candidate_id;?>">
...
<div class="modal fade" id="skillModal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    ...
    <div class="notess">
     ...
     action="<?php echo $this->config->site_url();?>/verify_data/skills_2/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p id="deletemessage"></p>
            ...
            <form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" 
            action="<?php echo $this->config->site_url();?>/verify_data/change_contract_details/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
