...
<table class="hori-form">
    ...
    <a href="<?php echo $this->config->site_url();?>/verify_data" class="attach-subs subs pull-right">Listing</a>
    <a href="<?php echo $this->config->site_url();?>/verify_data/profile_entry/<?php echo $candidate_id; ?>" class="attach-subs subs pull-right">Raw Data</a>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo $this->config->site_url();?>/verify_data/editfiles" enctype="multipart/form-data"> 
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>index.php/verify_data/show_cv_photo/',
...
//BEGIN FILE DETAILS
	   ...
	   $('#candidate_form5').submit(function(evt){
		...
		//if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo $this->config->site_url();?>/verify_data/editfiles",
                data:formData,
                cache:false,
                contentType: false,
                processData: false,
 ...
 //onchange of job_category
	...
	$('#job_cat_id').change(function() 
	{
		...
		if($('#job_cat_id').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/verify_data/getfunction/',
