...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/mytasks/add" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
...
<a href="<?php echo $this->config->site_url();?>/mytasks" class="attach-subs subs">Cancel</a></span></td>
</tr>
</form>
</tbody>
</table>
...
$(document).ready(function(){
	...
	$('#project_id').change(function(){
		...
		$.ajax({
					url: "<?php echo $this->config->site_url();?>/mytasks/getmilestone",	
					type: "POST",	
		...
		$.ajax({
					url: "<?php echo $this->config->site_url();?>/mytasks/getteam",	
					type: "POST",	
					data: "project_id="+jQuery('#project_id').val(),	
					cache: false,
					success: function (data) {
