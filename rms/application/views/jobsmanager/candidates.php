...
<table border="0" cellpadding="3" cellspacing="3" width="100%">
  ...
  <tbody>
      <tr>
        ...
        <tr>
          <td align="center" valign="middle">
           <?php echo form_open_multipart('jobsmanager/search_candidate/'.$postdata['job_id'], 'name="frmcandidate"');?> <input type="hidden" name="skills" id="skills"/>
      ...
      <tr>
        ...
        <?php echo $pagination; ?> &nbsp;&nbsp;
      	<br>
      	<form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>index.php/jobsmanager/search_candidate/<?php echo $postdata['job_id'];?>"> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <a href="javascript:;" title="Add to Applications"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/add_candidate_to_job/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_candidate_to_job" class="btn btn-info btn-xs"> Add to Job </a>
        
            |  
           
            
            <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/send_jd/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a>&nbsp;
...
//onchange of job_category
	...
	$('#job_cat_id').change(function() 
	{
		...
		if($('#job_cat_id').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/jobsmanager/getfunction/',
