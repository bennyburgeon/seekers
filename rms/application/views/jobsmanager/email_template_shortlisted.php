<!DOCTYPE html>
					...
					<title>Unicorn Personnel Consultancy</title>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td width="10%"><strong>CTC</strong></td>
                                  <td width="9%"><strong>Exp.   CTC</strong></td>
                                  <td width="4%"><strong>Notice</strong></td>
                                  <td width="4%"><strong>CV</strong></td>
                                  <td colspan="6"><strong>Feedback</strong><strong></strong></td>
                                  </tr>
                               ...
                               <?php  if(is_array($table_rows)) 
							   {
								   ...
								   ?>
									   <tr>
										  ...
										  <td width="7%"><?php echo $val['accept_url'];?></td>
										  <td width="8%"><?php echo $val['not_skilled'];?></td>
										  <td width="8%"><?php echo $val['not_qualified'];?></td>
										  <td width="6%"><?php echo $val['no_experience'];?></td>
										  <td width="9%"><?php echo $val['no_domain_exp'];?></td>
										  <td width="5%"><?php echo $val['reject_url'];?></td>
						          </tr>
								   <?php } ?>
                               <?php } ?>
                                 </tbody>
						  ...
						  <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main">
							  ...
							  <tr>
                                ...
                                <p><strong><?php echo $powered_by;?><br><br> 
                                <?php echo $powered_by_address;?><br>
                                <br>
                                <strong>Phone</strong>: <?php echo $powered_by_phone;?><br><br>
                                <strong>e-mail</strong> : <?php echo $powered_by_email;?><br> | <strong>Web</strong> : <?php echo $powered_by_web;?><br></p>
</td>
							  </tr>
							</table>
							<!--  Footer Part End-->
