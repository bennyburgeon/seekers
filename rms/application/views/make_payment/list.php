    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          <form name="form1" method="post" id="form1" action="<?php  echo $this->config->base_url();?>index.php/make_payment/multidelete?rows=<?php echo $rows;?>" >
          <div class="right-btns"> <a href="<?php echo base_url();?>index.php/make_payment/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> 
...
foreach($records as $value){ ?>
                ...
                <td><?php echo $value['company_name']; ?></td>
                  ...
                  <td>30 Days</td>
                  <td><b>
                    <?php if($value['package_id']==1) { echo '1 Month'; }
									else if($value['package_id']==2) { echo '3 Month'; }
									else if($value['package_id']==3) { echo '6 Month'; }
									else if($value['package_id']==4) { echo '1 Year'; } 
                     if($value['emp_package_status']==1 ){ echo '&nbsp;&nbsp;&nbsp;<span class="blinking"> active </span>'; }  ?>
                    </b><br>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>make_payment?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>make_payment?limit='+limits;
	});
