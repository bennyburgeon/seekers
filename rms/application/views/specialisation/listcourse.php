...
?>
		<tr>
           ...
           <td><?php echo $result['spcl_name']?></td>
                  ...
                  <td>
                    <a href="<?php echo base_url();?>index.php/specialisation/edit/<?php echo $result['spcl_id']?>" class="views" title="Edit">
                    <img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                  
                 
                    <a href="<?php echo base_url();?>index.php/specialisation/delete/<?php echo $result['spcl_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')">
                    
                    <img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
