<form class="form-horizontal form-bordered"  method="post" id="add_consultant_feedback_frm"   name="add_consultant_feedback_frm"> 
                ...
                <tr>
                  ...
                  <input type="buton" class="attach-subs" value="Update Feedback" id="save_consultant_feedback" style="width:180px;" 
                  data-url="<?php echo $this->config->site_url();?>/candidates_all/add_consultant_feedback/<?php echo $candidate_id;?>" />
