...
<ul>
<li><a href="<?php echo $this->config->site_url();?>/candidates_all/add" >Add New</a></li>
  <li><a href="<?php echo $this->config->site_url();?>/candidates_all" >List All</a></li>
  <li><!-- <a href="<?php echo base_url();?>index.php/candidates_all/candidate_delete/<?php echo md5($detail_list['candidate_id']);?>">Delete this profile</a>--></li>
</ul>
...
<table width="100%" border="0" cellspacing="3" cellpadding="3" class="table">
  ...
  <?php if($msg === NULL) { ?>
        ...
        <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#personalModal">Update Personal Details</a> || 
        <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#langModal">Update Language</a> || 
         
         <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#skillModal">Add Skills</a> ||
        <!--         
        
        <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#catModal">Manage Industry-Function-Role</a> ||
        
        <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#primaryModal">Add Skills[Primary & Secondary]</a> ||   
        
        <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#certModal">Add Certifications</a> || 
        -->
        <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#eduModal">Add Education</a> ||  
		<?php if($edit_job_html!=''){?>
        <a href="#" class="btn btn-success btn-xs" id="edit_mode_profession" data-toggle="modal11" data-target="#jobModal">Update Profession</a>
		<?php }else{?>
        ...
        <?php } ?> </div></td>
          ...
          <tr>
            ...
            <div class="col-sm-16">
              ...
              <div class="tab-head mar-spec"><h3>Personal Details</h3></div>
                <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    ...
                    <td width="24%"><?php echo $formdata['mobile_prefix'].' '.$formdata['mobile'];?>
					<?php if($formdata['mobile1']!='')echo ', '.$formdata['mobile_prefix1'].' '.$formdata['mobile1'];?></td>
                  ...
                  <tr>
                    ...
                    <td><?php echo $formdata['username'];?>
                     <?php if($formdata['alternate_email']!='')echo '<br>'.$formdata['alternate_email'];?>
                     </td>
                    <td>VISA Type</td>
                  ...
                  <tr>
                    ...
                    <td><?php echo  $this->config->item('currency_symbol');?><?php if(isset($job_search['current_ctc']))echo $job_search['current_ctc'];?></td>
                  </tr>
                  
                  <tr>
                    <td>Gender :</td>
                    <td><?php if($formdata['gender']==1) echo 'Male'; if($formdata['gender']==0)echo 'Female';?></td>
                    <td>Expeced Salary</td>
                    <td><?php echo  $this->config->item('currency_symbol');?><?php if(isset($job_search['expected_ctc'])) echo $job_search['expected_ctc'];?></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><?php if(isset($job_search['total_experience'])) echo $job_search['total_experience'];?>                      Years</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><?php if(isset($job_search['reason_to_leave']) && $job_search['reason_to_leave']!='')echo $job_search['reason_to_leave'];else echo 'NA';?></td>
                  </tr>                                                      
            ...
            <?php } ?> </td>
                   ...
                   <tr>
             <td colspan="4">
           	Current Job Status: <?php echo $formdata['cur_job_status_name'];?> 
	          </td>
    	      </tr>
...
<tr>
             <td colspan="4">
           	Linkedin Profile Link: <a href="<?php echo $formdata['linkedin_url']?>" target="_blank">View Profile</a>
	          </td>
    	      </tr>
          ...
          <div class="tab-head mar-spec"><h3>Photo & CV </h3></div>
<table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                 
                  <tr>
                    <td width="22%">
                    
                      <?php if(file_exists('uploads/photos/'.$formdata['photo']) && $formdata['photo']!=''){?><span id="imgTab2"><img src="<?php echo base_url().'uploads/photos/'.$formdata['photo'];?>" style="width:158px;height:100px;"><br /><br /><a href="<?php echo site_url().'/candidates_all/delete_photo/'.$candidate_id.'/';?>" style="color:#0033FF">Delete Photo</a>&nbsp;&nbsp;</span> 
                    ...
                    <td width="78%"><form class="form-horizontal form-bordered"  method="post" id="upload_cv_photo_frm" name="upload_cv_photo_frm" action="<?php echo $this->config->site_url();?>/candidates_all/upload_cv_photo/<?php echo $formdata['candidate_id'];?>" enctype="multipart/form-data"> 
        	...
        	<div id="success"></div>
                  ...
                  <tr>
                    <td>
                    <!-- 
                                <a href="<?php echo base_url().'index.php/candidates_all/print_cv/'.$candidate_id;?>" target="_blank" class="btn btn-info btn-sm">Print CV</a> -->
                <?php if($formdata['cv_file']!=''){?> <a href="<?php echo base_url().'uploads/cvs/'.$formdata['cv_file'];?>" target="_blank" class="btn btn-success btn-sm">Download CV</a> <a href="<?php echo site_url().'/candidates_all/delete_cv/'.$candidate_id.'/';?>" class="btn btn-danger btn-sm">Delete CV</a> <?php } ?> </td>
                    <td>&nbsp;</td>
                  </tr>
             ...
             <thead>
                <tr>
                    ...
                    <td width="40%">Industry </td>
                 	...
                 	<tr>
                 	  <td> <?php foreach($category_name as $cat){?>  
                         	                  
                   				<?php echo $cat['job_cat_name'];?><br>
                  		 <?php }?></td>
                 	<td class="selector">
                         <?php foreach($function_name as $fun){?>  
                         	                  
                   				<?php echo $fun['func_area'];?><br>
                  		 <?php }?>
                     </td>
                 	<td class="selector"> <?php foreach($desig_name as $desig){?>  
                         	                  
                   				<?php echo $desig['desig_name'];?><br>
                  		 <?php }?></td> 
...
<td colspan="2" align="center" valign="top" class="borderTopNone"> 
				 ...
				 <?php foreach($education_details as $key => $val){?>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url().'index.php/candidates_all/delete_candidate_edu/?id='.$val['eucation_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
                     
                     <a href="javascript:void();" data-url="<?php echo base_url().'index.php/candidates_all/loadEditEducationhtml/?edu_id='.$val['eucation_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_edu" class="btn btn-info btn-xs">Edit This</a>
                     </td>
         		 </tr>
    ...
    <tr>        
        <td colspan="2" align="center" valign="top">
         ...
         <table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    <td><?php //print_r($val);?><?php echo $val['organization'];?></td>                                        
                    ...
                    <a href="<?php echo base_url().'index.php/candidates_all/delete_candidate_prof/?id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> ||
                    
                    
                       <a href="<?php echo base_url().'index.php/candidates_all/summary/'.$candidate_id.'/?edit_job=1&job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile_url" class="btn btn-info btn-xs">Edit</a>  
                    
                    <!--         
                    
                    update with popup
                    
                       <a href="javascript:void();" data-url="<?php echo base_url().'index.php/candidates_all/loadEditJobhtml/?job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile" class="btn btn-info btn-xs">Edit Profession</a>  
...
<div class="notes" id="add_job_history">
    ...
    <?php }else{?>
               <form class="form-horizontal form-bordered"  method="post" id="job_form" name="add_job_frm" action="<?php echo $this->config->site_url();?>/candidates_all/add_job_history/<?php echo $candidate_id;?>"> 
	<table class="hori-form">
			<tbody>
 ...
 <tr>
                    <td>Designation</td>
                     <td> <?php echo form_dropdown('desig_id',  $designation_list, '','class="form-control" id="desig_id"');?> </td>
                </tr>  
 <tr>
                      <td>Country</td>
                      <td colspan="3"><?php echo form_dropdown('country_id',  $country_list,'','class="form-control" id="country_id_pros"');?></td>
                    </tr>
                    
                    <tr>
                      <td>State</td>
                      <td colspan="3"><?php echo form_dropdown('state_id',  array('' => 'Select State'),'','class="form-control" id="state_id_pros"');?></td>
                    </tr>
                    
                    
                    <tr>
                      <td>City</td>
                      <td colspan="3"><?php echo form_dropdown('city_id',   array('' => 'Select City'),'','class="form-control" id="city_id_pros"');?></td>
                    </tr>
...
<div class="notes" id="add_general_skills">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="update_skill_form" name="update_skill_form" action="<?php echo $this->config->site_url();?>/candidates_all/update_skills/<?php echo $candidate_id;?>"> 
	<table class="hori-form">
			<tbody>
               ...
               <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                ...
                <tr>
                    <td>Skills</td>
                    <td>
                    <?php echo $this->ckeditor->editor('feedback_projects',$feedback_projects);?>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                    <span class="click-icons">
                    <input type="submit" class="attach-subs" value="Update Skills" id="update_skills" style="width:180px;">
                    </span>
                    </td>
                </tr>
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="update_candidate_profile" name="update_candidate_profile" action="<?php echo $this->config->site_url();?>/candidates_all/update_candidate_profile/<?php echo $candidate_id;?>" onSubmit="return validate_profile_form();"> 
               
                <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                 <input type="hidden" name="last_name" value="">
                 <input type="hidden" name="skills" value="">
                  <input type="hidden" name="fee_comments" value="">
                   ...
                   <tr>
                    <td>Password</td>
                     <td>  <input style="width:300px;"  type="password"  name="password" value="" id="password"> </td>
                    </tr>
                    <tr>
                    ...
                    <td>Mobile</td>
                     ...
                     <table>
                     <tr>
                     <td><input type="text" style="width:100px;"  name="mobile_prefix" class="form-control input-sm" placeholder="Country Code" maxlength="5" value="+971" id="mobile_prefix"></td><td><input placeholder="Last Name" style="width:100px;" type="text" maxlength="10"  name="mobile" value="<?php echo $formdata['mobile']?>" id="mobile"> </td><td>
 </td>
                     </tr>
                     
                     <tr>
                     <td colspan="3">( For eg. +971 501234567 )</td>
                     </tr>
                    ...
                    Alternate Mobile
                     ...
                     <td>
                      <table>
                     <tr>
                     <td> <input type="text" name="mobile_prefix1" style="width:100px;" class="form-control input-sm" placeholder="Country Code" value="<?php echo $formdata['mobile_prefix1'];?>" maxlength="5" id="mobile_prefix1" ></td>
                     <td><input type="text" name="mobile1" style="width:100px;" class="form-control input-sm" value="<?php echo $formdata['mobile1'];?>" placeholder="Mobile No. 2" maxlength="9" id="mobile1">
                          </td>
                     <td></td>
                     </tr>
                     <tr><td colspan="2"> ( For eg. +971 501234567 )</td></tr>
                     </table>
                ...
                <tr>
                    <td> Alternative E Mail ID </td>
                     <td>  <input type="text" name="alternate_email" class="form-control input-sm" value="<?php echo $formdata['alternate_email'];?>" placeholder="Alternative E Mail ID" maxlength="200" id="alternate_email"></td>
                    </tr>
                    ...
                    <tr>
                    <td>DoB</td>
                     <td colspan="3"><input style="width:200px;" type="text" readonly name="date_of_birth" id="datepicker2" class="datepicker"
                    ...
                    <tr>
                    <td>Current CTC [AED]</td>
                     <td><input style="width:50px;" placeholder="CTC"  type="text"  name="current_ctc" value="<?php if(isset($job_search['current_ctc'])) echo $job_search['current_ctc']?>" id="current_ctc"></td>
                     <td>Expected CTC [AED]</td>
                     <td><input style="width:50px;" placeholder="Exp. CTC"  type="text"  name="expected_ctc" value="<?php if(isset($job_search['expected_ctc'])) echo $job_search['expected_ctc']?>" id="expected_ctc"></td>
                    </tr>
                    
                    <tr>
                    <td>Notice Peiord</td>
                     <td><input style="width:50px;" placeholder="Notice"  type="text"  name="notice_period" value="<?php if(isset($job_search['notice_period'])) echo $job_search['notice_period']?>" id="notice_period"> 
                     Days</td>
                     <td>Total Experience</td>
                     <td><input style="width:50px;" placeholder="Total Exp"  type="text"  name="total_experience" value="<?php if(isset($job_search['total_experience'])) echo $job_search['total_experience']?>" id="total_experience">
                       Years</td>
                    </tr>
                    ...
                    <tr>
                     <td>Reason to Leave</td>
                     <td colspan="3"><input style="width:400px;" placeholder="Reason to Leave."  type="text"  name="reason_to_leave" value="<?php echo $job_search['reason_to_leave']?>" id="reason_to_leave"></td>
                    </tr>
                              	                    
                    <!-- 
                    <tr>
                    <td>Passport Number</td>
                     <td> <input style="width:50px;" placeholder="Passport No."  type="text"  name="passportno" value="<?php echo $formdata['passportno']?>" id="repeat"> </td>
                     <td>Issued From</td>
                     <td><?php echo form_dropdown('passport_nationality',  $nationality_list,$formdata['passport_nationality'],'class="form-control" id="passport_nationality"');?></td>
                    </tr>
-->
                    <tr>
                      <td>Nationality</td>
                    ...
                    <tr>
                      <td>Country</td>
                      <td colspan="3"><?php echo form_dropdown('country_id',  $country_list,$formdata['country_id'],'class="form-control" id="country_id_profile"');?></td>
                    </tr>
                    
                    <tr>
                      <td>State</td>
                      <td colspan="3"><?php echo form_dropdown('state_id',  $state_list,$formdata['state_id'],'class="form-control" id="state_id_profile"');?></td>
                    </tr>
                    
                    <tr>
                      <td>City</td>
                      <td colspan="3"><?php echo form_dropdown('city_id',  $city_list,$formdata['city_id'],'class="form-control" id="city_id_profile"');?></td>
                    </tr>

 <tr>
                      <td>Industry</td>
                      <td colspan="3"><?php echo form_dropdown('job_cat_id',  $industries_list,$formdata['job_cat_id'],'class="form-control" id="job_cat_id"');?></td>
                    </tr>                    
                    ...
                    <td>Linkedin Profile Link</td>
                     <td> <input type="text" class="form-control input-sm" value="<?php echo $formdata['linkedin_url'];?>" placeholder="Linkedin Profile" name="linkedin_url" id="linkedin_url"></td>
                    </tr>

                    <tr>
                    <td>Current Job Status</td>
                     <td> <?php echo form_dropdown('cur_job_status',  $cur_job_status_list, $formdata['cur_job_status'],' id="cur_job_status" data-placeholder="Filter by status" class="form-control input-sm"');?></td>
                    </tr>
                    ...
                    <td>Job Folder</td>
                     ...
                     <?php echo form_dropdown('job_folder_id',  $job_folders,$formdata['job_folder_id'],'class="form-control" id="job_folder_id"');?>
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="edu_history_frm" name="edu_history_frm" action="<?php echo $this->config->site_url();?>/candidates_all/edu_history_2/<?php echo $candidate_id;?>" onSubmit="return candidate_validate();"> 
                <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                    <table class="hori-form">
                    ...
                    <tr>
                    <td>University</td>
                     <td>  <input placeholder="University" style="width:300px;"   type="text"  name="univ_name" value="" id="univ_name"></td>
                    </tr>
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="job_history_frm" name="job_history_frm" action="<?php echo $this->config->site_url();?>/candidates_all/job_history_2/<?php echo $candidate_id;?>" onSubmit="return job_validate();" > 
	<table class="hori-form">
			<tbody>
               ...
               <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                ...
                <tr>
                    ...
                    <textarea name="responsibility" cols="" rows="" class="text_area" id="responsibility"></textarea>
...
<form class="form-horizontal form-bordered"  method="post" id="skill_form" name="skill_form" action="<?php echo $this->config->site_url();?>/candidates_all/skills_2/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
    ...
    <div class="notess">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="edit_category_frm" name="edit_category_frm" action="<?php echo $this->config->site_url();?>/candidates_all/editCategory/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
        ...
        <tr>
            <td>Category</td>
              <td> 
                ...
                <?php foreach($this->data["industries_list"] as $key => $category){?>
                <option  <?php  if (in_array($key, $category_list)){ ?> selected="selected" <?php  } ?> 
                value="<?php echo $key;?>"><?php echo $category;?></option>
                <?php }?>
                </select>
            </td>
        </tr>
         ...
         <tr>
             ...
             <td>
              <select class="js-example-basic-multiple-cert" name="function[]" multiple="multiple" id="func_role_id" style="width:300px;">
                ...
                <?php foreach($functional_list as $key => $function){?>
                <option <?php   if (in_array($key, $function_list)){ ?> selected="selected" <?php  } ?>  
                value="<?php echo $key;?>"><?php echo $function;?></option>
                <?php }?>
                </select>
                </td>
         </tr>
         ...
         <tr>
             <td>Designation</td>
             <td>
              <select class="js-example-basic-multiple-cert" name="designation[]" multiple="multiple" id="desig_id" style="width:300px;">
                
                <?php foreach($designation_list as $key => $val){?>
                <option <?php   if (in_array($key, $desig_list)){ ?> selected="selected" <?php  } ?>  
...
<div class="modal fade" id="primaryModal" role="dialog" aria-labelledby="enquiry-modal-label">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="edit_skill_form" name="edit_skill_form" action="<?php echo $this->config->site_url();?>/candidates_all/editSkills/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
<!--SCRIPT FOR EDUCATION MODAL END-->
	...
	$('#multiple_category_old').change(function() 
	{
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/candidates_all/download_cv_content/"+candidate_id,
			method: "POST",
...
<script type="text/javascript">
	$('#country_id_profile').change(function() {
		
	jQuery('#state_id_profile').html('');
	jQuery('#state_id_profile').append('<option value="">Select State</option');

	jQuery('#city_id_profile').html('');
	jQuery('#city_id_profile').append('<option value="">Select City</option');
			
	if($('#country_id_profile').val()=='')return;

		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/candidates_all/getstate/',
		  data: { country_id: $('#country_id_profile').val()},
		  dataType: 'json',
		  
		  beforeSend:function(){
				jQuery('#state_id_profile').html('');
				jQuery('#state_id_profile').append('<option value="">Loading...</option');
		  },
		  ...
		  success:function(data){
			  if(data.success==true)
			  {
				  ...
				  {
					  if(index=='')
						 jQuery('#state_id_profile').append('<option value="'+ index +'" selected="selected">'+ value +'</option');
					 else
						 jQuery('#state_id_profile').append('<option value="'+ index +'">'+ value +'</option');
				 });
	...
	if($('#state_id_profile').val()=='')return;

		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/candidates_all/getcity/',
		  data: { state_id: $('#state_id_profile').val()},
		  dataType: 'json',
		  
		  beforeSend:function(){
				jQuery('#city_id_profile').html('');
				jQuery('#city_id_profile').append('<option value="">Loading...</option');
		  },
		  ...
		  success:function(data){
			  if(data.success==true)
			  {
				  ...
				  {
					  if(index=='')
						 jQuery('#city_id_profile').append('<option value="'+ index +'" selected="selected">' + value + '</option');
					 else
						 jQuery('#city_id_profile').append('<option value="'+ index +'">' + value + '</option');
				 });
			  }else
			  {
			  	alert(data.success);
...
<script type="text/javascript">
	$('#country_id_pros').change(function() {
		
	jQuery('#state_id_pros').html('');
	jQuery('#state_id_pros').append('<option value="">Select State</option');

	jQuery('#city_id_pros').html('');
	jQuery('#city_id_pros').append('<option value="">Select City</option');
			
	if($('#country_id_pros').val()=='')return;

		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/candidates_all/getstate/',
		  data: { country_id: $('#country_id_pros').val()},
		  dataType: 'json',
		  
		  beforeSend:function(){
				jQuery('#state_id_pros').html('');
				jQuery('#state_id_pros').append('<option value="">Loading...</option');
		  },
		  ...
		  success:function(data){
			  if(data.success==true)
			  {
				  ...
				  {
					  if(index=='')
						 jQuery('#state_id_pros').append('<option value="'+ index +'" selected="selected">'+ value +'</option');
					 else
						 jQuery('#state_id_pros').append('<option value="'+ index +'">'+ value +'</option');
				 });
	...
	$('#state_id_pros').change(function() {

	jQuery('#city_id_pros').html('');
	jQuery('#city_id_pros').append('<option value="">Select City</option');
		
	if($('#state_id_pros').val()=='')return;

		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/candidates_all/getcity/',
		  data: { state_id: $('#state_id_pros').val()},
		  dataType: 'json',
		  
		  beforeSend:function(){
				jQuery('#city_id_pros').html('');
				jQuery('#city_id_pros').append('<option value="">Loading...</option');
		  },
		  ...
		  success:function(data){
			  if(data.success==true)
			  {
				  ...
				  {
					  if(index=='')
						 jQuery('#city_id_pros').append('<option value="'+ index +'" selected="selected">' + value + '</option');
					 else
						 jQuery('#city_id_pros').append('<option value="'+ index +'">' + value + '</option');
				 });
			  }else
			  {
			  	alert(data.success);
