				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('candidates_all/loadEditPassporthtml'); ?>" +'/'+ candidateId;
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
							...
							//alert(id);
                            var site_url = "<?php echo site_url('candidates_all/loadEditPassporthtml'); ?>" +'/'+ id;
                            $("#step1").load(site_url, function() {
                                //alert("success step2");
                            });
						}
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
							...
							$("#step1").html('<img src="'+img_path+'" alt="Uploading...."/>');
							var id = ret['SUCCESS_ID'];
                            var site_url = "<?php echo site_url('candidates_all/edit'); ?>" +'/'+ id;
