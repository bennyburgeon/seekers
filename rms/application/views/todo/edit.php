...
<span>
<a href="<?php echo $this->config->site_url()?>/todo">Todo</a></span> / <span>Edit Todo</span></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
<form action="<?php echo $this->config->site_url();?>/todo/update" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();">
      									 <?php echo form_hidden('todo_id', $formdata['todo_id']);?>
...
<td>Status</td>
 ...
 <label class="radio-inline">
      <input type="radio" name="status_id" value="1" <?php if($formdata['status_id']==1){?> checked <?php } ?> />New</label>
      
    <label class="radio-inline">
   <input type="radio" name="status_id"  value="2" <?php if($formdata['status_id']==2){?> checked <?php } ?> >Working On</label>
   
   <label class="radio-inline">
   <input type="radio" name="status_id"  value="3" <?php if($formdata['status_id']==3){?> checked <?php } ?> >Working On</label>
  </td>
</tr>
<tr>
<td>Details</td>
