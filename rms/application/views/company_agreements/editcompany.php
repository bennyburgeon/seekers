...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/company_agreements/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
      										 <?php echo form_hidden('company_id', $formdata['company_id']);?> 

    <tr>
    <td> Company Name</td>
    <td> <input type="text" id="company_name" readonly name="company_name" value="<?php echo $formdata['company_name'];?>" placeholder=" Enter Company Name" class="form-control" /></td>
    </tr>
...
<tr>
    ...
    <td><?php echo form_dropdown('city_id', $city_list , $formdata['city_id'],'class="form-control"  id="city_id" ');?>
      ...
      <tr>
    <td>Address</td>
    <td><textarea id="company_address" name="company_address" rows="8" placeholder=" Enter Company Address" class="form-control" ><?php echo $formdata['company_address'];?></textarea></td>
    </tr>
...
<tr>
    ...
    <a href="<?php echo $this->config->site_url();?>/company_agreements" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
...
$('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_agreements/getstate/',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_agreements/getcity/',
