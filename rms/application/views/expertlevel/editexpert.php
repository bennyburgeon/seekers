...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/expertlevel/update/<?php echo $formdata['exp_level_id'];?>" class="form-horizontal form-bordered"  method="post" id="frmpages" name="frmpages" onSubmit="return validate();" enctype="multipart/form-data"> 
      <?php echo form_hidden('exp_level_id', $formdata['exp_level_id']);?>
    <tr>
    ...
    <input type="submit" class="attach-subs" value="Submit" name="updpage">
