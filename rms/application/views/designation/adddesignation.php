  ...
  <div class="section-wrap">
    <div class="row">
      <ul class="page-breadcrumb breadcrumb">
        ...
        <li><a href="<?php echo $this->config->site_url();?>/designation">Designation</a> <i class="icon-angle-right"></i> </li>
        ...
        <div class="table-tech specs hor">
          <table class="hori-form">
            ...
            <form action="<?php echo $this->config->site_url();?>/designation/add" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
              <tr>
                <td>Industry</td>
                <td><?php echo form_dropdown('job_cat_id', $industry_list, $formdata['job_cat_id'],'class="form-control hori" id="job_cat_id"');?></td>
              </tr>
              <tr>
                <td>Functional Area</td>
                <td><?php echo form_dropdown('func_id[]', $func_list, $formdata['func_id'],'class="form-control hori" multiple="multiple" style="height:500px;" id="func_id"');?></td>
              </tr>
              <tr>
                <td>Designation</td>
                <td><input type="text" id="desig_name" name="desig_name" value="<?php echo $formdata['desig_name'];?>" placeholder="" class="form-control" /></td>
              </tr>
              <tr>
                <td colspan="2"><span class="click-icons">
                  <input type="submit" class="attach-subs" value="Submit">
                  <a href="<?php echo $this->config->site_url();?>/designation" class="attach-subs subs">Cancel</a> </span></td>
              </tr>
            </form>
            </tbody>
