...
<div class="row">
<div class="col-sm-12">
<div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3>Edit Designation</h3></div>
...
<form action="<?php echo $this->config->site_url();?>/designation/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
<?php echo form_hidden('desig_id', $formdata['desig_id']);?>
   ...
   <tr>
    ...
    <td><?php echo form_dropdown('func_id[]', $func_list, $cur_func_list,'class="form-control hori" multiple="multiple" style="height:500px;" id="func_id"');?></td>
  </tr>
