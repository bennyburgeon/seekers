...
<tbody>
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo site_url('contact/addCandidate'); ?>" > 
<tr>
<td>Title</td>
<td> <?php 
				   $options = array(
...
<a href="<?php echo $this->config->site_url();?>/contact" class="attach-subs subs">Back</a></span></td>
</tr>
</form>
</tbody>
</table>
