...
<li id="tab_2btn">Cv File</li>
    ...
    <form method="post" id="profile_cvfile" name="profile_cvfile" action="<?php  echo $this->config->site_url();?>/contact/cvfile/<?php echo $detail_list['candidate_id'];?>" >
<input type="hidden" value="<?php echo $detail_list['candidate_id'];?>" name="candidate_id" id="candidate_id">
    <h3>File:</h3>
...
function validate(cvfile_id)
{
	if(confirm('Are you sure you want to delete?'))
	{
		...
		$.ajax({
		type:"POST",
		url: '<?php echo site_url('contact/cvfile_drop'); ?>',
		data:{ 
		cvfile_id:cvfile_id,
		},
