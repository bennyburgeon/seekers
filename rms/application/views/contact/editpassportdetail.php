...
$( document ).ready(function() {
   ...
   $('#edit_candidate2').click(function(){
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('contact/editPassportDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('contact/summary'); ?>" +'/'+ candidateId;
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('contact/summary'); ?>" +'/'+ id;
                           window.location=site_url;
						}
					}
					catch(e) {		
