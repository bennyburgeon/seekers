...
<li class="active"><a href="<?php echo base_url();?>index.php/contact/certifications/<?php echo $detail_list['candidate_id'];?>"><span><img src="<?php echo base_url('assets/images/profile-icon-2.png');?>"></span><span><img src="<?php echo base_url('assets/images/profile-icon-2_hover.png');?>"></span>Certifications</a></li>
...
<form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo $this->config->site_url();?>/contact/certifications/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
?>
  ...
  <td><input type="checkbox" name="certifications[]" value="<?php echo $key?>" <?php if(in_array($key,$certifications_list_current))echo 'checked="checked"';?> /></td>
