...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li class="active">Edit Study Mode </li>
      </ul>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
 <form action="<?php echo $this->config->site_url();?>/stdmode/update/<?php echo $formdata['mode_id'];?>" class="form-horizontal form-bordered"  method="post" id="frmpages" name="frmpages" onSubmit="return validate();" enctype="multipart/form-data"> 
    <tr>
    <td>Study Mode Name</td>
    <td><input class="form-control hori" type="text" name="mode_name" value="<?php echo $formdata['mode_name'];?>" placeholder="Enter Study Mode Name"></td>
    </tr>
    <tr>
    <tr>
    <td>Short Name</td>
    <td><input class="form-control hori" type="text" name="mode_desc" value="<?php echo $formdata['mode_desc'];?>" placeholder="Enter Short Name"></td>
    </tr>
    <tr>
    <td colspan="2">
