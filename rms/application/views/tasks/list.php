...
<tbody>
<tr>
<td><input class="form-control" type="text" name="searchterm" value="<?php echo $searchterm;?>" id="search_term" placeholder="Search Task Title" style="width: 185px;">&nbsp;<?php  echo form_dropdown('admin_id',  $admin_users_lists, $admin_id,'class="form-control" id="admin_id"');?> </td>
...
<td><input type="radio" name="date_range" id="date_range" value="2" <?php if($date_range==2)echo 'checked="checked"';?> /> 
Due Till Date-- <?php echo date('d M Y');?></td>
...
foreach($records as $result){ ?>
                   ...
                   <td align="center"><input type="checkbox" name="checkbox[]" class="checkboxes" value="<?php echo $result['task_id']?>" ></td>
                            <td><a href="<?php  echo $this->config->site_url();?>/tasks/followup/<?php echo $result["task_id"]; ?>"><?php echo $result["task_title"]; ?></a></td>
