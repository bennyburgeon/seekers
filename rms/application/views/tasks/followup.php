...
<div class="tab-content">
    ...
    <input type="hidden" name="candidate_id" id="candidate_id" value="<?php echo $task_details['candidate_id'];?>" />
     <input type="hidden" name="task_id" id="task_id" value="<?php echo $task_details['task_id'];?>" />
      <input type="hidden" id="title" name="title" value="Updates" />
   ...
   <div id="deletemessage"></div>	
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-4">
								  	<div class="input-icon">
															...
															<input type="text" readonly id="date" name="date" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="<?php echo date("Y-m-d"); ?>" value="<?php echo date("Y-m-d"); ?>" size="16" class="form-control date-picker" style="width:150px;">
														</div>
								...
								<div class="form-group">
                                  ...
                                  <div class="col-md-4">
								  	<div class="input-icon">
															<i class="fa fa-calendar"></i>
									<input type="text" readonly id="due_date" name="due_date" value="" placeholder="yyyy-mm-dd" size="16" class="form-control date-picker" style="width:150px;">
														</div>
                                  </div>
                                 </div>
...
<!-- END FORM--> 
								...
								<tbody>
								 <tr>
                                  ...
                                  <tr>
                                    ...
                                    <a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $task_details['candidate_id'];?>" target="_blank">Open Candidate Profile</a><?php } ?>
               ...
               <?php 
                ...
                <td><?php echo $followup['firstname'] ?></td>
