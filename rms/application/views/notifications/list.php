...
<a href="<?php echo base_url();?>index.php/notifications/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<th><div class="checker"><span><input type="checkbox" class="group-checkable" id="selectall"></span></div></th>
                         <th>
								 <a href="<?php echo $this->config->site_url();?>/notifications?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';}?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Title</a></th>
 <th>Message</th>
 <th>Post Date</th>
<!--  <th>Actions</th>  -->
...
<?php 
	...
	<div class="checker">
    	<span>
    		<input type="checkbox" name="checkbox[]" class="checkboxes" value="<?php echo $result['not_id']?>" >
        </span>
	</div>
</td>
    <td><?php echo $result['not_title'];?></td>
	<td><?php echo substr($result['not_text'],0,50);?></td>
	<td><?php echo $result['start_date'];?></td>
    
    
   <!-- <td> <a href="<?php echo base_url();?>index.php/notifications/edit/<?php echo $result['not_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a> -->
	<!-- 		<a href="<?php echo base_url();?>index.php/notifications/delete/<?php echo $result['not_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a></td> -->
