...
<div class="row">
<div class="col-sm-12 pages"><a href="<?php echo $this->config->site_url();?>/admin_leave_self">Leave </a> / <span><?php echo $page_head;?></span></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
<!--
  <form action="<?php echo $this->config->site_url();?>/admin_leave/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
-->
  <form action="<?php echo $this->config->site_url();?>/admin_leave_self/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry"  enctype="multipart/form-data"> 
<tr>
<td>Name</td>
<td>
...
<td>From Date</td>
<td>
<input type="date" maxlength="5" placeholder="" class="form-control hori" id="date_from" name="date_from" value="01-01-2016">
</td>
</tr>
<tr>
<td>To Date</td>
<td>
<input type="date" maxlength="5" placeholder="" class="form-control hori" id="date_to" name="date_to" value="">
</td>
</tr>
<tr>
<td>Type</td>
...
<a href="<?php echo $this->config->site_url();?>/admin_leave_self" class="attach-subs subs">Cancel</a>
</span>
</td>
</tr>
</form>
