...
<?php echo form_hidden('searchterm', $formdata['searchterm']);?>
<?php echo form_hidden('rows', $formdata['rows']);?>
    ...
    <td> <input type="text" id="func_area" name="func_area" value="<?php echo $formdata['func_area'];?>" placeholder="" class="form-control" />
        ...
        <tr>
    <td>Industry</td>
    <td> <?php echo form_dropdown('job_cat_id[]', $industry_list, $cur_industry,'class="form-control hori" id="job_cat_id" multiple="multiple" style="height:500px;"');?>
    </td>
    </tr>
