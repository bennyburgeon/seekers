...
<?php  if($this->input->get('csv')==1){ ?> 
    ...
    <strong>Success !</strong>csv file uploaded successfully.
    </div>
<?php }?>
...
<form name="form1" method="post" id="form1" action="<?php  echo $this->config->site_url();?>/admindomain/multidelete?rows=<?php echo $rows;?>" >

<div class="right-btns">
<a href="<?php echo base_url();?>index.php/admindomain/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<form id="searchForm">
<tr>
<td><input class="form-control" type="text" name="searchterm" id="search_term" placeholder="Search Your Domain " value="<?php echo $searchterm != '' ? $searchterm: '' ;?>" style="width: 185px;"></td>
...
<div class="checker"><span><input type="checkbox" class="group-checkable" id="selectall"></span></div>
								...
								<th>
                                <a href="<?php echo $this->config->site_url()?>/admindomain?sort_by=<?php if($sort_by=='asc')
{echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Domain Name </a>
 ...
 <tbody>
	...
	<div class="checker">
    	<span>
    		<input type="checkbox" name="checkbox[]" class="checkboxes" value="<?php echo $result['domain_id']?>" >
        </span>
	</div>
</td>
								...
								<td>
                                	<a href="<?php echo base_url();?>index.php/admindomain/edit/<?php echo $result['domain_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
			<a href="<?php echo base_url();?>index.php/admindomain/delete/<?php echo $result['domain_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/admindomain?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>/admindomain?limit='+limits;
	});
