...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li><a href="<?php echo $this->config->site_url();?>/companytype">Company Type</a>
                            ...
                            <li><a href="#">Add Company Type</a></li>
      </ul>
</div>

<div class="row">
<div class="col-sm-12">
<div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3>Add Company Type</h3></div>
...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/companytype/add" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();">
    <tr>
    <td> Company Type</td>
