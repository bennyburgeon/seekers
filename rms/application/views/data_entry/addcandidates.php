 ...
 <input type="radio" name="lead_source" value="5" id="lead_source" <?php if($formdata['lead_source']==5)echo 'checked="checked"';?> />Others&nbsp;&nbsp;</td>
               ...
               <tr>
                ...
                <tr>
                        ...
                        data-url="<?php echo $this->config->site_url();?>/data_entry/addCandidate" />
                        <a href="<?php echo $this->config->site_url();?>/data_entry" class="attach-subs subs">Back</a></span></td>
...
function check_email()
{
	var pattern=/^([a-zA-Z0-9_.-])+@([a-zA-Z0-9_.-])+\.([a-zA-Z])+([a-zA-Z])+/;
		...
		if(!pattern.test($('#username').val())){
			...
			$.ajax({
				type: "post",
				url: "<?php echo $this->config->site_url();?>/data_entry/check_email",
				cache: false,				
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) 
						{
                            ...
                            window.location.href = "<?php echo site_url('data_entry/profile_entry'); ?>" +'/'+ id;
