...
<div class="profile_top_left">Summary &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url();?>index.php/jobs_caller/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobs_caller/send_mass_mail/<?php echo $formdata['job_id'];?>">Mass Email</a>	&nbsp;&nbsp;&nbsp; ||&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobs_caller/add_candidate/<?php echo $formdata['job_id'];?>">Add New Candidate</a>	&nbsp;&nbsp;&nbsp; ||</div>  
            ...
            <tr>
              <td colspan="2" align="center" valign="top">
                <div class="tab-head mar-spec">
                  <h3>Candidates Applied&nbsp;&nbsp;[<?php echo count($applied_candidates);?>]&nbsp;&nbsp;<a id="toggle_applied" href="javascript:;" class="tab-head mar-spec">View All</a></h3>
                </div>
...
<tr id="candidate_applied_list" style="display:none;">
    ...
    <table border="1" cellpadding="1" cellspacing="1" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody >
        ...
        <tr>
          	<td width="22%"><a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $candidate['candidate_id']?>" target="_blank"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a>
            </td>
  ...
  <tbody>
    <tr>
      ...
      <div style="float:left">CV Source:<a href="javascript:;" title="CV Source"  id="cv_source" class="btn btn-info btn-xs"><?php if($candidate['lead_source']==1)echo 'Recruiter';if($candidate['lead_source']==2)echo 'Web/Social Media';if($candidate['lead_source']==3)echo 'Vendor';if($candidate['lead_source']==4)echo 'Mobile';if($candidate['lead_source']==5 || $candidate['lead_source']=='')echo 'Source not updated';?></a></div>
        ...
        <a href="javascript:;" title="<?php echo $candidate['last_call_date'];?> | <?php echo $candidate['last_call_note'];?> | <?php if($candidate['cur_job_status']==1)echo 'No Job';if($candidate['cur_job_status']==2)echo 'Working, But Need a Change';if($candidate['cur_job_status']==3)echo 'Not Interested';if($candidate['cur_job_status']==4)echo 'Seeking Good Opportunity';if($candidate['cur_job_status']==5)echo 'Need a change ';if($candidate['cur_job_status']==6)echo 'Call after 1 Year';if($candidate['cur_job_status']==7)echo 'Call after this month ';?>" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Calls [<?php echo $candidate['total_calls'];?>] </a>
        
        
        <?php }else{ ?>
        <a href="javascript:;" title="No Calls Made" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-danger btn-xs"> Calls [?] </a>
        <?php }?>
        
        
        
        
        <a href="javascript:;" title="Update CTC" onclick="add_ctc(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/add_ctc/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="update_ctc" class="btn btn-info btn-xs"> CTC </a>
        
        <a href="javascript:;" title="Add Notes" onclick="add_notes(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/add_notes/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_notes" class="btn btn-info btn-xs"> Notes </a>
        
        <a href="javascript:;" title="Send Message" onclick="add_message(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/add_message/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_msg" class="btn btn-info btn-xs"> Msg </a>
        
        <a href="javascript:;" title="Short List this candidate"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/shortlist_jquery/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="shortlisted_candidate" class="btn btn-info btn-xs"> Short List </a>
        
        <a href="javascript:;" data-url="<?php echo base_url(); ?>index.php/jobs_caller/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>
        
        <a href="javascript:;" title="Change Job"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/change_job/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>" onclick="manage_job_change(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" id="change_job" class="btn btn-info btn-xs"> Change Job </a>
...
--> 
        <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/send_jd/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a> &nbsp; 
...
<tr>
              <td colspan="2" align="center" valign="top">
                <div class="tab-head mar-spec"><h3>Candidates Rejected &nbsp;&nbsp;[<?php echo count($rejected_candidates);?>]&nbsp;&nbsp;<a id="toggle_rejected" href="javascript:;" class="tab-head mar-spec">View All</a></h3></div> 
              </td>
</tr>
...
<tr id="candidate_rejected" style="display:none;">
    ...
    <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody >
        ...
        <tr>
          	<td width="25%"><a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $candidate['candidate_id']?>" target="_blank"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a></td>    
...
<tr>
	<td colspan="2" align="center" valign="top" id="short" <?php  if(empty($shortlisted)) { ?> class="hide" <?php } ?>>
      ...
      <div class="tab-head mar-spec"><h3>Candidates Shortlisted&nbsp;&nbsp;[<?php echo count($shortlisted);?>]&nbsp;&nbsp;<a id="toggle_shortlisted" href="javascript:;" class="tab-head mar-spec">View All</a></h3> 
      </div>
    </td>
</tr>
...
<tr id="candidate_shortlisted" style="display:none;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody>
        ...
        <tr>
           <td width="45%"><a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $candidate['candidate_id']?>" target="_blank"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a>
           
           <br>Client Feedback:
           <?php if($candidate['client_feedback']<1)echo 'No Feedback';?>
            ...
            <td width="10%"><?php echo $candidate['mobile'];?></a></td> 
            <td width="32%"><?php echo $candidate['username'];?></a></td>
                 
         <td width="13%"> <a href='javascript:;'  onclick="add_interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a></td>
          </tr>
              ...
              <?php foreach($interview_list as $interview){
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobs_caller/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a>
                    ...
                    <a href="javascript:;"  <?php /*?>data-url="<?php echo base_url(); ?>index.php/jobs_caller/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>"<?php */?>onclick="select_candidate(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs"> Select </a>
                    </td>
                </tr>
        		<?php } ?> 
                  ...
                  <?php foreach($candidates_selected as $selected){?>
                    ...
                    <tr>
                      ...
                      <td width="19%"><?php echo $selected['select_date'];?></td>
                       ...
                       <td width="43%"><?php echo $selected['feedback'];?></td>
...
<tr>
	<td ><a href="<?php base_url().'index.php/candidates_all/summary/'.$offerletter['candidate_id'];?>" target="_blank"><?php echo $offerletter['first_name'].' '.$offerletter['last_name'];?></a></td>
	<td ><?php echo date("d-m-Y", strtotime($offerletter['offer_date']))?></td>
    <td ><?php echo $offerletter['salary_offered']?></td>
    <td ><?php echo $offer_status;?></td>
    
    <td><a href="<?php echo base_url().'index.php/candidates_all/summary/'.$offerletter['candidate_id']?>" target="_blank" class="btn btn-info btn-xs"> Profile </a>  <a href="javascript:;" onclick="accept_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-success btn-xs"> Accept </a>  <a href="javascript:;" onclick="reject_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-warning btn-xs"> Reject </a></td>                                  
          </tr>
...
<tr id="offer_accepted2">
        ...
        <?php 
			...
			?>
				<tr>
				 <td width="33%">
                 <a href="<?php echo base_url().'index.php/candidates_all/summary/'.$accepted['candidate_id'];?>" target="_blank">
                 ...
                 <p> <a href="<?php echo base_url().'index.php/candidates_all/summary/'.$accepted['candidate_id']?>" target="_blank" class="btn btn-info btn-xs"> Profile </a>&nbsp;<a href="javascript:;" onclick="create_invoice(<?php echo $formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id']?>);" class="btn btn-primary btn-xs">Invoice</a></p></td>
        ...
        <thead>
          ...
          <tbody >
              ...
              <?php foreach($invoice_generated as $invoice){?>                                                
                ...
                <tr>
                  <td width="17%"><a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $invoice['candidate_id']?>" target="_blank"><?php echo $invoice['first_name'].' '.$invoice['last_name'];?></a></td>
                  <td width="11%">date</td>
                  <td width="11%">date</td>
                  <td width="14%">date</td>
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="calls_form" name="calls_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/add_calls" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_caller/manage_rejection"  method="post" id="rejection_form" name="rejection_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/manage_rejection" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_caller/save_job_change"  method="post" id="change_form" name="change_form"> 
                ...
                <td>Remove from This Job ?</td>
                 <td><input type="radio" value="1" name="remove_from" />Yes&nbsp;<input type="radio" value="0" name="remove_from" checked />No&nbsp;</td>
                </tr>

                <tr>
                  <td colspan="2">
                  <span class="click-icons">
                  <input type="submit" class="attach-subs" value="Change Job" id="save_job_change" style="width:180px;" 
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/save_job_change" />
...
<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_caller/send_shortlisted"  method="post" id="shortlisted_form" name="shortlisted_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/send_shortlisted" />
...
<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_caller/add_feedback"  method="post" id="feedback_form" name="feedback_form">
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/add_feedback" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="ctc_form" name="ctc_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/add_ctc" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="notes_form" name="notes_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/add_notes" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_caller/add_message"  method="post" id="message_form" name="message_form"> 
			...
			<tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/add_message" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobs_caller/addinterview_jqery"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_caller/addinterview_jqery" />
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                             ...
                             data-url="<?php echo base_url(); ?>index.php/jobs_caller/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>" />
                              </span>
                          </td>
                	   </tr>
                      </tbody>
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_caller/issue_offer" />
                              <?php /*?><input type="submit" class="attach-subs" value="Save" id="save_candidate333" style="width:180px;"><?php */?>
                              </span>
                          </td>
                	   </tr>
                    </tbody>
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_caller/reject_offer" />
	...
	<?php //echo form_input(array('name'=>'min_contract_months', 'class' => 'smallinput'));?> </td>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_caller/accept_offer2" />
                              <?php /*?><input type="submit" class="attach-subs" value="Save" id="save_candidate33" style="width:180px;"><?php */?>
                              </span>
                          </td>
                	   </tr>
                    </tbody>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_caller/create_invoice2" />
...
{ 
	$.ajax({
	   type: 'POST',
		data: {job_id:job_id},
		dataType: "json",
	   url: '<?php echo base_url(); ?>index.php/jobs_caller/get_select_candidate/',
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>index.php/jobs_caller/get_offer_issued/',	
	   success: function(data){ 
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>index.php/jobs_caller/get_offer_accepted/',	
	   success: function(data){	
