...
<span>
<a href="<?php echo $this->config->site_url()?>/tickets">Tickets</a></span> / <span>Edit Ticket</span></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
<form action="<?php echo $this->config->site_url();?>/tickets/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();">
				
      <input type="hidden" name="ticket_id" value="<?php echo $formdata['ticket_id'];?>"?>
...
<td>Ticket Status</td>
 <td>
  <?php echo form_dropdown('ticket_status_id',  $tickets_status_list,$formdata["ticket_status_id"],'id="ticket_status_id" class="table-group-action-input form-control input-medium"');?>
  </td>	
</tr>
...
<td>Select Candidate</td>
 <td><?php echo form_dropdown('candidate_id',  $candidate_list,$formdata["candidate_id"],'class="form-control" id="candidate_id"');?>	</td>	
</tr>
