...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/course_type/update" class="form-horizontal form-bordered"  method="post" id="frmlevel" name="frmlevel" onSubmit="return validate();" enctype="multipart/form-data"> 
      <input class="form-control hori" type="hidden" name="course_type_id" id="course_type_id" value="<?php echo $formdata['course_type_id'];?>" >
    <tr>
    <td>Course Type</td>
