...
<a href="<?php echo base_url();?>index.php/company_leads/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>


<a href="<?php echo base_url(); ?>index.php/company_leads" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a>


</div>
<form id="searchForm" action="<?php echo base_url(); ?>index.php/company_leads" method="get" name="searchForm">
...
<form name="frm_assignment" method="post" id="frm_assignment" action="<?php  echo $this->config->site_url();?>/company_leads/multiple_assignment?rows=<?php echo $rows;?>" >
<table class="tool-table new">
<thead>
								<tr role="row" class="heading">
<th width="24"><div class="checker"><span><input type="checkbox" class="group-checkable" id="selectall"></span></div></th>
                                        <th width="616"><a href="<?php echo $this->config->site_url()?>/company_leads?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Company Name</a></th>
...
if($records!=NULL)
{
	foreach($records as $result){ ?>
		<tr class="odd gradeX">
			...
			<td>
				<a href="<?php echo base_url();?>index.php/company_leads/edit/<?php echo $result['company_id']?>" class="views" title="Edit This Company"><?php echo $result['company_name']?></a><br> 
        ...
        <br>
            ...
            <a href="javascript:;" title="Make Calls" onclick="add_calls(<?php echo $result['company_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/company_leads/add_calls/?company_id=<?php echo $result['company_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Calls</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/company_leads/add_calls" id="calls_form" name="calls_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/company_leads/add_calls" />
...
<div class="modal fade" id="jobs_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/company_leads/add_jobs" id="jobs_form" name="calls_form"> 
                ...
                <tr>
				 ...
				 <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/company_leads/add_jobs" />
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/company_leads/save_assignment" id="assignment_form" name="assignment_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/company_leads/save_assignment" />
                  </span>
                  </td>
                </tr>
                </tbody>
...
$(document).ready(function()
{
	...
	$("#sel_limit1").change(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/company_leads?limit='+limits;
	});
...
function get_calls_history(company_id){
	...
	$('#show_followup_history').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/company_leads/get_calls_history/?company_id=<?php echo $result['company_id'];?>",
...
function assign_requirement(company_id)
{
	...
	$('#data_holder').html('Loading..................');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/company_leads/assign_requirement/?company_id="+company_id,
...
$('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_leads/getstate/',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_leads/getcity/',
