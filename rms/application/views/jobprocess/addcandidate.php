...
<div id="contentwrapper" class="contentwrapper widgetpage">
               ...
               <div class="tableoptions">
				 ...
				 <?php echo form_open_multipart('jobprocess/addcandidate/'.$postdata['job_id'], 'name="frmcandidate"');?>
...
var strURL="<?php echo base_url(); ?>index.php/jobprocess/add_candidate_to_job/?candidate_id="+candidate_id + "&job_id=" + document.frmcandidate.job_id.value ;
