...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li><a href="<?php echo $this->config->site_url();?>/jobprocess">Jobs</a>
...
<form action="<?php echo $this->config->site_url();?>/jobprocess/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
 <?php echo form_hidden('job_id', $formdata['job_id']);?>
    ...
    <a href="<?php echo $this->config->site_url();?>/jobprocess" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
...
//onchange of job_category
	...
	$('#job_cat_id').change(function() 
	{
		...
		if($('#job_cat_id').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/jobprocess/getfunction/',
