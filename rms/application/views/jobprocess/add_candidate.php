...
<a href="<?php echo base_url();?>index.php/jobprocess/manage/<?php echo $formdata['job_id'];?>">Summary</a>&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; 
<a href="<?php echo base_url();?>index.php/jobprocess/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	&nbsp;&nbsp;&nbsp;
<a href="<?php echo base_url();?>index.php/jobprocess/send_mass_mail/<?php echo $formdata['job_id'];?>">Mass Email</a>	&nbsp;&nbsp;&nbsp; ||&nbsp;&nbsp;&nbsp;
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobprocess/add_candidate/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobprocess/import_from_other_jobs/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
