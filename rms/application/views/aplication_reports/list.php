...
<tbody>
<tr>
<td><input class="form-control" type="text" name="searchterm" id="search_term" placeholder="Search University" style="width: 185px;"></td>
...
<thead>
                       ...
                       <th> <a href="<?php echo $this->config->site_url()?>/aplication_reports?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&limit=<?php echo $limit;?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">University </a></th>
                        <th>Course</th>
                        <th>Process Status</th>
                        <th>Aplication Details</th>
...
foreach($records as $result){ ?>
                    ...
                    <td><?php echo $result["app_details"]; ?></td>
                    </td>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/aplication_reports?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>/aplication_reports?limit='+limits;
	});
