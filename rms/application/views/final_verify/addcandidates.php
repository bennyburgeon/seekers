          ...
          <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" > 
               ...
               <tr>
                ...
                <tr>
                        ...
                        data-url="<?php echo $this->config->site_url();?>/final_verify/addCandidate" />
                        <a href="<?php echo $this->config->site_url();?>/final_verify" class="attach-subs subs">Back</a></span></td>
...
function check_email()
{
	var pattern=/^([a-zA-Z0-9_.-])+@([a-zA-Z0-9_.-])+\.([a-zA-Z])+([a-zA-Z])+/;
		...
		if(!pattern.test($('#username').val())){
			...
			$.ajax({
				type: "post",
				url: "<?php echo $this->config->site_url();?>/final_verify/check_email",
				cache: false,				
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) 
						{
                            ...
                            window.location.href = "<?php echo site_url('final_verify/profile_entry'); ?>" +'/'+ id;
