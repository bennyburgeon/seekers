...
<div id ="step1">
    <div class="table-tech specs hor">
        ...
        <a href="<?php echo $this->config->site_url();?>/data_entry/edit/<?php echo $candidate_id; ?>" class="attach-subs subs pull-right" title="Data Entry">Update</a>
        ...
        <span id="test_personal">
        <?php if(isset($profile_list['1'])){ ?>
        <table align="right" width="40%" border="0">
            <tr>
            	<td>&nbsp;<?php echo html_entity_decode($profile_list['1']);?></td>
            </tr>
            <tr>
           		 <td align="center" >
                 <a class="attach-subs personal-delete" title="Delete" data-id="<?php echo '1';?>"  href="javascript:;">Clear</a>
                 </td>
            </tr>
        </table>
        <?php }?>
...
<div id ="step2">
    <div class="table-tech specs hor">
      ...
      action="<?php echo site_url('data_mgmt/editCandidateDetail'); ?>/<?php echo $candidate_id ?>" > 
      <?php echo form_hidden('candidateId', $candidate_id);?>
      <h2 class="srevHd">Address</h2>
        <table align="left" width="50%" border="0">
            ...
            <tr>
            <td>Nationality</td>
            <td><?php if(!empty($address)) echo $address['country_name'];?></td>
            </tr>
      ...
      <span id="test_address">
      <?php if(isset($profile_list['2'])){?>
        
      <table align="right" width="40%" border="0">
        <tr>
        	<td>&nbsp;<?php echo html_entity_decode($profile_list['2']);?></td>
        </tr>
        
        <tr>
            <td align="center" >
            <a class="attach-subs address-delete" title="Delete" data-id="<?php echo '2';?>"  href="javascript:;">Clear</a>
            </td>
        </tr>
    </table>
    <?php }?>
...
<div class="table-tech specs hor">
  ...
  action="<?php echo site_url('data_mgmt/addEducationDetail'); ?>/<?php echo $candidate_id ?>"  > 
  <?php echo form_hidden('candidateId', $candidate_id);?>
    ...
    <h2 class="srevHd">Education</h2>
     <div style="float:left;">
    	...
    	<table align="left" width="115%" border="1" style="margin-top:30px;">
            <tr >
            <td width="260"><b>Level Name</b></td>
    ...
    <span id="test_education">
     <?php if(isset($profile_list['3'])){?>
        <table align="right" width="40%" border="0">
        
            <tr>
            <td>&nbsp;<?php if(isset($profile_list['3']))echo html_entity_decode($profile_list['3']);?></td>
            </tr>
            
            <tr>
                <td align="center" >
                <a class="attach-subs education-delete" title="Delete" data-id="<?php echo '3';?>"  href="javascript:;">Clear</a>
                </td>
            </tr>
        </table>
        </span>
...
<div class="table-tech specs hor">
 ...
 <?php echo form_hidden('candidateId', $candidate_id);?>
    ...
    <div style="float:left;">
       ...
       <table align="left"  border="1" style="margin-top:30px;">
            <tr>
            <td width="300"><b>Organization</b></td>
            <td width="350"><?php echo $item['organization'];?></td>
            </tr>
	...
	<span id="test_job">
	 <?php if(isset($profile_list['4'])){?>
        <table align="right" width="40%" border="0">
            <tr>
            <td>&nbsp;<?php if(isset($profile_list['4']))echo html_entity_decode($profile_list['4']);?></td>
            </tr>
            
            <tr>
            <td align="center" >
            <a class="attach-subs job-delete" title="Delete" data-id="<?php echo '4';?>"  href="javascript:;">Clear</a>
            </td>
            </tr>
        </table>
     <?php }?>
...
<div id ="step3" >
    <div class="table-tech specs hor">
        ...
        <h2 class="srevHd">Language Skills</h2>
    		...
    		<span id="test_language">
    		<?php if(isset($profile_list['5'])){?>
            <table align="right" width="40%" border="0">
                <tr>
                <td>&nbsp;&nbsp;<?php if(isset($profile_list['5']))echo html_entity_decode($profile_list['5']);?></td>
                </tr>
                
                 <tr>
                <td align="center" >
                <a class="attach-subs language-delete" title="Delete" data-id="<?php echo '5';?>"  href="javascript:;">Clear</a>
                </td>
                </tr>
            </table>
    	 <?php }?>
...
<div class="table-tech specs hor">
    ...
    <?php echo form_hidden('candidateId', $candidate_id);?>
    	...
    	<span id="test_skill">
    	 <?php if(isset($profile_list['6'])){?>
        <table align="right" width="40%" border="0">
            <tr>
            <td>&nbsp;<?php if(isset($profile_list['6']))echo html_entity_decode($profile_list['6']);?></td>
            </tr>
            
            <tr>
            <td align="center" >
            <a class="attach-subs skill-delete" title="Delete" data-id="<?php echo '6';?>"  href="javascript:;">Clear</a>
            </td>
            </tr>
        </table>
        <?php }?>
...
<div id ="step4" >
	...
	<div class="table-tech specs hor">
        ...
        action="<?php echo site_url('data_mgmt/editCertificateDetail'); ?>/<?php echo $candidate_id ?>" > 
        <?php echo form_hidden('candidateId', $candidate_id);?>        
            ...
            <span id="test_cert">
            <?php if(isset($profile_list['7'])){?>
            <table align="right" width="40%" border="0">
                <tr>
                <td>&nbsp;<?php if(isset($profile_list['7']))echo html_entity_decode($profile_list['7']);?></td>
                </tr>
                
                <tr>
                <td align="center" >
                <a class="attach-subs cert-delete" title="Delete" data-id="<?php echo '7';?>"  href="javascript:;">Clear</a>
                </td>
                </tr>
            </table>
            <?php }?>
...
<div class="table-tech specs hor">
        ...
        <?php echo form_hidden('candidateId', $candidate_id);?>
            ...
            <span id="test_domain">
             <?php if(isset($profile_list['8'])){?>
            <table align="right" width="40%" border="0">
                <tr>
                <td>&nbsp;<?php if(isset($profile_list['8']))echo html_entity_decode($profile_list['8']);?></td>
                </tr>
                
                <tr>
                <td align="center" >
                <a class="attach-subs domain-delete" title="Delete" data-id="<?php echo '8';?>"  href="javascript:;">Clear</a>
                </td>
                </tr>
...
<div class="table-tech specs hor">
        ...
        <?php if(is_array($sports)){?>
            ...
            <span id="test_sport">
             <?php if(!empty($profile_list['9'])){?>
            <table align="right" width="40%" border="0">
                <tr>
                <td>&nbsp;<?php if(isset($profile_list['9']))echo html_entity_decode($profile_list['9']);?></td>
                </tr>
                
                <tr>
                <td align="center" >
                <a class="attach-subs game-delete" title="Delete" data-id="<?php echo '9';?>"  href="javascript:;">Clear</a>
                </td>
                </tr>
...
<h2 class="srevHd">Social</h2>
    ...
    <?php } ?>
    <span id="test_social">
     <?php if(!empty($profile_list['10'])){?>
    <table align="right" width="40%" border="0">
        <tr>
        <td>&nbsp;<?php if(isset($profile_list['10']))echo html_entity_decode($profile_list['10']);?></td>
        </tr>
        
        <tr>
        <td align="center" >
        <a class="attach-subs social-delete" title="Delete" data-id="<?php echo '10';?>"  href="javascript:;">Clear</a>
        </td>
        </tr>
    </table>
	<?php }?>
    ...
    <table align="left" width="90%"><tr><td>    <h2>Present Contract Details</h2></td></tr>
      <tbody>              
        <tr>
            ...
            <td>
                <input style="width:200px;" placeholder="Company Name"  type="text"  name="company_name" 
                value="<?php if(!empty($contract))echo $contract['company_name'];?>" id="company_name">&nbsp;&nbsp;&nbsp;&nbsp;
                
                
                <input style="width:200px;" placeholder="Start Date"  type="text"  name="start_date" readonly
                ...
                <select name='total_months' id="total_months" style="width:200px;">
        ...
        <tr>
            <td>
                ...
                <input style="width:200px;" placeholder="Job Change Date"  type="text"  name="job_change_date" readonly
                value="<?php if(!empty($contract))echo $contract['job_change_date'];?>" id="datepicker">&nbsp;&nbsp;&nbsp;&nbsp;
                
                <select  name="total_exp" style="width:200px;">
                <option value="" >Total Experience </option>
                <?php foreach($years_list as $key => $val){?>
                <option <?php if(isset($contract['total_exp']) && $contract['total_exp']==$key){?> selected="selected" <?php } ?> value="<?php echo $key;?>">
                <?php echo $val;?></option>
                <?php }?>
                </select>   
                ...
                <select name="present_status"  id="present_status" style="width:220px;">
...
<form class="form-horizontal form-bordered"  method="post" id="frm_category" name="frm_category" > 
 <input type="hidden" name="candidate_id" value="<?php echo $candidate_id ?>">
<h2>Set Possible Designation for Candidate</h2>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="frm_profile_status" name="frm_profile_status"   
  action="<?php echo site_url('final_verify/update_profile_status'); ?>/<?php echo $candidate_id ?>" > 
  ...
  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id ?>">
        ...
        <tr>
                ...
                <table class="hori-form">
                    <tbody>
                        ...
                        <td>Personal</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_1']) && $profile_status['profile_stat_1']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_1']) && $profile_status['profile_stat_1']==0){echo 'No';} else echo 'Nil'; ?>
                        ...
                        <td>Address</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_2']) && $profile_status['profile_stat_2']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_2']) && $profile_status['profile_stat_2']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Education</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_3']) && $profile_status['profile_stat_3']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_3']) && $profile_status['profile_stat_3']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Profession</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_4']) && $profile_status['profile_stat_4']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_4']) && $profile_status['profile_stat_4']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Language</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_5']) && $profile_status['profile_stat_5']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_5']) && $profile_status['profile_stat_5']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Tech Skills</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_6']) && $profile_status['profile_stat_6']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_6']) && $profile_status['profile_stat_6']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Certification</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_7']) && $profile_status['profile_stat_7']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_7']) && $profile_status['profile_stat_7']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Projects</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_8']) && $profile_status['profile_stat_8']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_8']) && $profile_status['profile_stat_8']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Sports</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_9']) && $profile_status['profile_stat_9']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_9']) && $profile_status['profile_stat_9']==0){echo 'No';} else echo 'Nil';  ?>
                        ...
                        <td>Social</td>
                        <td>
                        <?php if(is_array($profile_status) && isset($profile_status['profile_stat_10']) && $profile_status['profile_stat_10']==1){echo 'Yes';}else if(is_array($profile_status) && isset($profile_status['profile_stat_10']) && $profile_status['profile_stat_10']==0){echo 'No';} else echo 'Nil'; ?>
    ...
    <table align="right" width="40%" border="0">
        <tr>
        <td><?php if(isset($formdata['profile_list']['10']))echo html_entity_decode($formdata['profile_list']['10']);?></td>
        </tr>
    </table>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="" name=""   action="<?php echo site_url('final_verify/profile_completion'); ?>/<?php echo $candidate_id ?>" > 
  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id ?>">
...
//BEGIN DELETE PERSONAL
	$(document).on('click','.personal-delete',function()
	{ 
		var $this	    =	$(this);
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deletePersonalDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE ADDRESS
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteAddressDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE EDUCATION
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteEducationHistoryDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE JOB HISTORY
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteJobHistoryDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//END DELETE JOB HISTORY

//BEGIN DELETE LANGUAGE
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteLanguageDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE Skills
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteSkillDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE CertIFICATIOn
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteCertDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE Domain
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteDomainDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE SPORTS AND GAMES
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteGameDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//BEGIN DELETE Social
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('final_verify/deleteSocialDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { cat_id:cat_id},
				success: function(json){
					try{		
...
//END DELETE Social
	...
	$('#multiple_category').change(function() 
	{
		...
		if($('#multiple_category').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/final_verify/get_category_function_multiple/',
...
//BEGIN SKILLS AND CERTIFICATE
   $('#edit_skills').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/editSkills'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
...
//BEGIN category and functional area
   $('#edit_category').click(function(){ 
		var dataStringprop = $("#frm_category").serialize(); 
