      ...
      <div class="col-sm-12">
        ...
        <div class="table-tech specs hor">
          <table class="hori-form">
            <tbody>
            <form action="<?php echo $this->config->site_url();?>/companyusers/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();">
             ...
             <!-- <tr>
              ...
              <tr>
                <td colspan="2"><span class="click-icons">
                  ...
                  <a href="<?php echo $this->config->site_url();?>/companyusers" class="attach-subs subs">Cancel</a> </span></td>
              </tr>
            </form>
            </tbody>
