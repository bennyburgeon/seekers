...
<div class="profile_top_left">Summary &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url();?>index.php/jobs_sourcer/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	

<!-- <a href="<?php echo base_url();?>index.php/jobs_sourcer/send_mass_mail/<?php echo $formdata['job_id'];?>">Mass Email</a>	&nbsp;&nbsp;&nbsp; || 
&nbsp;&nbsp;&nbsp; --> 
&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobs_sourcer/add_candidate/<?php echo $formdata['job_id'];?>">Add New Candidate</a>	&nbsp;&nbsp;&nbsp; ||</div>  
...
<!-- 
  ...
  <a href="javascript:;" onclick="candidate_cv(<?php echo $candidate['candidate_id'];?>);" id="download_cv" data-url="<?php echo base_url();?>index.php/jobs_sourcer/download_cv/<?php echo $candidate['candidate_id']?>" title="View CV" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i> Candidate CV</a>
...
-->
 ...
 <a href="javascript:;" class="btn btn-warning btn-xs" title="View Profile" onclick="open_client_cv(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>);">Client CV</a>
 ...
 <?php if($candidate['total_calls']>0){?>
        ...
        <a href="javascript:;" title="<?php echo $candidate['last_call_date'];?> | <?php echo $candidate['last_call_note'];?> | <?php if($candidate['cur_job_status']==1)echo 'No Job';if($candidate['cur_job_status']==2)echo 'Working, But Need a Change';if($candidate['cur_job_status']==3)echo 'Not Interested';if($candidate['cur_job_status']==4)echo 'Seeking Good Opportunity';if($candidate['cur_job_status']==5)echo 'Need a change ';if($candidate['cur_job_status']==6)echo 'Call after 1 Year';if($candidate['cur_job_status']==7)echo 'Call after this month ';?>" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Notes [<?php echo $candidate['total_calls'];?>] </a>
        
<?php }else{ ?>
        
<a href="javascript:;" title="No Calls Made" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-danger btn-xs"> Add Notes [?] </a>
        
<?php } ?>
        
<!--         
<a href="javascript:;" title="Add Notes" onclick="add_notes(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_notes/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_notes" class="btn btn-info btn-xs"> Notes </a>
-->


<a href="javascript:;" title="Update Consultant's Feedback" onclick="add_consultant_feedback(<?php echo $candidate['candidate_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_consultant_feedback/?candidate_id=<?php echo $candidate['candidate_id'];?>"  id="add_consultant_feedback" class="btn btn-<?php if($candidate['consultant_feedback']!='')echo 'info';else echo 'danger';?> btn-xs"> Consultant's Feedback</a>
        
        <?php if($candidate['app_status_id']==1){?>
        
        <a href="javascript:;" title="Short List this candidate" onclick="add_to_shortlist(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_to_shortlist/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_to_shortlist" class="btn btn-info btn-xs"> Short List </a>
        
        <a href="javascript:;" data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>

        <a href="javascript:;" title="Change Job"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/change_job/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>" onclick="manage_job_change(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" id="change_job" class="btn btn-info btn-xs"> Change Job </a>
        
<?php } ?>

        <!-- 
        <a href="javascript:;" title="Send Message" onclick="add_message(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_message/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_msg" class="btn btn-info btn-xs"> Msg to Mobile </a>

                   
        <a href="javascript:;" title="Update CTC" onclick="add_ctc(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_ctc/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="update_ctc" class="btn btn-info btn-xs"> CTC </a>

  <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/send_jd/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a> &nbsp; 
  -->
...
<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_sourcer/send_shortlisted"  method="post" id="shortlisted_form" name="shortlisted_form"> 
        ...
        <div class="col-md-15">
            ...
            <div class="alert alert-info"><strong>Info!</strong> You can edit all details. Fill CC to get a copy of this email.</div>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/send_shortlisted" />
...
<?php } ?>
         ...
         <td width="16%"><?php if($candidate['app_status_id']==3){?> <a href='javascript:;'  onclick="add_interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a>  || <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
        <thead>
          ...
          <?php if($interview['total_rejection']==0  && $interview['selected']==0){?>       
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a>
                    ...
                    <a href="javascript:;" onclick="reject_interview_fn(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $interview['interview_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/reject_interview/"  id="reject_interview" class="btn btn-danger btn-xs">Reject </a>
                    <?php }else{ ?>
               ...
               <tr>
                  ...
                  <?php foreach($candidates_selected as $selected){?>
                    ...
                    <tr>
                      ...
                      <a href='javascript:;' onclick="issue_offer(<?php echo $formdata['job_id'];?>,<?php echo $selected['app_id'];?>,<?php echo $selected['candidate_id'];?>);" id="issue_offer" class="btn btn-info btn-xs"> Issue Offer </a> &nbsp;<a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/delete_selectedcandidate/?job_app_id=<?php echo $selected['app_id'];?>&candidate_id=<?php echo $selected['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_selected_candidate" class="btn btn-danger btn-xs">X </a>
                      <?php }else{ ?>
                      Offered
                      <?php } ?>
...
<tr>
    ...
    <?php if($offerletter['offer_status']==1){?>		
      ...
      <a href="javascript:;" onclick="accept_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-success btn-xs"> Accept </a>  <a href="javascript:;" onclick="reject_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-warning btn-xs"> Reject </a>&nbsp;<a href="javascript:;"  data-url="<?php echo base_url().'index.php/jobs_sourcer/delete_offercandidate/?job_app_id='.$offerletter['app_id'].'&candidate_id='.$offerletter['candidate_id'].'&job_id='.$formdata['job_id'];?>"  id="delete_offer_candidate" class="btn btn-danger btn-xs">X </a>
        ...
        <?php 
			...
			?>
				<tr>
                 ...
                 <p>
                 <!-- <a href="javascript:;" onclick="create_invoice(<?php //echo $formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id']?>);" class="btn btn-primary btn-xs">Invoice</a>&nbsp;-->
                 <a href="javascript:;" data-url="<?php echo base_url().'index.php/jobs_sourcer/delete_acceptcandidate/?job_id='.$formdata['job_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id']?>" id="delete_accept_candidate" class="btn btn-danger btn-xs">X </a></p></td>
          ...
          <tbody >
              ...
              <?php foreach($invoice_generated as $invoice){?>                                                
                ...
                <tr>
                  ...
                  <td>
                  <p><!--
                  <a href="<?php echo base_url(); ?>index.php/jobs_sourcer/create_invoice/?job_id=<?php echo $formdata['job_id'];?>/?placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>" class="btn btn-primary btn-xs">Edit</a> -->
                  <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" class="btn btn-danger btn-xs">X</a>
                   </p>       
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="calls_form" name="calls_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/add_calls" />
...
<br>
            ...
            <form class="form-horizontal form-bordered"  method="post" id="add_to_shortlist_form"  action="<?php echo $this->config->site_url();?>/jobs_sourcer/add_to_shortlist"  name="add_to_shortlist_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/add_to_shortlist" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_sourcer/manage_rejection"  method="post" id="rejection_form" name="rejection_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/manage_rejection" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_sourcer/save_job_change"  method="post" id="change_form" name="change_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/save_job_change" />
...
<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_sourcer/add_feedback"  method="post" id="feedback_form" name="feedback_form">
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/add_feedback" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="ctc_form" name="ctc_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/add_ctc" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="notes_form" name="notes_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/add_notes" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobs_sourcer/add_message"  method="post" id="message_form" name="message_form"> 
			...
			<tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/add_message" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobs_sourcer/addinterview"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/addinterview" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="reject_interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobs_sourcer/reject_interview"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/reject_interview"/>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                             ...
                             data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>" />
                              </span>
                          </td>
                	   </tr>
                      </tbody>
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/issue_offer" />
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/reject_offer" />
	...
	<?php //echo form_input(array('name'=>'min_contract_months', 'class' => 'smallinput'));?> </td>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/accept_offer2" />
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobs_sourcer/create_invoice2" />
...
{ 
	$.ajax({
	   type: 'POST',
		data: {job_id:job_id},
		dataType: "json",
	   url: '<?php echo base_url(); ?>index.php/jobs_sourcer/get_select_candidate/',
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>index.php/jobs_sourcer/get_offer_issued/',	
	   success: function(data){ 
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>index.php/jobs_sourcer/get_offer_accepted/',	
	   success: function(data){	
...
function candidate_profile(candidate_profile){
	...
	$('#show_candidate_profile').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobs_sourcer/candidate_profile/"+candidate_profile,
			method: "POST",
...
function open_client_cv(candidate_id,job_app_id)
{
	$('#show_client_cv').html('');	
	 $.ajax({
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobs_sourcer/client_cv/?view="+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id,job_app_id : job_app_id },
		    dataType: "html",
			success: function(data) 
			{
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobs_sourcer/download_cv/"+candidate_id,
			method: "POST",
...
function add_consultant_feedback(candidate_id,job_id){
	...
	$('#show_consultant_feedback').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobs_sourcer/open_consultant_feedback/"+candidate_id,
			method: "POST",
