  ...
  <tbody>
      <tr>
              <td align="center" valign="top">
                Search Candidates Database</td>
        </tr>

        <tr>
          <td align="center" valign="middle">
           <?php echo form_open_multipart('jobs_sourcer/search_candidate/'.$postdata['job_id'], 'name="frmcandidate"');?> <input type="hidden" name="skills" id="skills"/>
...
<select   name="exp_years_max"  style="width:100px;">
                ...
                <tr>
                   ...
                   <td><?php echo form_dropdown('job_folder_id',  $job_folders, $job_folder_id,'class="form-control " id="job_folder_id" style="width:150px"');?></td>
                    ...
                    <td width="11%" align="left" valign="middle"><button class="radius3" onclick="search_submit();" id="applyfilter">Apply Filter</button> 
                        ...
                        &nbsp;&nbsp; <a style="background-color: #2980b9;" href="<?php echo base_url();?>index.php/jobs_sourcer/search_candidate/<?php echo $id; ?>" class="attach-subs tools"> Reset </a> 
                </td>
      ...
      <tr>
        ...
        <?php echo $pagination; ?> &nbsp;&nbsp;
      	<br>
      	<form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>index.php/jobs_sourcer/search_candidate/<?php echo $postdata['job_id'];?>"> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <a href="javascript:;" title="Add to Applications"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/add_candidate_to_job/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_candidate_to_job" class="btn btn-info btn-xs"> Add to Job </a>
        
            |  
           
            
            <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>index.php/jobs_sourcer/send_jd/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a>&nbsp;
...
//onchange of job_category
	...
	/* $('#job_cat_id').change(function() 
	{
		...
		if($('#job_cat_id').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/jobs_sourcer/getfunction/',
