...
<table border="0" cellpadding="3" cellspacing="3" width="100%">
  ...
  <tbody>
     ...
     <a href="javascript:;" title="Short List this candidate"  data-url="<?php echo base_url(); ?>index.php/jobs/shortlist_jquery/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="shortlisted_candidate" class="btn btn-info btn-xs"> Short List </a>
     							
        <a href="<?php echo base_url(); ?>index.php/jobs/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>
