...
<tr>
<td width="64">Select Priority</td>
...
<table class="tool-table new">
 <thead>
	<tr role="row" class="heading">
		...
		<th width="833"><a href="<?php echo $this->config->site_url()?>/jobs?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>
        &rows=<?php echo $rows;?>">Job Title</a></th>	
		<th width="65">Expires</th>
 ...
 <tbody>
	...
	if($records!=NULL)
	{
		...
		<tr class="odd gradeX">
            ...
            <td>
              <a href="<?php echo base_url();?>index.php/jobs_sourcer/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job">Manage</a>
            </td>
	</tr>
