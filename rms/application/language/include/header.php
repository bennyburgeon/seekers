...
<span><?php if($_SESSION['admin_prof_img_url']!=''){?><img src="<?php echo base_url();?>uploads/adminprofile/<?php echo $_SESSION['admin_prof_img_url'];?>" width="31"><?php } ?><a href="#"><?php echo $_SESSION['firstname'].''.$_SESSION['lastname'];?></a></span>
</div>
...
<ul>
<?php
              foreach($_SESSION['menu_list'] as $result)
			  { 
             ?>
                      		<li>
