...
class Todostatus extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/todostatus/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
		...
		$config['base_url'] = base_url().'index.php/todostatus/?';
