...
class offerletters extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/job_apps/?sort_by=$sort_by&searchterm=$searchterm$query_str";
	...
	function multidelete()
	{
		...
		if(count($id_arr)>0){
			$this->load->model('offer_letter_model');
			$this->offer_letter_model->delete_multiple_record($id_arr);
