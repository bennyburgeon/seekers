...
class Admintype extends CI_controller{
	...
	function index()
	{
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/admintype/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
		...
		$config['base_url'] = base_url().'index.php/branch/?';
