...
class Programs extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/candidates/?sort_by=".$this->data['sort_by']."&limit=".$this->data['limit']."&search_name=".$this->data['search_name']."&search_email=".$this->data['search_email']."&search_mobile=".$this->data['search_mobile']."&"."lreg_status=".$this->data['reg_status']."&branch_id=".$this->data['branch_id'];
