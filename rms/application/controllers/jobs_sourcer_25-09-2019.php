          ...
          <th>Action</th>
					...
					foreach($shortlisted as $candidate){
						...
						$html.='<tr>
								 ...
								 <td width="10%"> <a href="javascript:;"  onclick="interview('.$candidate['candidate_id'].','.$candidate['job_app_id'].','.$formdata['job_id'].')" class="btn btn-primary btn-xs" >Interview</a>|<a href="javascript:;"  data-url="'.base_url().'index.php/jobs_sourcer/delete_shortlisted_candidate/?job_app_id='.$candidate['job_app_id'].'&candidate_id='.$candidate['candidate_id'].'&job_id='.$formdata['job_id'].'"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a></td>			
							   </tr>';		
					}
