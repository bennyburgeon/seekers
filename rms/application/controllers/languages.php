...
class Languages extends CI_Controller {
	...
	function index($offset = 0)
	{
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/languages/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
		...
		$config['base_url'] = base_url().'index.php/languages/?';
