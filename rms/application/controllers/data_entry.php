<?php class Data_entry extends CI_Controller {
	function Data_entry()
	{
		parent::__construct();
		$this->load->library('csvimport');
	  	if(!isset($_SESSION['admin_session']) || $_SESSION['admin_session']=='')redirect('logout');
		if(!isset($_SESSION['profile_status']) || $_SESSION['profile_status']=='')$_SESSION['profile_status']=1;
	}
