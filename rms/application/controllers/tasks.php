...
class Tasks extends CI_controller{
	...
	function index($offset = 0)
	{
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/tasks/?date_range=".$this->data["date_range"]."&sort_by=$sort_by&limit=$limit&searchterm=".$this->data["searchterm"]."&priority=".$this->data["priority"]."&status=".$this->data["status"]."&admin_id=".$this->data["admin_id"];
	...
	function followup($id)
	{
		...
		//print_r($this->data["followup_list"]);
		//exit();
