...
class Vendors extends CI_controller
 {
	function __construct()
	{
	   ...
	   if(!isset($_SESSION['admin_session']) || $_SESSION['admin_session']=='')redirect('logout');	
		...
		$this->data['current_page_head']='Company Partners';
		$this->data['page'] = 'Partners';
		$this->data['module_head'] = 'Manage Partners';
	...
	function editor($path,$width) {
     ...
     function index()	 
	 {
		...
		$this->data["page_head"]= "Manage Partners";
	...
	function delete($id='')
	{
		if($_SESSION['admin_session']==$id) redirect('vendors');
		if($id!='')
		{
