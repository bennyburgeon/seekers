...
class Location extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/location/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
		...
		$config['base_url'] = base_url().'index.php/location/?';		
