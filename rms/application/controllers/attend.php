...
class Attend extends CI_Controller {
	...
	function index()
	{
		...
		$config['base_url'] = $this->config->item('base_url')."index.php/attend/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
		...
		$config['base_url'] = base_url().'index.php/attend/?';	
