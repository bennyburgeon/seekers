<?php class Skill_based_candidates extends CI_Controller {

	function Skill_based_candidates()
	{
		parent::__construct();
	...
	{	
		...
		$this->data['total_rows']= $this->candidateallmodel->result_count($this->data['skills']);
		$this->data['cur_page']=$this->router->class;
		
		
		
		$config['base_url'] = $this->config->item('base_url')."index.php/skill_based_candidates/?sort_by=".$this->data['sort_by']."&limit=".$this->data['limit']."&skills=".$this->data["skills"];
		...
		$this->data["records"] = $this->candidateallmodel->get_result($this->data['start'],$this->data['limit'],$this->data['sort_by'],$this->data['skills']);

		$this->load->model('candidateallmodel'); 
		
		$this->data['page_head']= 'Skill Based Candidates';		
...
// Technical Skilss
		...
		$this->load->view('candidates_all/skill_candidates',$this->data);				
