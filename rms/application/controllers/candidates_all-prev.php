...
//specilaisation 
		...
		$this->data['total_rows']= $this->candidateallmodel->record_count($this->data['search_email'],$this->data['search_name'],$this->data['search_mobile'],$this->data['reg_status'],$this->data['branch_id'],$this->data['skills'],$this->data['level_id'],$this->data['course_id'],$this->data['spcl_id'],$this->data['exp_years']);
...
//Job Details
		...
		if(count($this->data["formdata6"])<1)
		{
			...
			$this->data['formdata6']['job_ind_id'] = '';
...
//FILE DEATILS
		...
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_all/editcandidates',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
	...
	function loadEditEducationhtml($id)
	{
		...
		$this->data["edu_univ_list"] = $this->candidateallmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidateallmodel->edu_course_type_list();
		$this->data["formdata"] = $this->candidateallmodel->get_education_single_record($id);
		...
		$this->load->view('candidates_all/editeducationdetail',$this->data);
	}
...
//EDUCATION DETAILS
	...
	function loadEditJobhtml($id){
		...
		$this->data["years_list"] = $this->candidateallmodel->years_list();
		$this->data["months_list"] = $this->candidateallmodel->months_list();
		$this->data["formdata"] = $this->candidateallmodel->get_job_single_record($id);
		...
		$this->load->view('candidates_all/editjobdetail', $this->data);
	}
...
//JOB DETAILS
	...
	function editJobDetail($candidateId){
		$this->load->model('candidateallmodel');
        $this->candidateallmodel->edit_job_detail($candidateId);
				...
				if($res['username'] != '')
				{
						...
						$result	=	$qry->row_array(); 
							...
							if(empty($result))
							{
								...
								'job_ind_id'	=>(!empty($res['industry']))?$this->common('pms_job_industries',$res['industry']):'',
...
//Certification 
		...
		$this->data['candidate_programs_summary'] = $this->candidateallmodel->candidate_programs_summary($candidate_id);

	
		$this->data['candidate_coe_summary'] = $this->candidateallmodel->candidate_coe_summary($candidate_id);
		$this->data['candidate_visa_summary'] = $this->candidateallmodel->candidate_visa_summary($candidate_id);
...
//category and functional role
		$this->data["industry_list"] = $this->candidateallmodel->multiple_industry_list();
		$this->data["functional_list"] = $this->candidateallmodel->multiple_functional_list();
