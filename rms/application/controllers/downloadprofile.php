<?php class Downloadprofile extends CI_Controller 
{
	...
	{	
		...
		$this->load->model('downloadprofilemodel');
		...
		$this->data['sort_param']='a.first_name';
		
		$this->data['search_name']='';
		$this->data['cur_employer']='';
		...
		$this->data['exp_years_from']='';
		$this->data['exp_years_to']='';
		$this->data['salary_from']='';
		$this->data['salary_to']='';	
		...
		$this->data['visa_type']='';		
		$this->data['gender']='';
		$this->data['driving_license_country']='';	
		...
		if($this->input->get('sort_param')!='')
		{
			$this->data['sort_param']=$this->input->get("sort_param");
		}
		else
		{
			$this->data['sort_param'] = 'a.first_name';
		...
		{
			$this->data['created']=$this->input->get("created");
		}
		else
		{
			$this->data['created'] = '';
		...
		{
			$this->data['updated']=$this->input->get("updated");
		}
		else
		{
			$this->data['updated'] = '';
		...
		if($this->input->get('skil_id'))
		{
			$this->data['skil_id']=$this->input->get('skil_id');
		}

		if($this->input->post('skil_id'))
		{
			$this->data['skil_id']=$this->input->post('skil_id');
		}
	
		//exp years		
		if($this->input->get('exp_years_from')!='')
		{
			$this->data['exp_years_from']	=	$this->input->get('exp_years_from');
		}	
		
		if($this->input->post('exp_years_from')!='')
		{
			$this->data['exp_years_from']	=	$this->input->post('exp_years_from');
		}

		//exp years		
		if($this->input->get('exp_years_to')!='')
		{
			$this->data['exp_years_to']	=	$this->input->get('exp_years_to');
		}	
		
		if($this->input->post('exp_years_to')!='')
		{
			$this->data['exp_years_to']	=	$this->input->post('exp_years_to');
		}

		//exp years		
		if($this->input->get('salary_from')!='')
		{
			$this->data['salary_from']	=	$this->input->get('salary_from');
		}	
		
		if($this->input->post('salary_from')!='')
		{
			$this->data['salary_from']	=	$this->input->post('salary_from');
		}

		//exp years		
		if($this->input->get('salary_to')!='')
		{
			$this->data['salary_to']	=	$this->input->get('salary_to');
		}	
		
		if($this->input->post('salary_to')!='')
		{
			$this->data['salary_to']	=	$this->input->post('salary_to');
		}		
		
				//exp years		
		if($this->input->get('age_from')!='')
		{
			$this->data['age_from']	=	$this->input->get('age_from');
		}	
		
		if($this->input->post('age_from')!='')
		{
			$this->data['age_from']	=	$this->input->post('age_from');
		}

		//exp years		
		if($this->input->get('age_to')!='')
		{
			$this->data['age_to']	=	$this->input->get('age_to');
		}	
		
		if($this->input->post('age_to')!='')
		{
			$this->data['age_to']	=	$this->input->post('age_to');
		}

		//exp years		
		if($this->input->get('lang_id')!='')
		{
			$this->data['lang_id']	=	$this->input->get('lang_id');
		}	
		...
		//visa_type		
		if($this->input->get('visa_type'))
		{
			$this->data['visa_type']	=	$this->input->get('visa_type');
		}	
		
		if($this->input->post('visa_type'))
		{
			$this->data['visa_type']	=	$this->input->post('visa_type');
		}		
		...
		{ 
			$this->data['gender']=$this->input->get("gender");
		}
		...
		{ 
			$this->data['nationality']=$this->input->get("nationality");
		}
		...
		{ 
			$this->data['state_id']=$this->input->get("state_id");
		}
		...
		{ 
			$this->data['marital_status']=$this->input->get("marital_status");
		}
		
		if($this->input->post("marital_status")!='')
		{ 
			$this->data['marital_status']=$this->input->post("marital_status");
		}		

		if($this->input->get("driving_license_country")!='')
		{ 
			$this->data['driving_license_country']=$this->input->get("driving_license_country");
		}
		
		if($this->input->post("driving_license_country")!='')
		{ 
			$this->data['driving_license_country']=$this->input->post("driving_license_country");
		}		

		if($this->input->get("cur_employer")!='')
		{ 
			$this->data['cur_employer']=$this->input->get("cur_employer");
		}
		
		if($this->input->post("cur_employer")!='')
		{ 
			$this->data['cur_employer']=$this->input->post("cur_employer");
		}

	
		$this->data['total_rows']= $this->downloadprofilemodel->record_count($this->data['search_name'], $this->data['search_email'],$this->data['search_mobile'],$this->data['cur_employer'],$this->data['cur_job_status'], $this->data['lead_source'], $this->data['job_folder_id'], $this->data['job_cat_id'],$this->data['func_id'],$this->data['desig_id'], $this->data['skil_id'],$this->data['level_id'],$this->data['course_id'],$this->data['spcl_id'],$this->data['exp_years_from'],$this->data['exp_years_to'],$this->data['salary_from'],$this->data['salary_to'],$this->data['marital_status'],$this->data['visa_type'],$this->data['gender'],$this->data['driving_license_country'],$this->data['nationality'], $this->data['country_id'],$this->data['state_id'],$this->data['city_id'],$this->data['age_from'],$this->data['age_to'],$this->data['lang_id']);
	
		$this->data['cur_page']=$this->router->class;
			
		$config['base_url'] = $this->config->item('base_url')."index.php/downloadprofile/?sort_by=".$this->data['sort_by']."&sort_param=".$this->data['sort_param']."&limit=".$this->data['limit']."&start=".$this->data['start']."&search_name=".$this->data['search_name']."&search_email=".$this->data['search_email']."&search_mobile=".$this->data['search_mobile']."&cur_employer=".$this->data['cur_employer']."&cur_job_status=".$this->data['cur_job_status']."&lead_source=".$this->data["lead_source"]."&job_folder_id=".$this->data["job_folder_id"]."&job_cat_id=".$this->data["job_cat_id"]."&func_id=".$this->data["func_id"]."&desig_id=".$this->data['desig_id']."&skil_id=".$this->data['skil_id']."&level_id=".$this->data['level_id']."&course_id=".$this->data['course_id']."&spcl_id=".$this->data['spcl_id']."&exp_years_from=".$this->data['exp_years_from']."&exp_years_to=".$this->data['exp_years_to']."&salary_from=".$this->data['salary_from']."&salary_to=".$this->data['salary_to']."&marital_status=".$this->data['marital_status']."&visa_type=".$this->data['visa_type']."&gender=".$this->data['gender']."&driving_license_country=".$this->data['driving_license_country']."&nationality=".$this->data['nationality']."&country_id=".$this->data['country_id']."&state_id=".$this->data['state_id']."&city_id=".$this->data['city_id']."&age_from=".$this->data['age_from']."&age_to=".$this->data['age_to']."&lang_id=".$this->data['lang_id'];
		...
		$this->data["records"] = $this->downloadprofilemodel->get_list($this->data['start'],$this->data['limit'],$this->data['sort_by'],$this->data['sort_param'],$this->data['search_email'],$this->data['search_name'],$this->data['search_mobile'],$this->data['cur_employer'],$this->data['cur_job_status'],$this->data['lead_source'],$this->data['job_folder_id'],$this->data['job_cat_id'],$this->data['func_id'],$this->data['desig_id'], $this->data['skil_id'], $this->data['level_id'],$this->data['course_id'],$this->data['spcl_id'],$this->data['exp_years_from'],$this->data['exp_years_to'],$this->data['salary_from'],$this->data['salary_to'],$this->data['marital_status'],$this->data['visa_type'],$this->data['gender'],$this->data['driving_license_country'],$this->data['nationality'],$this->data['country_id'],$this->data['state_id'],$this->data['city_id'],$this->data['age_from'],$this->data['age_to'],$this->data['lang_id']);		
		...
		if($this->input->get('download_csv') == '1')
		{
		...
		//exit;
			...
			if( count($this->data["records"]) > 10000 ) {

				$message ='<div class="alert alert-danger alert-dismissible" role="alert">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
				
				<span>Too many records could n\'t export, the maximum record limit is 500, reduce the list by applying any  filters.</span>
			</div>'	;
			$this->data['csv_error'] = $message;
			}else{
				$this->exports_csv($this->data["records"]);
				//print_r($this->data["records"]);
				//exit();
				exit;
			}	
		...
		$this->data['admin_users_lists']= $this->downloadprofilemodel->get_admin_users_lists();
		//$this->data["branch_list"] = $this->downloadprofilemodel->branch_list();
		
		//Education details
		$this->data["edu_level_list"] = $this->downloadprofilemodel->edu_level_list();
		...
		$this->data['job_folders']        =$this->downloadprofilemodel->get_job_folders();
		$this->data['job_cat_list']       =$this->downloadprofilemodel->industry_list();
		$this->data['func_area_list']     =$this->downloadprofilemodel->functional_list();
		$this->data['desig_list']         =$this->downloadprofilemodel->desig_list();
		$this->data['skill_list']=$this->downloadprofilemodel->get_all_skills($this->data['desig_id']);
		
		$this->data["cur_job_status_list"] = $this->downloadprofilemodel->cur_job_status_list();
		
		$this->data["edu_spec_list"] = $this->downloadprofilemodel->edu_spec_list();
		$this->data["years_list"] = $this->downloadprofilemodel->years_list();
		
		$this->data["language_list"] = $this->downloadprofilemodel->get_language_candidate();
		
		$this->data["country_list"] = $this->downloadprofilemodel->country_list();
		$this->data["state_list"] = $this->downloadprofilemodel->state_list_by_country($this->data["country_id"]);
		$this->data["city_list"] = $this->downloadprofilemodel->location_list_by_state($this->data["state_id"]);
		
		$this->data["nationality_list"] = $this->downloadprofilemodel->nationality_list();
		
		$this->data["marital_status_list"] = $this->downloadprofilemodel->marital_status_list();
		$this->data["gender_list"] = $this->downloadprofilemodel->gender_list();		
		$this->data["driving_license_country_list"] = $this->downloadprofilemodel->driving_license_country_list();
		
		$this->data["visa_type_list"]       = $this->downloadprofilemodel->visa_type_list();
				
		$this->data["salary_from_list"]     = $this->downloadprofilemodel->salary_from_list();
		$this->data["salary_to_list"]       = $this->downloadprofilemodel->salary_to_list();

		$this->data["exp_years_from_list"]     = $this->downloadprofilemodel->exp_years_from();
		$this->data["exp_years_to_list"]       = $this->downloadprofilemodel->exp_years_to();
				
		//print_r($this->data["salary_from_list"]);
		//exit();
		
		$this->load->view('include/header',$this->data);
		$this->load->view('downloadprofile/candidateslist',$this->data);				
		$this->load->view('include/footer',$this->data);
	
	}

	public function downloadprofilecsv()
	{
		print_r($_GET);
		exit();
	}

	public function exports_csv( $candidate_data , $delimiter=','){
		//echo '<pre>';
		//print_r( $candidate_data);
		//echo '</pre>';
		//exit();
		
		$file_name='candidate-list-'.date('Y-m-d h:i:s');
		header("Content-type: application/csv");
		header("Content-Disposition: attachment; filename=\"$file_name".".csv\"");
		header("Pragma: no-cache");
		header("Expires: 0");
		$handle = fopen('php://output', 'w');
		$header = array("ID", "Cur Job Status", "First Name","Email","Reg. Date", "Mobile","Experience","Exp. CTC", "Industry", "Func. Area", "Organization", "Designation");
		fputcsv($handle, $header,$delimiter);
		foreach ($candidate_data as $candidate) {
			$array = array( 
				$candidate['candidate_id'],
				$candidate['cur_job_status_name'],
				$candidate['first_name'].' '.$candidate['last_name'],
				$candidate['username'],
				$candidate['reg_date'],
				$candidate['mobile_prefix'].''.$candidate['mobile'],
				$candidate['total_experience'] != '' ?  $candidate['total_experience']." Yrs" : '',
				$candidate['expected_ctc'] != '' ?  'AED '. $candidate['expected_ctc']."" : '',
	...
	{	
		...
		$this->data["edu_course_list"] = $this->downloadprofilemodel->edu_course_list();
		$this->data["level_list"] = $this->coursemodel->fill_levels();
		$this->data["branch_list"] = $this->downloadprofilemodel->branch_list();
		$this->data['admin_users_lists']= $this->downloadprofilemodel->get_admin_users_lists();

		$this->data["industry_list"]    = $this->downloadprofilemodel->industries_list();
		...
		$this->load->view('include/header',$this->data);
		$this->load->view('downloadprofile/addcandidates',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
	...
	{
		$this->load->model('downloadprofilemodel');  
		$this->data["personal"] = $this->downloadprofilemodel->get_single_record($id);
		$file_text='';
	...
	public function get_functional_by_industry()
	{
		...
		{
			$data=array();
			$data["func_list"] = $this->downloadprofilemodel->get_functional_by_industry($_POST['job_cat_id']);
			$data = array('success' => true, 'func_list' => $data["func_list"]);
		}else{
			$data=array();
			$data["func_list"] = $this->downloadprofilemodel->all_func_list();
			$data = array('success' => true, 'func_list' => $data["func_list"]);			
		}
	...
	public function get_designation_by_function()
	{
		...
		{
			$data=array();
			$data["desig_list"] = $this->downloadprofilemodel->get_designation_by_function($_POST['func_id']);
			$data = array('success' => true, 'desig_list' => $data["desig_list"]);
		}else{
			$data=array();
			$data["desig_list"] = $this->downloadprofilemodel->all_desig_list();
			$data = array('success' => true, 'desig_list' => $data["desig_list"]);			
		}
		echo json_encode($data);
	}
	...
	function loadContacthtml($id) {
		...
		$this->data["religion_list"]    = $this->downloadprofilemodel->religion_list();
        ...
        $this->load->view('downloadprofile/addcontactdetail', $this->data);
    }
	
	function skip_step2($candidateId){
		$this->load->model('downloadprofilemodel');
		//$this->downloadprofilemodel->insert_contact_detail_skip($candidateId);		
	...
	function addCandidateDetail($candidateId){
		$this->load->model('downloadprofilemodel');
		$id  = $this->downloadprofilemodel->insert_contact_detail($candidateId);
		$uid = $this->downloadprofilemodel->update_contact_detail($candidateId);
        if ($id > 0) { //success
	...
	function loadPassporthtml($id){
		...
		$this->data["formdata"]=$this->downloadprofilemodel->get_passport_details($id);
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->downloadprofilemodel->country_list();
		$this->load->view('downloadprofile/addpassportdetail', $this->data);
	}
	...
	function addPassportDetail($candidateId){
		$this->load->model('downloadprofilemodel');
		$uid = $this->downloadprofilemodel->update_passport_detail($candidateId);
		$status = array("STATUS" => "1");
		echo json_encode($status);
	}
	...
	function loadEducationhtml($id){
		...
		$this->data["country_list"] 	= $this->countrymodel->country_list_by_state_city_location();
		$this->data["edu_level_list"] = $this->downloadprofilemodel->edu_level_list();
		$this->data["edu_years_list"] = $this->downloadprofilemodel->edu_years_list();
		$this->data["edu_course_list"] = $this->downloadprofilemodel->edu_course_list();
		$this->data["edu_spec_list"] = $this->downloadprofilemodel->edu_spec_list();
		$this->data["edu_univ_list"] = $this->downloadprofilemodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->downloadprofilemodel->edu_course_type_list();
		$this->load->view('downloadprofile/addeducationdetail',$this->data);
	}
	
	function skip_step4($candidateId){
		$this->load->model('downloadprofilemodel');
		//$this->downloadprofilemodel->insert_education_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function addEducationDetail($candidateId)
	{
		...
		$id  = $this->downloadprofilemodel->insert_education_detail($data);
	...
	function open_notes_list()
	{
		...
		$this->data['interview_time_ar']=array(
						...
						'6:30 PM' => '6:30 PM',
						'7:00 PM' => '7:00 PM');
		$this->data['records']=$this->downloadprofilemodel->get_notes_list($this->data['candidate_id']);
		$output_html=$this->load->view('downloadprofile/manage_notes',$this->data,true);	
		echo $output_html;
	}
	...
	function open_consultant_feedback($candidate_id)
	{
		...
		$this->data['candidate_id']=$this->input->post('candidate_id');
		$this->data['job_id']=0;
		$this->data['feedback']=$this->downloadprofilemodel->get_consultant_feedback($this->data['candidate_id']);
		$output_html=$this->load->view('downloadprofile/consultant_feedback',$this->data,true);	
		echo $output_html;
	}
...
function add_consultant_feedback($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			$this->downloadprofilemodel->add_consultant_feedback($data,$this->data['candidate_id']);
	...
	function loadJobhtml($id){
		...
		//employment
		$this->data["industry_list"] = $this->downloadprofilemodel->industry_list();
		$this->data["functional_list"] = $this->downloadprofilemodel->functional_list();
		$this->data["currecy_list"] = $this->downloadprofilemodel->currency_list();
		$this->data["years_list"] = $this->downloadprofilemodel->years_list();
		$this->data["months_list"] = $this->downloadprofilemodel->months_list();
		$this->load->view('downloadprofile/addjobdetail', $this->data);
	}
	
	function skip_step5($candidateId){
		$this->load->model('downloadprofilemodel');
		//$this->downloadprofilemodel->insert_job_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	{
		$this->load->model('downloadprofilemodel');
		$id  = $this->downloadprofilemodel->insert_job_detail($candidateId);
		$uid = $this->downloadprofilemodel->update_job_detail($candidateId);
	...
	function loadFilehtml($id)
	{
		...
		$this->data['candidate_id'] = $id;
		$this->load->model('downloadprofilemodel');
		$this->load->view('downloadprofile/addfiledetail', $this->data);
	}
	...
	function upload_cv_photo($candidate_id)
	{
		...
		if($candidate_id!='')
		{
			if(isset($_FILES['cv_file'])){
				...
				{       				
					...
					if ($this->upload->do_upload('cv_file'))
					{
						...
						$this->downloadprofilemodel->insert_files($dataArr);
					}
				}
			}
			...
			redirect('downloadprofile/summary/'.$this->input->post('candidate_id'));
		}else
		{
			redirect('downloadprofile');
		}		
	}
	...
	function addCandidate(){
		...
		{ 
			$id = $this->downloadprofilemodel->insert_candidate_record();
			if ($id != '') { 
...
//Loading Models
		...
		$this->data["formdata"] = $this->downloadprofilemodel->get_single_record($id);
	
//Certification and Technical Skilss
		
		$this->data['cerifications']=$this->jobsmodel->get_cert();
		$candidate_certifications = $this->downloadprofilemodel->candidate_certifications($id);
...
//skills
		...
		$this->data['skill_list']=$this->downloadprofilemodel->get_parent_skills();
		
		$candidate_skills = $this->downloadprofilemodel->candidate_skills($id);
		...
		//all child skills		
		$this->data['all_child_skills']	=	$this->downloadprofilemodel->child_skills();
		//domain knowledge
		
		
		$this->data['job_folders']=$this->downloadprofilemodel->get_job_folders();
		
		$this->data['domain']=$this->downloadprofilemodel->get_domain();
		$candidate_domain = $this->downloadprofilemodel->get_domain_details($id);
...
//Planning Job Change Details
		$this->data["formdata8"] = $this->downloadprofilemodel->job_search($id);
...
//Language Deatils
		$this->data['lang_list']=$this->downloadprofilemodel->get_language_set();
		$candidate_certifications =$this->downloadprofilemodel->candidate_languages($id);
...
//Contact Details
		...
		$this->data["formdata3"] = $this->downloadprofilemodel->get_address_single_record($id);
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->downloadprofilemodel->country_list();
		$this->data["formdata4"] = $this->downloadprofilemodel->get_passport_single_record($id);
		...
		$this->data["edu_spec_list"]        = $this->downloadprofilemodel->edu_spec_list();
		$this->data["edu_univ_list"]        = $this->downloadprofilemodel->edu_univ_list();
		$this->data["edu_coll_list"]        = $this->downloadprofilemodel->edu_coll_list();
		$this->data["edu_course_type_list"] = $this->downloadprofilemodel->edu_course_type_list();
		$this->data["formdata5"]            = $this->downloadprofilemodel->get_education_single_record($id);
...
//Job Details
		$this->data["industries_list"] = $this->downloadprofilemodel->industries_list();
		$this->data["industry_list"] = $this->downloadprofilemodel->industry_list();
		$this->data["functional_list"] = $this->downloadprofilemodel->functional_list();
		$this->data["currecy_list"] = $this->downloadprofilemodel->currency_list();
		$this->data["years_list"] = $this->downloadprofilemodel->years_list();
		$this->data["months_list"] = $this->downloadprofilemodel->months_list();
		$this->data["formdata6"] = $this->downloadprofilemodel->get_job_single_record($id);
...
//FILE DEATILS
		$this->data['survey_result']=$this->downloadprofilemodel->get_survey_result($id);
		$this->data["formdata7"] = $this->downloadprofilemodel->get_file_single_record($id);
		...
		// fetch profile data
		$this->data["formdata"]['profile_list'] = $this->downloadprofilemodel->profile_list($id);
		
		$this->data["edu_view"]	=	$this->educationDetails($id);
		$this->data["job_view"]	=	$this->jobDetails($id);
		
		$this->load->view('include/header',$this->data);
		$this->load->view('downloadprofile/editcandidates_auto_complete',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
 ...
 //FETCHING ALL FUNCTIONS
	...
	{ 
		...
		redirect('downloadprofile/?upd=1');
	...
	function editCandidate(){
		...
		$this->load->model('downloadprofilemodel');
        $this->downloadprofilemodel->update_candidate_record($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function update_candidate_profile()
	{
		if( $this->input->post('candidate_id')!='')
		{
			...
			$this->downloadprofilemodel->update_candidate_record($candidate_id,$data_profile,$data_job);
			redirect('downloadprofile/summary/'.$candidate_id.'?upd=1');
		}else
		{
			echo 'Invalid Data';
			exit();
    ...
    function connect_with_jobs(){
		...
		{			
			$this->data['candidate_id']=$this->input->post("candidate_id");
			$this->data['candidate_profile']=$this->downloadprofilemodel->get_single_profile($this->data['candidate_id']);
			
			$this->data["jobs_list"] = $this->downloadprofilemodel->fill_job_list($this->data['candidate_id']);
			}		
		
		$this->data['page_head'] = 'Jobs List';	
		$this->load->view('downloadprofile/get_connect_jobs',$this->data);			
	}
	...
	function loadEditContacthtml($id){
        ...
        $this->load->view('downloadprofile/editcontactdetail', $this->data);

	}
	
	function editCandidateDetail($candidateId){
		$this->load->model('downloadprofilemodel');
        $this->downloadprofilemodel->edit_contact_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function loadEditPassporthtml($id){
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->downloadprofilemodel->country_list();
		$this->data["formdata"] = $this->downloadprofilemodel->get_passport_single_record($id);
		$this->load->view('downloadprofile/editpassportdetail', $this->data);
	}
	
	function editPassportDetail($candidateId)
	{
		$this->load->model('downloadprofilemodel');
        $this->downloadprofilemodel->edit_passport_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditEducationhtml()
	{
		...
		$this->data["edu_univ_list"] = $this->downloadprofilemodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->downloadprofilemodel->edu_course_type_list();
		$this->data["formdata"] = $this->downloadprofilemodel->get_education_single_record($this->data['edu_id']);
		...
		$data=$this->load->view('downloadprofile/editeducationdetail',$this->data,true);
		echo $data;
		exit();
	}
...
//EDUCATION DETAILS
	function educationDetails($id)
	{
		...
		$edu_level = $this->downloadprofilemodel->edu_level_list();
		
		$course = $this->downloadprofilemodel->edu_course_list();

		$spec = $this->downloadprofilemodel->edu_spec_list();


		
		$results = $this->downloadprofilemodel->get_education_details($id);
		$form_data	=	array();
		...
		$education_details_view	=	$this->load->view('downloadprofile/education_details',$this->data,true);
	...
	function update_education()
	{
		...
		$this->downloadprofilemodel->update_education($data,$this->input->post('edu_id'),$this->input->post('candidate_id'));
//        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
		redirect('downloadprofile/summary/'.$this->input->post('candidate_id').'?edu_upd=1');
        //echo json_encode($status);
	}
	...
	{
		$this->load->model('downloadprofilemodel');
        $this->downloadprofilemodel->edit_education_detail($candidateId);
	...
	{
		$this->load->model('downloadprofilemodel');
        $this->downloadprofilemodel->edit_job_change_detail($candidateId);
		 $this->downloadprofilemodel->edit_passport_num_type($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditJobhtml()
	{
		...
		$this->data["years_list"] = $this->downloadprofilemodel->years_list();
		$this->data["months_list"] = $this->downloadprofilemodel->months_list();
		$this->data["formdata"] = $this->downloadprofilemodel->get_job_single_record($this->data['job_profile_id']);
		...
		$output_string=$this->load->view('downloadprofile/editjobdetail', $this->data,true);
		echo $output_string;
	}
...
//JOB DETAILS
	function jobDetails($id)
	{
		...
		$industry_list = $this->downloadprofilemodel->industry_list();
		$functional_list = $this->downloadprofilemodel->functional_list();

		
		$results = $this->downloadprofilemodel->get_job_details($id);
		$form_data	=	array();
		...
		$job_details_view	=	$this->load->view('downloadprofile/job_details',$this->data,true);
    ...
    function update_job_vacancy()
	{
		...
		if($this->input->post("candidate_id")!='')
		{
			...
			{	
				...
				{
					$this->downloadprofilemodel->update_job_vacancy($candidate_id,$val);	
				}
	...
	function update_job_details()
	{
        ...
        $job_profile_id=$this->downloadprofilemodel->update_job_details($data,$job_profile_id,$candidate_id);
		
		redirect('downloadprofile/summary/'.$candidate_id.'?prof_upd=1');
	...
	function loadEditFilehtml($id){
		...
		$this->load->model('downloadprofilemodel');
		$this->data['survey_result']=$this->downloadprofilemodel->get_survey_result($id);
		$this->data["formdata"] = $this->downloadprofilemodel->get_file_single_record($id);	

		$this->load->view('downloadprofile/editfiledetail', $this->data);
	}
    ...
    {    
        ...
        {
			$this->load->view('include/header',$this->data);    
			$this->load->view('downloadprofile/import_csv',$this->data);                
			$this->load->view('include/footer',$this->data);        
        }
        else
        {
				...
				if($res['username'] != '')
				{
						...
						$result	=	$qry->row_array(); 
							...
							if(empty($result))
							{
								...
								$id = $this->downloadprofilemodel->insert_csv_records($data);
								...
								$this->downloadprofilemodel->insert_csv_edu($data1);
								...
								$this->downloadprofilemodel->insert_csv_job($data2);
								...
								{								
									...
									$this->downloadprofilemodel->insert_csv_skills($data3);
								}
								...
								{								
									...
									$this->downloadprofilemodel->insert_csv_cert($data4);
								}
								...
								{								
									...
									$this->downloadprofilemodel->insert_csv_domain($data5);
								}
								...
								{								
									...
									$this->downloadprofilemodel->insert_csv_lang($data6);
								}
								...
								$this->downloadprofilemodel->insert_csv_job_search($data7);						
			...
			redirect('downloadprofile/?csv=1');
        }  
    ...
    {    
        ...
        {
			//$this->load->view('include/header',$this->data);    
			$this->load->view('downloadprofile/import_csv_linkedin',$this->data);                
			//$this->load->view('include/footer',$this->data);        
        }
        else
        {
			...
			redirect('downloadprofile/import_csv_linkedin/?csv=1');
        }  
    }
		...
		foreach($result as $key => $val)
		{
				...
				if(trim($val['organization']!=''))
				{
					...
					}else
					{
						...
						$company_id=$this->downloadprofilemodel->insert_csv_company($company_list);
					}
    ...
    {    
		...
		foreach($result as $key => $val)
		{
			...
			{				
				...
				$this->downloadprofilemodel->insert_csv_job($job_profile);																
				$this->db->query("delete from pms_candidate_new where candidate_id=".$val['candidate_id']);							
			}
		}
...
/*				$data=array(
    ...
    {    
		...
		$this->load->view('include/header',$this->data);    
		$this->load->view('downloadprofile/import_xml',$this->data);                
		$this->load->view('include/footer',$this->data);        
	...
	function candidate_view($candidate_id)
	{
		...
		$this->data['detail_list'] = $this->downloadprofilemodel->detail_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('downloadprofile/candidate_view/'.$this->input->post('candidate_id'));
		}

		$this->data['list']               =$this->downloadprofilemodel->follow_record($candidate_id);
		$this->data['note_list']          =$this->downloadprofilemodel->notes_record($candidate_id);		
		$this->data['coe_list']           =$this->downloadprofilemodel->coe_list($candidate_id);
		$this->data['visa_approval_list'] =$this->downloadprofilemodel->visa_approval_list($candidate_id);

		$this->data['interview_list']     =$this->downloadprofilemodel->interview_record($candidate_id);
		$this->data['aplication_list']    =$this->downloadprofilemodel->aplication_record($candidate_id);
		
		$this->data['interview_status_list']=$this->downloadprofilemodel->interview_status_list();		
		
		$this->data['app_list']           =$this->downloadprofilemodel->aplication_list($candidate_id);
		$this->data['app_list_coe']       =$this->downloadprofilemodel->select_aplication_coe($candidate_id);
		$this->data['admin_user_list']    =$this->downloadprofilemodel->admin_user_list();
		$this->data['interview_type_list']=$this->downloadprofilemodel->interview_type_list();
		$this->data['university_list']    =$this->downloadprofilemodel->university_list();
		$this->data['campus_list']        =array('' => 'Select Campus');
		$this->data['intake_list']        =$this->downloadprofilemodel->intake_list();
		$this->data['course_list']        =array('' => 'Select Course');;
		$this->data['level_list']         =$this->coursemodel->fill_levels();
		$this->data['status_list']        =$this->downloadprofilemodel->status_list();

		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("downloadprofile/candidate_view",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function summary($candidate_id)
	{
		...
		{
				$this->data['job_profile_id'] = $this->input->get('job_profile_id');
				$this->data["formdata_job"]         = $this->downloadprofilemodel->get_job_single_record($this->data['job_profile_id']);
				$this->data['candidate_id'] = $this->input->get('candidate_id');
				$this->data["location_ids_pros"] = $this->downloadprofilemodel->get_location_ids_job_profile($this->data['job_profile_id']);
				...
				if($this->data["formdata_job"]["job_cat_id"]>0)
					$this->data["functional_list"] =$this->downloadprofilemodel->get_functional_by_industry($this->data["formdata_job"]["job_cat_id"]);
				else
					$this->data["functional_list"] = $this->downloadprofilemodel->functional_list();

				if($this->data["formdata_job"]["func_id"]>0)
					$this->data["designation_list"] =$this->downloadprofilemodel->get_designation_by_function($this->data["formdata_job"]["func_id"]);
				else
					$this->data["designation_list"] = $this->downloadprofilemodel->desig_list();
									
				$this->data["country_list"] 	= $this->countrymodel->country_list();
				$this->data["state_list"] 	    = $this->downloadprofilemodel->state_list_by_country($this->data["formdata_job"]["country_id"]);
			
				$this->data["city_list"] 	    = $this->downloadprofilemodel->location_list_by_state($this->data["formdata_job"]["state_id"]);
		
				$this->data["currecy_list"]         = $this->downloadprofilemodel->currency_list();
				$this->data["years_list"]           = $this->downloadprofilemodel->years_list();
				$this->data["months_list"]          = $this->downloadprofilemodel->months_list();
				
				$this->data['edit_job_html']        = $this->load->view('downloadprofile/editjobdetail', $this->data,true);
		}
		...
		$this->data["formdata"]               = $this->downloadprofilemodel->get_single_record($candidate_id);
		$this->data["location_ids"]			  = $this->downloadprofilemodel->get_country_state_city_ids($candidate_id);
		//print_r($this->data["location_ids"]);
		//exit();
		...
		$this->data['candidate_languages']    = $this->downloadprofilemodel->candidate_languages($candidate_id);
		$this->data['education_details']      = $this->downloadprofilemodel->education_deatils($candidate_id);
		
		$this->data['job_history']            = $this->downloadprofilemodel->job_list($candidate_id);
		$this->data['followup_history']       = $this->downloadprofilemodel->get_followup_detail($candidate_id);
		
		$this->data['all_calls']              = $this->downloadprofilemodel->all_calls($candidate_id);
		
		//print_r($this->data["formdata"]);
		//exit();
		
		$this->data['all_messages']           = $this->downloadprofilemodel->all_messages($candidate_id);
		$this->data['all_notes']              = $this->downloadprofilemodel->all_notes($candidate_id);
	
		$this->data['candidate_skill']        = $this->downloadprofilemodel->candidate_skills($candidate_id);
		
		//candidate doamin knowledge
		$this->data['candidate_domain']       = $this->downloadprofilemodel->candidate_domains($candidate_id);
		$this->data['admin_user_list']        =$this->downloadprofilemodel->admin_user_list();
		//Certification 
		
		$this->data['cerifications']          =$this->downloadprofilemodel->get_cert();
		$candidate_certifications             = $this->downloadprofilemodel->candidate_certifications($candidate_id);
		...
		$this->data['candidate_questionnaire_summary'] = $this->downloadprofilemodel->get_survey_result($candidate_id);
		$this->data['candidate_files_summary'] = $this->downloadprofilemodel->get_files($candidate_id);
		$this->data['candidate_complaints_summary'] = $this->downloadprofilemodel->ticket_list($candidate_id);

//Job Search details(candidate_job_serach)
		$this->data['job_search'] = $this->downloadprofilemodel->job_search($candidate_id);
		...
		$candidate_skills = $this->downloadprofilemodel->candidate_skills($candidate_id);
...
//Edit Language Modal
		//Language Deatils
		$this->data['lang_list']=$this->downloadprofilemodel->get_language_set();
		$candidate_languages =$this->downloadprofilemodel->candidate_languages($candidate_id);
		...
		$this->data["country_list"] 	= $this->countrymodel->country_list();
		$this->data["state_list"] 	    = $this->downloadprofilemodel->state_list_by_country($this->data["formdata"]["country_id"]);
		$this->data["city_list"] 	    = $this->downloadprofilemodel->location_list_by_state($this->data["formdata"]["state_id"]);

		$this->data["nationality_list"] 	= $this->countrymodel->country_list();
		$this->data["current_location_list"] 	= $this->downloadprofilemodel->city_list();
		...
		$this->data["functional_list"] = $this->downloadprofilemodel->functional_list();
		$this->data["designation_list"] = $this->downloadprofilemodel->desig_list();	
		//print_r($this->data["designation_list"]);
		//exit();
...
//suggested jobs to candidate		
		$this->data['suggested_jobs']=$this->downloadprofilemodel->get_suggested_jobs($candidate_id);	

//applied jobs of candidate		
		$this->data['applied_jobs']=$this->downloadprofilemodel->get_job_list($candidate_id);

		//shortlisted jobs
		$this->data['shortlisted']=$this->downloadprofilemodel->get_shortlisted($candidate_id);

		//interview scheduled jobs
		$this->data['interview_list']=$this->downloadprofilemodel->get_interview_list($candidate_id);

		//selected jobs
		$this->data['jobs_selected']=$this->downloadprofilemodel->jobs_selected($candidate_id);

		//offer letters issued
		$this->data['offer_letters_issued']=$this->downloadprofilemodel->offer_letters_issued($candidate_id);
		
		//offer accepted
		$this->data['offer_accepted']=$this->downloadprofilemodel->offer_accepted($candidate_id);

		//invoice genereted
		$this->data['invoice_generated']=$this->downloadprofilemodel->invoice_generated($candidate_id);

		//all child skills		
		$this->data['all_child_skills']	=	$this->downloadprofilemodel->child_skills();

		//present contract details
		$this->data['contract']=$this->downloadprofilemodel->get_contract_detail($candidate_id);
		...
		/*--------------------------------------------------------------------------*/		
		//category /industry
		$category = $this->downloadprofilemodel->get_cat_list($candidate_id);		
		$cat_list=array();		
		...
		// funcional area
		$function = $this->downloadprofilemodel->get_function_list($candidate_id);
		...
		// designation list
		$designation = $this->downloadprofilemodel->get_designation_list($candidate_id);		
		$desig_list=array();
...
//primary_skills
		$candidate_skills_primary = $this->downloadprofilemodel->candidate_skills_primary($candidate_id);
...
//secondary skills
		$candidate_skills_secondary = $this->downloadprofilemodel->candidate_skills_secondary($candidate_id);
...
//Language Deatails pms_candidate_language
		$this->data['lang_details'] = $this->downloadprofilemodel->get_lang_details($candidate_id);
...
/*--------------------------------------------------------------------------*/
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('downloadprofile/summary/'.$candidate_id);
		}
		...
		$this->load->view("downloadprofile/candidate_summary",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function remove_job_app()
	{
		...
		{
			$this->downloadprofilemodel->remove_job_app($this->input->get('candidate_id'),$this->input->get('job_id'));
			redirect('downloadprofile/summary/'.$this->input->get('candidate_id').'?upd=1');
		}else
		{
			echo 'No Details';
		}
	...
	function candidate_programs($candidate_id)
	{
		...
		// update suggestion logic from here
			$this->downloadprofilemodel->update_suggestion_module($this->input->post('candidate_id'), $this->input->post('campus_id'), $this->input->post('course_id'), $this->input->post('total_semester'), $this->input->post('fee_per_semester'), $this->input->post('annual_tution_fee'), $this->input->post('total_tution_fee'),$this->input->post('candidate_course_id'));
		// end here	
					
			redirect('downloadprofile/candidate_programs/'.$this->input->post('candidate_id').'/?upd=1');
		}
...
if($this->input->get('education')!='')
		...
		if($this->input->get('course_id')!='')
		{
			...
			$this->data['single_application']['app_details']=$this->downloadprofilemodel->create_program_name($this->data['single_application']['course_id']);
		}					
		...
		$this->data['aplication_list']=$this->downloadprofilemodel->aplication_record($candidate_id); // application lists - 	
		$this->data['detail_list'] = $this->downloadprofilemodel->detail_list($candidate_id); // candidate details
		$this->data['university_list']=$this->downloadprofilemodel->university_list(); // university list		
		$this->data['intake_list']=$this->downloadprofilemodel->intake_list(); // intake list 		
		$this->data['level_list']=$this->coursemodel->fill_levels(); // education levels
		$this->data['status_list']=$this->downloadprofilemodel->status_list(); // application process status list
		$this->data['campus_list']=array('' => 'Select Campus');
		$this->data['course_list']=array('' => 'Select Course');

		if($this->data['single_application']['univ_id']>0)
			$this->data['campus_list']=$this->downloadprofilemodel->campus_list($this->data['single_application']['univ_id']);
		if($this->data['single_application']['level_study']>0)
			$this->data['course_list']=$this->downloadprofilemodel->course_list_level($this->data['single_application']['level_study']);
			
		$this->data['candidate_qualification_list']=$this->downloadprofilemodel->candidate_qualification_list($candidate_id); 
		// candidate's qualification for higher studies
		// edit mode		
		if($this->input->get('app_id')!='')
		{
			$this->data['single_application']=$this->downloadprofilemodel->select_aplication_record($this->input->get('app_id'));
			if(count($this->data['single_application'])>0)
			{
				if($this->data['single_application']['univ_id']>0)$this->data['campus_list']=$this->downloadprofilemodel->campus_list($this->data['single_application']['univ_id']);
				if($this->data['single_application']['level_study']>0)$this->data['course_list']=$this->downloadprofilemodel->course_list_level($this->data['single_application']['level_study']);
		...
		// update program		
		$this->load->view("include/header",$this->data);
		$this->load->view("downloadprofile/candidate_programs",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function aplication()
	{
		...
		$this->data['aplication_list']=$this->downloadprofilemodel->select_aplication_record($id);		
	...
	function candidate_coe($candidate_id)
	{
		...
		$this->editor($path, $width);
		$this->load->view("include/header",$this->data);
		$this->load->view("downloadprofile/candidate_coe",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function candidate_visa($candidate_id)
	{
		...
		$this->data['visa_approval_list']=$this->downloadprofilemodel->visa_approval_list($candidate_id);
		$this->data['app_list_coe']=$this->downloadprofilemodel->select_aplication_visa($candidate_id);
...
// Manage Email & SMS
	function email_sms($candidate_id)
	{
		...
		$this->load->model('downloadprofilemodel');
		$this->data['detail_list'] = $this->downloadprofilemodel->detail_list($candidate_id);
		$this->data['email_sms_list']=$this->downloadprofilemodel->email_sms_list($candidate_id);
		...
		if($this->input->post('send_type')!='')
		{
			...
			redirect('downloadprofile/email_sms/'.$candidate_id);
		}
		$this->data['error']="Fill subject and email content to send to the candidate.";
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("downloadprofile/candidate_email_sms",$this->data);
		$this->load->view("include/footer",$this->data);
	}
// Schedule an interview
	function interview(){
		...
		$id=$this->db->insert_id();
		$this->load->model('downloadprofilemodel');
		$this->data['interview_list']=$this->downloadprofilemodel->select_interview_record($id);
	...
	function tickets($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['detail_list'] = $this->downloadprofilemodel->detail_list($candidate_id);
			...
			$this->data['ticket_list']=$this->downloadprofilemodel->ticket_list($candidate_id);
			...
			if($this->input->post('send_type')!='')
			{
				...
				$id=$this->db->insert_id();
				redirect('downloadprofile/tickets/'.$candidate_id);
			}
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("downloadprofile/candidate_complaints",$this->data);
			$this->load->view("include/footer",$this->data);
	}
	...
	function invoice($candidate_id)
	{
		...
		$this->data['education_details'] = $this->downloadprofilemodel->education_deatils($candidate_id);
		$this->data['job_history'] = $this->downloadprofilemodel->job_list($candidate_id);
		$this->data['all_counselor'] = $this->downloadprofilemodel->all_counselor($candidate_id);
		$this->data['candidate_counselor'] = $this->downloadprofilemodel->candidate_counselor($candidate_id);
		...
		foreach($this->input->post('admin_id') as $key => $val)
		{
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("downloadprofile/candidate_invoice",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function cvfile($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->downloadprofilemodel->cvfile_list($candidate_id);
		...
		if($this->input->post('cvfile')!=''){
			...
			redirect('downloadprofile/cvfile/'.$candidate_id);
			$path = '../js/ckfinder';
			$width = '100%';
			$this->editor($path, $width);
			$this->load->view("include/header",$this->data);
			$this->load->view("downloadprofile/candidate_cvfile",$this->data);
			$this->load->view("include/footer",$this->data);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
	...
	function job_history($candidate_id)
	{
		...
		$this->data['cv_fileist']=$this->downloadprofilemodel->job_list($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('downloadprofile/job_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("downloadprofile/candidate_job_history",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function update_skills($candidate_id)
	{
		$this->data['candidate_id']=$candidate_id;
		$this->load->model('downloadprofilemodel');
	...
	function edu_history($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->downloadprofilemodel->education_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			redirect('downloadprofile/edu_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("downloadprofile/candidate_edu_history",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function lang_history($candidate_id)
	{
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->downloadprofilemodel->country_list();
		$this->data["formdata"] = $this->downloadprofilemodel->get_passport_single_record($candidate_id);
		...
		//Language Deatils
		$this->data['lang_list']=$this->downloadprofilemodel->get_language_set();
		$candidate_certifications =$this->downloadprofilemodel->candidate_languages($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			   ...
			   $this->downloadprofilemodel->edit_passport_detail($this->input->post('candidate_id'));
			   redirect('downloadprofile/lang_history/'.$this->input->post('candidate_id'));
		}
		else
		{
			$path = '../js/ckfinder';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("downloadprofile/candidate_lang_history",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function questionnaire($candidate_id)
	{
		...
		$this->data['candidate_id']=$candidate_id;
		$this->load->model('downloadprofilemodel');
		$this->data['survey_result']=$this->downloadprofilemodel->get_survey_result($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('downloadprofile/questionnaire/'.$this->input->post('candidate_id').'?cv_file='.$cv_file.'&photo_file='.$photo_file);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->data['error']="Please update language skills here";
			$this->load->view("include/header",$this->data);
			$this->load->view("downloadprofile/candidate_questionnaire",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
...
// tech skills
	...
	function skills($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('downloadprofile/skills/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['skill_list']=$this->downloadprofilemodel->get_skill_set();
		$this->data['skill_list_current']=$this->downloadprofilemodel->get_skill_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->downloadprofilemodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->downloadprofilemodel->job_list($candidate_id);
		...
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("downloadprofile/candidate_skills",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function add_certification($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->downloadprofilemodel->insert_cert_details($this->input->post('candidate_id'));
			redirect('downloadprofile/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
	...
	function skills_2($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->downloadprofilemodel->insert_skill_details($this->input->post('candidate_id'));
			redirect('downloadprofile/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
...
function certifications($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('downloadprofile/certifications/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['certifications_list']=$this->downloadprofilemodel->get_certifications_set();
		$this->data['certifications_list_current']=$this->downloadprofilemodel->get_certifications_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->downloadprofilemodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->downloadprofilemodel->job_list($candidate_id);
		...
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("downloadprofile/candidate_certifications",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function followup()
	{
		...
		if(isset($_POST['candidate_id']))
		{
			...
			/*$this->data['single_list']=$this->downloadprofilemodel->select_record($id);
		
			$dataArr = $this->load->view('downloadprofile/candidatefollowup_list', $this->data,TRUE);
			echo $dataArr;
			exit();
	...
	$id=$this->db->insert_id();
	$this->load->model('downloadprofilemodel');
	$this->data['note_list']=$this->downloadprofilemodel->select_notes_record($id);
	$dataArr = $this->load->view('downloadprofile/candidatenotes_list', $this->data,TRUE);
	echo $dataArr;
	...
	function visa_approval(){
		...
		$this->db->insert('pms_candidate_applications',$data);
		 $id=$this->db->insert_id();
		$this->load->model('downloadprofilemodel');
		$this->data['aplication_list']=$this->downloadprofilemodel->select_aplication_coe($id);
		$dataArr = $this->load->view('downloadprofile/candidate_aplication_list', $this->data,TRUE);
		echo $dataArr;
		exit();	
		$query = $this->db->query("SELECT *  FROM  pms_candidate where candidate_id =".$_POST['candidate_id']);
			$row = $query->row_array();
	...
	function drop(){
		...
		$this->load->model('downloadprofilemodel');
		 $this->downloadprofilemodel->drop_record($candidate_follow_id);
		$dataArr = $this->load->view('downloadprofile/candidate_view');
		echo $dataArr;
	}
	...
	function cvfile_drop(){
		...
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->cvfile_drop_record($cvfile_id);		          
	}
	...
	function drop_job_item()
	{
		$job_profile_id=$this->input->post('job_profile_id');
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->drop_job_item($job_profile_id);
	}
	...
	function deleteJobDetail($candidateId)
	{
		$job_id=$this->input->post('job_id');
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->drop_job_item($job_id);
		$view	=	$this->jobDetails($candidateId);
...
//DELETE EDUCATION DETAILS
	function deleteEducationDetail($candidateId)
	{
		...
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->drop_edu_item($edu_id);
		$view	=	$this->educationDetails($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId,"VIEW"=>$view);
        echo json_encode($status);
	}
	function drop_email_sms_item()
	{
		...
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->drop_email_sms_item($email_sms_id);
	}
	...
	function drop_ticket_item()
	{
		...
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->drop_ticket_item($ticket_id);
	}
		
	function drop_edu_item(){
		$eucation_id=$this->input->post('eucation_id');
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->drop_edu_item($eucation_id);
	}	
	...
	function drop_notes(){
		...
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->note_drop_record($candidate_note_id);
		$dataArr = $this->load->view('downloadprofile/candidate_view');
		echo $dataArr;
	 ...
	 function drop_interviews(){
		...
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->interview_drop_record($interview_id);
		$dataArr = $this->load->view('downloadprofile/candidate_view');
		echo $dataArr;
	 ...
	 function drop_aplication(){
		 $app_id=$_POST['app_id'];
		$this->load->model('downloadprofilemodel');
		$this->downloadprofilemodel->aplication_drop_record($app_id);
		$dataArr = $this->load->view('downloadprofile/candidate_view');
		echo $dataArr;
	...
	function candidate_file($candidate_id)
	{
	   ...
	   if($this->input->post('title')!='')
	   {
			 ...
			 if(isset($_FILES['photo']))
			 {
					...
					{
						$this->load->model('downloadprofilemodel');
						$id=$this->downloadprofilemodel->insert_file($candidate_id);
						redirect('downloadprofile/candidate_file/'.$this->input->post('candidate_id'));
					}
			}
		}
		$this->data['file_list']=$this->downloadprofilemodel->file_list($candidate_id);
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("downloadprofile/manage_files",$this->data);
		$this->load->view("include/footer",$this->data);
	}
...
/*			echo '<pre>';
		...
		$this->load->view("downloadprofile/csv_data_import",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	   ...
	   if($this->input->post('title')!='')
	   {
		 if(isset($_FILES['photo']))
		 {
					if(!$candidate_id='')
					{
						$this->load->model('downloadprofilemodel');
						$id=$this->downloadprofilemodel->insert_file($candidate_id);
						$this->data['upload_list']=$this->downloadprofilemodel->get_one_record($id);
						$replay=$this->load->view("downloadprofile/upload_file",$this->data,TRUE);
						echo $replay;
					}
					else
					{
						redirect("downloadprofile/candidate_file");
					}
				}
			else{
				 echo "Choose file";
	...
	function img_update(){
	 ...
	 if(isset($_FILES['photo'])){
						  $this->load->model('downloadprofilemodel');
						   $this->downloadprofilemodel->update_file($candidate_id);
	
							 $this->data['single_file']=$this->downloadprofilemodel->get_one_file($candidate_id);
		...
		function deletefile1()
	{
		...
		if(!empty($id))
		{
			          ...
			          $this->load->model('downloadprofilemodel');
					   $this->downloadprofilemodel->delete_file($id);
					    $this->data['delete_file']=$this->downloadprofilemodel->delete_one_file($id);
						
                           echo $this->data['delete_file']['photo'];  //$replay=$this->load->view("downloadprofile/delete_file",$this->data,TRUE);
					         //echo $replay;
	...
	function delete_cv($id)
	{
		if(!empty($id))
		{
			...
			redirect("downloadprofile/summary/".$id."?del_cv=1");
		}else
		{
			redirect("downloadprofile/summary/".$id);
		}
	}
	...
	function candidate_delete($id)
	{
		...
		if(!empty($id))
		{
			$this->downloadprofilemodel->candidate_delete($id);
			redirect('downloadprofile/?del=1');
		}
	}

	function candidate_delete_ajax()
	{
		$id=$this->input->post('candidate_id');
		$this->load->model('downloadprofilemodel');
		if(!empty($id))
		{
			$this->downloadprofilemodel->candidate_delete($id);			
			$status = array("status" => "success", "value" => $id);
        	echo json_encode($status);
		}		
	}
	...
	public function getstate()
	{
		...
		{
			$data=array();
			$data["state_list"] = $this->downloadprofilemodel->state_list_by_country($_POST['country_id']);
	...
	public function getcity()
	{
		...
		{
			$data=array();
			$data["city_list"] = $this->downloadprofilemodel->location_list_by_state($_POST['state_id']);
...
//onchange get function	
	...
	{		
		...
		{
			$data=array();
			$data["function_list"] = $this->downloadprofilemodel->function_list_by_category($_POST['category_id']);
			$function	='';
...
//onchange getlocation
	...
	public function assignAdmin()
	{
		...
		for($i=0;$i<count($candidatesArr);$i++){
			$id = $this->downloadprofilemodel->assign_admin_user($candidatesArr[$i],$adminId);
		}
		/***************************** send mail to admin user ***************************/
		$data["adminEmail"] = $this->downloadprofilemodel->getAdminEmail($adminId);
		$subject = 'Assignment';
...
// email ends here	
	...
	function delete_photo($id)
	{
		if(!empty($id))
		{
			...
			redirect("downloadprofile/summary/".$id."?del_photo=1");
		}else
		{
			redirect("downloadprofile/summary/".$id);
		}
...
//APPLY JOB
	function apply_job($candidateId,$jobId)
	{
		...
		{
		$this->load->model('downloadprofilemodel');
        $this->downloadprofilemodel->apply_job($candidateId,$jobId);
		}
		redirect("downloadprofile/summary/".$candidateId);
	}
	
	function editSkillCertificateDetail($candidateId)
	{ 
		$this->load->model('downloadprofilemodel');
	 	$id  = $this->downloadprofilemodel->insert_skill_details($candidateId);
		
		$id  = $this->downloadprofilemodel->insert_cert_details($candidateId);
		
		$id  = $this->downloadprofilemodel->insert_domain_details($candidateId);
...
// email to candidate
	...
	{		
		...
		{
			$data=array();
			$function_list = $this->downloadprofilemodel->function_list_by_category_multiple($_POST['category_id']);
...
//EDIT Category and functional area
	...
	{
		$this->load->model('downloadprofilemodel');
	 	$id  = $this->downloadprofilemodel->insert_functional($candidateId);
		redirect('downloadprofile/summary/'.$this->input->post('candidate_id').'?upd=1');
	}	
...
//EDIT PRIMARY AND SECONDARY SKILLS
	...
	{
		$this->load->model('downloadprofilemodel');
	 	$id  = $this->downloadprofilemodel->insert_skills($candidateId);
		redirect('downloadprofile/summary/'.$this->input->post('candidate_id').'?upd=1');
...
//Add Contract Details
	...
	function add_contract_details($candidateId){
		$this->load->model('downloadprofilemodel');
		$uid = $this->downloadprofilemodel->add_contract_detail($candidateId);
		redirect('downloadprofile/summary/'.$this->input->post('candidate_id').'?upd=1');
	}
	...
	function print_cv($id=null)
	{
		...
		$this->data["personal"] = $this->downloadprofilemodel->get_single_record($id);
		$this->data['address'] = $this->downloadprofilemodel->get_address($id);
		$this->data['education'] = $this->downloadprofilemodel->education_list($id);
		$this->data['job_details'] = $this->downloadprofilemodel->get_job_details($id);
		$this->data['language_skills'] = $this->downloadprofilemodel->candidate_languages($id);
		$this->data['tech_skills'] = $this->downloadprofilemodel->candidate_skills($id);
		$this->data['certification'] = $this->downloadprofilemodel->candidate_certifications($id);
		$this->data['domain'] = $this->downloadprofilemodel->candidate_domains($id);
		$this->data['sports'] = $this->downloadprofilemodel->candidate_sports($id);
		$this->data['social'] = $this->downloadprofilemodel->candidate_social($id);
		$this->data['contract'] = $this->downloadprofilemodel->get_contract_detail($id);
		$this->data['formdata'] = $this->downloadprofilemodel->get_lang_details($id);

		$this->data["profile_list"] = $this->downloadprofilemodel->profile_list($id);
					

		//$this->load->view('include/header',$this->data);
		$this->load->view('downloadprofile/print_cv',$this->data);	
		//$this->load->view('include/footer',$this->data);
	}
...
//GET CANDIDATE EDUCATION
	function get_candidate_education()
	{
		...
		$education_details = $this->downloadprofilemodel->education_deatils($candidate_id);
			...
			$html2='<td colspan="2" align="center" valign="top" class="borderTopNone"> 
					 ...
					 foreach($education_details as $key => $val)
					 {
						...
						$html2.='<tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'index.php/downloadprofile/delete_candidate_edu/?id='.$val['eucation_id'].'" id="delete_candidate_edu" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate education	
	...
	function get_candidate_professional()
	{
		...
		$job_history = $this->downloadprofilemodel->job_list($candidate_id);
					...
					<table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
					 ...
					 {	
						...
						$html2.=' <tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'index.php/downloadprofile/delete_candidate_prof/?id='.$val['job_profile_id'].'" id="delete_candidate_prof" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate Professional details	
	...
	function get_present_contract()
	{
		...
		$contract = $this->downloadprofilemodel->get_contract_detail($candidate_id);
		...
		if(!empty($contract))
		{
			...
			$html2.=' <tr>
							...
							<td>'. $status.'</td>   
							<td><a href="javascript:;"  data-url="'.base_url().'index.php/downloadprofile/delete_candidate_contract/?id='.$contract['candidate_id'].'" id="delete_candidate_contract" >Delete</td>
						</tr>';
