...
//INSTRUCTION AND GUIDE LINES
	...
	function addcandidate($id=null)
	{
		...
		//contracts ending between (jobstart date -30 days) and (job end date +30 days)
			...
			//$data['contracts_ending']=$this->jobsmodel->contracts_ending($id,$data['start_date'],$data['end_date']);
			...
			if($this->input->post('contract_start_date')!='' && $this->input->post('contract_end_date')!='')
			{
				...
				$this->data["postdata"]["contract_start_date"]=$this->data['start_date'];
				$this->data["postdata"]["contract_end_date"]=$this->data['end_date'];
			}
	...
	function addinterview2()
	{
		...
		if($this->input->post('job_app_id')!='' && $this->input->post('candidate_id')!='' && $this->input->post('title')!='' )
		{
			...
			$html.=	'<tr>
						  ...
						  <td><a href="javascript:;"  data-url="'.base_url().'index.php/jobs/edit_interview/?job_app_id='.$interview['job_app_id'].'&candidate_id='.$interview['candidate_id'].'&job_id='.$formdata['job_id'].'"  id="edit_interview" >Change</a> |<a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_interview_candidate/?job_app_id='.$interview['job_app_id'].'&candidate_id='.$interview['candidate_id'].'&job_id='.$formdata['job_id'].'"  id="delete_interview_candidate" >Remove </a>| <a href="'.base_url().'index.php/candidates_all/summary/'.$interview['candidate_id'].'" target="_blank"> Profile </a> | <a href="javascript:;"  onclick="select_candidate('.$interview['candidate_id'].','.$interview['job_app_id'].','.$formdata['job_id'].')" > Select </a></td>';
					...
					<table border="1" cellpadding="3" cellspacing="3" width="95%">
						 <tbody >					
						  ...
						  foreach($candidates_selected as $selected){
							  ...
							  $html.='<tr>
										  <td width="13%"><a href="'.base_url().'index.php/candidates_all/summary/'.$seleceted['candidate_id'].'" target="_blank">'.$selected['first_name'].' '.$selected['last_name'].'</a></td>
										  <td width="13%">'.date("d-m-Y", strtotime($selected['select_date'])).'</td>
										 
										  <td width="11%">'.$selected['feedback'].'</td>
										  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_selectedcandidate/?job_app_id='.$selected['app_id'].'&candidate_id='.$selected['candidate_id'].'&job_id='.$formdata['job_id'].'"  id="delete_selected_candidate" >Remove </a>|<a href="'.base_url().'index.php/candidates_all/summary/'.$seleceted['candidate_id'].'" target="_blank"> Profile </a> | <a href="javascript:;" onclick="issue_offer('.$formdata['job_id'].','.$selected['app_id'].','.$selected['candidate_id'].');" id="issue_offer"> Issue Offer </a></td>';
			...
			$html2='<td colspan="2" align="center" valign="top">
					 ...
					 foreach($interview_schedule as $interview)
					 {
						...
						$html2.=' <tr>
									  ...
									  <td width="12%">'.$interview['interview_type'].'</td>
									  <td width="11%">'.$interview['description'].'</td>
									  <td> <a href="javascript:;" onclick="select_candidate('.$interview['candidate_id'].','.$interview['job_app_id'].','.$formdata['job_id'].');" > Select </a></td>';
					 ...
					 <table border="1" cellpadding="3" cellspacing="3" width="95%">
					  ...
					  <tr>
						...
						$html2.='<tr>
								  ...
								  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_offercandidate/?job_app_id='.$offerletter['app_id'].'&candidate_id='.$offerletter['candidate_id'].'&job_id='.$formdata['job_id'].'"  id="delete_offer_candidate" >Remove </a>|<a href="'.base_url().'index.php/candidates_all/summary/'.$offerletter['candidate_id'].'" target="_blank"> Profile </a> | <a href="javascript:;" onclick="accept_offer('.$formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id'].');"> Accept </a> | <a href="javascript:;" onclick="reject_offer('.$formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id'].');"> Reject </a></td>';
		...
		if(!empty($offer_accepted)){
			...
			$html2='<td colspan="2" align="center" valign="top">
				...
				$html2.='<tr>
						  ...
						  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_acceptcandidate/?job_id='.$formdata['job_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id'].'" id="delete_accept_candidate" >Remove </a>|<a href="'.base_url().'index.php/candidates_all/summary/'.$accepted['candidate_id'].'" target="_blank"> Profile </a>| <a href="javascript:;" onclick="create_invoice('.$formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id'].');">Invoice</a></td>';
...
//get visa details
	...
	function get_visa_details()
	{
		...
		if(!empty($visa_details)){
		   ...
		   $html2.=' <tr>
                      <td width="13%"><a href="'.base_url().'index.php/candidates_all/summary/'.$visa['candidate_id'].'" target="_blank">'.$visa['first_name'].' '.$visa['last_name'].'</a></td>
                      ...
                      <td width="13%">'.$visa['date_issued'].'</td>
                       ...
                       <td><a href="javascript:;" onclick="create_medical('.$formdata['job_id'].','.$visa['app_id'].','.$visa['candidate_id'].');">Create Medical</a>|<a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_visa/?job_id='.$formdata['job_id'].'&app_id='.$visa['app_id'].'&visa_id='.$visa['visa_id'].'"  id="delete_visa_candidate" >Delete</a></td></tr>';
		...
		if(!empty($visa_documents)){
		   ...
		   $html2.=' <tr>
                      ...
                      <td width="36%">'.date('d-m-Y',strtotime($visa['date_send'])).'</td>
                       ...
                       <td><a href="javascript:;" onclick="create_ticket('.$formdata['job_id'].','.$visa['app_id'].','.$visa['candidate_id'].');"> Ticket & Travel</a>|<a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_visa_document/?job_id='.$formdata['job_id'].'&app_id='.$visa['app_id'].'&doc_id='.$visa['doc_id'].'"  id="delete_visa_document" >Delete</a></td></tr>';
...
//GET MEDICAL DETAILS
	function get_medical_details()
	{
		...
		if(!empty($medical_details)){
		   ...
		   $html2.=' <tr>
                      <td width="13%"><a href="'.base_url().'index.php/candidates_all/summary/'.$medical['candidate_id'].'" target="_blank">'.$medical['first_name'].' '.$medical['last_name'].'</a></td>
					   <td width="14%">'.$medical['title'].'</td>
                      <td width="13%">'.date('d-m-Y',strtotime($medical['date'])).'</td>
                     
                      <td width="36%">'.$medical['description'].'</td>

                       <td><a href="javascript:;" onclick="create_document('.$formdata['job_id'].','.$medical['app_id'].','.$medical['candidate_id'].');"> Visa Process Document</a>|<a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_medical/?job_id='.$formdata['job_id'].'&app_id='.$medical['app_id'].'&medical_id='.$medical['medical_id'].'"  id="delete_medical_candidate" >Delete</a></td></tr>';
		...
		if(!empty($ticket_details)){
			...
			$html2='	 <td colspan="2" align="center" valign="top">
  			...
  			foreach($ticket_details as $ticket){
		  		 ...
		  		 $html2.=' <tr>
                      <td width="13%"><a href="'.base_url().'index.php/candidates_all/summary/'.$ticket['candidate_id'].'" target="_blank">'.$ticket['first_name'].' '.$ticket['last_name'].'</a></td>
						 ...
						 <tbody >					
						  ...
						  foreach($candidates_selected as $selected){
							  ...
							  $html.='<tr>
										  ...
										  <td width="11%">&nbsp;</td>
										  <td width="11%">'.$selected['feedback'].'</td>
										  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'index.php/jobs/delete_selectedcandidate/?job_app_id='.$selected['app_id'].'&candidate_id='.$selected['candidate_id'].'&job_id='.$formdata['job_id'].'"  id="delete_selected_candidate" >Remove </a>|<a href="'.base_url().'index.php/candidates_all/summary/'.$selected['candidate_id'].'" target="_blank"> Profile </a> | <a href="javascript:;" onclick="issue_offer('.$formdata['job_id'].','.$selected['app_id'].','.$selected['candidate_id'].');" id="issue_offer"> Issue Offer </a></td>';
