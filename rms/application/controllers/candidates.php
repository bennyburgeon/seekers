...
class Candidates extends CI_Controller {
	...
	{	
		...
		$this->data["records"] = $this->candidatemodel->get_list($this->data['start'],$this->data['limit'],$this->data['search_email'],$this->data['search_name'],$this->data['search_mobile'],$this->data['sort_by'],$this->data['reg_status'],$this->data['branch_id'],$this->data['skills'],$this->data['level_id'],$this->data['course_id'],$this->data['spcl_id'],$this->data['exp_years']);
...
//AFTER ADD CANDIDATES :-EDITOR FORM
	function profile_entry($id=null)
	{
		...
		$this->data["formdata"]['profile_list'] = $this->candidatemodel->profile_list($id);
		...
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates/profile_entry',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
...
//Certification and Technical Skilss
		...
		$candidate_certifications = $this->candidatemodel->candidate_certifications($id);
...
//skills
		...
		$this->data['skill_list']=$this->candidatemodel->get_parent_skills();
		
		$candidate_skills = $this->candidatemodel->candidate_skills($id);
		...
		$this->data['child_skills']	=	$this->candidatemodel->get_child_skills($res1[0]['skill_id']);
		}
		
//all child skills		
		$this->data['all_child_skills']	=	$this->candidatemodel->child_skills();
//domain knowledge
		
		$this->data['domain']=$this->candidatemodel->get_domain();
		$candidate_domain = $this->candidatemodel->get_domain_details($id);
...
//Planning Job Change Details
		$this->data["formdata8"] = $this->candidatemodel->job_search($id);
...
//Language Deatils
		$this->data['lang_list']=$this->candidatemodel->get_language_set();
		$candidate_certifications =$this->candidatemodel->candidate_languages($id);
...
//Passport Details
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidatemodel->country_list();
		$this->data["formdata4"] = $this->candidatemodel->get_passport_single_record($id);
...
//Education Details
		...
		$this->data["edu_spec_list"] = $this->candidatemodel->edu_spec_list();
		$this->data["edu_univ_list"] = $this->candidatemodel->edu_univ_list();
		$this->data["edu_coll_list"] = $this->candidatemodel->edu_coll_list();
		$this->data["edu_course_type_list"] = $this->candidatemodel->edu_course_type_list();
		$this->data["formdata5"] = $this->candidatemodel->get_education_single_record($id);
...
//Job Details
		$this->data["industries_list"] = $this->candidatemodel->industries_list();		
		$this->data["industry_list"] = $this->candidatemodel->industry_list();
		$this->data["functional_list"] = $this->candidatemodel->functional_list();
		$this->data["currecy_list"] = $this->candidatemodel->currency_list();
		$this->data["years_list"] = $this->candidatemodel->years_list();
		$this->data["months_list"] = $this->candidatemodel->months_list();
		$this->data["formdata6"] = $this->candidatemodel->get_job_single_record($id);
...
//FILE DEATILS
		...
		$this->data["formdata7"] = $this->candidatemodel->get_file_single_record($id);
...
//SHOW CV AND PHOTOT AJAX
	function show_cv_photo()
	{
		...
		$formdata = $this->candidatemodel->get_single_record($id);
...
//EDUCATION DETAILS
	function educationDetails($id)
	{
		...
		$edu_level = $this->candidatemodel->edu_level_list();
		
		$course = $this->candidatemodel->edu_course_list();

		$spec = $this->candidatemodel->edu_spec_list();


		
		$results = $this->candidatemodel->get_education_details($id);
		$form_data	=	array();
		...
		$education_details_view	=	$this->load->view('candidates/education_details',$this->data,true);
	...
	{
		$this->load->model('candidatemodel');
        $this->candidatemodel->edit_job_change_detail($candidateId);
		 $this->candidatemodel->edit_passport_num_type($candidateId);
...
//JOB DETAILS
	function jobDetails($id)
	{
		...
		$industry_list = $this->candidatemodel->industry_list();
		$functional_list = $this->candidatemodel->functional_list();

		
		$results = $this->candidatemodel->get_job_details($id);
		$form_data	=	array();
		...
		$job_details_view	=	$this->load->view('candidates/job_details',$this->data,true);
...
//updating profile completion value		
    ...
    {    
		...
		$this->load->view('include/header',$this->data);    
		$this->load->view('candidates/import_xml',$this->data);                
		$this->load->view('include/footer',$this->data);        
	...
	function summary($candidate_id)
	{
		...
		$this->load->model('candidatemodel');
		$this->load->model('countrymodel');
		$this->data["formdata"] = $this->candidatemodel->get_single_record($candidate_id);
		$this->data['detail_list'] = $this->candidatemodel->detail_list($candidate_id);
		$this->data['candidate_languages'] = $this->candidatemodel->candidate_languages($candidate_id);
		...
		$this->data['candidate_skill'] = $this->candidatemodel->candidate_skills($candidate_id);
		
//candidate doamin knowledge
		$this->data['candidate_domain'] = $this->candidatemodel->candidate_domains($candidate_id);
		
		$this->data['candidate_certifications'] = $this->candidatemodel->candidate_certifications($candidate_id);
	
		$this->data['candidate_programs_summary'] = $this->candidatemodel->candidate_programs_summary($candidate_id);

	
		$this->data['candidate_coe_summary'] = $this->candidatemodel->candidate_coe_summary($candidate_id);
		$this->data['candidate_visa_summary'] = $this->candidatemodel->candidate_visa_summary($candidate_id);

		$this->data['candidate_questionnaire_summary'] = $this->candidatemodel->get_survey_result($candidate_id);
		$this->data['candidate_files_summary'] = $this->candidatemodel->get_files($candidate_id);
		$this->data['candidate_complaints_summary'] = $this->candidatemodel->ticket_list($candidate_id);

//Job Search details(candidate_job_serach)
		$this->data['job_search'] = $this->candidatemodel->job_search($candidate_id);
		//print_r($this->data['job_search']);exit;
//Edit skill Modal

		$this->data['skill_list']=$this->candidatemodel->get_parent_skills();
		
		$candidate_skills = $this->candidatemodel->candidate_skills($candidate_id);
...
//Edit Language Modal
		//Language Deatils
		$this->data['lang_list']=$this->candidatemodel->get_language_set();
		$candidate_certifications =$this->candidatemodel->candidate_languages($candidate_id);
...
//applied jobs of candidate		
		$this->data['applied_jobs']=$this->candidatemodel->get_job_list($candidate_id);

//shortlisted jobs
		$this->data['shortlisted']=$this->candidatemodel->get_shortlisted($candidate_id);

//interview scheduled jobs
		$this->data['interview_list']=$this->candidatemodel->get_interview_list($candidate_id);

//selected jobs
		$this->data['jobs_selected']=$this->candidatemodel->jobs_selected($candidate_id);

//offer letters issued
		$this->data['offer_letters_issued']=$this->candidatemodel->offer_letters_issued($candidate_id);
		
//offer accepted
		$this->data['offer_accepted']=$this->candidatemodel->offer_accepted($candidate_id);

//invoice genereted
		$this->data['invoice_generated']=$this->candidatemodel->invoice_generated($candidate_id);

//present contract details
		$this->data['contract_details']=$this->candidatemodel->get_contract_detail($candidate_id);
		
//Profile completion status
		$this->data['profile_completion']=$this->candidatemodel->get_profile_status($candidate_id);

//Profile Assessment status
		$this->data['profile_assessment']=$this->candidatemodel->get_profile_assessment($candidate_id);
		
//All language details
		$this->data['lang_details']=$this->candidatemodel->get_lang_details($candidate_id);
	...
	function candidate_programs($candidate_id)
	{
		...
		// update suggestion logic from here
			$this->candidatemodel->update_suggestion_module($this->input->post('candidate_id'), $this->input->post('campus_id'), $this->input->post('course_id'), $this->input->post('total_semester'), $this->input->post('fee_per_semester'), $this->input->post('annual_tution_fee'), $this->input->post('total_tution_fee'),$this->input->post('candidate_course_id'));
		// end here	
					
			redirect('candidates/candidate_programs/'.$this->input->post('candidate_id').'/?upd=1');
		}
...
if($this->input->get('education')!='')
		...
		if($this->input->get('course_id')!='')
		{
			...
			$this->data['single_application']['app_details']=$this->candidatemodel->create_program_name($this->data['single_application']['course_id']);
		}					
		...
		$this->data['aplication_list']=$this->candidatemodel->aplication_record($candidate_id); // application lists - 	
		$this->data['detail_list'] = $this->candidatemodel->detail_list($candidate_id); // candidate details
		$this->data['university_list']=$this->candidatemodel->university_list(); // university list		
		$this->data['intake_list']=$this->candidatemodel->intake_list(); // intake list 		
		$this->data['level_list']=$this->coursemodel->fill_levels(); // education levels
		$this->data['status_list']=$this->candidatemodel->status_list(); // application process status list
		$this->data['campus_list']=array('' => 'Select Campus');
		$this->data['course_list']=array('' => 'Select Course');

		if($this->data['single_application']['univ_id']>0)
			$this->data['campus_list']=$this->candidatemodel->campus_list($this->data['single_application']['univ_id']);
		if($this->data['single_application']['level_study']>0)
			$this->data['course_list']=$this->candidatemodel->course_list_level($this->data['single_application']['level_study']);
			
		$this->data['candidate_qualification_list']=$this->candidatemodel->candidate_qualification_list($candidate_id); 
		// candidate's qualification for higher studies
		// edit mode		
		if($this->input->get('app_id')!='')
		{
			$this->data['single_application']=$this->candidatemodel->select_aplication_record($this->input->get('app_id'));
			if(count($this->data['single_application'])>0)
			{
				if($this->data['single_application']['univ_id']>0)$this->data['campus_list']=$this->candidatemodel->campus_list($this->data['single_application']['univ_id']);
				if($this->data['single_application']['level_study']>0)$this->data['course_list']=$this->candidatemodel->course_list_level($this->data['single_application']['level_study']);
		...
		// update program		
		$this->load->view("include/header",$this->data);
		$this->load->view("candidates/candidate_programs",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function candidate_coe($candidate_id)
	{
		...
		$this->editor($path, $width);
		$this->load->view("include/header",$this->data);
		$this->load->view("candidates/candidate_coe",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function candidate_visa($candidate_id)
	{
		...
		$this->data['visa_approval_list']=$this->candidatemodel->visa_approval_list($candidate_id);
		$this->data['app_list_coe']=$this->candidatemodel->select_aplication_visa($candidate_id);
...
// Schedule an interview
	...
	function lang_history($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!=''){
			   ...
			   $this->candidatemodel->edit_passport_detail($this->input->post('candidate_id'));
...
// tech skills
	...
	function skills_2($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->candidatemodel->insert_skill_details($this->input->post('candidate_id'));
			redirect('candidates/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
...
function certifications($candidate_id)
	...
	function deleteJobDetail($candidateId)
	{
		...
		$this->load->model('candidatemodel');
		$this->candidatemodel->drop_job_item($job_id);
		$view	=	$this->jobDetails($candidateId);
...
//DELETE EDUCATION DETAILS
	function deleteEducationDetail($candidateId)
	{
		...
		$this->load->model('candidatemodel');
		$this->candidatemodel->drop_edu_item($edu_id);
		$view	=	$this->educationDetails($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId,"VIEW"=>$view);
        echo json_encode($status);
	}
...
/*			echo '<pre>';
	...
	function candidate_delete($id)
	{
		...
		if(!empty($id))
		{
			$this->candidatemodel->candidate_delete($id);
...
//onchange get function	
	...
	{		
		...
		{
			$data=array();
			$data["function_list"] = $this->candidatemodel->function_list_by_category($_POST['category_id']);
...
//onchange get function by multiple	
	...
	{		
		...
		{
			$data=array();
			$function_list = $this->candidatemodel->function_list_by_category_multiple($_POST['category_id']);
...
//APPLY JOB
	function apply_job($candidateId,$jobId)
	{
		...
		{
		$this->load->model('candidatemodel');
        $this->candidatemodel->apply_job($candidateId,$jobId);
		}
		redirect("candidates/summary/".$candidateId);
	}
	
	function editSkillCertificateDetail($candidateId)
	{ 
		$this->load->model('candidatemodel');
	 	$id  = $this->candidatemodel->insert_skill_details($candidateId);
		
		$id  = $this->candidatemodel->insert_cert_details($candidateId);
		
		$id  = $this->candidatemodel->insert_domain_details($candidateId);
...
// step 1
	function update_profile_personal($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_personal($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function update_profile_address($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_address($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function update_profile_education($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_education($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function update_profile_profession($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_profession($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function update_profile_language($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_language($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function update_profile_tech_skills($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_tech_skills($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function update_profile_certification($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_certification($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function update_profile_projects($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_projects($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function update_profile_sports($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_sports($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function update_profile_social($candidateId){
		$this->load->model('candidatemodel');
        $this->candidatemodel->update_profile_social($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
...
/* end here 10 functions */	 
	...
	function profile_approval($id=null)
	{
		...
		$this->data["personal"] = $this->candidatemodel->get_single_record($id);
		$this->data['address'] = $this->candidatemodel->get_address($id);
		$this->data['education'] = $this->candidatemodel->education_list($id);
		$this->data['job_details'] = $this->candidatemodel->get_job_details($id);
		$this->data['language_skills'] = $this->candidatemodel->candidate_languages($id);
		$this->data['tech_skills'] = $this->candidatemodel->candidate_skills($id);
		$this->data['certification'] = $this->candidatemodel->candidate_certifications($id);
		$this->data['domain'] = $this->candidatemodel->candidate_domains($id);
		$this->data['sports'] = $this->candidatemodel->candidate_sports($id);
		$this->data['social'] = $this->candidatemodel->candidate_social($id);
		$this->data['contract'] = $this->candidatemodel->get_contract_detail($id);
		$this->data['formdata'] = $this->candidatemodel->get_lang_details($id);
		$this->data['profile_status'] = $this->candidatemodel->get_profile_status($id);
		$this->data['profile_assessment'] = $this->candidatemodel->get_profile_assessment($id);
		
		$this->data["industry_list"] = $this->candidatemodel->multiple_industry_list();
		$this->data["functional_list"] = $this->candidatemodel->multiple_functional_list();
		...
		$this->data["profile_list"] = $this->candidatemodel->profile_list($id);
		
		//category 
		$category = $this->candidatemodel->get_cat_fun_list($id);
		...
		// funcional area
		$function = $this->candidatemodel->get_cat_fun_list($id);
...
//primary_skills
		$candidate_skills_primary = $this->candidatemodel->candidate_skills_primary($id);
...
//secondary skills
		$candidate_skills_secondary = $this->candidatemodel->candidate_skills_secondary($id);
...
//all child skills		
		...
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates/profile_approve',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
...
//EDIT CAtegory and functional area
	...
	{
		$this->load->model('candidatemodel');
	 	$id  = $this->candidatemodel->insert_functional($candidateId);
...
//EDIT PRIMARY AND SECONDARY SKILLS
	...
	{
		$this->load->model('candidatemodel');
	 	$id  = $this->candidatemodel->insert_skills($candidateId);
...
//FINAL VERIFICATION 
	function final_verification($id=null)
	{
		...
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates/final_verification',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
	function add_lang_details($candidateId){
		$this->load->model('candidatemodel');
		$uid = $this->candidatemodel->update_lang_detail($candidateId);
		if($uid){
			$status = array("STATUS" => "1");
			echo json_encode($status);
		}
	...
	function add_contract_details($candidateId){
		$this->load->model('candidatemodel');
		$uid = $this->candidatemodel->update_contract_detail($candidateId);
		if($uid){
			$status = array("STATUS" => "1");
			echo json_encode($status);
		}
	...
	function change_contract_details($candidateId){
		...
		$uid = $this->candidatemodel->update_contract_detail($candidateId);
		if($uid){
			redirect('candidates/summary/'.$candidateId.'?upd=1');
		}
	}
	...
	{
		$this->load->model('candidatemodel');
	 	$id  = $this->candidatemodel->update_profile_status($candidateId);
        if ($id > 0) { //success
            $status = array("STATUS" => "1");
            echo json_encode($status);
        } else { //failure
	...
	{
		$this->load->model('candidatemodel');
	 	$id  = $this->candidatemodel->update_profile_assessment($candidateId);
        if ($id > 0) { //success
            $status = array("STATUS" => "1");
            echo json_encode($status);
        } else { //failure
	...
	{ 
		...
		$profile  = $this->candidatemodel->get_profile_status($candidateId);
		if(count(array_filter($profile))== 12)
		{
			$this->candidatemodel->process_completed($candidateId);
			redirect('candidates/?upd=1');
		}
		else
		{
			redirect('candidates/profile_approval/'.$candidateId.'?upd=2');}
	}
