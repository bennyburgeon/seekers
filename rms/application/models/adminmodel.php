...
class Adminmodel extends CI_Model{
    ...
    function admin_list($start,$limit,$searchterm,$sort_by)
	{
		...
		$sql="select a.*,b.user_grp_name from pms_admin_users a inner join pms_admin_user_groups b on a.group_id=b.user_grp_id where a.username like '%" . $searchterm . "%' ";
		$sql.=" order by a.admin_id ".$sort_by." limit ".$start.",".$limit;
		$query = $this->db->query($sql);
		return $query->result_array();
	}
