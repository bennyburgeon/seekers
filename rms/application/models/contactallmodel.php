<?php 
class Contactallmodel extends CI_Model {
	var $table_name='';
	...
	function record_count($search_email,$search_name,$search_mobile,$reg_status,$branch_id) 
	{
		$sql="select count(*) as total_count from pms_candidate a left join pms_candidate_address b on a.candidate_id=b.candidate_id ";
		$cond='';
	...
	function get_list($start,$limit,$search_email,$search_name,$search_mobile,$sort_by,$reg_status,$branch_id)
	{

		$sql="SELECT a.*,b.branch_name FROM ".$this->table_name." a left join pms_branch b on a.branch_id=b.branch_id ";
		$cond='';
   ...
   function education_deatils($candidate_id)
   {
    ...
    {
        $query=$this->db->query("SELECT a.skill_name FROM `pms_candidate_skills` a inner join pms_candidate_to_skills b on a.skill_id=b.skill_id where b.candidate_id=".$candidate_id." order by a.skill_name");
		return $query->result_array();
	}

	 function candidate_certifications($candidate_id)
    {
        $query=$this->db->query("SELECT a.cert_name FROM `pms_candidate_certification` a inner join pms_candidate_to_certification b on a.cert_id=b.cert_id where b.candidate_id=".$candidate_id." order by a.cert_name");
		return $query->result_array();
	}
