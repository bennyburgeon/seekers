<?php 
class Manage_data_update_model extends CI_Model {
	...
	{
		$a=$_SESSION['admin_session'];
	
		//~ $sql	= "select count(*)as leave_id from ".$this->table_name." a join pms_admin_users b";
	$sql	= "select count(*)as leave_id from ".$this->table_name." a join pms_admin_users b where a.admin_id=$a";
		$cond	= '';
