<?php 
class Downloadprofilemodel extends CI_Model {
	var $table_name='';
	...
	{
		$sql="SELECT a.candidate_id, cj.cur_job_status_name , a.first_name, a.last_name, a.username,a.reg_date,a.lead_opportunity, a.mobile,a.mobile_prefix, a.photo,a.status_updated_on, a.linkedin_url,js.total_experience, js.expected_ctc,cty.city_name,  ";
		...
		$sql.="(SELECT jp.organization FROM `pms_candidate_job_profile` jp  where jp.candidate_id=a.candidate_id order by jp.from_date desc limit 0,1 ) as organization,  ";
	...
	$sql.=" cty.city_name as location  ";
		...
		$sql.=" FROM ".$this->table_name." a left join pms_city cty on a.city_id=cty.city_id left join pms_cur_job_status cj on cj.cur_job_status=a.cur_job_status left join pms_candidate_job_search js on a.candidate_id=js.candidate_id ";
		$cond='';
