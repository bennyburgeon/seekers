<?php 
class Company_clientsmodel extends CI_Model {
	var $table_name='';
	...
	$cond = " a.status=3 and company_id in (select company_id from pms_company_to_recruiter where admin_id=".$_SESSION['admin_session'].") ";
