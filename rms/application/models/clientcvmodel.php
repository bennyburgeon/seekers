...
//getting jobs applied by candidate
	...
	function get_job_details($job_id)
	{
		...
		$query = $this->db->query('select DISTINCT a.* from pms_jobs a where a.job_id='.$job_id);
