...
class University extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."university/?sort_by=".$this->data["sort_by"]."&limit=".$this->data["limit"]."&searchterm=".$this->data["searchterm"]."&univ_type=".$this->data["univ_type"]."&rows=".$this->data["rows"];
