...
class Cv_parser extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."cv_parser/?sort_by=".$this->data['sort_by']."&limit=".$this->data['limit']."&any_keywords=".$this->data['any_keywords']."&all_keywords=".$this->data['all_keywords']."&skills=".$this->data['skills']."&designation=".$this->data['designation']."&edu_level=".$this->data['edu_level']."&industry=".$this->data['industry'];
