...
class Calendar extends CI_Controller {
	...
	function index()
	{
		...
		$config['base_url'] = $this->config->item('base_url')."manage_leave/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
		...
		$config['base_url'] = base_url().'manage_leave/?';	
