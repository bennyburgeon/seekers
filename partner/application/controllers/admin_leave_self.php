...
class Admin_leave_self extends CI_Controller {
	...
	function index()
	{
		...
		$config['base_url'] = $this->config->item('base_url')."admin_leave_self/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
		...
		$config['base_url'] = base_url().'admin_leave_self/?';	
