<?php class candidates_dir extends CI_Controller 
{
	...
	{	
		...
		$this->data["records"] = $this->candidatesdirmodel->get_list($this->data['start'],$this->data['limit'],$this->data['search_email'],$this->data['search_name'],$this->data['search_mobile'],$this->data['sort_by'],$this->data['cur_job_status'],$this->data['reg_status'],$this->data['skills'],$this->data['level_id'],$this->data['course_id'],$this->data['spcl_id'],$this->data['exp_years'],$this->data['lead_source'],$this->data['job_folder_id'],$this->data['job_cat_id'],$this->data['func_id'], $this->data['desig_id'], $this->data['city_id'], $this->data['pref_city_id'], $this->data['expected_ctc_from'], $this->data['expected_ctc_to'], $this->data['notice_period_from'], $this->data['notice_period_to'], $this->data['total_experience_from'], $this->data['total_experience_to'], $this->data['payment_status']);
			
		$this->load->model('candidatesdirmodel'); 
		
		$this->data['page_head']= 'Manage Candidates';		
		$this->data['formdata']=array('admin_id' =>'');
		$this->data['admin_users_lists']= $this->candidatesdirmodel->get_admin_users_lists();
		$this->data['all_jobs_list']= $this->candidatesdirmodel->all_jobs_list();
		
		$this->data["reg_status_list"] = $this->candidatesdirmodel->reg_status_list();
		
		// Technical Skils		
		$this->data['skill_list']=$this->candidatesdirmodel->get_parent_skills();
		...
		if(!empty($skill))
		{
			...
			$this->data['child_skills']	=	$this->candidatesdirmodel->get_child_skills($res1[0]['skill_id']);
		}

		//Education details
		$this->data["edu_level_list"] = $this->candidatesdirmodel->edu_level_list();
		...
		$this->data["city_list"]                  = $this->candidatesdirmodel->city_list();
		$this->data["pref_city_list"]             = $this->candidatesdirmodel->pref_city_list();
		$this->data["industry_list"]              = $this->candidatesdirmodel->industries_list();
		$this->data["department_list"]            = $this->candidatesdirmodel->functional_list();
		
		$this->data["department_list"]            = array('' => 'Select Department');
		$this->data["roles_list"]                 = array('' => 'Select Designation');
		
		//$this->data["roles_list"]                 = $this->candidatesdirmodel->fill_roles();
		...
		$this->data['job_folders']=$this->candidatesdirmodel->get_job_folders();
		$this->data['job_status_list']=$this->candidatesdirmodel->get_job_status();
		
		
		$this->data["edu_spec_list"] = $this->candidatesdirmodel->edu_spec_list();
		$this->data["years_list"] = $this->candidatesdirmodel->years_list();
		
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_dir/candidateslist',$this->data);				
	...
	{	
		...
		$this->data['job_folders']                =$this->candidatesdirmodel->get_job_folders();
		$this->data['job_status']                 =$this->candidatesdirmodel->get_job_status();
		
		$this->data["edu_course_list"]            = $this->candidatesdirmodel->edu_course_list();
		...
		$this->data["years_list"]                 = $this->candidatesdirmodel->years_list();
		$this->data["months_list"]                = $this->candidatesdirmodel->months_list();	
		
		$this->data['page_head']= 'Add Candidate';
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_dir/addcandidates',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
	...
	function addCandidate(){
		...
		{ 
			...
			$id = $this->candidatesdirmodel->insert_candidate_record();
			if ($id != '') { 			
				...
				if(isset($_FILES['cv_file'])){
					...
					{       				
						...
						if ($this->upload->do_upload('cv_file'))
						{
							...
							$this->candidatesdirmodel->insert_files($dataArr);
									$cv_file=1;
						}
					}
				}	
	...
	function update_candidate_profile()
	{
		if( $this->input->post('candidate_id')!='')
		{
			...
			$this->candidatesdirmodel->update_candidate_record($candidate_id,$data_profile,$data_job);
			//$this->candidatesdirmodel->update_role_designation($candidate_id, $this->input->post('desig_id'));
			//$this->candidatesdirmodel->update_job_location($candidate_id, $this->input->post('pref_city_id'));	
			//$this->candidatesdirmodel->update_industry($candidate_id, $this->input->post('job_cat_id'));	
			//$this->candidatesdirmodel->update_functional_area($candidate_id, $this->input->post('func_id'));
			//$this->candidatesdirmodel->update_qualification_level($candidate_id, $this->input->post('level_id'));
					
					
			redirect('candidates_dir/summary/'.$candidate_id.'?upd=1');
		}else
		{
			echo 'Invalid Data';
			exit();
	...
	function summary($candidate_id)
	{
		...
		$candidate_check = $this->candidatesdirmodel->candidate_check($candidate_id);
		
		if($candidate_check == 0)
		{
			redirect('candidates_dir');
		}
		
		$this->data["formdata"]               = $this->candidatesdirmodel->get_single_record($candidate_id);		

		$this->data["formdata"]['desig_id']      = $this->candidatesdirmodel->get_role($candidate_id);
		$this->data["formdata"]['func_id']       = $this->candidatesdirmodel->get_functional_area($candidate_id);
		$this->data["formdata"]['job_cat_id']    = $this->candidatesdirmodel->get_industry($candidate_id);
		
		$this->data['job_folders']            = $this->candidatesdirmodel->get_job_folders();
		$this->data['visa_type_list']         = $this->candidatesdirmodel->visa_type_list();
		$this->data['job_status']             = $this->candidatesdirmodel->get_job_status();
		$this->data["designation_list"] = $this->candidatesdirmodel->designation_list();

		
		$this->data["roles_list"]      = $this->candidatesdirmodel->fill_roles();
		$this->data['candidate_roles'] =$this->candidatesdirmodel->candidate_roles($candidate_id);
		
		$this->data["edu_level_list"]   = $this->candidatesdirmodel->edu_level_list();
		$this->data['qualification_level'] =$this->candidatesdirmodel->qualification_level($candidate_id);
		
		$this->data['candidate_languages']    = $this->candidatesdirmodel->candidate_languages($candidate_id);
		$this->data['education_details']      = $this->candidatesdirmodel->education_deatils($candidate_id);
        
		$this->data['proj_history']      = $this->candidatesdirmodel->project_details($candidate_id);
        
		$this->data['job_history']            = $this->candidatesdirmodel->job_list($candidate_id);
		$this->data['followup_history']       = $this->candidatesdirmodel->get_followup_detail($candidate_id);
		$this->data['candidate_license_type'] =$this->candidatesdirmodel->candidate_license_type($candidate_id);
		$this->data['all_calls']              = $this->candidatesdirmodel->all_calls($candidate_id);
	
		$this->data['all_messages']           = $this->candidatesdirmodel->all_messages($candidate_id);
		$this->data['all_notes']              = $this->candidatesdirmodel->all_notes($candidate_id);
	
		$this->data['candidate_skill']        = $this->candidatesdirmodel->candidate_skills($candidate_id);
		
		//candidate doamin knowledge
		$this->data['candidate_domain']       = $this->candidatesdirmodel->candidate_domains($candidate_id);
		$this->data['admin_user_list']        =$this->candidatesdirmodel->admin_user_list();
		//Certification 
		
		$this->data['cerifications']          =$this->candidatesdirmodel->get_cert();
		$candidate_certifications             = $this->candidatesdirmodel->candidate_certifications($candidate_id);
		...
		$this->data['candidate_questionnaire_summary'] = $this->candidatesdirmodel->get_survey_result($candidate_id);
		$this->data['candidate_files_summary']         = $this->candidatesdirmodel->get_files($candidate_id);
		$this->data['candidate_complaints_summary']    = $this->candidatesdirmodel->ticket_list($candidate_id);

		//Job Search details(candidate_job_serach)
		$this->data['job_search'] = $this->candidatesdirmodel->job_search($candidate_id);		

		$this->data['skill_list']=$this->candidatesdirmodel->get_parent_skills();
		
		$candidate_skills = $this->candidatesdirmodel->candidate_skills($candidate_id);
		...
		//all child skills		
		$this->data['all_child_skills']	=	$this->candidatesdirmodel->child_skills();
		
		//Edit Language Modal
		//Language Deatils
		$this->data['lang_list']=$this->candidatesdirmodel->get_language_set();
		$candidate_languages =$this->candidatesdirmodel->candidate_languages($candidate_id);
		
		$this->data['candidate_locations'] =$this->candidatesdirmodel->candidate_locations($candidate_id);
		$this->data['candidate_industries'] =$this->candidatesdirmodel->candidate_industries($candidate_id);
		$this->data['candidate_functional_areas'] =$this->candidatesdirmodel->candidate_functional_areas($candidate_id);
		$this->data['candidate_roles'] =$this->candidatesdirmodel->candidate_roles($candidate_id);
		...
		$this->data["edu_level_list"]   = $this->candidatesdirmodel->edu_level_list();
		$this->data["edu_years_list"]   = $this->candidatesdirmodel->edu_years_list();
		...
		$this->data["edu_spec_list"] = $this->candidatesdirmodel->edu_spec_list();
		$this->data["edu_univ_list"] = $this->candidatesdirmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidatesdirmodel->edu_course_type_list();
		//Job History Modal
		
		//employment
		$this->data["industries_list"] = $this->candidatesdirmodel->industries_list();
		$this->data["functional_list"] = $this->candidatesdirmodel->functional_list();
		...
		$this->data["current_location_list"] 	= $this->candidatesdirmodel->city_list();		
		
		$this->data["currecy_list"] = $this->candidatesdirmodel->currency_list();
		$this->data["years_list"] = $this->candidatesdirmodel->years_list();
		$this->data["months_list"] = $this->candidatesdirmodel->months_list();	
		
			
		//suggested jobs to candidate		
		$this->data['suggested_jobs']=$this->candidatesdirmodel->get_suggested_jobs($candidate_id);	
		//applied jobs of candidate		
		$this->data['applied_jobs']=$this->candidatesdirmodel->get_job_list($candidate_id);
		//shortlisted jobs
		$this->data['shortlisted']=$this->candidatesdirmodel->get_shortlisted($candidate_id);
		//interview scheduled jobs
		$this->data['interview_list']=$this->candidatesdirmodel->get_interview_list($candidate_id);
		//selected jobs
		$this->data['jobs_selected']=$this->candidatesdirmodel->jobs_selected($candidate_id);
		//offer letters issued
		$this->data['offer_letters_issued']=$this->candidatesdirmodel->offer_letters_issued($candidate_id);		
		//offer accepted
		$this->data['offer_accepted']=$this->candidatesdirmodel->offer_accepted($candidate_id);
		//invoice genereted
		$this->data['invoice_generated']=$this->candidatesdirmodel->invoice_generated($candidate_id);
		//all child skills		
		$this->data['all_child_skills']	=	$this->candidatesdirmodel->child_skills();
		//present contract details
		$this->data['contract']=$this->candidatesdirmodel->get_contract_detail($candidate_id);
...
/*--------------------------------------------------------------------------*/		
	//category 
		$category = $this->candidatesdirmodel->get_cat_fun_list($candidate_id);
	...
	// funcional area
		$function = $this->candidatesdirmodel->get_cat_fun_list($candidate_id);
...
//primary_skills
		$candidate_skills_primary = $this->candidatesdirmodel->candidate_skills_primary($candidate_id);
...
//secondary skills
		$candidate_skills_secondary = $this->candidatesdirmodel->candidate_skills_secondary($candidate_id);
...
//Language Deatails pms_candidate_language
		$this->data['lang_details'] = $this->candidatesdirmodel->get_lang_details($candidate_id);
...
/*--------------------------------------------------------------------------*/
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('candidates_dir/summary/'.$candidate_id);
		}
		...
		$this->load->view("candidates_dir/candidate_summary",$this->data);
		$this->load->view("include/footer",$this->data);
	}
...
//Loading Models
		...
		$this->data["formdata"] = $this->candidatesdirmodel->get_single_record($id);
	
//Certification and Technical Skilss
		
		$this->data['cerifications']=$this->jobsmodel->get_cert();
		$candidate_certifications = $this->candidatesdirmodel->candidate_certifications($id);
...
//skills
		...
		$candidate_skills = $this->candidatesdirmodel->candidate_skills($id);
		...
		$this->data['domain']=$this->candidatesdirmodel->get_domain();
		$candidate_domain = $this->candidatesdirmodel->get_domain_details($id);
...
//Planning Job Change Details
		$this->data["formdata8"] = $this->candidatesdirmodel->job_search($id);
...
//Language Deatils
		$this->data['lang_list']=$this->candidatesdirmodel->get_language_set();
		$candidate_certifications =$this->candidatesdirmodel->candidate_languages($id);
...
//Contact Details
		...
		$this->data["formdata3"] = $this->candidatesdirmodel->get_address_single_record($id);
		...
		$this->data["country_list"] = $this->candidatesdirmodel->country_list();
		$this->data["formdata4"] = $this->candidatesdirmodel->get_passport_single_record($id);
		...
		$this->data["edu_spec_list"]        = $this->candidatesdirmodel->edu_spec_list();
		$this->data["edu_univ_list"]        = $this->candidatesdirmodel->edu_univ_list();
		$this->data["edu_coll_list"]        = $this->candidatesdirmodel->edu_coll_list();
		$this->data["edu_course_type_list"] = $this->candidatesdirmodel->edu_course_type_list();
		$this->data["formdata5"]            = $this->candidatesdirmodel->get_education_single_record($id);
...
//Job Details
		$this->data["industries_list"] = $this->candidatesdirmodel->industries_list();
		$this->data["industry_list"] = $this->candidatesdirmodel->industry_list();
		$this->data["functional_list"] = $this->candidatesdirmodel->functional_list();
		$this->data["currecy_list"] = $this->candidatesdirmodel->currency_list();
		$this->data["years_list"] = $this->candidatesdirmodel->years_list();
		$this->data["months_list"] = $this->candidatesdirmodel->months_list();
		$this->data["formdata6"] = $this->candidatesdirmodel->get_job_single_record($id);
...
//FILE DEATILS
		$this->data['survey_result']=$this->candidatesdirmodel->get_survey_result($id);
		$this->data["formdata7"] = $this->candidatesdirmodel->get_file_single_record($id);
		...
		// fetch profile data
		$this->data["formdata"]['profile_list'] = $this->candidatesdirmodel->profile_list($id);
		
		$this->data["edu_view"]	=	$this->educationDetails($id);
		$this->data["job_view"]	=	$this->jobDetails($id);
		
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_dir/editcandidates_auto_complete',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
	...
	{
		$this->load->model('candidatesdirmodel');  
		$this->data["personal"] = $this->candidatesdirmodel->get_single_record($id);
		$file_text='';
	...
	function loadContacthtml($id) {
		...
		$this->data["religion_list"]    = $this->candidatesdirmodel->religion_list();
        ...
        $this->load->view('candidates_dir/addcontactdetail', $this->data);
    }
	
	function skip_step2($candidateId){
		$this->load->model('candidatesdirmodel');
		//$this->candidatesdirmodel->insert_contact_detail_skip($candidateId);		
	...
	function addCandidateDetail($candidateId)
	{
		...
		$id  = $this->candidatesdirmodel->insert_contact_detail($candidateId);
		$uid = $this->candidatesdirmodel->update_contact_detail($candidateId);
	...
	function loadPassporthtml($id){
		...
		$this->load->model('candidatesdirmodel');
		$this->load->model('visatypemodel');
		$this->data["formdata"]=$this->candidatesdirmodel->get_passport_details($id);
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidatesdirmodel->country_list();
		$this->load->view('candidates_dir/addpassportdetail', $this->data);
	}
	...
	function addPassportDetail($candidateId){
		$this->load->model('candidatesdirmodel');
		$uid = $this->candidatesdirmodel->update_passport_detail($candidateId);
		$status = array("STATUS" => "1");
		echo json_encode($status);
	}
	...
	function loadEducationhtml($id){
		...
		$this->data["edu_univ_list"] = $this->candidatesdirmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidatesdirmodel->edu_course_type_list();
		$this->load->view('candidates_dir/addeducationdetail',$this->data);
	}
	
	function skip_step4($candidateId){
		$this->load->model('candidatesdirmodel');
		//$this->candidatesdirmodel->insert_education_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function addEducationDetail($candidateId)
	{
		...
		$id  = $this->candidatesdirmodel->insert_education_detail($data);
	...
	function loadJobhtml($id){
		...
		$this->data["years_list"] = $this->candidatesdirmodel->years_list();
		$this->data["months_list"] = $this->candidatesdirmodel->months_list();
		$this->load->view('candidates_dir/addjobdetail', $this->data);
	}
	
	function skip_step5($candidateId){
		$this->load->model('candidatesdirmodel');
		//$this->candidatesdirmodel->insert_job_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	{
		$this->load->model('candidatesdirmodel');
		$id  = $this->candidatesdirmodel->insert_job_detail($candidateId);
		$uid = $this->candidatesdirmodel->update_job_detail($candidateId);
	...
	function loadFilehtml($id)
	{
		...
		$this->data['candidate_id'] = $id;
		$this->load->model('candidatesdirmodel');
		$this->load->view('candidates_dir/addfiledetail', $this->data);
	}
	...
	function upload_cv_photo($candidate_id)
	{
		...
		if($candidate_id!='')
		{
			...
			redirect('candidates_dir/summary/'.$this->input->post('candidate_id'));
		}else
		{
			redirect('candidates_dir');
		}		
	...
	function connect_with_jobs(){
		...
		{			
			...
			$this->data['candidate_profile']=$this->candidatesdirmodel->get_single_profile($this->data['candidate_id']);
			$this->data["jobs_list"] = $this->candidatesdirmodel->fill_job_list($this->data['candidate_id']);
			
			$this->data['candidate_locations'] =$this->candidatesdirmodel->candidate_locations($this->data['candidate_id']);
			$this->data['candidate_industries'] =$this->candidatesdirmodel->candidate_industries($this->data['candidate_id']);
			$this->data['candidate_functional_areas'] =$this->candidatesdirmodel->candidate_functional_areas($this->data['candidate_id']);
			$this->data['candidate_roles'] =$this->candidatesdirmodel->candidate_roles($this->data['candidate_id']);
			$this->data['job_search'] = $this->candidatesdirmodel->job_search($this->data['candidate_id']);
		}		
		
		$this->data['page_head'] = 'Jobs List';	
		$this->load->view('candidates_dir/get_connect_jobs',$this->data);			
	}
	...
	function update_job_vacancy()
	{
		...
		if($this->input->post("candidate_id")!='')
		{
			...
			{	
				...
				{
					$this->candidatesdirmodel->update_job_vacancy($candidate_id,$val);	
				}
...
function profile_completion($candidateId)
	...
	function editCandidate(){
		...
		$this->load->model('candidatesdirmodel');
        $this->candidatesdirmodel->update_candidate_record($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditContacthtml($id){
        ...
        $this->load->view('candidates_dir/editcontactdetail', $this->data);

	}
	
	function editCandidateDetail($candidateId){
		$this->load->model('candidatesdirmodel');
        $this->candidatesdirmodel->edit_contact_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function loadEditPassporthtml($id){
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidatesdirmodel->country_list();
		$this->data["formdata"] = $this->candidatesdirmodel->get_passport_single_record($id);
		$this->load->view('candidates_dir/editpassportdetail', $this->data);
	}
	
	function editPassportDetail($candidateId)
	{
		$this->load->model('candidatesdirmodel');
        $this->candidatesdirmodel->edit_passport_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditEducationhtml()
	{
		...
		$this->data["edu_univ_list"] = $this->candidatesdirmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidatesdirmodel->edu_course_type_list();
		$this->data["formdata"] = $this->candidatesdirmodel->get_education_single_record($this->data['edu_id']);
		...
		$data=$this->load->view('candidates_dir/editeducationdetail',$this->data,true);
		echo $data;
		exit();
	}
...
//EDUCATION DETAILS
	function educationDetails($id)
	{
		...
		$edu_level = $this->candidatesdirmodel->edu_level_list();
		
		$course = $this->candidatesdirmodel->edu_course_list();

		$spec = $this->candidatesdirmodel->edu_spec_list();


		
		$results = $this->candidatesdirmodel->get_education_details($id);
		$form_data	=	array();
		...
		$education_details_view	=	$this->load->view('candidates_dir/education_details',$this->data,true);
	...
	function update_education()
	{
		...
		$this->candidatesdirmodel->update_education($data,$this->input->post('edu_id'),$this->input->post('candidate_id'));
//        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
		redirect('candidates_dir/summary/'.$this->input->post('candidate_id').'?edu_upd=1');
        //echo json_encode($status);
	}
	...
	{
		$this->load->model('candidatesdirmodel');
        $this->candidatesdirmodel->edit_education_detail($candidateId);
	...
	{
		$this->load->model('candidatesdirmodel');
        $this->candidatesdirmodel->edit_job_change_detail($candidateId);
		 $this->candidatesdirmodel->edit_passport_num_type($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditJobhtml()
	{
		...
		$this->data["years_list"] = $this->candidatesdirmodel->years_list();
		$this->data["months_list"] = $this->candidatesdirmodel->months_list();
		$this->data["formdata"] = $this->candidatesdirmodel->get_job_single_record($this->data['job_profile_id']);
		...
		$output_string=$this->load->view('candidates_dir/editjobdetail', $this->data,true);
		echo $output_string;
	}
    ...
    function loadEditProjhtml()
	{
		...
		$this->data["formdata"] = $this->candidatesdirmodel->get_proj_single_record($this->data['project_id']);
		...
		$output_string=$this->load->view('candidates_dir/editprojdetail', $this->data,true);
		echo $output_string;
	}
...
//JOB DETAILS
	function jobDetails($id)
	{
		...
		$industry_list = $this->candidatesdirmodel->industry_list();
		$functional_list = $this->candidatesdirmodel->functional_list();

		
		$results = $this->candidatesdirmodel->get_job_details($id);
		$form_data	=	array();
		...
		$job_details_view	=	$this->load->view('candidates_dir/job_details',$this->data,true);
	...
	function add_consultant_feedback($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			$this->candidatesdirmodel->add_consultant_feedback($data,$this->data['candidate_id']);
			redirect('candidates_dir/');
		}
		exit();
	}
	...
	{
		$this->load->model('candidatesdirmodel');
		$this->data["package_list"]         = $this->candidatesdirmodel->fill_package();
		$this->data['candidate_id']         =$this->input->post('candidate_id');
		$this->data['feedback']             =$this->candidatesdirmodel->get_consultant_feedback($this->data['candidate_id']);
		$output_html                        =$this->load->view('candidates_dir/consultant_feedback',$this->data,true);	
		echo $output_html;
	}
	...
	function add_candidates_notes($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			$this->candidatesdirmodel->add_candidates_notes($data);
			redirect('candidates_dir/');
		}
		exit();
	}
	...
	function get_all_notes($candidate_id)
	{
		$this->load->model('candidatesdirmodel');
		$this->data['candidate_id']         = $this->input->post('candidate_id');
		$this->data['note_list']            =$this->candidatesdirmodel->select_all_notes($this->data['candidate_id']);
		$output_html                        = $this->load->view('candidates_dir/all_notes',$this->data,true);	
		echo $output_html;
	}
	...
	function update_job_details()
	{
        ...
        $job_profile_id=$this->candidatesdirmodel->update_job_details($data,$job_profile_id,$candidate_id);
		
		redirect('candidates_dir/summary/'.$candidate_id.'?prof_upd=1');
    ...
    function update_project()
	{
        ...
        $project_id=$this->candidatesdirmodel->update_proj_details($data,$project_id,$candidate_id);
		
		redirect('candidates_dir/summary/'.$candidate_id.'?proj_upd=1');
	...
	function loadEditFilehtml($id){
		...
		$this->load->model('candidatesdirmodel');
		$this->data['survey_result']=$this->candidatesdirmodel->get_survey_result($id);
		$this->data["formdata"] = $this->candidatesdirmodel->get_file_single_record($id);	

		$this->load->view('candidates_dir/editfiledetail', $this->data);
	}
    ...
    {    
        ...
        {
			$this->load->view('include/header',$this->data);    
			$this->load->view('candidates_dir/import_csv',$this->data);                
			$this->load->view('include/footer',$this->data);        
        }
        else
        {
				...
				if($res['mobile'] != '')
				{
						...
						$result	=	$qry->row_array(); 
							...
							if(empty($result))
							{
								...
								$id = $this->candidatesdirmodel->insert_csv_records($data);
								...
								$this->candidatesdirmodel->insert_csv_pre_jobdata($data1);
								...
								$this->candidatesdirmodel->insert_csv_address($data2);	
								...
								{								
									...
									$this->candidatesdirmodel->insert_csv_levels($data3);
								}
								//print_r($data3); exit(); */
    ...
    {    
        ...
        {
			//$this->load->view('include/header',$this->data);    
			$this->load->view('candidates_dir/import_csv_linkedin',$this->data);                
			//$this->load->view('include/footer',$this->data);        
        }
        else
        {
               ...
               $res = $contacts[$i];
				if($res['Email Address'] != '')
				{
					...
					if(empty($result))
					{
						...
						$this->candidatesdirmodel->insert_csv_job($data2);
					}
				}
            }
			redirect('candidates_dir/import_csv_linkedin/?csv=1');
        }  
    }
		...
		foreach($result as $key => $val)
		{
				...
				if(trim($val['organization']!=''))
				{
					...
					}else
					{
						...
						$company_id=$this->candidatesdirmodel->insert_csv_company($company_list);
					}
    ...
    {    
		...
		foreach($result as $key => $val)
		{
			...
			{				
				...
				$this->candidatesdirmodel->insert_csv_job($job_profile);																
				$this->db->query("delete from pms_candidate_new where candidate_id=".$val['candidate_id']);							
			}
		}
...
/*				$data=array(
    ...
    {    
		...
		$this->load->view('include/header',$this->data);    
		$this->load->view('candidates_dir/import_xml',$this->data);                
		$this->load->view('include/footer',$this->data);        
	...
	function candidate_view($candidate_id)
	{
		...
		$this->data['detail_list'] = $this->candidatesdirmodel->detail_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('candidates_dir/candidate_view/'.$this->input->post('candidate_id'));
		}

		$this->data['list']               =$this->candidatesdirmodel->follow_record($candidate_id);
		$this->data['note_list']          =$this->candidatesdirmodel->notes_record($candidate_id);		
		$this->data['coe_list']           =$this->candidatesdirmodel->coe_list($candidate_id);
		$this->data['visa_approval_list'] =$this->candidatesdirmodel->visa_approval_list($candidate_id);

		$this->data['interview_list']     =$this->candidatesdirmodel->interview_record($candidate_id);
		$this->data['aplication_list']    =$this->candidatesdirmodel->aplication_record($candidate_id);
		
		$this->data['interview_status_list']=$this->candidatesdirmodel->interview_status_list();		
		
		$this->data['app_list']           =$this->candidatesdirmodel->aplication_list($candidate_id);
		$this->data['app_list_coe']       =$this->candidatesdirmodel->select_aplication_coe($candidate_id);
		$this->data['admin_user_list']    =$this->candidatesdirmodel->admin_user_list();
		$this->data['interview_type_list']=$this->candidatesdirmodel->interview_type_list();
		$this->data['university_list']    =$this->candidatesdirmodel->university_list();
		$this->data['campus_list']        =array('' => 'Select Campus');
		$this->data['intake_list']        =$this->candidatesdirmodel->intake_list();
		$this->data['course_list']        =array('' => 'Select Course');;
		$this->data['level_list']         =$this->coursemodel->fill_levels();
		$this->data['status_list']        =$this->candidatesdirmodel->status_list();

		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_dir/candidate_view",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function remove_job_app()
	{
		...
		{
			$this->candidatesdirmodel->remove_job_app($this->input->get('candidate_id'),$this->input->get('job_id'));
			redirect('candidates_dir/summary/'.$this->input->get('candidate_id').'?upd=1');
		}else
		{
			echo 'No Details';
		}
	...
	function candidate_programs($candidate_id)
	{
		...
		// update suggestion logic from here
			$this->candidatesdirmodel->update_suggestion_module($this->input->post('candidate_id'), $this->input->post('campus_id'), $this->input->post('course_id'), $this->input->post('total_semester'), $this->input->post('fee_per_semester'), $this->input->post('annual_tution_fee'), $this->input->post('total_tution_fee'),$this->input->post('candidate_course_id'));
		// end here	
					
			redirect('candidates_dir/candidate_programs/'.$this->input->post('candidate_id').'/?upd=1');
		}
...
if($this->input->get('education')!='')
		...
		if($this->input->get('course_id')!='')
		{
			...
			$this->data['single_application']['app_details']=$this->candidatesdirmodel->create_program_name($this->data['single_application']['course_id']);
		}					
		...
		$this->data['aplication_list']=$this->candidatesdirmodel->aplication_record($candidate_id); // application lists - 	
		$this->data['detail_list'] = $this->candidatesdirmodel->detail_list($candidate_id); // candidate details
		$this->data['university_list']=$this->candidatesdirmodel->university_list(); // university list		
		$this->data['intake_list']=$this->candidatesdirmodel->intake_list(); // intake list 		
		$this->data['level_list']=$this->coursemodel->fill_levels(); // education levels
		$this->data['status_list']=$this->candidatesdirmodel->status_list(); // application process status list
		$this->data['campus_list']=array('' => 'Select Campus');
		$this->data['course_list']=array('' => 'Select Course');

		if($this->data['single_application']['univ_id']>0)
			$this->data['campus_list']=$this->candidatesdirmodel->campus_list($this->data['single_application']['univ_id']);
		if($this->data['single_application']['level_study']>0)
			$this->data['course_list']=$this->candidatesdirmodel->course_list_level($this->data['single_application']['level_study']);
			
		$this->data['candidate_qualification_list']=$this->candidatesdirmodel->candidate_qualification_list($candidate_id); 
		// candidate's qualification for higher studies
		// edit mode		
		if($this->input->get('app_id')!='')
		{
			$this->data['single_application']=$this->candidatesdirmodel->select_aplication_record($this->input->get('app_id'));
			if(count($this->data['single_application'])>0)
			{
				if($this->data['single_application']['univ_id']>0)$this->data['campus_list']=$this->candidatesdirmodel->campus_list($this->data['single_application']['univ_id']);
				if($this->data['single_application']['level_study']>0)$this->data['course_list']=$this->candidatesdirmodel->course_list_level($this->data['single_application']['level_study']);
		...
		// update program		
		$this->load->view("include/header",$this->data);
		$this->load->view("candidates_dir/candidate_programs",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function aplication()
	{
		...
		$this->data['aplication_list']=$this->candidatesdirmodel->select_aplication_record($id);		
	...
	function candidate_coe($candidate_id)
	{
		...
		$this->editor($path, $width);
		$this->load->view("include/header",$this->data);
		$this->load->view("candidates_dir/candidate_coe",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function candidate_visa($candidate_id)
	{
		...
		$this->data['visa_approval_list']=$this->candidatesdirmodel->visa_approval_list($candidate_id);
		$this->data['app_list_coe']=$this->candidatesdirmodel->select_aplication_visa($candidate_id);
...
// Manage Email & SMS
	function email_sms($candidate_id)
	{
		...
		$this->load->model('candidatesdirmodel');
		$this->data['detail_list'] = $this->candidatesdirmodel->detail_list($candidate_id);
		$this->data['email_sms_list']=$this->candidatesdirmodel->email_sms_list($candidate_id);
		...
		if($this->input->post('send_type')!='')
		{
			...
			redirect('candidates_dir/email_sms/'.$candidate_id);
		}
		$this->data['error']="Fill subject and email content to send to the candidate.";
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_dir/candidate_email_sms",$this->data);
		$this->load->view("include/footer",$this->data);
	}
// Schedule an interview
	function interview(){
		...
		$id=$this->db->insert_id();
		$this->load->model('candidatesdirmodel');
		$this->data['interview_list']=$this->candidatesdirmodel->select_interview_record($id);
	...
	function tickets($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['detail_list'] = $this->candidatesdirmodel->detail_list($candidate_id);
			...
			$this->data['ticket_list']=$this->candidatesdirmodel->ticket_list($candidate_id);
			...
			if($this->input->post('send_type')!='')
			{
				...
				$id=$this->db->insert_id();
				redirect('candidates_dir/tickets/'.$candidate_id);
			}
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_dir/candidate_complaints",$this->data);
			$this->load->view("include/footer",$this->data);
	}
	...
	function invoice($candidate_id)
	{
		...
		$this->data['education_details'] = $this->candidatesdirmodel->education_deatils($candidate_id);
		$this->data['job_history'] = $this->candidatesdirmodel->job_list($candidate_id);
		$this->data['all_counselor'] = $this->candidatesdirmodel->all_counselor($candidate_id);
		$this->data['candidate_counselor'] = $this->candidatesdirmodel->candidate_counselor($candidate_id);
		...
		foreach($this->input->post('admin_id') as $key => $val)
		{
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("candidates_dir/candidate_invoice",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function cvfile($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidatesdirmodel->cvfile_list($candidate_id);
		...
		if($this->input->post('cvfile')!=''){
			...
			redirect('candidates_dir/cvfile/'.$candidate_id);
			$path = '../js/ckfinder';
			$width = '100%';
			$this->editor($path, $width);
			$this->load->view("include/header",$this->data);
			$this->load->view("candidates_dir/candidate_cvfile",$this->data);
			$this->load->view("include/footer",$this->data);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
	...
	function job_history($candidate_id)
	{
		...
		$this->data['cv_fileist']=$this->candidatesdirmodel->job_list($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('candidates_dir/job_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_dir/candidate_job_history",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function edu_history($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidatesdirmodel->education_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			redirect('candidates_dir/edu_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_dir/candidate_edu_history",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function lang_history($candidate_id)
	{
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidatesdirmodel->country_list();
		$this->data["formdata"] = $this->candidatesdirmodel->get_passport_single_record($candidate_id);
		...
		//Language Deatils
		$this->data['lang_list']=$this->candidatesdirmodel->get_language_set();
		$candidate_certifications =$this->candidatesdirmodel->candidate_languages($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			   ...
			   $this->candidatesdirmodel->edit_passport_detail($this->input->post('candidate_id'));
			   redirect('candidates_dir/lang_history/'.$this->input->post('candidate_id'));
		}
		else
		{
			$path = '../js/ckfinder';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_dir/candidate_lang_history",$this->data);
			$this->load->view("include/footer",$this->data);
	...
	function questionnaire($candidate_id)
	{
		...
		$this->data['candidate_id']=$candidate_id;
		$this->load->model('candidatesdirmodel');
		$this->data['survey_result']=$this->candidatesdirmodel->get_survey_result($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('candidates_dir/questionnaire/'.$this->input->post('candidate_id').'?cv_file='.$cv_file.'&photo_file='.$photo_file);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->data['error']="Please update language skills here";
			$this->load->view("include/header",$this->data);
			$this->load->view("candidates_dir/candidate_questionnaire",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
...
// tech skills
	...
	function skills($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('candidates_dir/skills/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['skill_list']=$this->candidatesdirmodel->get_skill_set();
		$this->data['skill_list_current']=$this->candidatesdirmodel->get_skill_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->candidatesdirmodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->candidatesdirmodel->job_list($candidate_id);
		...
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_dir/candidate_skills",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function add_certification($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->candidatesdirmodel->insert_cert_details($this->input->post('candidate_id'));
			redirect('candidates_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
	...
	function skills_2($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->candidatesdirmodel->insert_skill_details($this->input->post('candidate_id'));
			redirect('candidates_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
...
function certifications($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('candidates_dir/certifications/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['certifications_list']=$this->candidatesdirmodel->get_certifications_set();
		$this->data['certifications_list_current']=$this->candidatesdirmodel->get_certifications_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->candidatesdirmodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->candidatesdirmodel->job_list($candidate_id);
		...
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_dir/candidate_certifications",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function followup()
	{
		...
		if(isset($_POST['candidate_id']))
		{
			...
			/*$this->data['single_list']=$this->candidatesdirmodel->select_record($id);
		
			$dataArr = $this->load->view('candidates_dir/candidatefollowup_list', $this->data,TRUE);
			echo $dataArr;
			exit();
	...
	$id=$this->db->insert_id();
	$this->load->model('candidatesdirmodel');
	$this->data['note_list']=$this->candidatesdirmodel->select_notes_record($id);
	$dataArr = $this->load->view('candidates_dir/candidatenotes_list', $this->data,TRUE);
	echo $dataArr;
	...
	function visa_approval(){
		...
		$this->db->insert('pms_candidate_applications',$data);
		 $id=$this->db->insert_id();
		$this->load->model('candidatesdirmodel');
		$this->data['aplication_list']=$this->candidatesdirmodel->select_aplication_coe($id);
		$dataArr = $this->load->view('candidates_dir/candidate_aplication_list', $this->data,TRUE);
		echo $dataArr;
		exit();	
		$query = $this->db->query("SELECT *  FROM  pms_candidate where candidate_id =".$_POST['candidate_id']);
			$row = $query->row_array();
	...
	function drop(){
		...
		$this->load->model('candidatesdirmodel');
		 $this->candidatesdirmodel->drop_record($candidate_follow_id);
		$dataArr = $this->load->view('candidates_dir/candidate_view');
		echo $dataArr;
	}
	...
	function cvfile_drop(){
		...
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->cvfile_drop_record($cvfile_id);		          
	}
	...
	function drop_job_item()
	{
		$job_profile_id=$this->input->post('job_profile_id');
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->drop_job_item($job_profile_id);
	}
	...
	function deleteJobDetail($candidateId)
	{
		$job_id=$this->input->post('job_id');
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->drop_job_item($job_id);
		$view	=	$this->jobDetails($candidateId);
...
//DELETE EDUCATION DETAILS
	function deleteEducationDetail($candidateId)
	{
		...
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->drop_edu_item($edu_id);
		$view	=	$this->educationDetails($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId,"VIEW"=>$view);
        echo json_encode($status);
	}
	function drop_email_sms_item()
	{
		...
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->drop_email_sms_item($email_sms_id);
	}
	...
	function drop_ticket_item()
	{
		...
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->drop_ticket_item($ticket_id);
	}
		
	function drop_edu_item(){
		$eucation_id=$this->input->post('eucation_id');
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->drop_edu_item($eucation_id);
	}	
	...
	function drop_notes(){
		...
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->note_drop_record($candidate_note_id);
		$dataArr = $this->load->view('candidates_dir/candidate_view');
		echo $dataArr;
	 ...
	 function drop_interviews(){
		...
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->interview_drop_record($interview_id);
		$dataArr = $this->load->view('candidates_dir/candidate_view');
		echo $dataArr;
	 ...
	 function drop_aplication(){
		 $app_id=$_POST['app_id'];
		$this->load->model('candidatesdirmodel');
		$this->candidatesdirmodel->aplication_drop_record($app_id);
		$dataArr = $this->load->view('candidates_dir/candidate_view');
		echo $dataArr;
	...
	function candidate_file($candidate_id)
	{
	   ...
	   if($this->input->post('title')!='')
	   {
			 ...
			 if(isset($_FILES['photo']))
			 {
					...
					{
						$this->load->model('candidatesdirmodel');
						$id=$this->candidatesdirmodel->insert_file($candidate_id);
						redirect('candidates_dir/candidate_file/'.$this->input->post('candidate_id'));
					}
			}
		}
		$this->data['file_list']=$this->candidatesdirmodel->file_list($candidate_id);
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_dir/manage_files",$this->data);
		$this->load->view("include/footer",$this->data);
	}
...
/*			echo '<pre>';
		...
		$this->load->view("candidates_dir/csv_data_import",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	   ...
	   if($this->input->post('title')!='')
	   {
		 if(isset($_FILES['photo']))
		 {
					if(!$candidate_id='')
					{
						$this->load->model('candidatesdirmodel');
						$id=$this->candidatesdirmodel->insert_file($candidate_id);
						$this->data['upload_list']=$this->candidatesdirmodel->get_one_record($id);
						$replay=$this->load->view("candidates_dir/upload_file",$this->data,TRUE);
						echo $replay;
					}
					else
					{
						redirect("candidates_dir/candidate_file");
					}
				}
			else{
				 echo "Choose file";
	...
	function img_update(){
	 ...
	 if(isset($_FILES['photo'])){
						  $this->load->model('candidatesdirmodel');
						   $this->candidatesdirmodel->update_file($candidate_id);
	
							 $this->data['single_file']=$this->candidatesdirmodel->get_one_file($candidate_id);
		...
		function deletefile1()
	{
		...
		if(!empty($id))
		{
			          ...
			          $this->load->model('candidatesdirmodel');
					   $this->candidatesdirmodel->delete_file($id);
					    $this->data['delete_file']=$this->candidatesdirmodel->delete_one_file($id);
						
                           echo $this->data['delete_file']['photo'];  //$replay=$this->load->view("candidates_dir/delete_file",$this->data,TRUE);
					         //echo $replay;
	...
	function delete_cv($id)
	{
		if(!empty($id))
		{
			...
			redirect("candidates_dir/summary/".$id."?del_cv=1");
		}else
		{
			redirect("candidates_dir/summary/".$id);
		}
	}
	...
	function candidate_delete()
	{
		...
		if(!empty($id))
		{
			$this->candidatesdirmodel->candidate_delete($id);
			redirect('candidates_dir/?del=1');
		}
	}
...
//onchange get function	
	...
	{		
		...
		{
			$data=array();
			$data["function_list"] = $this->candidatesdirmodel->function_list_by_category($_POST['category_id']);
			$function	='';
...
//onchange getlocation
	...
	public function assign_job()
	{
		...
		{
			$id = $this->candidatesdirmodel->add_to_job($candidatesArr[$i],$job_id);
		}
		echo $id;
		exit;
	}
...
// email ends here	
	...
	{
		if($id=='')redirect('candidates_dir');
		if($this->input->get('reg_status')=='')redirect('candidates_dir');
		$this->db->query("update pms_candidate set reg_status=".$this->input->get('reg_status')." where candidate_id=".$id);
		redirect('candidates_dir?status=1');
	}
	...
	function delete_photo($id)
	{
		if(!empty($id))
		{
			...
			redirect("candidates_dir/summary/".$id."?del_photo=1");
		}else
		{
			redirect("candidates_dir/summary/".$id);
		}
...
//APPLY JOB
	function apply_job($candidateId,$jobId)
	{
		...
		{
		$this->load->model('candidatesdirmodel');
        $this->candidatesdirmodel->apply_job($candidateId,$jobId);
		}
		redirect("candidates_dir/summary/".$candidateId);
	}
	
	function editSkillCertificateDetail($candidateId)
	{ 
		$this->load->model('candidatesdirmodel');
	 	$id  = $this->candidatesdirmodel->insert_skill_details($candidateId);
		
		$id  = $this->candidatesdirmodel->insert_cert_details($candidateId);
		
		$id  = $this->candidatesdirmodel->insert_domain_details($candidateId);
...
// email to candidate
	...
	{		
		...
		{
			$data=array();
			$function_list = $this->candidatesdirmodel->function_list_by_category_multiple($_POST['category_id']);
...
//EDIT Category and functional area
	...
	{
		$this->load->model('candidatesdirmodel');
	 	$id  = $this->candidatesdirmodel->insert_functional($candidateId);
		redirect('candidates_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
	}	
...
//EDIT PRIMARY AND SECONDARY SKILLS
	...
	{
		$this->load->model('candidatesdirmodel');
	 	$id  = $this->candidatesdirmodel->insert_skills($candidateId);
		redirect('candidates_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
...
//Add Contract Details
	...
	function add_contract_details($candidateId){
		$this->load->model('candidatesdirmodel');
		$uid = $this->candidatesdirmodel->add_contract_detail($candidateId);
		redirect('candidates_dir/summary/'.$this->input->post('candidate_id').'?upd=1');
	}
	...
	function print_cv($id=null)
	{
		...
		$this->data["personal"] = $this->candidatesdirmodel->get_single_record($id);
		$this->data['address'] = $this->candidatesdirmodel->get_address($id);
		$this->data['education'] = $this->candidatesdirmodel->education_list($id);
		$this->data['job_details'] = $this->candidatesdirmodel->get_job_details($id);
		$this->data['language_skills'] = $this->candidatesdirmodel->candidate_languages($id);
		$this->data['tech_skills'] = $this->candidatesdirmodel->candidate_skills($id);
		$this->data['certification'] = $this->candidatesdirmodel->candidate_certifications($id);
		$this->data['domain'] = $this->candidatesdirmodel->candidate_domains($id);
		$this->data['sports'] = $this->candidatesdirmodel->candidate_sports($id);
		$this->data['social'] = $this->candidatesdirmodel->candidate_social($id);
		$this->data['contract'] = $this->candidatesdirmodel->get_contract_detail($id);
		$this->data['formdata'] = $this->candidatesdirmodel->get_lang_details($id);

		$this->data["profile_list"] = $this->candidatesdirmodel->profile_list($id);
					

		//$this->load->view('include/header',$this->data);
		$this->load->view('candidates_dir/print_cv',$this->data);	
		//$this->load->view('include/footer',$this->data);
	}
...
//GET CANDIDATE EDUCATION
	function get_candidate_education()
	{
		...
		$education_details = $this->candidatesdirmodel->education_deatils($candidate_id);
			...
			$html2='<td colspan="2" align="center" valign="top" class="borderTopNone"> 
					 ...
					 foreach($education_details as $key => $val)
					 {
						...
						$html2.='<tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_dir/delete_candidate_edu/?id='.$val['eucation_id'].'" id="delete_candidate_edu" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate education	
	...
	function get_candidate_professional()
	{
		...
		$job_history = $this->candidatesdirmodel->job_list($candidate_id);
					...
					<table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
					 ...
					 {	
						...
						$html2.=' <tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_dir/delete_candidate_prof/?id='.$val['job_profile_id'].'" id="delete_candidate_prof" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate Professional details	
	...
	function get_present_contract()
	{
		...
		$contract = $this->candidatesdirmodel->get_contract_detail($candidate_id);
		...
		if(!empty($contract))
		{
			...
			$html2.=' <tr>
							...
							<td>'. $status.'</td>   
							<td><a href="javascript:;"  data-url="'.base_url().'candidates_dir/delete_candidate_contract/?id='.$contract['candidate_id'].'" id="delete_candidate_contract" >Delete</td>
						</tr>';
...
// Manage Email 
	...
	public function get_functional_by_industry()
	{
		...
		{
			$data=array();
			$data["func_list"] = $this->candidatesdirmodel->get_functional_by_industry($_POST['job_cat_id']);
	...
	public function get_designation_by_functional()
	{
		...
		{
			$data=array();
			$data["desig_list"] = $this->candidatesdirmodel->get_designation_by_functional($_POST['func_id']);
	...
	function pre_screening(){
		...
		{			
			$this->data['candidate_id']=$this->input->post("candidate_id");
			$this->data['pre_screening']=$this->candidatesdirmodel->get_pre_screening($this->data['candidate_id']);
			$this->data['admin_list'] = $this->candidatesdirmodel->admin_recruiters_list();
			$this->data['company_list'] = $this->candidatesdirmodel->company_list();
			$this->data["jobs_list"] = $this->candidatesdirmodel->fill_job_list($this->data['candidate_id']);
		}		
		
		$this->data['page_head'] = 'Jobs List';	
		$this->load->view('candidates_dir/pre_screening',$this->data);			
	}
	...
	$arrival_date= date("Y-m-d",strtotime($this->input->post('arrival_date')));
		...
		if($this->input->post("candidate_id")!='')
		{
			...
			$this->candidatesdirmodel->update_payment_status($data1, $this->input->post("candidate_id"));
			
			
			if($this->input->post("pre_screen_id")!='' && $this->input->post("candidate_id")!='')
				
			{
				$this->candidatesdirmodel->update_pre_screening($data, $this->input->post('pre_screen_id'), $this->input->post("candidate_id"));
				redirect('candidates_dir/');
				
			}
			else
			{
				$this->candidatesdirmodel->add_pre_screening($data);
				redirect('candidates_dir/');
			}
		 }
