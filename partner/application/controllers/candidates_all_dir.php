...
// Manage Email 
	...
	function client_cv_doc()
	{
		...
		{			
			...
			if($this->data["personal"]['cv_file']!='' && file_exists('uploads/client_cvs/'.$this->data["personal"]['cv_file']))
			if($this->data["personal"]['cv_file']!='')
			{
				$out_put_str='';
 				$file_name=base_url().'uploads/client_cvs/'.$this->data["personal"]['cv_file'];
...
function update_company()
	{
		...
		if($this->input->post('candidate_id')!='' && $this->input->post('company_name')!='' && $this->input->post('company_phone')!='' && $this->input->post('company_email')!='')
		{
			...
			$job_id=$this->candidates_alldirmodel->update_company($data,$this->input->post('candidate_id'));	
	...
	function get_company_lists()
	{
		$this->load->model('candidates_alldirmodel');
		$this->data['candidate_id']         = $this->input->post('candidate_id');
		$this->data['shortlisted_data']     = $this->candidates_alldirmodel->select_company_lists($this->data['candidate_id']);
		
		$output_html                        = $this->load->view('candidates_all_dir/get_connect_jobs',$this->data,true);	
		echo $output_html;
	}
	...
	{
		$this->load->model('candidates_alldirmodel');
		if($this->input->post('candidate_id')!='' && $this->input->post('company_id')!='')
		{
			$this->data['candidate_id']=$this->input->post('candidate_id');
			$this->data['company_id']=$this->input->post('company_id');				
			$this->candidates_alldirmodel->delete_company($this->data['candidate_id'], $this->data['company_id']);
	...
	function edit_shortlisted_lists()
	{		
		$this->load->model('candidates_alldirmodel');		
		if($this->input->get('candidate_id')!='' && $this->input->get('company_id')!='')
		{
				$company_id         = $this->input->get('company_id');
				$candidate_id       = $this->input->get('candidate_id');		
				$this->db->where('company_id', $company_id);
				$this->db->where('candidate_id', $candidate_id);
				$query=$this->db->get('pms_company_temp');
		...
		function update_company_lists()
	{
		...
		if($this->input->post('candidate_id')!='' && $this->input->post('company_id')!='')
		{
			...
			$job_id=$this->candidates_alldirmodel->update_company_lists($data,$this->input->post('company_id'),$this->input->post('candidate_id'));
