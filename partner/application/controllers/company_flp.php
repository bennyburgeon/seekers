...
class Company_flp extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."company_flp/?sort_by=$sort_by&admin_id=$admin_id$query_str&ind_id=".$ind_id."&flp_status=$flp_status&company_priority=$company_priority&company_rating=$company_rating&status=$status&flp_date_from=$flp_date_from&flp_date_to=$flp_date_to";
