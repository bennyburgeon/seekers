...
class Company_agreements extends CI_Controller {
	...
	{	$this->load->library('pagination');
		...
		$config['base_url'] = $this->config->item('base_url')."company_agreements/?sort_by=$sort_by&searchterm=$searchterm$query_str&ind_id=".$ind_id."&flp_status=$flp_status&company_priority=$company_priority&company_rating=$company_rating&status=$status";
