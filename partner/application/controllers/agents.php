...
class Agents extends CI_controller
 {
	...
	function editor($path,$width) {
     ...
     function index()	 
	 {
		...
		$config['base_url'] = $this->config->item('base_url')."agents/?sort_by=$sort_by&limit=$limit&searchterm=$searchterm$query_str";
	...
	function delete($id='')
	{
		if($_SESSION['vendor_session']==$id) redirect('agents');
		if($id!='')
		{
