...
class Courses extends CI_Controller {
	...
	{	
		...
		$this->data['cur_page']=$this->router->class;
		$config['base_url'] = $this->config->item('base_url')."courses/?sort_by=$sort_by&limit=$limit&searchterm=".$this->data["searchterm"]."&international=".$this->data["international"]."&level_study=".$this->data["level_study"]."&$query_str";
