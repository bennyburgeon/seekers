<?php class Candidates_ctc extends CI_Controller 
{
	...
	{	
		...
		$this->data['exp_years']='';
		$this->data['rows']='';
		$this->load->model('candidatectcmodel');
...
//	exit();
		...
		$this->data['admin_users_lists']= $this->candidatectcmodel->get_admin_users_lists();
		$this->data['all_jobs_list']= $this->candidatectcmodel->all_jobs_list();
		
		$this->data["reg_status_list"] = $this->candidatectcmodel->reg_status_list();
		
// Technical Skilss

		
		$this->data['skill_list']=$this->candidatectcmodel->get_parent_skills();
		...
		if(!empty($skill))
		{
			...
			$this->data['child_skills']	=	$this->candidatectcmodel->get_child_skills($res1[0]['skill_id']);
		}

		//Education details
		$this->data["edu_level_list"] = $this->candidatectcmodel->edu_level_list();
		...
		$this->data['job_folders']=$this->candidatectcmodel->get_job_folders();
		$this->data['job_status_list']=$this->candidatectcmodel->get_job_status();
		
		
		$this->data["edu_spec_list"] = $this->candidatectcmodel->edu_spec_list();
		$this->data["years_list"] = $this->candidatectcmodel->years_list();
		
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_ctc/candidateslist',$this->data);				
	...
	{	
		...
		$this->data['job_folders']=$this->candidatectcmodel->get_job_folders();
		$this->data['job_status']=$this->candidatectcmodel->get_job_status();
		
		$this->data["edu_course_list"] = $this->candidatectcmodel->edu_course_list();
		$this->data["level_list"] = $this->coursemodel->fill_levels();
		$this->data['admin_users_lists']= $this->candidatectcmodel->get_admin_users_lists();
		$this->data["reg_status_list"] = $this->candidatectcmodel->reg_status_list();
		$this->data['all_jobs_list']= $this->candidatectcmodel->all_jobs_list();

		$this->data["band_list"]           = $this->candidatectcmodel->fill_bands();
		$this->data["roles_list"]          = $this->candidatectcmodel->fill_roles();
				
		$this->data['page_head']= 'Add Candidate';
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_ctc/addcandidates',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
	...
	function addCandidate(){
		...
		{ 
			$id = $this->candidatectcmodel->insert_candidate_record();
			if ($id != '') { 
				...
				if(isset($_FILES['cv_file'])){
					...
					{       				
						...
						if ($this->upload->do_upload('cv_file'))
						{
							...
							$this->candidatectcmodel->insert_files($dataArr);
									$cv_file=1;
						}
					}
				}	
...
//Loading Models
		...
		$this->data["formdata"] = $this->candidatectcmodel->get_single_record($id);
	
//Certification and Technical Skilss
		
		$this->data['cerifications']=$this->jobsmodel->get_cert();
		$candidate_certifications = $this->candidatectcmodel->candidate_certifications($id);
...
//skills
		...
		$candidate_skills = $this->candidatectcmodel->candidate_skills($id);
		...
		//all child skills		
		$this->data['all_child_skills']	=	$this->candidatectcmodel->child_skills();
		//domain knowledge
		
		
		$this->data['job_folders']=$this->candidatectcmodel->get_job_folders();
		
		$this->data['domain']=$this->candidatectcmodel->get_domain();
		$candidate_domain = $this->candidatectcmodel->get_domain_details($id);
...
//Planning Job Change Details
		$this->data["formdata8"] = $this->candidatectcmodel->job_search($id);
...
//Language Deatils
		$this->data['lang_list']=$this->candidatectcmodel->get_language_set();
		$candidate_certifications =$this->candidatectcmodel->candidate_languages($id);
...
//Contact Details
		...
		$this->data["formdata3"] = $this->candidatectcmodel->get_address_single_record($id);
		...
		$this->data["country_list"] = $this->candidatectcmodel->country_list();
		$this->data["formdata4"] = $this->candidatectcmodel->get_passport_single_record($id);

		//Education Details
		$this->data["country_list"] 	= $this->countrymodel->country_list_by_state_city_location();
		$this->data["edu_level_list"] = $this->candidatectcmodel->edu_level_list();
		$this->data["edu_years_list"] = $this->candidatectcmodel->edu_years_list();
		//$this->data["edu_course_list"] = $this->candidatectcmodel->edu_course_list();
		$this->data["edu_course_list"]  = array('' => 'Select Course');
		
		$this->data["edu_spec_list"]        = $this->candidatectcmodel->edu_spec_list();
		$this->data["edu_univ_list"]        = $this->candidatectcmodel->edu_univ_list();
		$this->data["edu_coll_list"]        = $this->candidatectcmodel->edu_coll_list();
		$this->data["edu_course_type_list"] = $this->candidatectcmodel->edu_course_type_list();
		$this->data["formdata5"]            = $this->candidatectcmodel->get_education_single_record($id);
...
//Job Details
		$this->data["industries_list"] = $this->candidatectcmodel->industries_list();
		$this->data["industry_list"] = $this->candidatectcmodel->industry_list();
		$this->data["functional_list"] = $this->candidatectcmodel->functional_list();
		$this->data["currecy_list"] = $this->candidatectcmodel->currency_list();
		$this->data["years_list"] = $this->candidatectcmodel->years_list();
		$this->data["months_list"] = $this->candidatectcmodel->months_list();
		$this->data["formdata6"] = $this->candidatectcmodel->get_job_single_record($id);
...
//FILE DEATILS
		$this->data['survey_result']=$this->candidatectcmodel->get_survey_result($id);
		$this->data["formdata7"] = $this->candidatectcmodel->get_file_single_record($id);
		...
		// fetch profile data
		$this->data["formdata"]['profile_list'] = $this->candidatectcmodel->profile_list($id);
		
		$this->data["edu_view"]	=	$this->educationDetails($id);
		$this->data["job_view"]	=	$this->jobDetails($id);
		
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_ctc/editcandidates_auto_complete',$this->data);	
		$this->load->view('include/footer',$this->data);
	}
	...
	{
		$this->load->model('candidatectcmodel');  
		$this->data["personal"] = $this->candidatectcmodel->get_single_record($id);
		$file_text='';
	...
	function loadContacthtml($id) {
		...
		$this->data["religion_list"]    = $this->candidatectcmodel->religion_list();
        ...
        $this->load->view('candidates_ctc/addcontactdetail', $this->data);
    }
	
	function skip_step2($candidateId){
		$this->load->model('candidatectcmodel');
		//$this->candidatectcmodel->insert_contact_detail_skip($candidateId);		
	...
	function addCandidateDetail($candidateId)
	{
		...
		$id  = $this->candidatectcmodel->insert_contact_detail($candidateId);
		$uid = $this->candidatectcmodel->update_contact_detail($candidateId);
	...
	function loadPassporthtml($id){
		...
		$this->load->model('candidatectcmodel');
		$this->load->model('visatypemodel');
		$this->data["formdata"]=$this->candidatectcmodel->get_passport_details($id);
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidatectcmodel->country_list();
		$this->load->view('candidates_ctc/addpassportdetail', $this->data);
	}
	...
	function addPassportDetail($candidateId){
		$this->load->model('candidatectcmodel');
		$uid = $this->candidatectcmodel->update_passport_detail($candidateId);
		$status = array("STATUS" => "1");
		echo json_encode($status);
	}
	...
	function loadEducationhtml($id){
		...
		$this->data["edu_univ_list"] = $this->candidatectcmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidatectcmodel->edu_course_type_list();
		$this->load->view('candidates_ctc/addeducationdetail',$this->data);
	}
	
	function skip_step4($candidateId){
		$this->load->model('candidatectcmodel');
		//$this->candidatectcmodel->insert_education_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function addEducationDetail($candidateId)
	{
		...
		$id  = $this->candidatectcmodel->insert_education_detail($data);
	...
	function loadJobhtml($id){
		...
		$this->data["years_list"] = $this->candidatectcmodel->years_list();
		$this->data["months_list"] = $this->candidatectcmodel->months_list();
		$this->load->view('candidates_ctc/addjobdetail', $this->data);
	}
	
	function skip_step5($candidateId){
		$this->load->model('candidatectcmodel');
		//$this->candidatectcmodel->insert_job_detail_skip($candidateId);
		$status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	{
		$this->load->model('candidatectcmodel');
		$id  = $this->candidatectcmodel->insert_job_detail($candidateId);
		$uid = $this->candidatectcmodel->update_job_detail($candidateId);
	...
	function loadFilehtml($id)
	{
		...
		$this->data['candidate_id'] = $id;
		$this->load->model('candidatectcmodel');
		$this->load->view('candidates_ctc/addfiledetail', $this->data);
	}
	...
	function upload_cv_photo($candidate_id)
	{
		...
		if($candidate_id!='')
		{
			...
			redirect('candidates_ctc/summary/'.$this->input->post('candidate_id'));
		}else
		{
			redirect('candidates_ctc');
		}		
	}
	...
	function calendar_ci(){
		...
		$this->load->model('candidatectcmodel');
		$this->data["shift_list"] = $this->candidatectcmodel->fill_shift_name();
		...
		$this->data['candidate_id']=0;		
		
		if($this->input->post("year")!='')
		{
			$this->data['cur_year']=$this->input->post("year");
		}

		if($this->input->post("month")!='')
		{
			$this->data['cur_month']=$this->input->post("month");
		}		
		...
		$this->data['current_schedule']=$this->candidatectcmodel->get_current_schedule($this->data['candidate_id'],$this->data['cur_month'],$this->data['cur_year']);
		
		$this->data['prev_month']= $this->data['cur_month']-1;
		$this->data['next_month']= $this->data['cur_month']+1;
		
		if($this->data['prev_month']< 1)
		{
			$this->data['prev_month']=12;
			$this->data['prev_year']=$this->data['cur_year']-1;
		}else
		{
		...
		$this->load->view('candidates_ctc/ci_calendar',$this->data);				
	...
	function calendar_ci_open(){
		...
		$this->data['page_head'] = 'Interview List';
		$this->load->view('include/header');
		$this->load->view('candidates_ctc/open_cal',$this->data);				
		$this->load->view('include/footer');		
	}	
		...
		if($this->input->post("candidate_id")!='')
		{
			...
			if(is_array($avail_id))
			{
				...
				foreach ($avail_id as $key => $val)
 				{					
					foreach($shift_name as $shift => $shift_val)
					{						
						$shift_array=array();
						$shift_array=explode('|',$shift_val);
						if(is_array($shift_array) && isset($shift_array[1]) && $shift_array[1]==$val)
							$this->candidatectcmodel->update_shift_vacancy($candidate_id,$val,$month,$year,$shift_array[0]);
					}
				}
			...
			{
				$this->candidatectcmodel->update_shift_vacancy_month($candidate_id,$month,$year);
				$response = array(
			    'data' => '',
				'status'=>'success',
				);
...
function profile_completion($candidateId)
	...
	function editCandidate(){
		...
		$this->load->model('candidatectcmodel');
        $this->candidatectcmodel->update_candidate_record($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function update_candidate_profile()
	{
		if( $this->input->post('candidate_id')!='')
		{
			...
			$this->candidatectcmodel->update_candidate_record($candidate_id,$data_profile,$data_job);
			$this->candidatectcmodel->update_role_designation($candidate_id, $this->input->post('desig_id'));
			
			redirect('candidates_ctc/summary/'.$candidate_id.'?upd=1');
		}else
		{
			echo 'Invalid Data';
			exit();
	...
	function loadEditContacthtml($id){
        ...
        $this->load->view('candidates_ctc/editcontactdetail', $this->data);

	}
	
	function editCandidateDetail($candidateId){
		$this->load->model('candidatectcmodel');
        $this->candidatectcmodel->edit_contact_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	...
	function loadEditPassporthtml($id){
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidatectcmodel->country_list();
		$this->data["formdata"] = $this->candidatectcmodel->get_passport_single_record($id);
		$this->load->view('candidates_ctc/editpassportdetail', $this->data);
	}
	
	function editPassportDetail($candidateId)
	{
		$this->load->model('candidatectcmodel');
        $this->candidatectcmodel->edit_passport_detail($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditEducationhtml()
	{
		...
		$this->data["edu_univ_list"] = $this->candidatectcmodel->edu_univ_list();
		$this->data["edu_course_type_list"] = $this->candidatectcmodel->edu_course_type_list();
		$this->data["formdata"] = $this->candidatectcmodel->get_education_single_record($this->data['edu_id']);
		...
		$data=$this->load->view('candidates_ctc/editeducationdetail',$this->data,true);
		echo $data;
		exit();
	}
...
//EDUCATION DETAILS
	function educationDetails($id)
	{
		...
		$edu_level = $this->candidatectcmodel->edu_level_list();
		
		$course = $this->candidatectcmodel->edu_course_list();

		$spec = $this->candidatectcmodel->edu_spec_list();


		
		$results = $this->candidatectcmodel->get_education_details($id);
		$form_data	=	array();
		...
		$education_details_view	=	$this->load->view('candidates_ctc/education_details',$this->data,true);
	...
	function update_education()
	{
		...
		$this->candidatectcmodel->update_education($data,$this->input->post('edu_id'),$this->input->post('candidate_id'));
//        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
		redirect('candidates_ctc/summary/'.$this->input->post('candidate_id').'?edu_upd=1');
        //echo json_encode($status);
	}
	...
	{
		$this->load->model('candidatectcmodel');
        $this->candidatectcmodel->edit_education_detail($candidateId);
	...
	{
		$this->load->model('candidatectcmodel');
        $this->candidatectcmodel->edit_job_change_detail($candidateId);
		 $this->candidatectcmodel->edit_passport_num_type($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);
        echo json_encode($status);
	}
	...
	function loadEditJobhtml()
	{
		...
		$this->data["years_list"] = $this->candidatectcmodel->years_list();
		$this->data["months_list"] = $this->candidatectcmodel->months_list();
		$this->data["formdata"] = $this->candidatectcmodel->get_job_single_record($this->data['job_profile_id']);
		...
		$output_string=$this->load->view('candidates_ctc/editjobdetail', $this->data,true);
		echo $output_string;
	}
...
//JOB DETAILS
	function jobDetails($id)
	{
		...
		$industry_list = $this->candidatectcmodel->industry_list();
		$functional_list = $this->candidatectcmodel->functional_list();

		
		$results = $this->candidatectcmodel->get_job_details($id);
		$form_data	=	array();
		...
		$job_details_view	=	$this->load->view('candidates_ctc/job_details',$this->data,true);
	...
	function add_consultant_feedback($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			$this->candidatectcmodel->add_consultant_feedback($data,$this->data['candidate_id']);
			redirect('candidates_ctc/');
		}
		exit();
	}
	...
	{
		$this->load->model('candidatectcmodel');
		$this->data["package_list"]         = $this->candidatectcmodel->fill_package();
		$this->data['candidate_id']         =$this->input->post('candidate_id');
		$this->data['feedback']             =$this->candidatectcmodel->get_consultant_feedback($this->data['candidate_id']);
		$output_html                        =$this->load->view('candidates_ctc/consultant_feedback',$this->data,true);	
		echo $output_html;
	}
	...
	function add_candidates_notes($candidate_id)
	{
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			$this->candidatectcmodel->add_candidates_notes($data);
			redirect('candidates_ctc/');
		}
		exit();
	}
	...
	function get_all_notes($candidate_id)
	{
		$this->load->model('candidatectcmodel');
		$this->data['candidate_id']         = $this->input->post('candidate_id');
		$this->data['note_list']            =$this->candidatectcmodel->select_all_notes($this->data['candidate_id']);
		$output_html                        = $this->load->view('candidates_ctc/all_notes',$this->data,true);	
		echo $output_html;
	}
	...
	function update_job_details()
	{
        ...
        $job_profile_id=$this->candidatectcmodel->update_job_details($data,$job_profile_id,$candidate_id);
		
		redirect('candidates_ctc/summary/'.$candidate_id.'?prof_upd=1');
	...
	function loadEditFilehtml($id){
		...
		$this->load->model('candidatectcmodel');
		$this->data['survey_result']=$this->candidatectcmodel->get_survey_result($id);
		$this->data["formdata"] = $this->candidatectcmodel->get_file_single_record($id);	

		$this->load->view('candidates_ctc/editfiledetail', $this->data);
	}
    ...
    {    
        ...
        {
			$this->load->view('include/header',$this->data);    
			$this->load->view('candidates_ctc/import_csv',$this->data);                
			$this->load->view('include/footer',$this->data);        
        }
        else
        {
				...
				if($res['username'] != '')
				{
						...
						$result	=	$qry->row_array(); 
							...
							if(empty($result))
							{
								...
								$id = $this->candidatectcmodel->insert_csv_records($data);
								...
								$this->candidatectcmodel->insert_csv_edu($data1);
								...
								$this->candidatectcmodel->insert_csv_job($data2);
								...
								{								
									...
									$this->candidatectcmodel->insert_csv_skills($data3);
								}
								...
								{								
									...
									$this->candidatectcmodel->insert_csv_cert($data4);
								}
								...
								{								
									...
									$this->candidatectcmodel->insert_csv_domain($data5);
								}
								...
								{								
									...
									$this->candidatectcmodel->insert_csv_lang($data6);
								}
								...
								$this->candidatectcmodel->insert_csv_job_search($data7);						
    ...
    {    
        ...
        {
			//$this->load->view('include/header',$this->data);    
			$this->load->view('candidates_ctc/import_csv_linkedin',$this->data);                
			//$this->load->view('include/footer',$this->data);        
        }
        else
        {
			...
			redirect('candidates_ctc/import_csv_linkedin/?csv=1');
        }  
    }
		...
		foreach($result as $key => $val)
		{
				...
				if(trim($val['organization']!=''))
				{
					...
					}else
					{
						...
						$company_id=$this->candidatectcmodel->insert_csv_company($company_list);
					}
    ...
    {    
		...
		foreach($result as $key => $val)
		{
			...
			{				
				...
				$this->candidatectcmodel->insert_csv_job($job_profile);																
				$this->db->query("delete from pms_candidate_new where candidate_id=".$val['candidate_id']);							
			}
		}
...
/*				$data=array(
    ...
    {    
		...
		$this->load->view('include/header',$this->data);    
		$this->load->view('candidates_ctc/import_xml',$this->data);                
		$this->load->view('include/footer',$this->data);        
	...
	function candidate_view($candidate_id)
	{
		...
		$this->data['detail_list'] = $this->candidatectcmodel->detail_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('candidates_ctc/candidate_view/'.$this->input->post('candidate_id'));
		}

		$this->data['list']               =$this->candidatectcmodel->follow_record($candidate_id);
		$this->data['note_list']          =$this->candidatectcmodel->notes_record($candidate_id);		
		$this->data['coe_list']           =$this->candidatectcmodel->coe_list($candidate_id);
		$this->data['visa_approval_list'] =$this->candidatectcmodel->visa_approval_list($candidate_id);

		$this->data['interview_list']     =$this->candidatectcmodel->interview_record($candidate_id);
		$this->data['aplication_list']    =$this->candidatectcmodel->aplication_record($candidate_id);
		
		$this->data['interview_status_list']=$this->candidatectcmodel->interview_status_list();		
		
		$this->data['app_list']           =$this->candidatectcmodel->aplication_list($candidate_id);
		$this->data['app_list_coe']       =$this->candidatectcmodel->select_aplication_coe($candidate_id);
		$this->data['admin_user_list']    =$this->candidatectcmodel->admin_user_list();
		$this->data['interview_type_list']=$this->candidatectcmodel->interview_type_list();
		$this->data['university_list']    =$this->candidatectcmodel->university_list();
		$this->data['campus_list']        =array('' => 'Select Campus');
		$this->data['intake_list']        =$this->candidatectcmodel->intake_list();
		$this->data['course_list']        =array('' => 'Select Course');;
		$this->data['level_list']         =$this->coursemodel->fill_levels();
		$this->data['status_list']        =$this->candidatectcmodel->status_list();

		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_ctc/candidate_view",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function summary($candidate_id)
	{
		...
		if($this->input->get('edit_job')==1 && $this->input->get('job_profile_id')>0 && $this->input->get('candidate_id') > 0)
		{
				...
				$this->data["months_list"]          = $this->candidatectcmodel->months_list();
				$this->data["formdata"]             = $this->candidatectcmodel->get_job_single_record($this->data['job_profile_id']);
				$this->data['edit_job_html']        = $this->load->view('candidates_ctc/editjobdetail', $this->data,true);
		}
		...
		$this->data["formdata"]               = $this->candidatectcmodel->get_single_record($candidate_id);
		$this->data["formdata"]['desig_id']   =$this->candidatectcmodel->get_role($candidate_id);
		$this->data['job_folders']            = $this->candidatectcmodel->get_job_folders();
		$this->data['visa_type_list']         = $this->candidatectcmodel->visa_type_list();
		$this->data['job_status']             =$this->candidatectcmodel->get_job_status();
		...
		$this->data['candidate_languages']    = $this->candidatectcmodel->candidate_languages($candidate_id);
		$this->data['education_details']      = $this->candidatectcmodel->education_deatils($candidate_id);
		
		$this->data['job_history']            = $this->candidatectcmodel->job_list($candidate_id);
		$this->data['followup_history']       = $this->candidatectcmodel->get_followup_detail($candidate_id);
		
		$this->data['all_calls']              = $this->candidatectcmodel->all_calls($candidate_id);
		
		//print_r($this->data["formdata"]);
		//exit();
		
		$this->data['all_messages']           = $this->candidatectcmodel->all_messages($candidate_id);
		$this->data['all_notes']              = $this->candidatectcmodel->all_notes($candidate_id);
	
		$this->data['candidate_skill']        = $this->candidatectcmodel->candidate_skills($candidate_id);
		
		//candidate doamin knowledge
		$this->data['candidate_domain']       = $this->candidatectcmodel->candidate_domains($candidate_id);
		$this->data['admin_user_list']        =$this->candidatectcmodel->admin_user_list();
		//Certification 
		
		$this->data['cerifications']          =$this->candidatectcmodel->get_cert();
		$candidate_certifications             = $this->candidatectcmodel->candidate_certifications($candidate_id);
		...
		$this->data['candidate_questionnaire_summary'] = $this->candidatectcmodel->get_survey_result($candidate_id);
		$this->data['candidate_files_summary'] = $this->candidatectcmodel->get_files($candidate_id);
		$this->data['candidate_complaints_summary'] = $this->candidatectcmodel->ticket_list($candidate_id);

//Job Search details(candidate_job_serach)
		$this->data['job_search'] = $this->candidatectcmodel->job_search($candidate_id);
		//print_r($this->data['job_search']);exit;
//Edit skill Modal

		$this->data['skill_list']=$this->candidatectcmodel->get_parent_skills();
		
		$candidate_skills = $this->candidatectcmodel->candidate_skills($candidate_id);
		...
		//Language Deatils
		$this->data['lang_list']=$this->candidatectcmodel->get_language_set();
		$candidate_languages =$this->candidatectcmodel->candidate_languages($candidate_id);
		...
		$this->data["current_location_list"] 	= $this->candidatectcmodel->city_list();
		...
		$this->data['suggested_jobs']=$this->candidatectcmodel->get_suggested_jobs($candidate_id);	

//applied jobs of candidate		
		$this->data['applied_jobs']=$this->candidatectcmodel->get_job_list($candidate_id);

//shortlisted jobs
		$this->data['shortlisted']=$this->candidatectcmodel->get_shortlisted($candidate_id);

//interview scheduled jobs
		$this->data['interview_list']=$this->candidatectcmodel->get_interview_list($candidate_id);

//selected jobs
		$this->data['jobs_selected']=$this->candidatectcmodel->jobs_selected($candidate_id);

//offer letters issued
		$this->data['offer_letters_issued']=$this->candidatectcmodel->offer_letters_issued($candidate_id);
		
//offer accepted
		$this->data['offer_accepted']=$this->candidatectcmodel->offer_accepted($candidate_id);

//invoice genereted
		$this->data['invoice_generated']=$this->candidatectcmodel->invoice_generated($candidate_id);

		//all child skills		
		$this->data['all_child_skills']	=	$this->candidatectcmodel->child_skills();

//present contract details
		$this->data['contract']=$this->candidatectcmodel->get_contract_detail($candidate_id);
...
/*--------------------------------------------------------------------------*/		
	//category 
		$category = $this->candidatectcmodel->get_cat_fun_list($candidate_id);
	...
	// funcional area
		$function = $this->candidatectcmodel->get_cat_fun_list($candidate_id);
...
//primary_skills
		$candidate_skills_primary = $this->candidatectcmodel->candidate_skills_primary($candidate_id);
...
//secondary skills
		$candidate_skills_secondary = $this->candidatectcmodel->candidate_skills_secondary($candidate_id);
...
//Language Deatails pms_candidate_language
		$this->data['lang_details'] = $this->candidatectcmodel->get_lang_details($candidate_id);
...
/*--------------------------------------------------------------------------*/
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('candidates_ctc/summary/'.$candidate_id);
		}
		...
		$this->load->view("candidates_ctc/candidate_summary",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function remove_job_app()
	{
		...
		{
			$this->candidatectcmodel->remove_job_app($this->input->get('candidate_id'),$this->input->get('job_id'));
			redirect('candidates_ctc/summary/'.$this->input->get('candidate_id').'?upd=1');
		}else
		{
			echo 'No Details';
		}
	...
	function candidate_programs($candidate_id)
	{
		...
		// update suggestion logic from here
			$this->candidatectcmodel->update_suggestion_module($this->input->post('candidate_id'), $this->input->post('campus_id'), $this->input->post('course_id'), $this->input->post('total_semester'), $this->input->post('fee_per_semester'), $this->input->post('annual_tution_fee'), $this->input->post('total_tution_fee'),$this->input->post('candidate_course_id'));
		// end here	
					
			redirect('candidates_ctc/candidate_programs/'.$this->input->post('candidate_id').'/?upd=1');
		}
...
if($this->input->get('education')!='')
		...
		if($this->input->get('course_id')!='')
		{
			...
			$this->data['single_application']['app_details']=$this->candidatectcmodel->create_program_name($this->data['single_application']['course_id']);
		}					
		...
		$this->data['aplication_list']=$this->candidatectcmodel->aplication_record($candidate_id); // application lists - 	
		$this->data['detail_list'] = $this->candidatectcmodel->detail_list($candidate_id); // candidate details
		$this->data['university_list']=$this->candidatectcmodel->university_list(); // university list		
		$this->data['intake_list']=$this->candidatectcmodel->intake_list(); // intake list 		
		$this->data['level_list']=$this->coursemodel->fill_levels(); // education levels
		$this->data['status_list']=$this->candidatectcmodel->status_list(); // application process status list
		$this->data['campus_list']=array('' => 'Select Campus');
		$this->data['course_list']=array('' => 'Select Course');

		if($this->data['single_application']['univ_id']>0)
			$this->data['campus_list']=$this->candidatectcmodel->campus_list($this->data['single_application']['univ_id']);
		if($this->data['single_application']['level_study']>0)
			$this->data['course_list']=$this->candidatectcmodel->course_list_level($this->data['single_application']['level_study']);
			
		$this->data['candidate_qualification_list']=$this->candidatectcmodel->candidate_qualification_list($candidate_id); 
		// candidate's qualification for higher studies
		// edit mode		
		if($this->input->get('app_id')!='')
		{
			$this->data['single_application']=$this->candidatectcmodel->select_aplication_record($this->input->get('app_id'));
			if(count($this->data['single_application'])>0)
			{
				if($this->data['single_application']['univ_id']>0)$this->data['campus_list']=$this->candidatectcmodel->campus_list($this->data['single_application']['univ_id']);
				if($this->data['single_application']['level_study']>0)$this->data['course_list']=$this->candidatectcmodel->course_list_level($this->data['single_application']['level_study']);
		...
		// update program		
		$this->load->view("include/header",$this->data);
		$this->load->view("candidates_ctc/candidate_programs",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function aplication()
	{
		...
		$this->data['aplication_list']=$this->candidatectcmodel->select_aplication_record($id);		
	...
	function candidate_coe($candidate_id)
	{
		...
		$this->editor($path, $width);
		$this->load->view("include/header",$this->data);
		$this->load->view("candidates_ctc/candidate_coe",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function candidate_visa($candidate_id)
	{
		...
		$this->data['visa_approval_list']=$this->candidatectcmodel->visa_approval_list($candidate_id);
		$this->data['app_list_coe']=$this->candidatectcmodel->select_aplication_visa($candidate_id);
...
// Manage Email & SMS
	function email_sms($candidate_id)
	{
		...
		$this->load->model('candidatectcmodel');
		$this->data['detail_list'] = $this->candidatectcmodel->detail_list($candidate_id);
		$this->data['email_sms_list']=$this->candidatectcmodel->email_sms_list($candidate_id);
		...
		if($this->input->post('send_type')!='')
		{
			...
			redirect('candidates_ctc/email_sms/'.$candidate_id);
		}
		$this->data['error']="Fill subject and email content to send to the candidate.";
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_ctc/candidate_email_sms",$this->data);
		$this->load->view("include/footer",$this->data);
	}
// Schedule an interview
	function interview(){
		...
		$id=$this->db->insert_id();
		$this->load->model('candidatectcmodel');
		$this->data['interview_list']=$this->candidatectcmodel->select_interview_record($id);
	...
	function tickets($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['detail_list'] = $this->candidatectcmodel->detail_list($candidate_id);
			...
			$this->data['ticket_list']=$this->candidatectcmodel->ticket_list($candidate_id);
			...
			if($this->input->post('send_type')!='')
			{
				...
				$id=$this->db->insert_id();
				redirect('candidates_ctc/tickets/'.$candidate_id);
			}
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_ctc/candidate_complaints",$this->data);
			$this->load->view("include/footer",$this->data);
	}
	...
	function invoice($candidate_id)
	{
		...
		$this->data['education_details'] = $this->candidatectcmodel->education_deatils($candidate_id);
		$this->data['job_history'] = $this->candidatectcmodel->job_list($candidate_id);
		$this->data['all_counselor'] = $this->candidatectcmodel->all_counselor($candidate_id);
		$this->data['candidate_counselor'] = $this->candidatectcmodel->candidate_counselor($candidate_id);
		...
		foreach($this->input->post('admin_id') as $key => $val)
		{
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("candidates_ctc/candidate_invoice",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function cvfile($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidatectcmodel->cvfile_list($candidate_id);
		...
		if($this->input->post('cvfile')!=''){
			...
			redirect('candidates_ctc/cvfile/'.$candidate_id);
			$path = '../js/ckfinder';
			$width = '100%';
			$this->editor($path, $width);
			$this->load->view("include/header",$this->data);
			$this->load->view("candidates_ctc/candidate_cvfile",$this->data);
			$this->load->view("include/footer",$this->data);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
	...
	function job_history($candidate_id)
	{
		...
		$this->data['cv_fileist']=$this->candidatectcmodel->job_list($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('candidates_ctc/job_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_ctc/candidate_job_history",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function edu_history($candidate_id)
	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidatectcmodel->education_list($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			...
			redirect('candidates_ctc/edu_history/'.$this->input->post('candidate_id'));
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_ctc/candidate_edu_history",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
	...
	function lang_history($candidate_id)
	{
		...
		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();
		$this->data["country_list"] = $this->candidatectcmodel->country_list();
		$this->data["formdata"] = $this->candidatectcmodel->get_passport_single_record($candidate_id);
		...
		//Language Deatils
		$this->data['lang_list']=$this->candidatectcmodel->get_language_set();
		$candidate_certifications =$this->candidatectcmodel->candidate_languages($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			   ...
			   $this->candidatectcmodel->edit_passport_detail($this->input->post('candidate_id'));
			   redirect('candidates_ctc/lang_history/'.$this->input->post('candidate_id'));
		}
		else
		{
			$path = '../js/ckfinder';
			...
			$this->load->view("include/header",$this->data);
			$this->load->view("include/candidate_sidebar",$this->data);
			$this->load->view("candidates_ctc/candidate_lang_history",$this->data);
			$this->load->view("include/footer",$this->data);
	...
	function questionnaire($candidate_id)
	{
		...
		$this->data['candidate_id']=$candidate_id;
		$this->load->model('candidatectcmodel');
		$this->data['survey_result']=$this->candidatectcmodel->get_survey_result($candidate_id);
		...
		if($this->input->post('candidate_id')!='')
		{
			   ...
			   redirect('candidates_ctc/questionnaire/'.$this->input->post('candidate_id').'?cv_file='.$cv_file.'&photo_file='.$photo_file);
		}else{
			$path = '../js/ckfinder';
			$width = '100%';
			$height = '900px';
			...
			$this->data['error']="Please update language skills here";
			$this->load->view("include/header",$this->data);
			$this->load->view("candidates_ctc/candidate_questionnaire",$this->data);
			$this->load->view("include/footer",$this->data);
		}	
	}
...
// tech skills
	...
	function skills($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('candidates_ctc/skills/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['skill_list']=$this->candidatectcmodel->get_skill_set();
		$this->data['skill_list_current']=$this->candidatectcmodel->get_skill_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->candidatectcmodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->candidatectcmodel->job_list($candidate_id);
		...
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_ctc/candidate_skills",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function add_certification($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->candidatectcmodel->insert_cert_details($this->input->post('candidate_id'));
			redirect('candidates_ctc/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
	...
	function skills_2($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			$this->candidatectcmodel->insert_skill_details($this->input->post('candidate_id'));
			redirect('candidates_ctc/summary/'.$this->input->post('candidate_id').'?upd=1');
		}
...
function certifications($candidate_id)
	{
		...
		if($this->input->post('candidate_id'))
		{
			...
			}else
			{
			   ...
			   redirect('candidates_ctc/certifications/'.$this->input->post('candidate_id').'?upd=1');
		}

		$this->data['certifications_list']=$this->candidatectcmodel->get_certifications_set();
		$this->data['certifications_list_current']=$this->candidatectcmodel->get_certifications_set_candidate($candidate_id);
		$this->data['detail_list'] = $this->candidatectcmodel->detail_list($candidate_id);
		$this->data['cv_fileist']=$this->candidatectcmodel->job_list($candidate_id);
		...
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_ctc/candidate_certifications",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	...
	function followup()
	{
		...
		if(isset($_POST['candidate_id']))
		{
			...
			/*$this->data['single_list']=$this->candidatectcmodel->select_record($id);
		
			$dataArr = $this->load->view('candidates_ctc/candidatefollowup_list', $this->data,TRUE);
			echo $dataArr;
			exit();
	...
	$id=$this->db->insert_id();
	$this->load->model('candidatectcmodel');
	$this->data['note_list']=$this->candidatectcmodel->select_notes_record($id);
	$dataArr = $this->load->view('candidates_ctc/candidatenotes_list', $this->data,TRUE);
	echo $dataArr;
	...
	function visa_approval(){
		...
		$this->db->insert('pms_candidate_applications',$data);
		 $id=$this->db->insert_id();
		$this->load->model('candidatectcmodel');
		$this->data['aplication_list']=$this->candidatectcmodel->select_aplication_coe($id);
		$dataArr = $this->load->view('candidates_ctc/candidate_aplication_list', $this->data,TRUE);
		echo $dataArr;
		exit();	
		$query = $this->db->query("SELECT *  FROM  pms_candidate where candidate_id =".$_POST['candidate_id']);
			$row = $query->row_array();
	...
	function drop(){
		...
		$this->load->model('candidatectcmodel');
		 $this->candidatectcmodel->drop_record($candidate_follow_id);
		$dataArr = $this->load->view('candidates_ctc/candidate_view');
		echo $dataArr;
	}
	...
	function cvfile_drop(){
		...
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->cvfile_drop_record($cvfile_id);		          
	}
	...
	function drop_job_item()
	{
		$job_profile_id=$this->input->post('job_profile_id');
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->drop_job_item($job_profile_id);
	}
	...
	function deleteJobDetail($candidateId)
	{
		...
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->drop_job_item($job_id);
		$view	=	$this->jobDetails($candidateId);
...
//DELETE EDUCATION DETAILS
	function deleteEducationDetail($candidateId)
	{
		...
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->drop_edu_item($edu_id);
		$view	=	$this->educationDetails($candidateId);
        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId,"VIEW"=>$view);
        echo json_encode($status);
	}
	function drop_email_sms_item()
	{
		...
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->drop_email_sms_item($email_sms_id);
	}
	...
	function drop_ticket_item()
	{
		...
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->drop_ticket_item($ticket_id);
	}
		
	function drop_edu_item(){
		$eucation_id=$this->input->post('eucation_id');
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->drop_edu_item($eucation_id);
	}	
	...
	function drop_notes(){
		...
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->note_drop_record($candidate_note_id);
		$dataArr = $this->load->view('candidates_ctc/candidate_view');
		echo $dataArr;
	 ...
	 function drop_interviews(){
		...
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->interview_drop_record($interview_id);
		$dataArr = $this->load->view('candidates_ctc/candidate_view');
		echo $dataArr;
	 ...
	 function drop_aplication(){
		 $app_id=$_POST['app_id'];
		$this->load->model('candidatectcmodel');
		$this->candidatectcmodel->aplication_drop_record($app_id);
		$dataArr = $this->load->view('candidates_ctc/candidate_view');
		echo $dataArr;
	...
	function candidate_file($candidate_id)
	{
	   ...
	   if($this->input->post('title')!='')
	   {
			 ...
			 if(isset($_FILES['photo']))
			 {
					...
					{
						$this->load->model('candidatectcmodel');
						$id=$this->candidatectcmodel->insert_file($candidate_id);
						redirect('candidates_ctc/candidate_file/'.$this->input->post('candidate_id'));
					}
			}
		}
		$this->data['file_list']=$this->candidatectcmodel->file_list($candidate_id);
		$this->load->view("include/header",$this->data);
		$this->load->view("include/candidate_sidebar",$this->data);
		$this->load->view("candidates_ctc/manage_files",$this->data);
		$this->load->view("include/footer",$this->data);
	}
...
/*			echo '<pre>';
		...
		$this->load->view("candidates_ctc/csv_data_import",$this->data);
		$this->load->view("include/footer",$this->data);
	}
	   ...
	   if($this->input->post('title')!='')
	   {
		 if(isset($_FILES['photo']))
		 {
					if(!$candidate_id='')
					{
						$this->load->model('candidatectcmodel');
						$id=$this->candidatectcmodel->insert_file($candidate_id);
						$this->data['upload_list']=$this->candidatectcmodel->get_one_record($id);
						$replay=$this->load->view("candidates_ctc/upload_file",$this->data,TRUE);
						echo $replay;
					}
					else
					{
						redirect("candidates_ctc/candidate_file");
					}
				}
			else{
				 echo "Choose file";
	...
	function img_update(){
	 ...
	 if(isset($_FILES['photo'])){
						  $this->load->model('candidatectcmodel');
						   $this->candidatectcmodel->update_file($candidate_id);
	
							 $this->data['single_file']=$this->candidatectcmodel->get_one_file($candidate_id);
		...
		function deletefile1()
	{
		...
		if(!empty($id))
		{
			          ...
			          $this->load->model('candidatectcmodel');
					   $this->candidatectcmodel->delete_file($id);
					    $this->data['delete_file']=$this->candidatectcmodel->delete_one_file($id);
						
                           echo $this->data['delete_file']['photo'];  //$replay=$this->load->view("candidates_ctc/delete_file",$this->data,TRUE);
					         //echo $replay;
	...
	function delete_cv($id)
	{
		if(!empty($id))
		{
			...
			redirect("candidates_ctc/summary/".$id."?del_cv=1");
		}else
		{
			redirect("candidates_ctc/summary/".$id);
		}
	}
	...
	function candidate_delete($id)
	{
		...
		if(!empty($id))
		{
			$this->candidatectcmodel->candidate_delete($id);
			redirect('candidates_ctc/?del=1');
		}
	}
...
//onchange get function	
	...
	{		
		...
		{
			$data=array();
			$data["function_list"] = $this->candidatectcmodel->function_list_by_category($_POST['category_id']);
			$function	='';
...
//onchange getlocation
	...
	public function assign_job()
	{
		...
		{
			$id = $this->candidatectcmodel->add_to_job($candidatesArr[$i],$job_id);
		}
		echo $id;
		exit;
	}
...
// email ends here	
	...
	{
		if($id=='')redirect('candidates_ctc');
		if($this->input->get('reg_status')=='')redirect('candidates_ctc');
		$this->db->query("update pms_candidate set reg_status=".$this->input->get('reg_status')." where candidate_id=".$id);
		redirect('candidates_ctc?status=1');
	}
	...
	function delete_photo($id)
	{
		if(!empty($id))
		{
			...
			redirect("candidates_ctc/summary/".$id."?del_photo=1");
		}else
		{
			redirect("candidates_ctc/summary/".$id);
		}
...
//APPLY JOB
	function apply_job($candidateId,$jobId)
	{
		...
		{
		$this->load->model('candidatectcmodel');
        $this->candidatectcmodel->apply_job($candidateId,$jobId);
		}
		redirect("candidates_ctc/summary/".$candidateId);
	}
	
	function editSkillCertificateDetail($candidateId)
	{ 
		$this->load->model('candidatectcmodel');
	 	$id  = $this->candidatectcmodel->insert_skill_details($candidateId);
		
		$id  = $this->candidatectcmodel->insert_cert_details($candidateId);
		
		$id  = $this->candidatectcmodel->insert_domain_details($candidateId);
...
// email to candidate
	...
	{		
		...
		{
			$data=array();
			$function_list = $this->candidatectcmodel->function_list_by_category_multiple($_POST['category_id']);
...
//EDIT Category and functional area
	...
	{
		$this->load->model('candidatectcmodel');
	 	$id  = $this->candidatectcmodel->insert_functional($candidateId);
		redirect('candidates_ctc/summary/'.$this->input->post('candidate_id').'?upd=1');
	}	
...
//EDIT PRIMARY AND SECONDARY SKILLS
	...
	{
		$this->load->model('candidatectcmodel');
	 	$id  = $this->candidatectcmodel->insert_skills($candidateId);
		redirect('candidates_ctc/summary/'.$this->input->post('candidate_id').'?upd=1');
...
//Add Contract Details
	...
	function add_contract_details($candidateId){
		$this->load->model('candidatectcmodel');
		$uid = $this->candidatectcmodel->add_contract_detail($candidateId);
		redirect('candidates_ctc/summary/'.$this->input->post('candidate_id').'?upd=1');
	}
	...
	function print_cv($id=null)
	{
		...
		$this->data["personal"] = $this->candidatectcmodel->get_single_record($id);
		$this->data['address'] = $this->candidatectcmodel->get_address($id);
		$this->data['education'] = $this->candidatectcmodel->education_list($id);
		$this->data['job_details'] = $this->candidatectcmodel->get_job_details($id);
		$this->data['language_skills'] = $this->candidatectcmodel->candidate_languages($id);
		$this->data['tech_skills'] = $this->candidatectcmodel->candidate_skills($id);
		$this->data['certification'] = $this->candidatectcmodel->candidate_certifications($id);
		$this->data['domain'] = $this->candidatectcmodel->candidate_domains($id);
		$this->data['sports'] = $this->candidatectcmodel->candidate_sports($id);
		$this->data['social'] = $this->candidatectcmodel->candidate_social($id);
		$this->data['contract'] = $this->candidatectcmodel->get_contract_detail($id);
		$this->data['formdata'] = $this->candidatectcmodel->get_lang_details($id);

		$this->data["profile_list"] = $this->candidatectcmodel->profile_list($id);
					

		//$this->load->view('include/header',$this->data);
		$this->load->view('candidates_ctc/print_cv',$this->data);	
		//$this->load->view('include/footer',$this->data);
	}
...
//GET CANDIDATE EDUCATION
	function get_candidate_education()
	{
		...
		$education_details = $this->candidatectcmodel->education_deatils($candidate_id);
			...
			$html2='<td colspan="2" align="center" valign="top" class="borderTopNone"> 
					 ...
					 foreach($education_details as $key => $val)
					 {
						...
						$html2.='<tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_ctc/delete_candidate_edu/?id='.$val['eucation_id'].'" id="delete_candidate_edu" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate education	
	...
	function get_candidate_professional()
	{
		...
		$job_history = $this->candidatectcmodel->job_list($candidate_id);
					...
					<table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
					 ...
					 {	
						...
						$html2.=' <tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_ctc/delete_candidate_prof/?id='.$val['job_profile_id'].'" id="delete_candidate_prof" class="btn btn-danger btn-xs">Delete</td>
         		 				</tr>';
...
//delete candidate Professional details	
	...
	function get_present_contract()
	{
		...
		$contract = $this->candidatectcmodel->get_contract_detail($candidate_id);
		...
		if(!empty($contract))
		{
			...
			$html2.=' <tr>
							...
							<td>'. $status.'</td>   
							<td><a href="javascript:;"  data-url="'.base_url().'candidates_ctc/delete_candidate_contract/?id='.$contract['candidate_id'].'" id="delete_candidate_contract" >Delete</td>
						</tr>';
