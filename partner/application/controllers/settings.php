...
class Settings extends CI_Controller {
	...
	function index($start = 0)
	{
		...
		//$query=$this->db->query("select smtp_outgoing_server,smtp_incoming_server,smtp_username,smtp_password,smtp_port from pms_admin_users WHERE `admin_id`=".$_SESSION["vendor_session"]);
		$query=$this->db->query("select smtp_outgoing_server,smtp_incoming_server,smtp_username,smtp_password,smtp_port from pms_candidate WHERE `candidate_id`=".$_SESSION["vendor_session"]);
