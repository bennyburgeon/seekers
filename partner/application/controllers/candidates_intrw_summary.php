<?php 
class Candidates_intrw_summary extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('candidates_intrw_summarymodel');
	...
	{	
		...
		$this->data['total_rows']= $this->candidates_intrw_summarymodel->record_count($this->data['search_name']);
		...
		$config['base_url'] = $this->config->item('base_url')."candidates_intrw_summary/?sort_by=".$this->data['sort_by']."&limit=".$this->data['limit']."&search_name=".$this->data['search_name'];
		...
		$this->data["records"] = $this->candidates_intrw_summarymodel->get_list($this->data['start'],$this->data['limit'],$this->data['search_name'],$this->data['sort_by']);
		
			
		$this->data['page_head'] = 'Candidates Interview based Report';				

	
		$this->load->view('include/header',$this->data);
		$this->load->view('candidates_intrw_summary/list',$this->data);
