		...
		if($this->input->post('job_app_id')!='' && $this->input->post('candidate_id')!='')
		{
			...
			else
			{
				...
				$email_array=array(
					...
					'designation'            =>  'Giri Nagar South,  - 682 020,',
					'address'                =>  ' Cochin - 682 020,',
					'job_title'              =>  $row_job['job_title'],
					'cmpny_name'              =>  $row_job['cmpny_name'],
					'mobile'                 =>  '+91 9995671980',
					'website'                =>  'web.com',
					'company_name'           =>  $this->config->item('company_name'),
					'pobox_address'          =>  '90 A, Canal Road,', 
					'telephone'              =>  '',	
...
//		$headers.= "From: ".$email_array['from_name']." <".$email_array['email_from'].">\r\n";		
	...
	function manage_rejection($id=null)
	{
		...
		{		
			$this->jobsmodel->manage_rejection($this->input->post('job_app_id'),$this->input->post('job_id'));
					...
					$this->db->where('job_id', $this->input->post('job_id'));
					$query1 = $this->db->get('pms_jobs');
					$row_job=$query1->row_array();
    ...
    // Email start from here
				...
				$email_array=array(
					...
					'job_title'              =>  $row_job['job_title'],
					'cmpny_name'             =>  $row_job['cmpny_name'],
					'company_address'        =>  $row_job['company_address'],
					'mobile'                 =>  '+91 9995671980',
					'website'                =>  'web.com',
					'company_name'           =>  $this->config->item('company_name'),
					'pobox_address'          =>  '90 A, Canal Road,', 
