...
class Jobs extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."jobs/?sort_by=$sort_by&searchterm=$searchterm$query_str&job_status=$job_status&company_id=$company_id&job_priority=$job_priority";
