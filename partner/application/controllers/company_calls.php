...
class Company_calls extends CI_Controller {
	...
	{	$this->load->library('pagination');
		...
		$config['base_url'] = $this->config->item('base_url')."company_calls/?sort_by=$sort_by&searchterm=$searchterm$query_str&ind_id=".$ind_id."&flp_status=$flp_status&company_priority=$company_priority&company_rating=$company_rating&status=$status&flp_next_date=$flp_next_date";
