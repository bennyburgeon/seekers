<?php class candidates_own extends CI_Controller 
{
	...
	{	
		...
		$this->data['rows']='';
		$this->load->model('candidatesownmodel');
		...
		$this->data['formdata']=array('vendor_id' =>'');

		$this->data['admin_users_lists']= $this->candidatesownmodel->get_admin_users_lists();

		$this->data['all_jobs_list']= $this->candidatesownmodel->all_jobs_list();

		

		$this->data["reg_status_list"] = $this->candidatesownmodel->reg_status_list();

		

		// Technical Skils		

		$this->data['skill_list']=$this->candidatesownmodel->get_parent_skills();
...

		{
			...
			$this->data['child_skills']	=	$this->candidatesownmodel->get_child_skills($res1[0]['skill_id']);
		...
		$this->data["edu_level_list"] = $this->candidatesownmodel->edu_level_list();
		...
		$this->data["city_list"]                  = $this->candidatesownmodel->city_list();

		$this->data["pref_city_list"]             = $this->candidatesownmodel->pref_city_list();

		$this->data["industry_list"]              = $this->candidatesownmodel->industries_list();

		$this->data["department_list"]            = $this->candidatesownmodel->functional_list();
		...
		//$this->data["roles_list"]                 = $this->candidatesownmodel->fill_roles();
		...
		$this->data['job_folders']=$this->candidatesownmodel->get_job_folders();

		$this->data['job_status_list']=$this->candidatesownmodel->get_job_status();

		

		

		$this->data["edu_spec_list"] = $this->candidatesownmodel->edu_spec_list();

		$this->data["years_list"] = $this->candidatesownmodel->years_list();

		

		$this->load->view('include/header',$this->data);

		$this->load->view('candidates_own/candidateslist',$this->data);				
	...
	{	
		...
		$this->data['job_status']                 =$this->candidatesownmodel->get_job_status();

		$this->data["current_ctc"]               = $this->candidatesownmodel->current_ctc();
		$this->data["expected_ctc"]               = $this->candidatesownmodel->expected_ctc();

		

		$this->data["edu_course_list"]            = $this->candidatesownmodel->edu_course_list();
		...
		$this->data["months_list"]                = $this->candidatesownmodel->months_list();	
		...
		$this->load->view('candidates_own/addcandidates',$this->data);	
	...
	function addCandidate(){
		...
		{ 
			...
			$id = $this->candidatesownmodel->insert_candidate_record();
			...
			if ($id != '') { 			
				...
				if(isset($_FILES['cv_file'])){
					...
					{       				
...

						{
							...
							$this->candidatesownmodel->insert_files($dataArr);
				...
				if(isset($_FILES['client_cv_file'])){
					...
					{       				
						...
						$config['upload_path'] = '../rms/uploads/client_cvs/';
	...
	function update_candidate_profile()
	{
		if( $this->input->post('candidate_id')!='')
		{
			...
			$data_job = array(
					...
					'salary_id_ctc'         => $this->input->post('current_ctc'),
					'salary_id_ectc'        => $this->input->post('expected_ctc'),
					'salary_take_home'      => $this->input->post('salary_take_home'),
					'salary_take_home_exp'  => $this->input->post('salary_take_home_exp'),
					'salary_negotiable'     => $this->input->post('salary_negotiable'),
					'salary_proof'          => $this->input->post('salary_proof'),
					'ref_name'              => $this->input->post('ref_name'),
					'ref_desig'             => $this->input->post('ref_desig'),
					'ref_mobile'            => $this->input->post('ref_mobile'),
					'abroad_preference'     => $this->input->post('abroad_preference'),
			...
			$this->candidatesownmodel->update_candidate_record($candidate_id,$data_profile,$data_job);

			//$this->candidatesownmodel->update_role_designation($candidate_id, $this->input->post('desig_id'));

			//$this->candidatesownmodel->update_job_location($candidate_id, $this->input->post('pref_city_id'));	

			//$this->candidatesownmodel->update_industry($candidate_id, $this->input->post('job_cat_id'));	

			//$this->candidatesownmodel->update_functional_area($candidate_id, $this->input->post('func_id'));

			//$this->candidatesownmodel->update_qualification_level($candidate_id, $this->input->post('level_id'));

					

					

			redirect('candidates_own/summary/'.$candidate_id.'?upd=1');
	...
	function summary($candidate_id)
	{
		...
		$this->data["formdata"]               = $this->candidatesownmodel->get_single_record($candidate_id);		
		$this->data["formdata"]['desig_id']      = $this->candidatesownmodel->get_role($candidate_id);
		$this->data["formdata"]['func_id']       = $this->candidatesownmodel->get_functional_area($candidate_id);
		$this->data["formdata"]['job_cat_id']    = $this->candidatesownmodel->get_industry($candidate_id);

		$this->data['pref_candidate_locations']    = $this->candidatesownmodel->pref_candidate_locations($candidate_id);

		$this->data['job_folders']            = $this->candidatesownmodel->get_job_folders();

		$this->data['visa_type_list']         = $this->candidatesownmodel->visa_type_list();

		$this->data['job_status']             = $this->candidatesownmodel->get_job_status();

		$this->data["designation_list"] = $this->candidatesownmodel->designation_list();
		...
		$this->data['candidate_roles'] =$this->candidatesownmodel->candidate_roles($candidate_id);

		

		$this->data["edu_level_list"]   = $this->candidatesownmodel->edu_level_list();

		$this->data['qualification_level'] =$this->candidatesownmodel->qualification_level($candidate_id);

		

		$this->data['candidate_languages']    = $this->candidatesownmodel->candidate_languages($candidate_id);

		$this->data['education_details']      = $this->candidatesownmodel->education_deatils($candidate_id);

        

		$this->data['proj_history']      = $this->candidatesownmodel->project_details($candidate_id);

        

		$this->data['job_history']            = $this->candidatesownmodel->job_list($candidate_id);

		$this->data['followup_history']       = $this->candidatesownmodel->get_followup_detail($candidate_id);

		$this->data['candidate_license_type'] =$this->candidatesownmodel->candidate_license_type($candidate_id);

		$this->data['all_calls']              = $this->candidatesownmodel->all_calls($candidate_id);

	

		$this->data['all_messages']           = $this->candidatesownmodel->all_messages($candidate_id);

		$this->data['all_notes']              = $this->candidatesownmodel->all_notes($candidate_id);

	

		$this->data['candidate_skill']        = $this->candidatesownmodel->candidate_skills($candidate_id);

		

		//candidate doamin knowledge

		$this->data['candidate_domain']       = $this->candidatesownmodel->candidate_domains($candidate_id);

		$this->data['admin_user_list']        =$this->candidatesownmodel->admin_user_list();

		//Certification 

		

		$this->data['cerifications']          =$this->candidatesownmodel->get_cert();

		$candidate_certifications             = $this->candidatesownmodel->candidate_certifications($candidate_id);
		...
		$this->data['candidate_questionnaire_summary'] = $this->candidatesownmodel->get_survey_result($candidate_id);

		$this->data['candidate_files_summary']         = $this->candidatesownmodel->get_files($candidate_id);

		$this->data['candidate_complaints_summary']    = $this->candidatesownmodel->ticket_list($candidate_id);



		//Job Search details(candidate_job_serach)

		$this->data['job_search'] = $this->candidatesownmodel->job_search($candidate_id);		
		...
		$candidate_skills = $this->candidatesownmodel->candidate_skills($candidate_id);
		...
		$this->data['all_child_skills']	=	$this->candidatesownmodel->child_skills();
		...
		$this->data['lang_list']=$this->candidatesownmodel->get_language_set();

		$candidate_languages =$this->candidatesownmodel->candidate_languages($candidate_id);

		

		$this->data['candidate_locations'] =$this->candidatesownmodel->candidate_locations($candidate_id);

		$this->data['candidate_industries'] =$this->candidatesownmodel->candidate_industries($candidate_id);

		$this->data['candidate_functional_areas'] =$this->candidatesownmodel->candidate_functional_areas($candidate_id);
		...
		$this->data["edu_years_list"]   = $this->candidatesownmodel->edu_years_list();
		...
		$this->data["edu_univ_list"] = $this->candidatesownmodel->edu_univ_list();

		$this->data["edu_course_type_list"] = $this->candidatesownmodel->edu_course_type_list();
		...
		$this->data["industries_list"] = $this->candidatesownmodel->industries_list();

		$this->data["functional_list"] = $this->candidatesownmodel->functional_list();
		...
		$this->data["current_location_list"] 	= $this->candidatesownmodel->city_list();		

		

		$this->data["currecy_list"] = $this->candidatesownmodel->currency_list();
		...
		$this->data['suggested_jobs']=$this->candidatesownmodel->get_suggested_jobs($candidate_id);	

		//applied jobs of candidate		

		$this->data['applied_jobs']=$this->candidatesownmodel->get_job_list($candidate_id);

		//shortlisted jobs

		$this->data['shortlisted']=$this->candidatesownmodel->get_shortlisted($candidate_id);

		//interview scheduled jobs

		$this->data['interview_list']=$this->candidatesownmodel->get_interview_list($candidate_id);

		//selected jobs

		$this->data['jobs_selected']=$this->candidatesownmodel->jobs_selected($candidate_id);

		//offer letters issued

		$this->data['offer_letters_issued']=$this->candidatesownmodel->offer_letters_issued($candidate_id);		

		//offer accepted

		$this->data['offer_accepted']=$this->candidatesownmodel->offer_accepted($candidate_id);

		//invoice genereted

		$this->data['invoice_generated']=$this->candidatesownmodel->invoice_generated($candidate_id);
		...
		$this->data['contract']=$this->candidatesownmodel->get_contract_detail($candidate_id);
...
/*--------------------------------------------------------------------------*/		
	...
	//category 
		...
		$category = $this->candidatesownmodel->get_cat_fun_list($candidate_id);
	...
	// funcional area
		...
		$function = $this->candidatesownmodel->get_cat_fun_list($candidate_id);
...
//primary_skills
		...
		$candidate_skills_primary = $this->candidatesownmodel->candidate_skills_primary($candidate_id);
...
//secondary skills
		...
		$candidate_skills_secondary = $this->candidatesownmodel->candidate_skills_secondary($candidate_id);
...
//Language Deatails pms_candidate_language
		...
		$this->data['lang_details'] = $this->candidatesownmodel->get_lang_details($candidate_id);
...
/*--------------------------------------------------------------------------*/
		...
		if($this->input->post('candidate_id')!=''){
...

				{
					...
					$this->db->where('vendor_id',$val);

					$this->db->where('candidate_id',$this->input->post('candidate_id'));

					$this->db->delete('pms_candidate_to_vendors');
...

						{
							...
							$this->db->insert('pms_candidate_to_vendors',$data);

						}

				}

			redirect('candidates_own/summary/'.$candidate_id);
		...
		$this->load->view("candidates_own/candidate_summary",$this->data);
...
//Loading Models
		...
		$this->data["formdata"] = $this->candidatesownmodel->get_single_record($id);
...
//Certification and Technical Skilss
		...
		$candidate_certifications = $this->candidatesownmodel->candidate_certifications($id);
...
//skills
		...
		$candidate_skills = $this->candidatesownmodel->candidate_skills($id);
		...
		$this->data['domain']=$this->candidatesownmodel->get_domain();

		$candidate_domain = $this->candidatesownmodel->get_domain_details($id);
...
//Planning Job Change Details
		...
		$this->data["formdata8"] = $this->candidatesownmodel->job_search($id);
...
//Language Deatils
		...
		$candidate_certifications =$this->candidatesownmodel->candidate_languages($id);
...
//Contact Details
		...
		$this->data["formdata3"] = $this->candidatesownmodel->get_address_single_record($id);
		...
		$this->data["country_list"] = $this->candidatesownmodel->country_list();

		$this->data["formdata4"] = $this->candidatesownmodel->get_passport_single_record($id);
		...
		$this->data["edu_coll_list"]        = $this->candidatesownmodel->edu_coll_list();

		$this->data["edu_course_type_list"] = $this->candidatesownmodel->edu_course_type_list();

		$this->data["formdata5"]            = $this->candidatesownmodel->get_education_single_record($id);
...
//Job Details
		...
		$this->data["industry_list"] = $this->candidatesownmodel->industry_list();
		...
		$this->data["formdata6"] = $this->candidatesownmodel->get_job_single_record($id);
...
//FILE DEATILS
		...
		$this->data['survey_result']=$this->candidatesownmodel->get_survey_result($id);

		$this->data["formdata7"] = $this->candidatesownmodel->get_file_single_record($id);
		...
		$this->data["formdata"]['profile_list'] = $this->candidatesownmodel->profile_list($id);
		...
		$this->load->view('candidates_own/editcandidates_auto_complete',$this->data);	
...

	{
		...
		$this->data["personal"] = $this->candidatesownmodel->get_single_record($id);
	...
	function loadContacthtml($id) {
		...
		$this->data["religion_list"]    = $this->candidatesownmodel->religion_list();
        ...
        $this->load->view('candidates_own/addcontactdetail', $this->data);
	...
	function skip_step2($candidateId){
		...
		//$this->candidatesownmodel->insert_contact_detail_skip($candidateId);		
...

	{
		...
		$id  = $this->candidatesownmodel->insert_contact_detail($candidateId);

		$uid = $this->candidatesownmodel->update_contact_detail($candidateId);
	...
	function loadPassporthtml($id){
		...
		$this->data["formdata"]=$this->candidatesownmodel->get_passport_details($id);

		$this->data["visatype_list"] = $this->visatypemodel->visatype_list();

		$this->data["country_list"] = $this->candidatesownmodel->country_list();

		$this->load->view('candidates_own/addpassportdetail', $this->data);
	...
	function addPassportDetail($candidateId){
		...
		$uid = $this->candidatesownmodel->update_passport_detail($candidateId);
	...
	function loadEducationhtml($id){
		...
		$this->load->view('candidates_own/addeducationdetail',$this->data);
	...
	function skip_step4($candidateId){
		...
		//$this->candidatesownmodel->insert_education_detail_skip($candidateId);
...

	{
		...
		$id  = $this->candidatesownmodel->insert_education_detail($data);
	...
	function loadJobhtml($id){
		...
		$this->load->view('candidates_own/addjobdetail', $this->data);
	...
	function skip_step5($candidateId){
		...
		//$this->candidatesownmodel->insert_job_detail_skip($candidateId);
...

	{
		...
		$id  = $this->candidatesownmodel->insert_job_detail($candidateId);

		$uid = $this->candidatesownmodel->update_job_detail($candidateId);
...

	{
		...
		$this->load->view('candidates_own/addfiledetail', $this->data);
...

	{
...

		{
			...
			redirect('candidates_own/summary/'.$this->input->post('candidate_id'));

		}else

		{

			redirect('candidates_own');
	...
	function connect_with_jobs(){
		...
		{			
			...
			$this->data['candidate_profile']=$this->candidatesownmodel->get_single_profile($this->data['candidate_id']);

			$this->data["jobs_list"] = $this->candidatesownmodel->fill_job_list($this->data['candidate_id']);

			

			$this->data['candidate_locations'] =$this->candidatesownmodel->candidate_locations($this->data['candidate_id']);

			$this->data['candidate_industries'] =$this->candidatesownmodel->candidate_industries($this->data['candidate_id']);

			$this->data['candidate_functional_areas'] =$this->candidatesownmodel->candidate_functional_areas($this->data['candidate_id']);

			$this->data['candidate_roles'] =$this->candidatesownmodel->candidate_roles($this->data['candidate_id']);

			$this->data['job_search'] = $this->candidatesownmodel->job_search($this->data['candidate_id']);
		...
		$this->load->view('candidates_own/get_connect_jobs',$this->data);			
...

		{
			...
			{	
...

				{
					...
					$this->candidatesownmodel->update_job_vacancy($candidate_id,$val);	
...
function profile_completion($candidateId)
	...
	function editCandidate(){
        ...
        $this->candidatesownmodel->update_candidate_record($candidateId);
	...
	function loadEditContacthtml($id){
        ...
        $this->load->view('candidates_own/editcontactdetail', $this->data);
	...
	function editCandidateDetail($candidateId){
        ...
        $this->candidatesownmodel->edit_contact_detail($candidateId);
	...
	function loadEditPassporthtml($id){
		...
		$this->data["formdata"] = $this->candidatesownmodel->get_passport_single_record($id);

		$this->load->view('candidates_own/editpassportdetail', $this->data);
...

	{
        ...
        $this->candidatesownmodel->edit_passport_detail($candidateId);
...

	{
		...
		$this->data["formdata"] = $this->candidatesownmodel->get_education_single_record($this->data['edu_id']);
		...
		$data=$this->load->view('candidates_own/editeducationdetail',$this->data,true);
...
//EDUCATION DETAILS
...

	{
		...
		$edu_level = $this->candidatesownmodel->edu_level_list();

		

		$course = $this->candidatesownmodel->edu_course_list();



		$spec = $this->candidatesownmodel->edu_spec_list();
		...
		$results = $this->candidatesownmodel->get_education_details($id);
		...
		$education_details_view	=	$this->load->view('candidates_own/education_details',$this->data,true);
...

	{
		...
		$this->candidatesownmodel->update_education($data,$this->input->post('edu_id'),$this->input->post('candidate_id'));

//        $status = array("STATUS" => "1", "SUCCESS_ID" => $candidateId);

		redirect('candidates_own/summary/'.$this->input->post('candidate_id').'?edu_upd=1');
...

	{
        ...
        $this->candidatesownmodel->edit_education_detail($candidateId);
...

	{
        ...
        $this->candidatesownmodel->edit_job_change_detail($candidateId);

		 $this->candidatesownmodel->edit_passport_num_type($candidateId);
...

	{
		...
		$this->data["formdata"] = $this->candidatesownmodel->get_job_single_record($this->data['job_profile_id']);
		...
		$output_string=$this->load->view('candidates_own/editjobdetail', $this->data,true);
    ...
    function loadEditProjhtml()

	{

		$this->data['project_id'] = $this->input->get('project_id');
		...
		$this->data["formdata"] = $this->candidatesownmodel->get_proj_single_record($this->data['project_id']);
...

		{
			...
			$this->data['formdata']['project_title'] = '';

			$this->data['formdata']['project_links'] = '';

			$this->data['formdata']['project_desc'] = '';

			$this->data['formdata']['tech_used'] = '';	
		...
		$output_string=$this->load->view('candidates_own/editprojdetail', $this->data,true);
...
//JOB DETAILS
...

	{
		...
		$industry_list = $this->candidatesownmodel->industry_list();

		$functional_list = $this->candidatesownmodel->functional_list();



		

		$results = $this->candidatesownmodel->get_job_details($id);
		...
		$job_details_view	=	$this->load->view('candidates_own/job_details',$this->data,true);
...

	{
...

		{
			...
			$this->candidatesownmodel->add_consultant_feedback($data,$this->data['candidate_id']);
...

	{
		...
		$this->data["package_list"]         = $this->candidatesownmodel->fill_package();

		$this->data['candidate_id']         =$this->input->post('candidate_id');

		$this->data['feedback']             =$this->candidatesownmodel->get_consultant_feedback($this->data['candidate_id']);

		$output_html                        =$this->load->view('candidates_own/consultant_feedback',$this->data,true);	
...

	{
...

		{
			...
			$this->candidatesownmodel->add_candidates_notes($data);
...

	{
		...
		$this->data['note_list']            =$this->candidatesownmodel->select_all_notes($this->data['candidate_id']);

		$output_html                        = $this->load->view('candidates_own/all_notes',$this->data,true);	
...

	{
        ...
        $job_profile_id=$this->candidatesownmodel->update_job_details($data,$job_profile_id,$candidate_id);

		

		redirect('candidates_own/summary/'.$candidate_id.'?prof_upd=1');
...

	{
				...
				'tech_used' => $this->input->post('tech_used'),
        ...
        $project_id=$this->candidatesownmodel->update_proj_details($data,$project_id,$candidate_id);

		

		redirect('candidates_own/summary/'.$candidate_id.'?proj_upd=1');
	...
	function loadEditFilehtml($id){
		...
		$this->data["formdata"] = $this->candidatesownmodel->get_file_single_record($id);	



		$this->load->view('candidates_own/editfiledetail', $this->data);
    ...
    {    
...

        {
			...
			$this->load->view('candidates_own/import_csv',$this->data);                
...

				{
						...
						$result	=	$qry->row_array(); 
...

							{
								...
								$id = $this->candidatesownmodel->insert_csv_records($data);
								...
								$this->candidatesownmodel->insert_csv_pre_jobdata($data1);
								...
								$this->candidatesownmodel->insert_csv_address($data2);	
								...
								{								
									...
									$this->candidatesownmodel->insert_csv_levels($data3);
    ...
    {    
...

        {
			...
			$this->load->view('candidates_own/import_csv_linkedin',$this->data);                
...

        {
               ...
               $res = $contacts[$i];
...

				{
...

					{
						...
						$this->candidatesownmodel->insert_csv_job($data2);
			...
			redirect('candidates_own/import_csv_linkedin/?csv=1');
...

		{
...

				{
...

					{
						...
						$company_id=$this->candidatesownmodel->insert_csv_company($company_list);
    ...
    {    
...

		{
			...
			{				
				...
				$this->candidatesownmodel->insert_csv_job($job_profile);																
...
/*				$data=array(
    ...
    {    
		...
		$this->load->view('candidates_own/import_xml',$this->data);                
...

	{
		...
		$this->data['detail_list'] = $this->candidatesownmodel->detail_list($candidate_id);
...

		{
			   ...
			   redirect('candidates_own/candidate_view/'.$this->input->post('candidate_id'));

		}



		$this->data['list']               =$this->candidatesownmodel->follow_record($candidate_id);

		$this->data['note_list']          =$this->candidatesownmodel->notes_record($candidate_id);		

		$this->data['coe_list']           =$this->candidatesownmodel->coe_list($candidate_id);

		$this->data['visa_approval_list'] =$this->candidatesownmodel->visa_approval_list($candidate_id);



		$this->data['interview_list']     =$this->candidatesownmodel->interview_record($candidate_id);

		$this->data['aplication_list']    =$this->candidatesownmodel->aplication_record($candidate_id);

		

		$this->data['interview_status_list']=$this->candidatesownmodel->interview_status_list();		

		

		$this->data['app_list']           =$this->candidatesownmodel->aplication_list($candidate_id);

		$this->data['app_list_coe']       =$this->candidatesownmodel->select_aplication_coe($candidate_id);

		$this->data['admin_user_list']    =$this->candidatesownmodel->admin_user_list();

		$this->data['interview_type_list']=$this->candidatesownmodel->interview_type_list();

		$this->data['university_list']    =$this->candidatesownmodel->university_list();

		$this->data['campus_list']        =array('' => 'Select Campus');

		$this->data['intake_list']        =$this->candidatesownmodel->intake_list();

		$this->data['course_list']        =array('' => 'Select Course');;

		$this->data['level_list']         =$this->coursemodel->fill_levels();

		$this->data['status_list']        =$this->candidatesownmodel->status_list();
		...
		$this->load->view("candidates_own/candidate_view",$this->data);
...

	{
...

		{
			...
			$this->candidatesownmodel->remove_job_app($this->input->get('candidate_id'),$this->input->get('job_id'));

			redirect('candidates_own/summary/'.$this->input->get('candidate_id').'?upd=1');
...

	{
		...
		// update suggestion logic from here
			...
			$this->candidatesownmodel->update_suggestion_module($this->input->post('candidate_id'), $this->input->post('campus_id'), $this->input->post('course_id'), $this->input->post('total_semester'), $this->input->post('fee_per_semester'), $this->input->post('annual_tution_fee'), $this->input->post('total_tution_fee'),$this->input->post('candidate_course_id'));

		// end here	

					

			redirect('candidates_own/candidate_programs/'.$this->input->post('candidate_id').'/?upd=1');
...
if($this->input->get('education')!='')
...

		{
			...
			$this->data['single_application']['app_details']=$this->candidatesownmodel->create_program_name($this->data['single_application']['course_id']);
		...
		$this->data['aplication_list']=$this->candidatesownmodel->aplication_record($candidate_id); // application lists - 	

		$this->data['detail_list'] = $this->candidatesownmodel->detail_list($candidate_id); // candidate details

		$this->data['university_list']=$this->candidatesownmodel->university_list(); // university list		

		$this->data['intake_list']=$this->candidatesownmodel->intake_list(); // intake list 		

		$this->data['level_list']=$this->coursemodel->fill_levels(); // education levels

		$this->data['status_list']=$this->candidatesownmodel->status_list(); // application process status list
		...
		if($this->data['single_application']['univ_id']>0)
			...
			$this->data['campus_list']=$this->candidatesownmodel->campus_list($this->data['single_application']['univ_id']);

		if($this->data['single_application']['level_study']>0)

			$this->data['course_list']=$this->candidatesownmodel->course_list_level($this->data['single_application']['level_study']);

			

		$this->data['candidate_qualification_list']=$this->candidatesownmodel->candidate_qualification_list($candidate_id); 
...

		{
			...
			$this->data['single_application']=$this->candidatesownmodel->select_aplication_record($this->input->get('app_id'));

			if(count($this->data['single_application'])>0)

			{

				if($this->data['single_application']['univ_id']>0)$this->data['campus_list']=$this->candidatesownmodel->campus_list($this->data['single_application']['univ_id']);

				if($this->data['single_application']['level_study']>0)$this->data['course_list']=$this->candidatesownmodel->course_list_level($this->data['single_application']['level_study']);
		...
		$this->load->view("candidates_own/candidate_programs",$this->data);
...

	{
		...
		$this->data['aplication_list']=$this->candidatesownmodel->select_aplication_record($id);		
...

	{
		...
		$this->load->view("candidates_own/candidate_coe",$this->data);
...

	{
		...
		$this->data['app_list_coe']=$this->candidatesownmodel->select_aplication_visa($candidate_id);
...
// Manage Email & SMS
...

	{
		...
		$this->data['email_sms_list']=$this->candidatesownmodel->email_sms_list($candidate_id);
...

		{
			...
			redirect('candidates_own/email_sms/'.$candidate_id);
		...
		$this->load->view("candidates_own/candidate_email_sms",$this->data);
...
// Schedule an interview
	...
	function interview(){
		...
		$this->data['interview_list']=$this->candidatesownmodel->select_interview_record($id);
...

	{
	   ...
	   $this->data['error']='';
		...
		$this->data['detail_list'] = $this->candidatesownmodel->detail_list($candidate_id);
			...
			$this->data['ticket_list']=$this->candidatesownmodel->ticket_list($candidate_id);
...

			{
				...
				redirect('candidates_own/tickets/'.$candidate_id);
			...
			$this->load->view("candidates_own/candidate_complaints",$this->data);
...

	{
		...
		$this->data['all_counselor'] = $this->candidatesownmodel->all_counselor($candidate_id);

		$this->data['candidate_counselor'] = $this->candidatesownmodel->candidate_counselor($candidate_id);
...

		{
			...
			$this->load->view("candidates_own/candidate_invoice",$this->data);
...

	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidatesownmodel->cvfile_list($candidate_id);
		...
		if($this->input->post('cvfile')!=''){
			...
			redirect('candidates_own/cvfile/'.$candidate_id);
			...
			$this->load->view("candidates_own/candidate_cvfile",$this->data);
...

	{
		...
		$this->data['cv_fileist']=$this->candidatesownmodel->job_list($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			...
			redirect('candidates_own/job_history/'.$this->input->post('candidate_id'));
			...
			$this->load->view("candidates_own/candidate_job_history",$this->data);
...

	{
	   ...
	   $this->data['error']='';
		...
		$this->data['cv_fileist']=$this->candidatesownmodel->education_list($candidate_id);
...

		{
			...
			redirect('candidates_own/edu_history/'.$this->input->post('candidate_id'));
			...
			$this->load->view("candidates_own/candidate_edu_history",$this->data);
    ...
    function proj_history_2($candidate_id)
...

	{
		...
		$this->data["formdata"] = $this->candidatesownmodel->get_passport_single_record($candidate_id);
		...
		$candidate_certifications =$this->candidatesownmodel->candidate_languages($candidate_id);
		...
		if($this->input->post('candidate_id')!=''){
			   ...
			   $this->candidatesownmodel->edit_passport_detail($this->input->post('candidate_id'));

			   redirect('candidates_own/lang_history/'.$this->input->post('candidate_id'));
...

		{
			...
			$this->load->view("candidates_own/candidate_lang_history",$this->data);
...

	{
		...
		$this->data['survey_result']=$this->candidatesownmodel->get_survey_result($candidate_id);
...

		{
			   ...
			   redirect('candidates_own/questionnaire/'.$this->input->post('candidate_id').'?cv_file='.$cv_file.'&photo_file='.$photo_file);
			...
			$this->load->view("candidates_own/candidate_questionnaire",$this->data);
...
// tech skills
...

	{
...

		{
...

			{
			   ...
			   redirect('candidates_own/skills/'.$this->input->post('candidate_id').'?upd=1');

		}



		$this->data['skill_list']=$this->candidatesownmodel->get_skill_set();

		$this->data['skill_list_current']=$this->candidatesownmodel->get_skill_set_candidate($candidate_id);
		...
		$this->load->view("candidates_own/candidate_skills",$this->data);
...

	{
...

		{
			...
			$this->candidatesownmodel->insert_cert_details($this->input->post('candidate_id'));

			redirect('candidates_own/summary/'.$this->input->post('candidate_id').'?upd=1');
...

	{
...

		{
			...
			$this->candidatesownmodel->insert_skill_details($this->input->post('candidate_id'));
...
function certifications($candidate_id)

	{
...

		{
...

			{
			   ...
			   redirect('candidates_own/certifications/'.$this->input->post('candidate_id').'?upd=1');

		}



		$this->data['certifications_list']=$this->candidatesownmodel->get_certifications_set();

		$this->data['certifications_list_current']=$this->candidatesownmodel->get_certifications_set_candidate($candidate_id);
		...
		$this->load->view("candidates_own/candidate_certifications",$this->data);
...

	{
...

		{
			...
			/*$this->data['single_list']=$this->candidatesownmodel->select_record($id);

		

			$dataArr = $this->load->view('candidates_own/candidatefollowup_list', $this->data,TRUE);
	...
	$this->data['note_list']=$this->candidatesownmodel->select_notes_record($id);

	$dataArr = $this->load->view('candidates_own/candidatenotes_list', $this->data,TRUE);
	...
	function visa_approval(){
		...
		$this->data['aplication_list']=$this->candidatesownmodel->select_aplication_coe($id);

		$dataArr = $this->load->view('candidates_own/candidate_aplication_list', $this->data,TRUE);
	...
	function drop(){
		...
		$this->load->model('candidatesownmodel');
		 ...
		 $this->candidatesownmodel->drop_record($candidate_follow_id);

		$dataArr = $this->load->view('candidates_own/candidate_view');
	...
	function cvfile_drop(){
		...
		$this->candidatesownmodel->cvfile_drop_record($cvfile_id);		          
...

	{
		...
		$this->candidatesownmodel->drop_job_item($job_profile_id);
...

	{
		...
		$this->candidatesownmodel->drop_job_item($job_id);
...
//DELETE EDUCATION DETAILS
...

	{
		...
		$this->candidatesownmodel->drop_edu_item($edu_id);
...

	{
		...
		$this->candidatesownmodel->drop_email_sms_item($email_sms_id);
...

	{
		...
		$this->candidatesownmodel->drop_ticket_item($ticket_id);
	...
	function drop_edu_item(){
		...
		$this->candidatesownmodel->drop_edu_item($eucation_id);
	...
	function drop_notes(){
		...
		$this->candidatesownmodel->note_drop_record($candidate_note_id);
	 ...
	 function drop_interviews(){
		...
		$this->candidatesownmodel->interview_drop_record($interview_id);
	 ...
	 function drop_aplication(){
		...
		$this->candidatesownmodel->aplication_drop_record($app_id);
...

	   {
...

			 {
...

					{
						...
						$id=$this->candidatesownmodel->insert_file($candidate_id);

						redirect('candidates_own/candidate_file/'.$this->input->post('candidate_id'));
		...
		$this->data['file_list']=$this->candidatesownmodel->file_list($candidate_id);

		$this->load->view("include/header",$this->data);

		$this->load->view("include/candidate_sidebar",$this->data);

		$this->load->view("candidates_own/manage_files",$this->data);
...
/*			echo '<pre>';
		...
		$this->load->view("candidates_own/csv_data_import",$this->data);
...

	   {
...

		 {
...

					{
						...
						$this->data['upload_list']=$this->candidatesownmodel->get_one_record($id);

						$replay=$this->load->view("candidates_own/upload_file",$this->data,TRUE);
...

					{
						...
						redirect("candidates_own/candidate_file");
	...
	function img_update(){
	 ...
	 if(isset($_FILES['photo'])){
						  ...
						  $this->load->model('candidatesownmodel');
						   ...
						   $this->candidatesownmodel->update_file($candidate_id);

	

							 $this->data['single_file']=$this->candidatesownmodel->get_one_file($candidate_id);
...

	{
...

		{
			          ...
			          $this->load->model('candidatesownmodel');
					   ...
					   $this->candidatesownmodel->delete_file($id);

					    $this->data['delete_file']=$this->candidatesownmodel->delete_one_file($id);

						

                           echo $this->data['delete_file']['photo'];  //$replay=$this->load->view("candidates_own/delete_file",$this->data,TRUE);
...

	{
...

		{
			...
			redirect("candidates_own/summary/".$id."?del_cv=1");

		}else

		{

			redirect("candidates_own/summary/".$id);
...

	{
...

		{
			...
			$this->candidatesownmodel->candidate_delete($id);

			redirect('candidates_own/?del=1');
...
//onchange get function	
	...
	{		
...

		{
			...
			$data["function_list"] = $this->candidatesownmodel->function_list_by_category($_POST['category_id']);
...
//onchange getlocation
...

	{
...

		{
			...
			$id = $this->candidatesownmodel->add_to_job($candidatesArr[$i],$job_id);
...
// email ends here	
...

	{
		...
		if($id=='')redirect('candidates_own');

		if($this->input->get('reg_status')=='')redirect('candidates_own');

		$this->db->query("update pms_candidate set reg_status=".$this->input->get('reg_status')." where candidate_id=".$id);

		redirect('candidates_own?status=1');
...

	{
...

		{
			...
			redirect("candidates_own/summary/".$id."?del_photo=1");
...
//APPLY JOB
...

	{
        ...
        $this->candidatesownmodel->apply_job($candidateId,$jobId);

		}

		redirect("candidates_own/summary/".$candidateId);
	...
	{ 
		...
		$this->load->model('candidatesownmodel');
	 	...
	 	$id  = $this->candidatesownmodel->insert_skill_details($candidateId);

		

		$id  = $this->candidatesownmodel->insert_cert_details($candidateId);

		

		$id  = $this->candidatesownmodel->insert_domain_details($candidateId);
...
// email to candidate
	...
	{		
...

		{
			...
			$function_list = $this->candidatesownmodel->function_list_by_category_multiple($_POST['category_id']);
...
//EDIT Category and functional area
...

	{
		...
		$this->load->model('candidatesownmodel');
	 	...
	 	$id  = $this->candidatesownmodel->insert_functional($candidateId);
...
//EDIT PRIMARY AND SECONDARY SKILLS
...

	{
		...
		$this->load->model('candidatesownmodel');
	 	...
	 	$id  = $this->candidatesownmodel->insert_skills($candidateId);
...
//Add Contract Details
	...
	function add_contract_details($candidateId){
		...
		$uid = $this->candidatesownmodel->add_contract_detail($candidateId);
...

	{
		...
		$this->data['address'] = $this->candidatesownmodel->get_address($id);

		$this->data['education'] = $this->candidatesownmodel->education_list($id);

		$this->data['job_details'] = $this->candidatesownmodel->get_job_details($id);

		$this->data['language_skills'] = $this->candidatesownmodel->candidate_languages($id);

		$this->data['tech_skills'] = $this->candidatesownmodel->candidate_skills($id);

		$this->data['certification'] = $this->candidatesownmodel->candidate_certifications($id);

		$this->data['domain'] = $this->candidatesownmodel->candidate_domains($id);

		$this->data['sports'] = $this->candidatesownmodel->candidate_sports($id);

		$this->data['social'] = $this->candidatesownmodel->candidate_social($id);

		$this->data['contract'] = $this->candidatesownmodel->get_contract_detail($id);

		$this->data['formdata'] = $this->candidatesownmodel->get_lang_details($id);



		$this->data["profile_list"] = $this->candidatesownmodel->profile_list($id);
		...
		$this->load->view('candidates_own/print_cv',$this->data);	
...
//GET CANDIDATE EDUCATION
...

	{
		...
		$education_details = $this->candidatesownmodel->education_deatils($candidate_id);
			...
			$html2='<td colspan="2" align="center" valign="top" class="borderTopNone"> 
...

					 {
						...
						$html2.='<tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_own/delete_candidate_edu/?id='.$val['eucation_id'].'" id="delete_candidate_edu" class="btn btn-danger btn-xs">Delete</td>
...
//delete candidate education	
...

	{
		...
		$job_history = $this->candidatesownmodel->job_list($candidate_id);
					...
					<table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
					 ...
					 {	
						...
						$html2.=' <tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_own/delete_candidate_prof/?id='.$val['job_profile_id'].'" id="delete_candidate_prof" class="btn btn-danger btn-xs">Delete</td>
...
//delete candidate Professional details	
    ...
    function delete_candidate_proj()

	{

		

		$proj_id     = $this->input->get('id');	
...

		{
			...
			$result = $this->db->query('DELETE FROM pms_candidate_projects WHERE project_id ="'.$proj_id.'" ' );		
...

	{
		...
		$contract = $this->candidatesownmodel->get_contract_detail($candidate_id);
...

		{
			...
			$html2.=' <tr>
							...
							<td><a href="javascript:;"  data-url="'.base_url().'candidates_own/delete_candidate_contract/?id='.$contract['candidate_id'].'" id="delete_candidate_contract" >Delete</td>
...
// Manage Email 
...

	{
		...
		{			
			...
			$this->data["personal"] = $this->candidatesownmodel->get_candidate_profile($candidate_id);
...

	{
...

		{
			...
			$data["func_list"] = $this->candidatesownmodel->get_functional_by_industry($_POST['job_cat_id']);
...

	{
...

		{
			...
			$data["desig_list"] = $this->candidatesownmodel->get_designation_by_functional($_POST['func_id']);
	...
	function pre_screening(){
		...
		{			
			...
			$this->data['pre_screening']=$this->candidatesownmodel->get_pre_screening($this->data['candidate_id']);

			$this->data['admin_list'] = $this->candidatesownmodel->admin_recruiters_list();

			$this->data['company_list'] = $this->candidatesownmodel->company_list();
		...
		$this->load->view('candidates_own/pre_screening',$this->data);			
	...
	$arrival_date= date("Y-m-d",strtotime($this->input->post('arrival_date')));
...

		{
			...
			$this->candidatesownmodel->update_payment_status($data1, $this->input->post("candidate_id"));
...

			{
				...
				$this->candidatesownmodel->update_pre_screening($data, $this->input->post('pre_screen_id'), $this->input->post("candidate_id"));
...

			{
				...
				$this->candidatesownmodel->add_pre_screening($data);
