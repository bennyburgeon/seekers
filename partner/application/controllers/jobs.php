...
class Jobs extends CI_Controller {
	...
	{	
		...
		$this->data['total_rows']= $this->jobsmodel->record_count($searchterm,$job_status,$company_id,$job_priority,$package_id);
		...
		$config['base_url'] = $this->config->item('base_url')."jobs/?sort_by=$sort_by&searchterm=$searchterm$query_str&job_status=$job_status&company_id=$company_id&job_priority=$job_priority&package_id=$package_id";
		...
		$this->data["records"] = $this->jobsmodel->get_list($start,$limit,$searchterm,$sort_by,$job_status,$company_id,$job_priority,$package_id);
		...
		$this->data["package_list"] = $this->jobsmodel->package_list();
		$this->data["admin_list"]=$this->jobsmodel->admin_list();
		$this->data["package_list"]         = $this->jobsmodel->fill_package();
	...
	{	
		...
		$this->data["product_list"]           = array('' => 'Select Product');
		//$this->data["product_list"]         = $this->jobsmodel->product_list();
		$this->data["package_list"]         = $this->jobsmodel->fill_package();
		$this->data["jobindustry"]          = $this->jobsmodel->fill_jobcategory();
		
		
		$this->data["business_type"]        = $this->jobsmodel->business_type_list();		
		//$this->data["functional"]           = $this->jobsmodel->fill_functional();
		$this->data["functional"]           = array('' => 'Select Department');
		//$this->data["roles_list"]           = $this->jobsmodel->fill_roles();
		...
		//$this->data['skill_names'] =$this->jobsmodel->skill_names($this->input->post('parent'));
		...
		$this->data["intl_locations"]       = $this->jobsmodel->intl_locations_list();
		...
		if($this->input->post('job_title')!='' && $this->input->post('company_id') != '0' )
		{
			...
			{	
				...
				$job_skill=$this->jobsmodel->insert_skill_details($id,$this->input->post('skills'));
				...
				'job_skill_name'      => $this->input->post('skills'),
	...
	function edit($id=null)
	{
		...
		if(intval($this->data['formdata']['company_id'])>0)	
		
		$this->data["product_list"] = $this->jobsmodel->product_list($this->data['formdata']['company_id']);
		...
		if($this->data['formdata']['job_cat_id']>0)
			$this->data["functional"]        = $this->jobsmodel->get_functional_by_industry($this->data['formdata']['job_cat_id']);
		else
			$this->data["functional"]        = array('' => 'Select Department');
			
		if($this->data['formdata']['func_id']>0)
			$this->data["roles_list"]        = $this->jobsmodel->get_designation_by_functional($this->data['formdata']['func_id']);
		else
			$this->data["roles_list"]            = array('' => 'Select Designation');
		...
		$this->data["country_list"] = $this->jobsmodel->country_list();
		$this->data['qualification_level'] =$this->jobsmodel->qualification_level($id);
		
		$this->data['skill_names'] =$this->jobsmodel->skill_names($this->data['formdata']['job_skills']);
		
		if($this->data['formdata']['job_skills'] !=0)
		{
		 	$this->data['childskill']=$this->jobsmodel->get_child_skills($this->data['formdata']['job_skills']);
		}
						
		if($this->data['formdata']['job_cat_id'] !=0)
		{
			$this->data["functional"] = $this->jobsmodel->function_list_by_category($this->data['formdata']['job_cat_id']);
		}
		if($this->data['formdata']['job_skills'] !=0)
		{
		 $this->data['childskill']=$this->jobsmodel->get_child_skills($this->data['formdata']['job_skills']);
			...
			if($this->input->post('job_title') && $this->input->post('comapny_id') == 0)
			{
				...
				//$this->form_validation->set_rules('job_title_dup', 'job name', 'callback_check_dups');
					if ($this->form_validation->run() == TRUE)
					{
						...
						$job_skill=$this->jobsmodel->insert_skill_details($this->input->post('job_id'),$this->input->post('skills'));
						$job_domain=$this->jobsmodel->insert_domain_details($this->input->post('job_id'),$this->input->post('domain_id'));
						$this->jobsmodel->update_qualification_level($this->input->post('job_id'), $this->input->post('level_id'));
	...
	public function getproduct()
	{
		...
		{
			$data=array();
			$data["product_list"] = $this->jobsmodel->product_list($_POST['company_id']);
			$data = array('success' => true, 'product_list' => $data["product_list"]);
		}else{
			$data = array('success' => false);
		}
		echo json_encode($data);
	...
	public function get_functional_by_industry()
	{
		...
		{
			$data=array();
			$data["func_list"] = $this->jobsmodel->get_functional_by_industry($_POST['job_cat_id']);
	...
	public function get_designation_by_functional()
	{
		...
		{
			$data=array();
			$data["desig_list"] = $this->jobsmodel->get_designation_by_functional($_POST['func_id']);
	...
	function save_assignment()
	{
		...
		if($this->input->post('job_id')!='')
		{
			...
			$this->db->delete('pms_jobs_to_recruiter');
		...
		{
			$this->db->where('job_id', $this->input->post('job_id'));
			$this->db->delete('pms_jobs_to_vendors');
				...
				if($this->input->post('vendor_id')!='')
				{
					...
					{
						 $val = $this->jobsmodel->add_vendor_to_job($this->input->post('job_id'),$val);
					}
				}
				}*/
	...
	function manage($id=null)
	{
		...
		if(!empty($id))
		{
            ...
            $this->data['formdata']['desig_name']=$this->jobsmodel->get_desig_name($this->data['formdata']['desig_id']);
            $this->data['formdata']['state_name']=$this->jobsmodel->get_state_name($this->data['formdata']['state_id']);
            $this->data['formdata']['city_name']=$this->jobsmodel->get_city_name($this->data['formdata']['job_location']);
            $this->data['formdata']['exp_range']=$this->jobsmodel->get_exp_range($this->data['formdata']['total_exp_needed']);
		...
		if($this->input->post('job_app_id')!='' && $this->input->post('candidate_id')!='')
		{
			...
			else
			{
				...
				$email_array=array(
					...
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_intrw_rjt',
				);
				//print_r($email_array); 
		...
		if($this->input->post('job_app_id')!='' && $this->input->post('candidate_id')!='')
		{
			...
			// Email start from here
				...
				$email_array=array(
					...
					'company_website'         =>  $this->config->item('company_website'),
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_job_shortlist',
				);
	...
	function send_shortlisted()
	{
		...
		{
			$job_details=$this->jobsmodel->get_job($this->input->post('job_id'));
			$user_details=$this->jobsmodel->get_user_info($_SESSION['vendor_session']);
	...
	function client_cv_doc()
	{
		...
		{			
			$candidate_id    =   $this->input->post('candidate_id');
			$this->data["personal"] = $this->jobsmodel->get_single_candiadte($candidate_id);
...
// upcoming contracts
	function upcoming_contracts($id=null)
	{
		...
		//paging starts here 
		$config['base_url'] = $this->config->item('base_url')."jobs/upcoming_contracts/".$id."/?";
		$config['page_query_string'] = TRUE;
		$config['total_rows'] = $this->data["total_rows"];
		$config['query_string_segment'] = 'rows';
		$config['per_page'] =50;
...
//INSTRUCTION AND GUIDE LINES
	...
	function search_candidate($id=null)
	{
		...
		//paging starts here 
		$config['base_url'] = $this->config->item('base_url')."jobs/search_candidate/".$id."/?";
		$config['page_query_string'] = TRUE;
		$config['total_rows'] = $this->data["total_rows"];
		$config['query_string_segment'] = 'rows';
		$config['per_page'] =50;
	...
	function send_mass_mail($id=null)
	{
		...
		//paging starts here 
		$config['base_url'] = $this->config->item('base_url')."jobs/send_mass_mail/".$id."/?";
		$config['page_query_string'] = TRUE;
		$config['total_rows'] = $this->data["total_rows"];
		$config['query_string_segment'] = 'rows';
		$config['per_page'] =50;
...
//		$headers.= "From: ".$email_array['from_name']." <".$email_array['email_from'].">\r\n";		
	...
	function upload_client_cv()
	{
		...
		if($candidate_id!='')
		{
			...
			redirect('jobs/manage/'.$this->input->post('job_id'));
		}else
		{
			redirect('jobs');
		}		
		...
		{		
			$this->jobsmodel->manage_rejection($this->input->post('job_app_id'),$this->input->post('job_id'));
				...
				$email_array=array(
					...
					'company_website'         =>  $this->config->item('company_website'),
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_job_rejected',
				);
				//print_r($email_array); 
		...
		if($this->input->post('job_app_id')!='' && $this->input->post('candidate_id')!='' && $this->input->post('title')!='' )
		{
			...
			// Email start from here
				...
				$email_array=array(
					...
					'company_website'         =>  $this->config->item('company_website'),
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_schedule_intrw',
				);
				//print_r($email_array); 
		...
		if($this->input->get('app_id')!='' && $this->input->get('candidate_id')!='')
		{
			...
			// Email start from here
				...
				$email_array=array(
					...
					'company_website'         =>  $this->config->item('company_website'),
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_intrw_select',
				);
				//print_r($email_array); 
			// EMAIL TO ADMIN
					$this->send_email($email_array);
    ...
    // Email start from here
				...
				$email_array=array(
					...
					'company_website'         =>  $this->config->item('company_website'),
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_ofr_reject',
				);
				//print_r($email_array); 
...
// Email start from here
				...
				$email_array=array(
					...
					'company_website'         =>  $this->config->item('company_website'),
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_ofr_ltr',
				);
				//print_r($email_array); 
		...
		if($this->input->post('app_id')!='' && $this->input->post('offer_accepted_date')!='' )
		{
			...
			// Email start from here
				...
				$email_array=array(
					...
					'company_website'         =>  $this->config->item('company_website'),
					'date'                   =>  date('d-m-Y'),
					'email_template'         =>  'jobs/email_template_ofr_accept',
				);
				//print_r($email_array); 
		...
		if($this->input->post('placement_id')!='' && $this->input->post('app_id')!='' && $this->input->post('candidate_id')!='' && $this->input->post('invoice_date')!='')
		{
		   ...
		   $html.=' <tr>
					  ...
					  <td width="11%">'.$client_candidate.'</td>
                       <td><a href="javascript:;"  data-url="'.base_url().'jobs/delete_invoice/?job_id='.$formdata['job_id'].'&placement_id='.$invoice['placement_id'].'&invoice_id='.$invoice['invoice_id'].'"  id="delete_invoice_candidate" class="btn btn-danger btn-xs" >X</a></td></tr>';
