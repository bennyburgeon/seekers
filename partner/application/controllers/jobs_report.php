...
class Jobs_report extends CI_Controller {
	...
	{	
		...
		$this->data['total_rows']= $this->jobs_reportmodel->record_count($searchterm);
		...
		$config['base_url'] = $this->config->item('base_url')."jobs_summary/?sort_by=$sort_by&$query_str&searchterm=$searchterm";
		...
		$this->data["records"] = $this->jobs_reportmodel->get_list($start,$limit,$sort_by,$searchterm);
		...
		$this->data['page_head'] = 'Job Process Report';				
