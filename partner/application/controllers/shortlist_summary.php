<?php 
class Shortlist_summary extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('shortlist_summary_model');
	...
	{	
		...
		if($this->input->get('shortlist_status'))
		{
			$this->data['shortlist_status']=$this->input->get('shortlist_status');
		}

		if($this->input->post('shortlist_status'))
		{
			$this->data['shortlist_status']=$this->input->post('shortlist_status');
		}
		
		
		$this->data['total_rows']= $this->shortlist_summary_model->record_count($this->data['search_name'],$this->data['shortlist_status']);
		...
		$config['base_url'] = $this->config->item('base_url')."shortlist_summary/?sort_by=".$this->data['sort_by']."&limit=".$this->data['limit']."&search_name=".$this->data['search_name']."&shortlist_status=".$this->data['shortlist_status'];
		...
		$this->data["records"] = $this->shortlist_summary_model->get_list($this->data['start'],$this->data['limit'],$this->data['search_name'],$this->data['sort_by'],$this->data['shortlist_status']);
		
			
		$this->data['page_head'] = 'Candidates Shortlist Report';
		
		
		$this->load->view('include/header',$this->data);
		$this->load->view('shortlist_summary/list',$this->data);
	...
	{
		$this->data["records"] = $this->shortlist_summary_model->get_calls_history($this->input->post('app_id'));
		$output_str='
