...
class Specialisation extends CI_Controller {
	...
	{	
		...
		$this->data['cur_page']=$this->router->class;
		$config['base_url'] = $this->config->item('base_url')."specialisation/?sort_by=$sort_by&limit=$limit&searchterm=".$this->data["searchterm"]."&course_id=".$this->data["course_id"]."&$query_str";
	...
	function edit($id=null)
	{
		...
		$query=$this->db->get('pms_specialisation');
