			...
			$html2='<td colspan="2" align="center" valign="top"> 
					 ...
					 foreach($education_details as $key => $val)
					 {
						...
						$html2.='<tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_all/delete_candidate_edu/?id='.$val['eucation_id'].'" id="delete_candidate_edu" >Delete</td>
         		 				</tr>';
					...
					<table width="95%" border="1" cellspacing="3" cellpadding="3">
					 ...
					 {	
						...
						$html2.=' <tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_all/delete_candidate_prof/?id='.$val['job_profile_id'].'" id="delete_candidate_prof" >Delete</td>
         		 				</tr>';
			...
			$html2='  <td colspan="2" align="center" valign="top">
					 ...
					 {	
						...
						$html2.=' <tr>
									...
									<td><a href="javascript:;"  data-url="'.base_url().'candidates_all/delete_candidate_followup/?id='.$val['candidate_follow_id'].'" id="delete_candidate_followup" >Delete</td>
         		 				</tr>';
