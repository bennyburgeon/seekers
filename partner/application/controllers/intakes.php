...
class Intakes extends CI_Controller {
	...
	{	
		...
		$config['base_url'] = $this->config->item('base_url')."intakes/?sort_by=$sort_by&searchterm=$searchterm$query_str";
	...
	function addinterview2()
	{
		...
		if($this->input->post('job_app_id')!='' && $this->input->post('candidate_id')!='' && $this->input->post('title')!='' )
		{
			...
			$html.=	'<tr>
						  ...
						  <td><a href="javascript:;"  data-url="'.base_url().'intakes/edit_interview/?job_app_id='.$interview['job_app_id'].'&candidate_id='.$interview['candidate_id'].'&intake_id='.$formdata['intake_id'].'"  id="edit_interview" >Change</a> |<a href="javascript:;"  data-url="'.base_url().'intakes/delete_interview_candidate/?job_app_id='.$interview['job_app_id'].'&candidate_id='.$interview['candidate_id'].'&intake_id='.$formdata['intake_id'].'"  id="delete_interview_candidate" >Remove </a>| <a href="'.base_url().'intakes/removeschedule/?intake_id=10&intid=12" target="_blank"> View Profile </a> | <a href="javascript:;"  onclick="select_candidate('.$interview['candidate_id'].','.$interview['job_app_id'].','.$formdata['intake_id'].')" > Select </a></td>';
						 ...
						 <tbody >					
						  ...
						  foreach($candidates_selected as $selected){
							  ...
							  $html.='<tr>
										  ...
										  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'intakes/delete_selectedcandidate/?job_app_id='.$selected['app_id'].'&candidate_id='.$selected['candidate_id'].'&intake_id='.$formdata['intake_id'].'"  id="delete_selected_candidate" >Remove </a>| <a href="'.base_url().'intakes/removeschedule/?intake_id=10&intid=12" target="_blank"> View Profile </a> | <a href="javascript:;" onclick="issue_offer('.$formdata['intake_id'].','.$selected['app_id'].','.$selected['candidate_id'].');" id="issue_offer"> Issue Offer </a></td>';
					 ...
					 foreach($applied_candidates as $candidate)
					 {
						...
						$html2.='<tr>
									...
									<td width="15%">'. $candidate['mobile'].'</td>
									  ...
									  <td width="25%"><a href="javascript:;"  onclick="create_program('.$candidate['candidate_id'].','.$id.');"  id="create_program"> Create Program </a>  | <a href="javascript:;"  data-url="'. base_url().'intakes/delete_applied_candidate/?intake_candidate_id='. $candidate['intake_candidate_id'].'&candidate_id='. $candidate['candidate_id'].'&intake_id='.$id.'"  id="delete_applied_candidate" > Delete Application</a></td>
					 ...
					 <table border="1" cellpadding="3" cellspacing="3" width="95%">
					  ...
					  <tr>
						...
						$html2.='<tr>
								  ...
								  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'intakes/delete_offercandidate/?job_app_id='.$offerletter['app_id'].'&candidate_id='.$offerletter['candidate_id'].'&intake_id='.$formdata['intake_id'].'"  id="delete_offer_candidate" >Remove </a>| <a href="'.base_url().'intakes/removeschedule/?intake_id=10&intid=12" target="_blank"> View Profile </a> | <a href="javascript:;" onclick="accept_offer('.$formdata['intake_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id'].');"> Accept Offer </a> | <a href="javascript:;" onclick="reject_offer('.$formdata['intake_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id'].');"> Reject Offer </a></td>';
		...
		if(!empty($offer_accepted)){
			...
			$html2='<td colspan="2" align="center" valign="top">
				...
				$html2.='<tr>
						  ...
						  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'intakes/delete_acceptcandidate/?intake_id='.$formdata['intake_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id'].'" id="delete_accept_candidate" >Remove </a>| <a href="'.base_url().'intakes/removeschedule/?intake_id=10&intid=12" target="_blank"> View Profile </a>| <a href="javascript:;" onclick="cert_attest('.$formdata['intake_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id'].');"> Certificate Attestation</a></td>';
		...
		if(!empty($get_cert_attest)){
			...
			$html2 =	'<td colspan="2" align="center" valign="top">
				...
				$html2.='<tr>
						  ...
						  <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="'.base_url().'intakes/delete_attest/?intake_id='.$formdata['intake_id'].'&app_id='.$cert_attest['app_id'].'&candidate_id='.$cert_attest['candidate_id'].'&cert_id='.$cert_attest['cert_id'].'" id="delete_attest" >Remove </a>| <a href="'.base_url().'intakes/removeschedule/?intake_id=10&intid=12" target="_blank"> View Profile </a> | <a href="javascript:;" onclick="create_visa('.$formdata['intake_id'].','.$cert_attest['app_id'].','.$cert_attest['candidate_id'].');"> Visa Details</a>  </td>';
...
//CERT ATTEST
	...
	function create_invoice2()
	{
		...
		if($this->input->post('placement_id')!='' && $this->input->post('app_id')!='' && $this->input->post('candidate_id')!='' && $this->input->post('invoice_date')!='')
		{
		   ...
		   $html.=' <tr>
                      <td width="13%"><a href="'.base_url().'candidates/summary/'.$invoice['candidate_id'].'/" target="_blank">'.$invoice['first_name'].' '.$invoice['last_name'].'</a></td>
					  ...
					  <td width="11%">'.$client_candidate.'</td>
                       <td><a href="'.base_url().'intakes/create_invoice/'.$formdata['intake_id'].'/?placement_id='.$invoice['placement_id'].'&invoice_id='.$invoice['invoice_id'].'"> &nbsp;Edit&nbsp;</a>|<a href="javascript:;"  data-url="'.base_url().'intakes/delete_invoice/?intake_id='.$formdata['intake_id'].'&placement_id='.$invoice['placement_id'].'&invoice_id='.$invoice['invoice_id'].'"  id="delete_invoice_candidate" >Delete</a>|<a href="'.base_url().'candidates/summary/'.$invoice['candidate_id'].'/" target="_blank"> &nbsp;Profile&nbsp;</a></td></tr>';
...
//get visa details
	...
	function get_visa_details()
	{
		...
		if(!empty($visa_details)){
		   ...
		   $html2.=' <tr>
                      <td width="13%"><a href="'.base_url().'candidates/summary/'.$visa['candidate_id'].'/" target="_blank">'.$visa['first_name'].' '.$visa['last_name'].'</a></td>
                      ...
                      <td width="13%">'.$visa['date_issued'].'</td>
                       ...
                       <td><a href="javascript:;" onclick="create_medical('.$formdata['intake_id'].','.$visa['app_id'].','.$visa['candidate_id'].');">Create Medical</a>|<a href="javascript:;"  data-url="'.base_url().'intakes/delete_visa/?intake_id='.$formdata['intake_id'].'&app_id='.$visa['app_id'].'&visa_id='.$visa['visa_id'].'"  id="delete_visa_candidate" >Delete</a></td></tr>';
		...
		if(!empty($visa_documents)){
		   ...
		   $html2.=' <tr>
                      ...
                      <td width="36%">'.date('d-m-Y',strtotime($visa['date_send'])).'</td>
                       ...
                       <td><a href="javascript:;" onclick="create_ticket('.$formdata['intake_id'].','.$visa['app_id'].','.$visa['candidate_id'].');"> Ticket & Travel</a>|<a href="javascript:;"  data-url="'.base_url().'intakes/delete_visa_document/?intake_id='.$formdata['intake_id'].'&app_id='.$visa['app_id'].'&doc_id='.$visa['doc_id'].'"  id="delete_visa_document" >Delete</a></td></tr>';
...
//GET MEDICAL DETAILS
	function get_medical_details()
	{
		...
		if(!empty($medical_details)){
		   ...
		   $html2.=' <tr>
                      <td width="13%"><a href="'.base_url().'candidates/summary/'.$medical['candidate_id'].'/" target="_blank">'.$medical['first_name'].' '.$medical['last_name'].'</a></td>
					   <td width="14%">'.$medical['title'].'</td>
                      <td width="13%">'.date('d-m-Y',strtotime($medical['date'])).'</td>
                     
                      <td width="36%">'.$medical['description'].'</td>

                       <td><a href="javascript:;" onclick="create_document('.$formdata['intake_id'].','.$medical['app_id'].','.$medical['candidate_id'].');"> Visa Process Document</a>|<a href="javascript:;"  data-url="'.base_url().'intakes/delete_medical/?intake_id='.$formdata['intake_id'].'&app_id='.$medical['app_id'].'&medical_id='.$medical['medical_id'].'"  id="delete_medical_candidate" >Delete</a></td></tr>';
		...
		if(!empty($ticket_details)){
			...
			$html2='	 <td colspan="2" align="center" valign="top">
  			...
  			foreach($ticket_details as $ticket){
		  		 ...
		  		 $html2.=' <tr>
                      <td width="13%"><a href="'.base_url().'candidates/summary/'.$ticket['candidate_id'].'/" target="_blank">'.$ticket['first_name'].' '.$ticket['last_name'].'</a></td>
				...
				$result = $this->intakesmodel->add_to_job();
					...
					foreach($applied as $candidate)
					{
						...
						$html.='<tr>
								  <td width="44%"><a href="#" target="_blank">'.$candidate['first_name'].' '.$candidate['last_name'].'</a></td>
								  <td width="31%">'.$candidate['skills'].'</td>          
								  <td width="25%"><a href="javascript:;"  data-url="'.base_url().'intakes/shortlist2/?job_app_id='.$candidate['job_app_id'].'&candidate_id='.$candidate['candidate_id'].'&intake_id='.$formdata['intake_id'].'"  id="shortlisted_candidate" > Short List </a> | <a href="javascript:;"  data-url="'.base_url().'intakes/delete_applied_candidate/?job_app_id='.$candidate['job_app_id'].'&candidate_id='. $candidate['candidate_id'].'&intake_id='.$formdata['intake_id'].'"  id="delete_applied_candidate" > Delete Application</a></td>
