...
<a href="<?php echo base_url();?>jobarea/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<tr class="odd gradeX">
                        ...
                        <td>
                        <a href="<?php echo base_url();?>jobarea/edit/<?php echo $result['func_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                        
                        <a href="<?php echo base_url();?>jobarea/delete/<?php echo $result['func_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
