...
<div class="col-md-9">
    <div class="profile_top">
                    ...
                    <div class="slider_redesign" id="tr_<?php echo $followup_list1['candidate_follow_id'];?>" >
                        <div class="side_adj second">
                            ...
                            <div class="date_edit">
                                ...
                                <img src="<?php echo base_url('assets/images/profile_delete.png');?>" id="<?php echo $followup_list1['candidate_follow_id'];?>" 
                                onClick="return validate(this.id)" >
                                </span>
				...
				<?php foreach($note_list as $note_list1){?>
                    <div class="slider_redesign" id="tr_<?php echo $note_list1['candidate_note_id'];?>">
                        <div class="side_adj second">
                            ...
                            <h2>Note Title:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<?php echo $note_list1['title'];?></h2>
                            <h2>Note Description:&nbsp;&nbsp;<?php echo $note_list1['notes'];?></h2>
                            
                            <div class="date_edit">
                                <span class="dates"><?php echo date('Y F d',strtotime ($note_list1['note_date']));?></span>
                                <span class="edit_delete">
                                <img src="<?php echo base_url('assets/images/profile_delete.png');?>" onClick="return note_validate(this.id)" 
                                id="<?php echo $note_list1['candidate_note_id'];?>" >
                            	</span>
                            </div>
                        </div>
                    </div>
             ...
             <div id="response2"></div>
                ...
                <div class="slider_redesign" id="tr_">
                    <div class="side_adj second">
                        ...
                        <div class="date_edit">Candidate registration is completed.
                ...
                <?php foreach($interview_list as $interview_list1){?>
                    <div class="slider_redesign" id="tr_<?php echo $interview_list1['interview_id'];?>">
                        <div class="side_adj second">
                            ...
                            <h2>Description:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<?php echo $interview_list1['description'];?></h2>
                            <h2>Interview Date:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo date('Y F d',strtotime ($interview_list1['interview_date']));?></h2>
                            ...
                            <div class="date_edit">
                                <span class="edit_delete">
                                    <img src="<?php echo base_url('assets/images/profile_delete.png');?>" id="<?php echo $interview_list1['interview_id'];?>" 
                                    onClick="return int_validate(this.id)" >
                                </span>
        ...
        <input type="hidden" value="<?php echo $detail_list['candidate_id'];?>" name="candidate_id" id="candidate_id">
          <?php /*?><input type="hidden" value="<?php echo $detail_list['job_id'];?>" name="job_id" id="job_id">
            <input type="hidden" value="<?php echo $detail_list['job_app_id'];?>" name="app_id" id="app_id"><?php */?>
                        ...
                        <table class="hori-form">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2">
                                    <span class="click-icons">
                                    <input type="button" name="interview_button" id="interview_button" class="attach-subs" value="Save" >
                                    <a href="#" class="attach-subs subs">Cancel</a>
                                    </span>
                                    </td>
                                </tr>
                        ...
                        <table class="hori-form">
                            <tbody>
                                <tr>
                                    ...
                                    <td> <input type="checkbox" name="reg_status" value="1" checked="checked" />  </td>
                                </tr> 
                                
                                <tr>
                                    <td>Date</td>
                                    <td><input type="text" name="fee_date" id="fee_date" class="text_box" value="" placeholder="yyyy-mm-dd" maxlength="10"/></td>
                                </tr>    
                                
                                <tr>
                                    <td>Fees Amount</td>
                                    <td><input type="text" name="fee_amount" id="fee_amount" class="text_box" value="" placeholder="Fee INR 0.00" maxlength="10"/></td>
                                </tr>       
                               
                                <tr>
                                    <td>Fee Details</td>
                                    <td> <input type="text" name="fee_comments" id="fee_comments" class="text_box"></td>
                                </tr>
...
<script type="text/javascript">
	   ...
	   $("#deletemessage").html('<div class="alert alert-success"><strong>Success!</strong> The page has been Deleted.</div>');
        ...
        $('#interview_button').click(function(){
        var candidate_id=$('#candidate_id').val();
