            ...
            <form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" > 
                <table class="hori-form">
                    <tbody>
                        ...
                        <tr>
                            <td>From Date</td>
                            <td><input class="form-control hori " type="text" name="from_date" id="datepickfrom" value="<?php echo $formdata['from_date'];?>" 
                            placeholder="Enter From Date YYYY-MM-DD"></td>
                        </tr>
                       
                        <tr>
                            <td>To Date</td>
                            <td><input class="form-control hori " type="text" name="to_date" id="datepickto" value="<?php echo $formdata['to_date'];?>" 
                        ...
                        <tr>
                            ...
                            <td>
                            <input class="form-control hori " type="text" name="monthly_salary" value="<?php echo $formdata['monthly_salary'];?>"  id="monthly_salary"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td> <?php echo form_dropdown('exp_years',  $years_list, $formdata['exp_years'],'style="width:200px;" id="exp_years"');?>&nbsp; 
							<?php echo form_dropdown('exp_months',  $months_list, $formdata['exp_months'],'style="width:200px;" id="exp_months"');?>
                            </td>	
                        </tr>
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('candidates_all/loadFilehtml'); ?>" +'/'+ candidateId;
...
var dataStringprop = $("#candidate_form4").serialize();
	$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_all/skip_step5'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) {
                            ...
                            var site_url = "<?php echo site_url('candidates_all/loadFilehtml'); ?>" +'/'+ id;
                            $("#step1").load(site_url, function() {
                                //alert("success step2");
                            });
						}
