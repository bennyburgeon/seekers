...
<div class="right-btns">
        ...
        <table class="tool-table">
            <tbody>
                <form id="searchForm"  method="post" action="<?php echo $this->config->site_url()?>/skill_based_candidates/">
...
<table class="tool-table new">
 <thead>
	<tr role="row" class="heading">
		...
		<th><a href="<?php echo $this->config->site_url()?>/skill_based_candidates?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&limit=<?php echo $limit;?>&rows=<?php echo $rows;?>">Candidate Name</a></th>
        <th>Skill Name</th>
        <th>Reg Date</th>
        <th>Mobile</th>
