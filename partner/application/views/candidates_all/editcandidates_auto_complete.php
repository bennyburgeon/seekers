...
<div class="clearfix">
    <a href="<?php echo $this->config->site_url();?>candidates_all" class="attach-subs subs pull-right">Back</a>
</div>
...
<table width="79%" class="hori-form">
    ...
    <tbody>
            ...
            <h2 class="srevHd">Personal Details</h2>
                ...
                <tr>
                    <td>First name</td>
                    <td><input class="form-control hori" type="text" name="first_name" value="<?php echo trim($formdata['first_name']);?>" id="first_name"></td>
                </tr>
                
                <tr>
                    <td>Last name</td>
                    <td><input class="form-control hori fo-icon-1" type="text" name="last_name" value="<?php echo trim($formdata['last_name']);?>" id="last_name"></td>
                </tr>
                
                <tr>
                    <td>Email</td>
                    <td><input class="form-control hori " type="text" readonly name="username" value="<?php echo trim($formdata['username']);?>" id="username"></td>
                </tr>
...
<form class="form-horizontal form-bordered"  method="post" id="form_new_skill" name="form_new_skill" > 
...
<table class="hori-form">
    <tbody>
        ...
        <tr>
            <td>
            <span class="click-icons">
            <input type="button" class="attach-subs" value="ADD & SAVE" id="add_new_skill" style="width:180px;" >                    
            </span>
            </td>
        </tr>
    </tbody>
...
<form class="form-horizontal form-bordered"  method="post" id="form_educatiron" name="form_educatiron" action="<?php echo site_url('data_entry/addEducationDetail'); ?>/<?php echo $candidate_id ?>" >
<h2>Education Details</h2> 

<input type="hidden" name="arrears" value="">
<input type="hidden" name="absesnse" value="">
<input type="hidden" name="repeat" value="">
<input type="hidden" name="year_back" value="">
<input type="hidden" name="mark_percentage" value="">
...
<!--                 <td> <?php echo form_dropdown('course_type_id',  $edu_course_type_list, '','class="form-control edu-field js-example-basic-single" id="course_type_id"');?> </td>-->
            ...
            <td colspan="2">
            <span class="clearfix">
            <input type="submit" class="attach-subs" value="Save" id="save_education11" style="width:180px;">
            <div class="clearfix"><br></div>
            </span>
            </td>
            </tr>
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>data_entry/show_cv_photo/',
...
//BEGIN SKILLS AND CERTIFICATE
   $('#edit_candidate7').click(function(){ 
		var dataStringprop = $("#form_new_skill").serialize(); 
...
//BEGIN EDUCATION DEATILS
   ...
   $('#save_education').click(function(){
		var dataStringprop = $("#form_educatiron").serialize();
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_entry/addEducationDetail'); ?>/<?php echo $candidate_id ?>",
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
$('#func').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   $element.data('jqXHR',
		$.ajax({
			url:'<?php echo $this->config->site_url();?>candidates_all/get_all_function_by_category',
			type: "POST", 
