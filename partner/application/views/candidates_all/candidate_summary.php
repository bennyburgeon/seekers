...
<?php if(count($all_messages)>0){?>  
	...
	<tr><td colspan="2" align="center" valign="top" class="borderTopNone">
   	 <table width="100%" border="1" cellspacing="1" cellpadding="0" class="table table-bordered table-condensed">
            ...
            <tr>
            <td width="20%"><?php echo $main_message['message_date'];?>, <?php if($main_message['admin_id']>0 && $main_message['admin_name']!='')echo $main_message['admin_name'].' [Support]'; else  echo $main_message['candidate'];?></td>
...
<li id="tab_2btn">Send Message</li>
   ...
   <input type="hidden" value="<?php echo $candidate_id;?>" name="candidate_id" id="candidate_id">
    ...
    <?php echo $this->ckeditor->editor('email_text','');?>
               ...
               <form class="form-horizontal form-bordered"  method="post" id="update_candidate_profile" name="update_candidate_profile" action="<?php echo $this->config->site_url();?>candidates_all/update_candidate_profile/<?php echo $candidate_id;?>" onSubmit="return validate_profile_form();"> 
                ...
                <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                 <input type="hidden" name="last_name" value="">
                    ...
                    <td>Package</td>
                     <td colspan="3"><?php echo form_dropdown('package_id', $package_list, $job_search['package_id'],'class="form-control hori" id="package_id"');?>
</td>
                    </tr>
