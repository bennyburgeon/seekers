...
<form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="<?php echo $this->config->site_url();?>candidates_all/edu_history/<?php echo $candidate_id;?>" onSubmit="return candidate_validate();"> 
...
<script type="text/javascript">
		...
		if(confirm('Are you sure you want to delete?'))
		{
			...
			$.ajax({
				type:"POST",
				url: '<?php echo site_url('candidates_all/drop_edu_item'); ?>',
				data:{ 
