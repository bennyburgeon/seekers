...
<td>From Date</td>
<td><input class="form-control hori " type="text" name="from_date" id="datepickfrom" value="<?php echo $formdata['from_date'];?>" placeholder="yyyy-mm-dd"></td>
</tr>
</tr>
<td>To Date</td>
<td><input class="form-control hori " type="text" name="to_date" id="datepickto" value="<?php echo $formdata['to_date'];?>" placeholder="yyyy-mm-dd"></td>
</tr>
...
-->
 ...
 <textarea name="responsibility" cols="" rows="" class="text_area" id="responsibility"><?php echo $formdata['responsibility'];?></textarea> 
