...
<a href="<?php echo base_url();?>candidates_all/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
</div>
...
<table class="tool-table new">
    ...
    ?>
        ...
        <tr class="odd gradeX">
            ...
            <td>            
            <a href="<?php echo base_url();?>candidates_all/summary/<?php echo $result['candidate_id']?>" class="views" title="View">Manage</a>
            
            <!-- 
            &nbsp;|&nbsp;            
            <a href="<?php echo base_url();?>candidates_all/edit/<?php echo $result['candidate_id']?>" class="views" title="Edit">Edit</a> 
