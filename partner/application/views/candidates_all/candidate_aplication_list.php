...
<a href="<?php echo base_url();?>candidates_all/candidate_programs/<?php echo $aplication_list['candidate_id'];?>?app_id=<?php echo $aplication_list['app_id'];?>"><img src="<?php echo base_url('assets/images/profile_edit.png');?>"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
