      ...
      <div class="col-sm-12">
        ...
        <div class="table-tech specs hor">
          <table class="hori-form">
            <tbody>
            <form action="<?php echo $this->config->site_url();?>internship/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data">
             ...
             <tr>
              ...
              <tr>
                <td>Free / Paid</td>
                <td><input type="radio" name="free_paid" id="free_paid" value="1" checked> Free
                 <input type="radio" name="free_paid" id="free_paid" value="2"> Paid
                </td>
              </tr>
