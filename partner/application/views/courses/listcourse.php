...
<a href="<?php echo base_url();?>courses/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
<!-- 
...
?>
		<tr>
            ...
            <?php echo $i;?>
                          ...
                          <a href="<?php echo base_url();?>courses/connect/<?php echo $result['course_id']?>" class="views" title="Match">Manage [ -> <?php echo $result['total_count']?>]</a>
                          <?php }else{ ?>---<?php } ?>                             </td>
                          -->
                          
            <td>
			<a href="<?php echo base_url();?>courses/edit/<?php echo $result['course_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
            
            <!-- 
			<a href="<?php echo base_url();?>courses/delete/<?php echo $result['course_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>		   
            -->
