...
<tbody>
  <form action="<?php echo $this->config->site_url();?>courses/connect/<?php echo $formdata['course_id'];?>" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<tr>
<td colspan="2">
<span class="click-icons"><a href="<?php echo $this->config->site_url();?>courses" class="attach-subs subs">Back</a></span></td>
</tr>
</form>
</tbody>
</table>
