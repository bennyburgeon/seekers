...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>trainingcenter/update?<?php echo $query_string;?>" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<td colspan="2"><input type="text" id="building_location" name="building_location" value="<?php echo $formdata['building_location'];?>" placeholder="Enter Building" class="form-control" />
      ...
      <tr>
    <td>Address</td>
    <td colspan="2"><textarea id="center_address" name="center_address" rows="8" placeholder=" Enter Trainingcenter Address" class="form-control" ><?php echo $formdata['center_address'];?></textarea></td>
    </tr>
