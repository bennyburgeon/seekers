    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          <div class="right-btns"> <a href="<?php echo base_url();?>trainingcenter/add?<?php echo $query_string;?>" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> 
            
            <!-- 
|| 
<a href="<?php echo base_url();?>trainingcenter/import_csv" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Import CSV</a>
--> 
            
            <a href="<?php echo base_url(); ?>trainingcenter" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a> </div>
          <form id="searchForm" action="<?php echo base_url(); ?>trainingcenter" method="get" name="searchForm">
            <table width="47%" class="tool-table">
              <tbody>
                <tr>
                  <td width="17%"><input class="form-control" type="text" name="searchterm" id="search_term" placeholder="Trainingcenter Name" value="<?php echo $searchterm != '' ? $searchterm: '' ;?>"     style="width: 200px;"></td>
...
--> 
                  <!--
<td width="3%">
<?php echo form_dropdown('center_rating', $company_rating_list , $center_rating,'style="width:100px;" class="form-control"  id="center_rating" ');?>
</td>
-->
...
-->
          ...
          <form name="frm_assignment" method="post" id="frm_assignment" action="<?php  echo $this->config->site_url();?>trainingcenter/multiple_assignment?rows=<?php echo $rows;?>" >
            <table class="tool-table new">
              <thead>
                <tr role="row" class="heading">
                  ...
                  <th width="534"><a href="<?php echo $this->config->site_url()?>trainingcenter?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Trainingcenter Name</a></th>
	...
	foreach($records as $result){ ?>
                <tr class="odd gradeX">
                  <td><div class="checker"> <span>
                      <input type="checkbox" name="center_id[]" class="checkboxes" value="<?php echo $result['center_id']?>" >
                      </span> </div></td>
                  <td><a href="<?php echo base_url();?>trainingcenter/edit/<?php echo $result['center_id']?>" class="views" title="Edit This Trainingcenter"><?php echo $result['center_name']?></a><br>
                   
                    Total Courses : <?php echo $result['total_jobs']?></td>
                  <td> Email:<?php echo $result['contact_email']?><br>
                    Phone:<?php echo $result['contact_phone']?> || Ext. <a href="javascript:void();" class="btn btn-success btn-xs"><?php echo $result['contact_phone_ext']?></a><br>
                    Contact:<?php echo $result['contact_name']?><br>
                    <?php 
				$host_ar=parse_url($result['center_website']);

			?>
                    <a href="<?php if(isset($host_ar['path']) && $host_ar['path']!='')echo 'http://'.$host_ar['path']; if(isset($host_ar['host']) && $host_ar['host']!='') echo ''.$host_ar['host'];?>" target="_blank"><?php echo $result['center_website'];?></a>

                    
                    </td>
                  <td>
                  
                  <a href="<?php echo base_url(); ?>trainingcenter/edit/<?php echo $result['center_id'];?>" title="Edit"   id="edit_company" class="btn btn-info btn-xs"> Edit</a> 
                  <br>
                    
                     <a href="<?php echo base_url();?>trainingcenter/connect/<?php echo $result['center_id']?>" class="views" title="Manage">Manage Courses</a>
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <div class="col-md-15">
                      <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>trainingcenter/add_calls" id="calls_form" name="calls_form">
                        ...
                        <table class="hori-form">
                          <tbody>
                            ...
                            <tr>
                              <td>Rate This Trainingcenter</td>
                              <td><?php echo form_dropdown('center_rating',  $company_rating_list,'','class="form-control" id="center_rating"');?></td>
                            </tr>
                            <tr>
                              <td>Call Date</td>
                  ...
                  data-url="<?php echo $this->config->site_url();?>trainingcenter/add_calls" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <div class="col-md-15">
                      <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>trainingcenter/add_jobs" id="jobs_form" name="calls_form">
                        <input type="hidden" name="center_id" id="jobs_company_id" value="">
                        <table class="hori-form">
                          <tbody>
                            <tr>
                              <td>Post Date</td>
                  ...
                  data-url="<?php echo $this->config->site_url();?>trainingcenter/add_jobs" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
                ...
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <div class="col-md-15" id="assignment_history">
                      <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>trainingcenter/save_assignment" id="assignment_form" name="assignment_form">
                        <input type="hidden" name="center_id" id="assign_company_id" value="">
                        <div id="data_holder">
                          <table class="hori-form">
                            <tbody>
                              <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>trainingcenter/save_assignment" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
...
$(document).ready(function()
{
	...
	$("#sel_limit1").change(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>trainingcenter?limit='+limits;
	});
...
function add_calls(center_id)
{
	$('#center_id').val(center_id);
    $('#calls_modal').modal();
}
function add_jobs(center_id)
{
	$('#jobs_company_id').val(center_id);
    $('#jobs_modal').modal();
}
...
function get_calls_history(center_id){
	...
	$('#show_followup_history').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>trainingcenter/get_calls_history/?center_id=<?php echo $result['center_id'];?>",
...
function assign_requirement(center_id)
{
	$('#assign_company_id').val(center_id);
	$('#data_holder').html('Loading..................');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>trainingcenter/assign_requirement/?center_id="+center_id,
