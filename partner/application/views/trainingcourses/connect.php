...
<span>
<a href="<?php echo $this->config->site_url()?>trainingcourses">Courses</a></span> / <span>Edit Course</span></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
  <form action="<?php echo $this->config->site_url();?>trainingcourses/connect/<?php echo $formdata['course_id'];?>" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
<?php echo form_hidden('course_id', $formdata['course_id']);?>

<tr>
<td><?php echo $formdata['course_name'];?> | <?php echo $formdata['level_name'];?></td>
<td>Selected Programs</td>
</tr>
...
<tr>
<td colspan="2">
<span class="click-icons"><a href="<?php echo $this->config->site_url();?>trainingcourses" class="attach-subs subs">Back</a></span></td>
</tr>
</form>
</tbody>
</table>
