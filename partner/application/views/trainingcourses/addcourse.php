...
<span>
<a href="<?php echo $this->config->site_url()?>trainingcourses">Courses</a></span> / <span>Add Course</span></div>
</div>
...
<tbody>
  <form action="<?php echo $this->config->site_url();?>trainingcourses/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<td>
    ...
    <label class="radio-inline">
<input type="radio" name="by_distance" id="by_distance" value="No" <?php if($formdata['by_distance'] ==0){?> checked <?php } ?> >No</label>
...
<a href="<?php echo $this->config->site_url();?>trainingcourses" class="attach-subs subs">Cancel</a>
</span>
</td>
</tr>
</form>
