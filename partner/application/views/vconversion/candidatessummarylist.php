...
<a href="<?php echo base_url();?>index.php/vconversion/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>



|| 

<a href="<?php echo base_url();?>index.php/vconversion/import_csv" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Import CSV</a>
...
--> 
          ...
          <table class="tool-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td width="30%"><a href="#" class="se-reset"><img src="<?php echo base_url('assets/images/search.png');?>" id="search"></a> <a style="height: 28px; padding: 5px; margin-left: 12px;" href="<?php echo base_url(); ?>index.php/vconversion" id="clear_search" class="btn btn-primary btn-xs">Clear Search</a></td>
        ...
        <form name="form1" method="post" id="form1" action="<?php  echo $this->config->site_url();?>/vconversion/multidelete?rows=<?php echo $rows;?>" >
          ...
          <table class="tool-table new">
            ...
            <thead>
              ...
              <tr role="row" class="heading">
				<th width="38">SLNO</th>
				<th width="18">Partner ID</th>
				<th width="19">Partner Name</th>
                <th width="79">Candidate Name</th>

                <th width="54">Mobile</th>
                <th width="54">Email</th>

                <th width="74">Location</th>
                <th width="74">Joined- Position</th>

                <th width="107">Company</th>

                <th width="29">Salary Offered</th>
                <th width="29">DoJ</th>
...

{
	...
	?>
              ...
              <tr class="odd gradeX">
            	 ...
            	 <td><?php echo 'FIRS-'.$result['vendor_id']; ?></td>
            	 <td><?php echo $result['vendor_name']; ?></td>

                <td><strong><font color="#3366CC"><?php echo $result['first_name']?></font></strong></td>

                <td title=""><strong> <font color="#3366CC"></a><?php echo $result['mobile']?><br>

                  </font> </strong> <br></td>
                <td title=""><?php echo $result['username']; ?></td>

                <td><?php echo $result['city_name']; ?></td>
                <td><?php echo $result['job_title']; ?></td>
                <td><?php echo $result['company_name']; ?></td>
                <td><?php echo number_format($result['monthly_salary_offered'],0); ?></td>
              ...
              <tr>
                ...
                <td colspan="13" align="center"> No Records Founds!! </td>
...

{
	...
	$("#sel_limit1").change(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/vconversion?limit='+limits;
...

{
	...
	$('#data_holder').html('Loading..................');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>index.php/vconversion/assign_requirement/?app_id="+app_id,
