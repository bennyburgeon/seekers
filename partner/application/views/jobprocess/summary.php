...
<div class="profile_top_left">Summary &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url();?>index.php/jobprocess/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobprocess/send_mass_mail/<?php echo $formdata['job_id'];?>">Mass Email</a>	&nbsp;&nbsp;&nbsp; ||&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobprocess/add_candidate/<?php echo $formdata['job_id'];?>">Add New Candidate</a>	&nbsp;&nbsp;&nbsp; ||</div>  
                ...
                <td colspan="2" align="center" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                 <td><span><strong>Download JD</strong></span></td>
    ...
    <table border="1" cellpadding="1" cellspacing="1" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody >
        ...
        <tr>
          ...
          <td width="7%"><strong>
            <?php if($candidate['total_experience']!='')echo $candidate['gcc_experience'];else echo 'Nil'; ?>
          </strong></td>
          <td width="6%"><strong>
            <?php if($candidate['total_experience']!='')echo $candidate['visa_status'];else echo 'Nil'; ?>
          </strong></td>
          <td width="6%"><strong>
    ...
    <tr>
     ...
     <?php echo $candidate['last_call_date'];?> | <?php echo $candidate['last_call_note'];?> | <?php if($candidate['cur_job_status']==1)echo 'No Job';if($candidate['cur_job_status']==2)echo 'Working, But Need a Change';if($candidate['cur_job_status']==3)echo 'Not Interested';if($candidate['cur_job_status']==4)echo 'Seeking Good Opportunity';if($candidate['cur_job_status']==5)echo 'Need a change ';if($candidate['cur_job_status']==6)echo 'Call after 1 Year';if($candidate['cur_job_status']==7)echo 'Call after this month ';?>     
      <?php } ?>
        ...
        <a href="javascript:;" title="<?php echo $candidate['last_call_date'];?> | <?php echo $candidate['last_call_note'];?> | <?php if($candidate['cur_job_status']==1)echo 'No Job';if($candidate['cur_job_status']==2)echo 'Working, But Need a Change';if($candidate['cur_job_status']==3)echo 'Not Interested';if($candidate['cur_job_status']==4)echo 'Seeking Good Opportunity';if($candidate['cur_job_status']==5)echo 'Need a change ';if($candidate['cur_job_status']==6)echo 'Call after 1 Year';if($candidate['cur_job_status']==7)echo 'Call after this month ';?>" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Calls [<?php echo $candidate['total_calls'];?>] </a>
        
        
        <?php }else{ ?>
        <a href="javascript:;" title="No Calls Made" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-danger btn-xs"> Calls [?] </a>
        <?php }?>
        
        <a href="javascript:;" title="Update CTC" onclick="add_ctc(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/add_ctc/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="update_ctc" class="btn btn-info btn-xs"> CTC </a>
        
        <a href="javascript:;" title="Add Notes" onclick="add_notes(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/add_notes/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_notes" class="btn btn-info btn-xs"> Notes </a>
        
        <a href="javascript:;" title="Send Message" onclick="add_message(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/add_message/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_msg" class="btn btn-info btn-xs"> Msg </a>

        
        <a href="javascript:;" title="Move to Documents Folder" onclick="move_to_docs(<?php echo $candidate['job_app_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/move_to_docs/?job_app_id=<?php echo $candidate['job_app_id'];?>"  id="move_to_docs" class="btn btn-info btn-xs"> Move To Docs </a>
        
        <a href="javascript:;" data-url="<?php echo base_url(); ?>index.php/jobprocess/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $candidate['job_app_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>

        <a href="javascript:;" title="Change Job"  data-url="<?php echo base_url(); ?>index.php/jobprocess/change_job/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>" onclick="manage_job_change(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" id="change_job" class="btn btn-info btn-xs"> Change Job </a>

  <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>index.php/jobprocess/send_jd/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a> &nbsp; 
  
  <?php if($candidate['cv_file']!='' && file_exists('uploads/cvs/'.$candidate['cv_file'])){?>
  <a href="javascript:;" onclick="candidate_cv(<?php echo $candidate['candidate_id'];?>);" id="download_cv" data-url="<?php echo base_url();?>index.php/jobprocess/download_cv/<?php echo $candidate['candidate_id']?>" title="View CV" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i> CV</a>
  <?php }else{ ?>
...
<tr id="candidate_rejected" style="display:none;">
    ...
    <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody >
        ...
        <tr>
          	<td width="25%"><a href="javascript:;" title="View Profile" onclick="candidate_profile(<?php echo $candidate['candidate_id'];?>);"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a>
...
<?php  if(!empty($doc_verification_candidates)) { ?>
  
<tr>
    <td colspan="2" align="center" valign="top">
        <div class="tab-head mar-spec">
        <h3>Certificates and Document Verification/Attestation&nbsp;&nbsp;[<?php echo count($doc_verification_candidates);?>]</h3>
        <div style="float:right;"><a id="toggle_applied_doc_verify" href="javascript:;" class="tab-head mar-spec">View All</a></div>
        </div>
    </td>
</tr>

<tr id="candidate_doc_list" style="display:none;">
    <td colspan="2" align="center" valign="top">
    ...
    <table border="1" cellpadding="1" cellspacing="1" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody >
        <?php foreach($doc_verification_candidates as $candidate){?>
        ...
        <tr>
          ...
          <td>
                  <a href="javascript:;" title="Short List this candidate" onclick="add_to_shortlist(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/add_to_shortlist/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_to_shortlist" class="btn btn-info btn-xs"> Short List </a>
          </td>
          </tr>
...
<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobprocess/send_shortlisted"  method="post" id="shortlisted_form" name="shortlisted_form"> 
            ...
            <p id="deletemessage"></p>
				...
				<tr>
                   ...
                   <td>
                    ...
                    <input id="contact_name" type="text" name="contact_name" value="<?php echo $formdata['contact_name'];?>" placeholder="Contact Name" />                  <br>[Phone: <?php echo $formdata['contact_phone'];?>]
				  </td>
                 </tr>
				...
				<tr>
                   ...
                   <td>
                    ...
                    <input id="contact_designation" type="text" name="contact_designation" value="<?php echo $formdata['contact_designation'];?>" placeholder="Designation" />                  
				  </td>
                 </tr>
				...
				<tr>
                   ...
                   <td>
                    ...
                    <input id="contact_email" type="text" name="contact_email" value="<?php echo $formdata['contact_email'];?>" placeholder="Contact Email" />                  
				  </td>
                 </tr>
				...
				<tr>
                   ...
                   <td>
                    ...
                    <input id="email_subject" type="text" name="email_subject" value="" placeholder="Please enter subject here" />                  
				  </td>
                 </tr>
                ...
                <td>Email Content</td>
                 <td><?php echo form_textarea(array('name'=>'email_text', 'id' => 'email_text','class' => 'smallinput','rows' => '8'));?> </td>
                </tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/send_shortlisted" />
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody>
        ...
        <tr>
           ...
           <br>
<p>Submission:<?php echo $candidate['total_submission'];?> Times.</p>
            ...
            <td width="19%">           <?php if($candidate['client_feedback']<1)echo 'No Feedback';?>
              ...
              <a href='javascript:;'  onclick="add_feedback(<?php echo $candidate['short_id'];?>,<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-warning btn-xs">Change</a> </td>
         ...
         <td width="14%"><?php if($candidate['app_status_id']==3){?> <a href='javascript:;'  onclick="add_interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a>  || <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobprocess/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">Remove</a> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
        <thead>
          ...
          <?php if($interview['total_rejection']==0  && $interview['selected']==0){?>       
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobprocess/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a>
                    ...
                    <a href="javascript:;" onclick="reject_interview_fn(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $interview['interview_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobprocess/reject_interview/"  id="reject_interview" class="btn btn-danger btn-xs">Reject </a>
                    <?php }else{ ?>
               ...
               <tr>
                  ...
                  <?php foreach($candidates_selected as $selected){?>
                    ...
                    <tr>
                      ...
                      <a href='javascript:;' onclick="issue_offer(<?php echo $formdata['job_id'];?>,<?php echo $selected['app_id'];?>,<?php echo $selected['candidate_id'];?>);" id="issue_offer" class="btn btn-info btn-xs"> Issue Offer </a> &nbsp;<a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobprocess/delete_selectedcandidate/?job_app_id=<?php echo $selected['app_id'];?>&candidate_id=<?php echo $selected['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_selected_candidate" class="btn btn-danger btn-xs">X </a>
                      <?php }else{ ?>
                      Offered
                      <?php } ?>
...
<tr>
    ...
    <?php if($offerletter['offer_status']==1){?>		
      ...
      <a href="javascript:;" onclick="accept_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-success btn-xs"> Accept </a>  <a href="javascript:;" onclick="reject_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-warning btn-xs"> Reject </a>&nbsp;<a href="javascript:;"  data-url="<?php echo base_url().'index.php/jobprocess/delete_offercandidate/?job_app_id='.$offerletter['app_id'].'&candidate_id='.$offerletter['candidate_id'].'&job_id='.$formdata['job_id'];?>"  id="delete_offer_candidate" class="btn btn-danger btn-xs">X </a>
        ...
        <?php 
			...
			?>
				<tr>
                 ...
                 <p> <a href="javascript:;" onclick="create_invoice(<?php echo $formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id']?>);" class="btn btn-primary btn-xs">Invoice</a>&nbsp;<a href="javascript:;" data-url="<?php echo base_url().'index.php/jobprocess/delete_acceptcandidate/?job_id='.$formdata['job_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id']?>" id="delete_accept_candidate" class="btn btn-danger btn-xs">X </a></p>
                 
                  <a href="javascript:;" onclick="cert_attestation(<?php echo $accepted['app_id'];?>,<?php echo $accepted['job_id'];?>);" class="btn btn-primary btn-xs">VCert</a>&nbsp;
                  
                   <a href="javascript:;" onclick="cert_attestation1(<?php echo $accepted['app_id'];?>,<?php echo $accepted['job_id'];?>);" class="btn btn-primary btn-xs">Check </a>&nbsp;
                   
                   
                 <a href="javascript:;" onclick="add_visa(<?php echo $accepted['app_id'];?>,<?php echo $accepted['job_id'];?>);" class="btn btn-primary btn-xs">Visa</a>&nbsp;
                 
                 <a href="javascript:;" onclick="add_medical(<?php echo $accepted['app_id'];?>,<?php echo $accepted['job_id'];?>);" class="btn btn-primary btn-xs">Medical</a>&nbsp;
                 
                 <a href="javascript:;" onclick="add_ticket(<?php echo $accepted['app_id'];?>,<?php echo $accepted['job_id'];?>);" class="btn btn-primary btn-xs">Ticket</a>&nbsp;
                 
                 <a href="javascript:;" onclick="add_ticket_followup(<?php echo $accepted['app_id'];?>,<?php echo $accepted['job_id'];?>);" class="btn btn-primary btn-xs">Ticket Flp</a>&nbsp;
          ...
          <tbody >
              ...
              <?php foreach($invoice_generated as $invoice){?>                                                
                ...
                <tr>
                  ...
                  <td>
                  <p><!--
                  <a href="<?php echo base_url(); ?>index.php/jobprocess/create_invoice/?job_id=<?php echo $formdata['job_id'];?>/?placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>" class="btn btn-primary btn-xs">Edit</a> -->
                  <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobprocess/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" class="btn btn-danger btn-xs">X</a>
                   </p>       
...
<div class="modal fade" id="move_to_doc_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" >
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <div class="col-md-15" >
            ...
            -->
            <p id="result"></p>
            <p id="deletemessage">This application will be moved to documents area to upload and check candidate's documents. Will be moved from applications list.</p>
            
            <form class="form-horizontal form-bordered"  method="post" id="move_to_docs_form" name="move_to_docs_form" action="<?php echo $this->config->site_url();?>/jobprocess/move_to_docs"> 
            
             		<input type="hidden" name="candidate_id" id="doc_candidate_id" value="">
                    <input type="hidden" name="job_app_id"  id="doc_job_app_id" value="">    
                     <input type="hidden" name="job_id"  id="doc_job_id" value="<?php echo $formdata['job_id'];?>">      
                ...
                <table class="hori-form">
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              <span class="click-icons">
           <input type="submit" class="attach-subs" value="Yes! Move.." id="save_cert" style="width:180px;" data-url="<?php echo $this->config->site_url();?>/jobprocess/move_to_docs" />
                              </span>
                          </td>
                	   </tr>
                      </tbody>
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="calls_form" name="calls_form"> 
                ...
                <tr>
                <td>Call Date</td>
                 <td><input type="text" name="call_date" class="smallinput datepicker" readonly id="datepicker"  /></td>
                </tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/add_calls" />
...
<br>
            ...
            <div class="table-tech specs note">
            <div class="new_notes">
            <div class="alert alert-info"><strong>Info!</strong>&nbsp;These feedbacks will be sending to Clients with profile.</div>
            
            <p id="result"></p>
            <p id="deletemessage"></p>
            
            
            <form class="form-horizontal form-bordered"  method="post" id="add_to_shortlist_form"  action="<?php echo $this->config->site_url();?>/jobprocess/add_to_shortlist"  name="add_to_shortlist_form"> 
				...
				<tr>
                   <td>Education</td>
                   <td><?php echo form_textarea(array('name'=>'feedback_education', 'id'=>'feedback_education','style' => 'width:400px;height:100px;'));?></td>
                 </tr>

				<tr>
                   <td>Experience</td>
                   <td><?php echo form_textarea(array('name'=>'feedback_industry', 'id'=>'feedback_industry','style' => 'width:400px;height:100px;'));?></td>
                 </tr>
                 
				<tr>
                   <td>Skills</td>
                   <td><?php echo form_textarea(array('name'=>'feedback_skills', 'id'=>'feedback_skills','style' => 'width:400px;height:100px;'));?></td>
                 </tr>

				<tr>
                   <td>Salary</td>
                   <td><?php echo form_textarea(array('name'=>'feedback_salary', 'id'=>'feedback_salary','style' => 'width:400px;height:100px;'));?></td>
                 </tr>
                 

				<tr>
                   <td>Others</td>
                   <td><?php echo form_textarea(array('name'=>'feedback_general', 'id'=>'feedback_general','style' => 'width:400px;height:100px;'));?></td>
                 </tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/add_to_shortlist" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobprocess/manage_rejection"  method="post" id="rejection_form" name="rejection_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/manage_rejection" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobprocess/save_job_change"  method="post" id="change_form" name="change_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/save_job_change" />
...
<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobprocess/add_feedback"  method="post" id="feedback_form" name="feedback_form">
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/add_feedback" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="ctc_form" name="ctc_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/add_ctc" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="notes_form" name="notes_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/add_notes" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobprocess/add_message"  method="post" id="message_form" name="message_form"> 
			...
			<tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/add_message" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobprocess/addinterview"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/addinterview" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="reject_interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobprocess/reject_interview"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobprocess/reject_interview"/>
        ...
        <br>
          ...
          <div class="modal-body">
            <div class="profile_top">
                ...
                <form class="form-horizontal form-bordered"  method="post" id="select_candidate_form" name="select_candidate_form" action="<?php echo base_url(); ?>index.php/jobprocess/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>"  > 
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                             ...
                             data-url="<?php echo base_url(); ?>index.php/jobprocess/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>" />
                              </span>
                          </td>
                	   </tr>
                      </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="issue_offer_form" name="issue_offer_form" action="<?php echo $this->config->site_url();?>/jobprocess/issue_offer"> 
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/issue_offer" />
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/reject_offer" />
    ...
    <div class="notes">
        <div class="table-tech specs note">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="accept_offer_form" name="accept_offer_form" action="<?php echo $this->config->site_url();?>/jobprocess/accept_job_offer"> 
                ...
                <table class="hori-form">
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              <span class="click-icons">
                              <input type="button" class="attach-subs" value="Save" id="accept_offer_button" style="width:180px;" 
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/accept_job_offer" />
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/create_invoice2" />
...
<!-- from 7th step -- need to recheck and follow --> 

<div class="modal fade" id="attest_cert_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <br>
          ...
          <div class="modal-body">
            <div class="col-md-15">
          	 <div class="profile_top">
                <div class="profile_top_left">Upload Certificates</div>
                ...
                <form class="form-horizontal form-bordered"  method="post" id="cert_form" name="cert_form" action="<?php echo $this->config->site_url();?>/jobprocess/add_certificate" > 
                  
                  <input type="hidden" name="job_id" id="job_id_cert" value="">
                  <input type="hidden" name="job_app_id" id="job_app_id_cert" value="">
                  <table class="hori-form">
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              <span class="click-icons">
           <input type="submit" class="attach-subs" value="Uopload Doc" id="upload_certificates_button" style="width:180px;" data-url="<?php echo $this->config->site_url();?>/jobprocess/add_certificate" />
                              </span>
                          </td>
                	   </tr>
                      </tbody>
...
<div class="modal fade" id="visa_doc_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
            <div class="col-md-15">
          	 <div class="profile_top">
                ...
                <form class="form-horizontal form-bordered"  method="post" id="candidate_form_doc" name="candidate_form_doc" action="<?php echo $this->config->site_url();?>/jobprocess/create_doc" > 
                  
                  <input type="hidden" name="candidate_id" id="candidate_id_doc"value="">
                  <input type="hidden" name="job_app_id" id="job_app_id_doc" value="">
                  ...
                  <table class="hori-form">
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              <span class="click-icons">
                              <input type="submit" class="attach-subs" value="Upload VISA" id="save_doc" style="width:180px;" 
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/create_doc" />
...
<div class="modal fade" id="job_visa_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
            <div class="col-md-15">
          	 <div class="profile_top">
                ...
                <form class="form-horizontal form-bordered"  method="post" id="candidate_form_visa" name="candidate_form_visa" action="<?php echo $this->config->site_url();?>/jobprocess/create_visa" > 
                  
                  <input type="hidden" name="candidate_id" id="candidate_id"value="">
                  <input type="hidden" name="app_id" id="app_id_visa" value="">
                  <input type="hidden" name="job_id" id="job_id_visa" value="">
                  ...
                  <table class="hori-form">
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              <span class="click-icons">
                              <input type="submit" class="attach-subs" value="Save" id="save_visa" style="width:180px;" 
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/create_visa" />
...
<div class="modal fade" id="job_medical_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
            <div class="col-md-15">
          	 <div class="profile_top">
                ...
                <form class="form-horizontal form-bordered"  method="post" id="candidate_form_medical" name="candidate_form_medical" action="<?php echo $this->config->site_url();?>/jobprocess/create_medical"> 
                  
                  <input type="hidden" name="candidate_id" id="candidate_id"value="">
                  <input type="hidden" name="app_id" id="app_id_med" value="">                  
                  <input type="hidden" name="job_id" id="job_id_med" value="">
                  ...
                  <table class="hori-form">
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              <span class="click-icons">
                      <input type="submit" class="attach-subs" value="Save" id="save_medical" style="width:180px;" 
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/create_medical" />
...
<div class="modal fade" id="job_ticket_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/create_ticket" />
...
<div class="modal fade" id="ticket_followup_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                   ...
                   <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="radio"  name="travel_confirmation" value="1">&nbsp;Complete&nbsp;
                             <input type="radio"  name="travel_confirmation" value="2" >&nbsp;Incomplete&nbsp;</td>
                        </tr>
                        <tr>
                            <td>Send Email</td>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobprocess/create_followup" />
...
function move_to_docs(doc_job_app_id){
   	$('#doc_job_app_id').val(doc_job_app_id);
    $('#move_to_doc_modal').modal();
}
...
function manage_rejection(rej_job_app_id){
   	$('#rej_job_app_id').val(rej_job_app_id);
...
function cert_attestation(app_id_cert,job_id)
{
	$('#job_app_id_cert').val(app_id_cert);
	$('#job_id_cert').val(job_id);
    $('#attest_cert_modal').modal('show');
}

function cert_attestation1(job_app_id_doc,job_id_doc)
{
	$('#job_app_id_doc').val(job_app_id_doc);
	$('#job_id_doc').val(job_id_doc);
    $('#visa_doc_modal').modal('show');
}

function add_visa(app_id_visa,job_id_visa)
{
	$('#app_id_visa').val(app_id_visa);
	$('#job_id_visa').val(job_id_visa);
    $('#job_visa_modal').modal('show');
}

function add_medical(app_id_med,job_id_med)
{
	$('#app_id_med').val(app_id_med);
	$('#job_id_med').val(job_id_med);
    $('#job_medical_modal').modal('show');
}

function add_ticket(ticket_job_app_id)
{
	$('#ticket_job_app_id').val(ticket_job_app_id);
    $('#job_ticket_modal').modal('show');
}

function add_ticket_followup(ticket_flp_job_app_id)
{
	$('#ticket_flp_job_app_id').val(ticket_flp_job_app_id);
    $('#ticket_followup_modal').modal('show');
}
...
$(document).on('click', '#accept_offer_button', function(){ 
        ...
        $.ajax({
			...
			type: 'POST',
			url: $url,
			data: $('#accept_offer_form').serialize(),
			dataType: "json",
...
function candidate_profile(job_id){
	
	$('#show_candidate_profile').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobprocess/candidate_profile/"+job_id,
			method: "POST",
  			data: { job_id : job_id },
		    dataType: "html",
			success: function(data) 
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobprocess/download_cv/"+candidate_id,
			method: "POST",
...
$( "#toggle_applied_doc_verify" ).click(function() {
	
  $( "#candidate_doc_list" ).toggle("slow");
});
