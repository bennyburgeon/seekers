      ...
      <div class="col-sm-12">
        ...
        <div class="table-tech specs hor">
          <table class="hori-form">
            <tbody>
            <form action="<?php echo $this->config->site_url();?>mock_tests/add" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();">
              ...
              <tr>
                <td>Materials</td>
                <td><input type="text" class="form-control" placeholder="List of materials need to bring" value="<?php echo $formdata["materials"] ?>"  name="materials" id="materials"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="2"><span class="click-icons">
                  ...
                  <a href="<?php echo $this->config->site_url();?>mock_tests" class="attach-subs subs">Cancel</a> </span></td>
              </tr>
            </form>
              </tbody>
