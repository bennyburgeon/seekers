...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/jobapps/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
                                  <?php echo form_hidden('page_id', $formdata['page_id']);?>
