...
<tbody>
<tr>
<td><input class="form-control" type="text" name="searchterm" id="search_term" placeholder="Search File" style="width: 185px;"></td>
...
<thead>
                       ...
                       <th> <a href="<?php echo $this->config->site_url()?>/uploadfile_reports?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&limit=<?php echo $limit;?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">File </a></th>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/uploadfile_reports?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>/uploadfile_reports?limit='+limits;
	});
