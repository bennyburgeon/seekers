    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          ...
          <form id="searchForm" method="get" action="<?php echo $this->config->site_url()?>candidates_skill_summary/">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="submit" id="submit" onclick="search_submit();" value="Search" class="btn btn-default btn-circle" style="width:100px" />
                    <a style="margin-left:13px" href="<?php echo base_url(); ?>candidates_skill_summary" class="btn btn-default btn-circle" >Reset</a></td>
                </tr>
              </tbody>
            </table>
          </form>
          ...
          <table class="tool-table new" width="100%">
            <thead>
              <tr role="row" class="heading">
                <th width="8%">#</th>
                <th width="40%"><strong style="margin-top: 5px; margin-left: 8%; font-size: 18px;">Candidates who did not fill Skills</strong></th>
...
if($records!=NULL)
{
    ...
    //print_r($records); exit();?>
              <tr class="odd gradeX">
                ...
                <td><a href="<?php echo base_url(); ?>candidates_skill_summary/sentmail?candidate_id=<?php echo $result['candidate_id']; ?>" class="btn btn-info btn-xs" title="Send Email to Candidate">Send</a></td>
               </tr>
              <?php
		 }}else{?>
              <tr>
