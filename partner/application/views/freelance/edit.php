...
<tbody>
   ...
   <form action="<?php echo $this->config->site_url();?>/freelance/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
  <?php echo form_hidden('part_id', $formdata["part_id"]);?>
...
<tr>
  ...
  <input type="text" class="form-control" placeholder="Enter text" value="<?php echo $formdata["start_date"] ?>"  name="start_date" id="start_date">
