...
<a href="<?php echo base_url();?>country/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<table class="tool-table new">
    ...
    ?>
        <tr>
            ...
            <td>
            <a href="<?php echo base_url();?>country/edit/<?php echo $result['country_id']?>" class="views" 
            title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
            <a href="<?php echo base_url();?>country/delete/<?php echo $result['country_id']?>" class="views" 
