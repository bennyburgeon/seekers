...
<a href="#"  onClick="manage_shift_vacancy(1,<?php echo $next_month;?>,<?php echo $next_year;?>);" >Next</a><br>
        ...
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>pre_screen/update_shift_vacancy" id="assignment_form" name="assignment_form"> 
...
?>
         <span class="click-icons">
                  ...
                  data-url="<?php echo $this->config->site_url();?>pre_screen/update_shift_vacancy" />
                  </span>
</form>
