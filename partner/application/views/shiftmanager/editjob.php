...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li><a href="<?php echo $this->config->site_url();?>/shiftmanager">Jobs</a>
...
<form action="<?php echo $this->config->site_url();?>/shiftmanager/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
 <?php echo form_hidden('client_shift_id', $formdata['client_shift_id']);?>
