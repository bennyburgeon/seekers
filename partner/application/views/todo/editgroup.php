...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/todogroup/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
   <?php echo form_hidden('todo_group_id', $formdata['todo_group_id']);?>
<tr>
