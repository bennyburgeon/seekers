...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/my_company/add?<?php echo $query_string;?>" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
    <tr>
    <td> Company Name</td>
