...
<tbody>
   ...
   <form action="<?php echo $this->config->site_url();?>/hrpartners/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
  <?php echo form_hidden('hr_partner_id', $formdata["hr_partner_id"]);?>

    <tr>
    <td>HR Partner Code</td>
    <td><input type="text" class="form-control" placeholder="Enter text" value="<?php echo $formdata["hr_partner_code"] ?>"  name="hr_partner_code" id="hr_partner_code"></td>
    </tr>
...
<tr>
<td>Mobile</td>
<td><input type="text" class="form-control" placeholder="Mobile" value="<?php echo $formdata["mobile"] ?>"  name="mobile" id="mobile"></td>
</tr>
...
<tr>
  ...
  <a href="<?php echo $this->config->site_url();?>/hrpartners" class="attach-subs subs">Cancel</a>
  </span>
  </td>
</tr>
</form>
...
if($('#hr_partner_code').val()=='')
{
	alert('Enter Partner Code');
	$('#hr_partner_code').focus();
	return false;
}
if($('#firstname').val()=='')
{
