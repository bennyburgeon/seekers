...
<div class="profile_top_left">Summary &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url();?>index.php/jobsmanager/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/jobsmanager/add_candidate/<?php echo $formdata['job_id'];?>">Add New Candidate</a></div>  
            ...
            <tr>
              <td colspan="2" align="center" valign="top">
                <div class="tab-head mar-spec">
                  <h3>Candidates Applied&nbsp;&nbsp;[<?php echo count($applied_candidates);?>]&nbsp;&nbsp; [Rejected and shortlisted will not be in this list.]</h3><div style="float:right;"><a id="toggle_applied" href="javascript:;" class="tab-head mar-spec">Show/Hide</a></div>
                </div>
...
<tr id="candidate_applied_list">
  ...
  <tbody>
    <tr>
      ...
      <div style="float:left">CV Source:<a href="javascript:;" title="CV Source"  id="cv_source" class="btn btn-info btn-xs"><?php if($candidate['lead_source']==1)echo 'Recruiter';if($candidate['lead_source']==2)echo 'Web/Social Media';if($candidate['lead_source']==3)echo 'Vendor';if($candidate['lead_source']==4)echo 'Mobile';if($candidate['lead_source']==5 || $candidate['lead_source']=='')echo 'Source not updated';?></a></div>
      
        <?php if($candidate['total_calls']>0){?>
        
        <a href="javascript:;" title="<?php echo $candidate['last_call_date'];?> | <?php echo $candidate['last_call_note'];?> | <?php if($candidate['cur_job_status']==1)echo 'No Job';if($candidate['cur_job_status']==2)echo 'Working, But Need a Change';if($candidate['cur_job_status']==3)echo 'Not Interested';if($candidate['cur_job_status']==4)echo 'Seeking Good Opportunity';if($candidate['cur_job_status']==5)echo 'Need a change ';if($candidate['cur_job_status']==6)echo 'Call after 1 Year';if($candidate['cur_job_status']==7)echo 'Call after this month ';?>" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Calls [<?php echo $candidate['total_calls'];?>] </a>
        
        
        <?php }else{ ?>
        <a href="javascript:;" title="No Calls Made" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-danger btn-xs"> Calls [?] </a>
        <?php }?>
        
        <a href="javascript:;" title="Update CTC" onclick="add_ctc(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/add_ctc/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="update_ctc" class="btn btn-info btn-xs"> CTC </a>
        
        <a href="javascript:;" title="Add Notes" onclick="add_notes(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/add_notes/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_notes" class="btn btn-info btn-xs"> Notes </a>
        
        <a href="javascript:;" title="Send Message" onclick="add_message(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/add_message/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_msg" class="btn btn-info btn-xs"> Msg </a>

        
        <a href="javascript:;" title="Short List this candidate" onclick="add_to_shortlist(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/add_to_shortlist/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_to_shortlist" class="btn btn-info btn-xs"> Short List </a>
        
        <a href="javascript:;" data-url="<?php echo base_url(); ?>index.php/jobsmanager/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>

        <a href="javascript:;" title="Change Job"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/change_job/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>" onclick="manage_job_change(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" id="change_job" class="btn btn-info btn-xs"> Change Job </a>

  <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/send_jd/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a> &nbsp; 
  
  <?php if($candidate['cv_file']!='' && file_exists('uploads/cvs/'.$candidate['cv_file'])){?>
  <a href="javascript:;" onclick="candidate_cv(<?php echo $candidate['candidate_id'];?>);" id="download_cv" data-url="<?php echo base_url();?>index.php/jobsmanager/download_cv/<?php echo $candidate['candidate_id']?>" title="View CV" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i> CV</a>
  <?php }else{ ?>
...
<tr>
              <td colspan="2" align="center" valign="top">
                <div class="tab-head mar-spec"><h3>Candidates Rejected &nbsp;&nbsp;[<?php echo count($rejected_candidates);?>]</h3><div style="float:right;"><a id="toggle_rejected" href="javascript:;" class="tab-head mar-spec">Show/Hide</a></div></div>  
              </td>
</tr>

<tr id="candidate_rejected">
    <td colspan="2" align="center" valign="top">
...
<tr>
	<td colspan="2" align="center" valign="top" id="short" <?php  if(empty($shortlisted)) { ?> class="hide" <?php } ?>>
      ...
      <div style="float:right;"><a id="toggle_shortlisted" href="javascript:;" class="tab-head mar-spec">Show/Hide</a></div>
...
<tr id="candidate_shortlisted">
    ...
    <td colspan="2" align="center" valign="top">
     ...
     <a href='javascript:;'  onclick="send_shortlisted(<?php echo $formdata['job_id'];?>);" class="btn btn-warning btn-xs">Sent This to Client</a><br><br>

<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobsmanager/send_shortlisted"  method="post" id="shortlisted_form" name="shortlisted_form"> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            -->
            <p id="result"></p>
            <p id="deletemessage">All selected candidates will be marked as 'Sent To Client.'</p>
...
<!-- 
     ...
     -->       
              <input type="button" class="attach-subs" value="Change Status" id="save_shortlisted" style="width:180px;" 
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/send_shortlisted" />
        </div>
...
<p>Submission:<?php echo $candidate['total_submission'];?> Times.</p>
         ...
         <td width="14%"><?php if($candidate['app_status_id']==3){?> <a href='javascript:;'  onclick="add_interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a>  || <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">Remove</a> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
        <thead>
          ...
          <?php if($interview['total_rejection']==0  && $interview['selected']==0){?>       
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a>
                    ...
                    <a href="javascript:;" onclick="reject_interview_fn(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $interview['interview_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/reject_interview/"  id="reject_interview" class="btn btn-danger btn-xs">Reject </a>
                    <?php }else{ ?>
               ...
               <tr>
                  ...
                  <?php foreach($candidates_selected as $selected){?>
                    ...
                    <tr>
                      ...
                      <a href='javascript:;' onclick="issue_offer(<?php echo $formdata['job_id'];?>,<?php echo $selected['app_id'];?>,<?php echo $selected['candidate_id'];?>);" id="issue_offer" class="btn btn-info btn-xs"> Issue Offer </a> &nbsp;<a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/delete_selectedcandidate/?job_app_id=<?php echo $selected['app_id'];?>&candidate_id=<?php echo $selected['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_selected_candidate" class="btn btn-danger btn-xs">X </a>
                      <?php }else{ ?>
                      Offered
                      <?php } ?>
...
<tr>
    ...
    <?php if($offerletter['offer_status']==1){?>		
      ...
      <a href="javascript:;" onclick="accept_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-success btn-xs"> Accept </a>  <a href="javascript:;" onclick="reject_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-warning btn-xs"> Reject </a>&nbsp;<a href="javascript:;"  data-url="<?php echo base_url().'index.php/jobsmanager/delete_offercandidate/?job_app_id='.$offerletter['app_id'].'&candidate_id='.$offerletter['candidate_id'].'&job_id='.$formdata['job_id'];?>"  id="delete_offer_candidate" class="btn btn-danger btn-xs">X </a>
        ...
        <?php 
			...
			?>
				<tr>
                 ...
                 <p> <a href="javascript:;" onclick="create_invoice(<?php echo $formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id']?>);" class="btn btn-primary btn-xs">Invoice</a>&nbsp;<a href="javascript:;" data-url="<?php echo base_url().'index.php/jobsmanager/delete_acceptcandidate/?job_id='.$formdata['job_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id']?>" id="delete_accept_candidate" class="btn btn-danger btn-xs">X </a></p></td>
          ...
          <tbody >
              ...
              <?php foreach($invoice_generated as $invoice){?>                                                
                ...
                <tr>
                  ...
                  <td>
                  <p><!--
                  <a href="<?php echo base_url(); ?>index.php/jobsmanager/create_invoice/?job_id=<?php echo $formdata['job_id'];?>/?placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>" class="btn btn-primary btn-xs">Edit</a> -->
                  <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/jobsmanager/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" class="btn btn-danger btn-xs">X</a>
                   </p>       
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="calls_form" name="calls_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/add_calls" />
...
<br>
            ...
            <form class="form-horizontal form-bordered"  method="post" id="add_to_shortlist_form"  action="<?php echo $this->config->site_url();?>/jobsmanager/add_to_shortlist"  name="add_to_shortlist_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/add_to_shortlist" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobsmanager/manage_rejection"  method="post" id="rejection_form" name="rejection_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/manage_rejection" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobsmanager/save_job_change"  method="post" id="change_form" name="change_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/save_job_change" />
...
<form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobsmanager/add_feedback"  method="post" id="feedback_form" name="feedback_form">
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/add_feedback" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="ctc_form" name="ctc_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/add_ctc" />
        ...
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="notes_form" name="notes_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/add_notes" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>/jobsmanager/add_message"  method="post" id="message_form" name="message_form"> 
			...
			<tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/add_message" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobsmanager/addinterview"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/addinterview" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
            ...
            <form class="form-horizontal form-bordered"  method="post" id="reject_interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>/jobsmanager/reject_interview"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobsmanager/reject_interview"/>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                             ...
                             data-url="<?php echo base_url(); ?>index.php/jobsmanager/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>" />
                              </span>
                          </td>
                	   </tr>
                      </tbody>
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobsmanager/issue_offer" />
                	...
                	<tbody>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobsmanager/reject_offer" />
	...
	<?php //echo form_input(array('name'=>'min_contract_months', 'class' => 'smallinput'));?> </td>
                      ...
                      <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobsmanager/accept_offer2" />
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>/jobsmanager/create_invoice2" />
...
{ 
	$.ajax({
	   type: 'POST',
		data: {job_id:job_id},
		dataType: "json",
	   url: '<?php echo base_url(); ?>index.php/jobsmanager/get_select_candidate/',
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>index.php/jobsmanager/get_offer_issued/',	
	   success: function(data){ 
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>index.php/jobsmanager/get_offer_accepted/',	
	   success: function(data){	
...
function candidate_profile(job_id){
	...
	$('#show_candidate_profile').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobsmanager/candidate_profile/"+job_id,
			method: "POST",
  			data: { job_id : job_id },
		    dataType: "html",
			success: function(data) 
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobsmanager/download_cv/"+candidate_id,
			method: "POST",
