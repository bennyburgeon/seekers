...
<a href="<?php echo base_url();?>skill_mgmt/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<table class="tool-table new">
    ...
    <tbody>
            ...
            <tr>
                    ...
                    <td>
                    <a href="<?php echo base_url();?>skill_mgmt/edit/<?php echo $result["id"];?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
            <a href="<?php echo base_url();?>skill_mgmt/delete/<?php echo $result["id"];?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
                    </td>
            </tr>
