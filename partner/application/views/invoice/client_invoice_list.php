        ...
        <div class="table-tech specs">
          ...
          <table class="tool-table">
            ...
            <tr>
              ...
              <td><input type="submit" id="submit"  value="Search" class="btn btn-primary btn-circle" /></td>
            </tr>
            <!--</form>-->
	...
	if($records!=NULL)
	{
		foreach($records as $result){ ?>
              <tr class="odd gradeX">
				...
				<?php //if($result['invoice_date']==0){echo '';}else{ echo date("d-m-Y", strtotime($result['invoice_date']));}?>
