...
<footer class="login_footer"><?php echo $this->config->item('powered_by_address')?><?php echo $this->config->item('powered_by_address1')?> || <?php echo $this->config->item('powered_by_phone')?> || <?php echo $this->config->item('powered_by_email')?></footer>
<!--scripts-->
