...
function profile_complete() 
{
	...
	$.ajax({
		type: "post",
		url: "<?php echo site_url('candidates/check_profile_complete'); ?>"+'/'+candidateId,
...
//CONTACT DETAILS VALIDATION AND SUBMIT
   ...
   $('#edit_candidate1').click(function(){
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/editCandidateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PASSPORT DETAILS
   ...
   $('#edit_candidate2').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/editPassportDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN SKILLS AND CERTIFICATE
   $('#edit_candidate7').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/editSkillCertificateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
...
*/	    return true;
   ...
   $('#save_candidate3').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/addEducationDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PANNING JOB DEATILS
   ...
   $('#edit_candidate8').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/editJobChangeDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE EDUCATION
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/deleteEducationDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { edu_id:edu_id},
				success: function(json){
					try{		
...
//BEGIN JOB DETAILS
   ...
   $('#edit_candidate4').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/addJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE JOB
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates/deleteJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { job_id:job_id},
				success: function(json){
					try{		
...
//BEGIN FILE DETAILS
	$('#candidate_form5').submit(function(evt){
        ...
        $.ajax({
			...
			type: 'POST',
			url: "<?php echo site_url('candidates/editfiles'); ?>"+'/'+candidateId,
			data:formData,
			cache:false,
			contentType: false,
			processData: false,
		...
		/*$(this).ajaxSubmit({success:function(data){ 
			...
			if(($.trim(data)=='Add title')||($.trim(data) == 'Invalid file format')||($.trim(data) == 'Choose file')||($.trim(data) == 'Image file size max 1 MB')||($.trim(data) == 'failed')){
				...
				window.location.href = '<?php echo $this->config->site_url();?>/candidates/';
			}	
		}*/
		});
});
...
//BEGIN DELETE PHOTO
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('candidates/photo_delete'); ?>"+'/'+candidateId,
			cache: false,				
...
//BEGIN DELETE CV
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('candidates/cv_delete'); ?>"+'/'+candidateId,
			cache: false,				
...
$('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/candidates/getstate/',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/candidates/getcity/',
...
$('#city_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/candidates/getlocation/',
 ...
 $('#organization').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/candidates/get_all_organisation', type: "GET", data:{organization: $('#organization').val()},dataType: "json", success:function(data) 																																							   {
		 if (data == null) 
		 {
 ...
 $('#designation').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/candidates/get_all_designation', type: "GET", data:{designation: $('#designation').val()},dataType: "json", success:function(data) {
     if (data == null) {
      $(".ui-autocomplete").hide();
     } else {
      response(data);
 ...
 $('#responsibility').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/candidates/get_all_responsibility', type: "GET", data:{responsibility: $('#responsibility').val()},dataType: "json", success:function(data) {
     if (data == null) {
      $(".ui-autocomplete").hide();
     } else {
      response(data);
