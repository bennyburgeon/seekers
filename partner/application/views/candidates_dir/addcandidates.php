        ...
        <div id ="step1">
          <div class="table-tech specs hor">
            <table class="hori-form">
              <tbody>
              <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo $this->config->site_url();?>candidates_dir/addCandidate">
                <input type="hidden"  name="linkedin_url" value="" >
                <input type="hidden" name="facebook_url" value="">
                <input type="hidden" name="last_name" value="">
                <input type="hidden" name="vendor_id" value="<?php echo $_SESSION['vendor_session']; ?>">
                <tr>
                  <td>Title</td>
                  <td><?php 
												$options = array(
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0">
                      <tbody>
                        <tr>
                          <td>Cur CTC</td>
                          <td><input class="form-control hori" style="width:100%;" type="text" name="current_ctc" value="<?php echo $formdata['current_ctc'];?>" placeholder="Cur. CTC"></td>
                          <td>Exp. CTC</td>
                          <td><input class="form-control hori" style="width:100%;" type="text" name="expected_ctc" value="<?php echo $formdata['expected_ctc'];?>" placeholder="Exp. CTC"></td>
                          <td>Notice</td>
                          <td><input class="form-control hori" style="width:100%;" type="text" name="notice_period" value="<?php echo $formdata['notice_period'];?>" placeholder="Notice"></td>
                          <td>Total Exp.</td>
                          <td><input class="form-control hori" style="width:100%;" type="text" name="total_experience" value="<?php echo $formdata['total_experience'];?>" placeholder="Total Exp."></td>
                        </tr>
                      </tbody>
                    </table></td>
                </tr>
                ...
                <tr>
                  <td colspan="2"><span class="click-icons">
                    <input type="submit" class="attach-subs" value="Save & Continue" id="save_candidate" style="width:180px;" 
                                            data-url="<?php echo $this->config->site_url();?>candidates_dir/addCandidate" />
                    <a href="<?php echo $this->config->site_url();?>candidates_dir" class="attach-subs subs">Back</a></span></td>
                    </span>
                    </td>
                </tr>
              </form>
...
function check_email()
{
	var pattern=/^([a-zA-Z0-9_.-])+@([a-zA-Z0-9_.-])+\.([a-zA-Z])+([a-zA-Z])+/;
		...
		if(!pattern.test($('#username').val())){
			...
			$.ajax({
				type: "post",
				url: "<?php echo $this->config->site_url();?>candidates_dir/check_email",
				cache: false,				
...
//END CHECK EMAIL
   ...
   function candidate_validate() {
		...
		var mobile_check=getValidNumber($('#job_id').val());
		if(mobile_check==false)
		{
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) 
						{
                            ...
                            window.location.href = "<?php echo site_url('candidates_dir/summary'); ?>" +'/'+ id;
