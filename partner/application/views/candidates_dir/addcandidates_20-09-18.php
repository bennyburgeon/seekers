            ...
            <table class="hori-form">
              ...
              <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo $this->config->site_url();?>/candidates_dir/addCandidate">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0">
                      <tbody>
                        <tr>
                          <td>Cur CTC</td>
                          <td><input class="form-control hori" style="width:100px;" type="text" name="current_ctc" value="<?php echo $formdata['current_ctc'];?>" placeholder="Cur. CTC"></td>
                          <td>Exp. CTC</td>
                ...
                <tr>
                  ...
                  <td><?php  echo form_dropdown('job_id',  $all_jobs_list, '','class="form-control" id="job_id" style="width:400px;"');?></td>
                </tr>
                <tr>
                  <td>Profile Status</td>
                  <td><?php echo form_dropdown('reg_status',  $reg_status_list, $formdata['reg_status'],'class="form-control " id="reg_status" style="width:150px"');?></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Industry</td>
                  <td><?php echo form_dropdown('job_cat_id', $industry_list, $formdata['job_cat_id'],'class="js-example-basic-single" id="job_cat_id"');?></td>
                </tr>
                <tr>
                  <td>Function/Department</td>
                  <td><?php echo form_dropdown('func_id', $department_list, $formdata['func_id'],'class="js-example-basic-single" id="func_id"');?></td>
                </tr>
                <tr>
                  <td>Role/Designation</td>
                  <td><?php echo form_dropdown('desig_id', $roles_list, $formdata['desig_id'],'class="js-example-basic-single" id="desig_id"');?></td>
                </tr>
                <tr>
                  <td>Job Folder</td>
                  <td><?php echo form_dropdown('job_folder_id', $job_folders, $formdata['job_folder_id'],'class="js-example-basic-single" id="job_folder_id"');?></td>
                </tr>
                <tr>
                  <td>Present Job Status</td>
                  <td><?php echo form_dropdown('cur_job_status', $job_status, $formdata['cur_job_status'],'class="js-example-basic-single" id="cur_job_status"  id="country_id" ');?></td>
                </tr>
                <!--       
