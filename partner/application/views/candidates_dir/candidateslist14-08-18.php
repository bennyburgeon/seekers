        ...
        <table class="tool-table" border="1">
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo form_dropdown('pref_city_id', $pref_city_list, $pref_city_id,' id="pref_city_id"  style="width:90px"');?></td>                </tr>
                <tr>
...
<table class="tool-table new">
    ...
    ?>
        ...
        <tr class="odd gradeX">
            ...
            <br> Present/Last Organization:<?php if($result['current_organization']!='')echo $result['current_organization'];else echo 'Not Updated';?>
            <br> Highest Education:<?php if($result['current_organization']!='')echo $result['current_organization'];else echo 'Not Updated';?>
            <br>
            
            <?php if($result['client_cv_file']==''){?>
             <br>

             <a href="<?php echo base_url();?>index.php/candidates_dir/summary/<?php echo $result['candidate_id']?>" target="_blank" title="Client CV not uploaded" id="open_candidate_profile" class="btn btn-danger btn-xs">Client CV not uploaded</a>
<br>
             <?php } ?>
