...
<a href="<?php echo base_url();?>index.php/candidates_dir/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>

|| <a href="<?php echo base_url(); ?>index.php/candidates_dir" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a>
...
<!-- 
        ...
        <table class="tool-table" border="1">
            <tbody>
                ...
                <tr>
                    <td><?php echo form_dropdown('job_cat_id', $industry_list, $job_cat_id,' id="job_cat_id" style="width:200px"');?></td>                  
                    <td><?php echo form_dropdown('func_id', $department_list, $desig_id,' id="func_id"  style="width:200px"');?></td>                    
                    <td><?php echo form_dropdown('desig_id', $roles_list, $desig_id,' id="desig_id"  style="width:200px"');?></td>			
                    <td><?php echo form_dropdown('city_id', $city_list, $city_id,' id="city_id"  style="width:200px"');?></td>
                    <td><?php echo form_dropdown('pref_city_id', $pref_city_list, $pref_city_id,' id="pref_city_id"  style="width:200px"');?></td>                </tr>
                <tr>
                  <td><?php echo form_dropdown('job_folder_id',  $job_folders, $job_folder_id,' id="job_folder_id" style="width:200px"');?></td>
                  <td><?php echo form_dropdown('cur_job_status',  $job_status_list, $cur_job_status,' id="cur_job_status" style="width:200px"');?></td>
                  <td><?php echo form_dropdown('reg_status',  $reg_status_list, $reg_status,'  id="reg_status" style="width:200px"');?></td>
...
<table class="tool-table new">
    ...
    ?>
        ...
        <tr class="odd gradeX">
            ...
            <td>			
            <a href="<?php echo base_url();?>index.php/candidates_dir/summary/<?php echo $result['candidate_id']?>" target="_blank" class="views" title="View"> <strong><?php echo $result['first_name']?></strong></a> 
            ...
            <?php if($result['client_cv_file']==''){?>
             ...
             <a href="<?php echo base_url();?>index.php/candidates_dir/summary/<?php echo $result['candidate_id']?>" target="_blank" title="Client CV not uploaded" id="manage_shifts" class="btn btn-danger btn-xs">Client CV not uploaded</a>
<br>
             <?php } ?>
         ...
         <strong>Dont Know</strong>
            || 
             <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || 
             <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || 
             <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
            <?php } ?>

            <?php if($result['reg_status']=='1'){?>
               <br>
        <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> 
            || 
           <strong>Open For Job</strong>  || 
             <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || 
             <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
            <?php } ?>
...
<?php if($result['reg_status']=='2'){?>
        ...
        <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> 
           ...
           <strong> Placed</strong>|| 
             <a href="<?php echo $this->config->site_url()?>/candidates_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black List</a>
            <?php } ?>
...
function open_client_cv_doc(candidate_id)
{
	$('#show_client_cv_doc').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobs/client_cv_doc/?view="+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
