            ...
            <table class="hori-form">
              ...
              <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo $this->config->site_url();?>candidates_dir/addCandidate">
                ...
                <tr>
                  ...
                  <td><?php //echo form_dropdown('desig_id', $roles_list, $formdata['desig_id'],'class="js-example-basic-single" id="desig_id" style="width:100%"');?>
                    <?php echo form_dropdown('desig_id[]',  $roles_list, $formdata['desig_id'],'data-placeholder="Filter by Designations" class="form-control input-sm" id="desig_id" width:100%;"');?></td>
                </tr>
                <tr>
                  <td>Job Folder</td>
