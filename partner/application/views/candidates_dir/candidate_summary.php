    ...
    <div class="profile_top">
      ...
      <div class="profile_top_right">
        <ul>
          ...
          <li><!-- <a href="<?php echo base_url();?>index.phpcandidates_dir/candidate_delete/<?php echo md5($detail_list['candidate_id']);?>">Delete this profile</a>--></li>
        </ul>
      </div>
        ...
        <tr>
          ...
          <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#langModal">Update Language</a>  || 
            <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#primaryModal">Add Skills[Primary & Secondary]</a> 
              <!--|| <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#skillModal">Add Skills</a>--> || <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#certModal">Add Certifications</a> 
              
              || <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#projModal">Add Project</a>
              
              || <a href="javascript:;" title="Update Consultant's Feedback" onclick="add_consultant_feedback(<?php echo $formdata['candidate_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_consultant_feedback/?candidate_id=<?php echo $formdata['candidate_id'];?>"  id="add_consultant_feedback" class="btn btn-success btn-xs"> Consultant's Feedback</a>
        ...
        <tr>
          <td colspan="2" align="center" valign="top"><table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'index.phpcandidates_dir/delete_candidate_prof/?id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
                  
                  <!--    
                       <a href="<?php echo base_url().'index.phpcandidates_dir/summary/'.$candidate_id.'/?edit_job=1&job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile_url" class="btn btn-info btn-xs">Edit</a>  
                    
                       
                    
                    update with editor
                    --> 
                  <a href="javascript:void();" data-url="<?php echo base_url().'candidates_dir/loadEditJobhtml/?job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile" class="btn btn-info btn-xs">Edit Profession</a></td>
              </tr>
              <tr>
        ...
        <tr>
          <td colspan="2" align="center" valign="top"><table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'index.phpcandidates_dir/delete_candidate_proj/?id='.$val['project_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
               
                  <a href="javascript:void();" data-url="<?php echo base_url().'candidates_dir/loadEditProjhtml/?project_id='.$val['project_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_Project" class="btn btn-info btn-xs">Edit Project</a></td>
              </tr>
        ...
        <tr>
          <td colspan="2" align="center" valign="top" class="borderTopNone"><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'index.phpcandidates_dir/delete_candidate_contract/?';?>candidate_id=<?php echo $candidate_id?>" id="delete_candidate_followup" >Delete</a></td>
              </tr>
            </table></td>
        </tr>
        <?php } ?>
        ...
        <tr>
          <td colspan="2" align="center" valign="top"><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              <tbody>
                ...
                <tr>
                  <td width="13%"><a href="#"><?php echo $invoice['job_title'];?></a></td>
...
<div class="modal fade" id="projModal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="notes">
            ...
            <div class="table-tech  note" style="border:none;">
              <div class="new_notes">
                <p id="result"></p>
                <p id="deletemessage"></p>
                <form class="form-horizontal form-bordered"  method="post" id="proj_history_frm" name="proj_history_frm" action="<?php echo $this->config->site_url();?>candidates_dir/proj_history_2/<?php echo $candidate_id;?>" onSubmit="return proj_validate();">
                  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                  <table class="hori-form">
                    <tbody>
                    ...
                    <tr>
                    <td>Project Title</td>
                     <td> <input type="text" name="project_title" class="form-control" placeholder="Project Title"  id="project_title"> </td>
                    </tr>
                        
                         <tr>
                    <td>Project Url</td>
                     <td> <input type="text" name="project_links" class="form-control" placeholder="Project Url"  id="project_desc"> </td>
                    </tr>
                        
                         <tr>
                    <td>Project Description</td>
                     <td> <input type="text" name="project_desc" class="form-control" placeholder="Project Description"  id="project_desc"> </td>
                    </tr>
                        
                         <tr>
                    <td>Technologies Used</td>
                     <td> <input type="text" name="tech_used" class="form-control" placeholder="Technologies Used"  id="tech_used"> </td>
                    </tr>
...
<div class="modal fade" id="edit_Project_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        ...
        <div class="modal-body">
          <div class="col-md-15">
            <div class="notes"> 
              <!--Followup-->
              <div class="new_notes" id="proj_holder"> </div>
            </div>
          </div>
          <!-------------------------modal1 end------------------------------->
          <div style="clear:both;"></div>
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.phpcandidates_dir/download_cv_content/"+candidate_id,
			method: "POST",
...
<script type="text/javascript">
	...
	if($('#job_cat_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_dir/get_functional_by_industry/',
	...
	if($('#func_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_dir/get_designation_by_functional/',
	...
	$('#show_consultant_feedback').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>candidates_dir/open_consultant_feedback/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
