<form class="form-horizontal form-bordered" action="<?php echo site_url('candidates_dir/update_job_details'); ?>"  method="post" id="update_job_form" name="update_job_form" >
  ...
  <table class="hori-form">
    ...
    <tr>
      <td colspan="2"><span class="click-icons">
       ...
       <!-- <input type="button" class="attach-subs" onClick="window.location='<?php echo site_url('candidates_dir/summary'); ?>/'" value="Cancel" id="cancel_update_job_profile" style="width:180px;">-->
        </span></td>
    </tr>
    </tbody>
...
$('#job_cat_id_prof_edit').change(function() {
	...
	if($('#job_cat_id_prof_edit').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_dir/getdepartment/',
...
$('#func_id_prof_edit').change(function() {
	...
	if($('#func_id_prof_edit').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_dir/getdesignation/',
