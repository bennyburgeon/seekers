...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo $this->config->site_url();?>/contact/addfiles/<?php echo $candidate_id;?>" enctype="multipart/form-data"> 
...
<a href="<?php echo $this->config->site_url();?>/contact/summary/<?php echo $candidate_id;?>" class="attach-subs subs">Done</a></span></td>
</tr>
</tbody>
</table>
...
var candidateId = '<?php echo $candidate_id ?>';
		...
		$(this).ajaxSubmit({success:function(data){ 
			...
			if(($.trim(data)=='Choose cv file')||($.trim(data) == 'Choose photo')||($.trim(data) == 'Choose file')||($.trim(data) == 'Image file size max 1 MB')||($.trim(data) == 'failed')){
				...
				window.location.href = '<?php echo $this->config->site_url();?>/contact/summary/<?php echo $candidate_id;?>';
			}	
		}
		});
});
