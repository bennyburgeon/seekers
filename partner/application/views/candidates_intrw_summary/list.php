    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          ...
          <form id="searchForm" method="get" action="<?php echo $this->config->site_url()?>candidates_intrw_summary/">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="submit" id="submit" onclick="search_submit();" value="Search" class="btn btn-default btn-circle" style="width:100px" />
                    <a style="margin-left:13px" href="<?php echo base_url(); ?>candidates_intrw_summary" class="btn btn-default btn-circle" >Reset</a></td>
                </tr>
              </tbody>
            </table>
          </form>
          ...
          <table class="tool-table new" width="100%">
            <thead>
              <tr role="row" class="heading">
                <th width="8%">#</th>
                <th width="52%"><strong style="margin-top: 5px; margin-left: 8%; font-size: 18px;">Candidates Short listed and waiting for Interview</strong></th>
...
if($records!=NULL)
{
    ...
    //print_r($records); exit();?>
              <tr class="odd gradeX">
                ...
                <td><?php echo date('d-m-Y', strtotime($result['short_date'])); ?></td>
