...
function profile_complete() 
{
	...
	$.ajax({
		type: "post",
		url: "<?php echo site_url('verify_data/check_profile_complete'); ?>"+'/'+candidateId,
...
//CONTACT DETAILS VALIDATION AND SUBMIT
   ...
   $('#edit_candidate1').click(function(){
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/editCandidateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PASSPORT DETAILS
   ...
   $('#edit_candidate2').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/editPassportDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN SKILLS AND CERTIFICATE
   $('#edit_candidate7').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/editSkillCertificateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
...
*/	    return true;
   ...
   $('#save_candidate3').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/addEducationDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PANNING JOB DEATILS
   ...
   $('#edit_candidate8').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/editJobChangeDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE EDUCATION
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/deleteEducationDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { edu_id:edu_id},
				success: function(json){
					try{		
...
//BEGIN JOB DETAILS
   ...
   $('#edit_candidate4').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/addJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE JOB
	...
	{ 
		...
		if(isconfirm){
			$.ajax({
				type: "post",
				url: "<?php echo site_url('verify_data/deleteJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: { job_id:job_id},
				success: function(json){
					try{		
...
//BEGIN FILE DETAILS
	$('#candidate_form5').submit(function(evt){
        ...
        $.ajax({
			...
			type: 'POST',
			url: "<?php echo site_url('verify_data/editfiles'); ?>"+'/'+candidateId,
			data:formData,
			cache:false,
			contentType: false,
			processData: false,
		...
		/*$(this).ajaxSubmit({success:function(data){ 
			...
			if(($.trim(data)=='Add title')||($.trim(data) == 'Invalid file format')||($.trim(data) == 'Choose file')||($.trim(data) == 'Image file size max 1 MB')||($.trim(data) == 'failed')){
				...
				window.location.href = '<?php echo $this->config->site_url();?>/verify_data/';
			}	
		}*/
		});
});
...
//BEGIN DELETE PHOTO
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('verify_data/photo_delete'); ?>"+'/'+candidateId,
			cache: false,				
...
//BEGIN DELETE CV
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('verify_data/cv_delete'); ?>"+'/'+candidateId,
			cache: false,				
...
$('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/verify_data/getstate/',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/verify_data/getcity/',
...
$('#city_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/verify_data/getlocation/',
	...
	$('#level_id').change(function() 
	{
		...
		if($('#level_id').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/verify_data/getcourses/',
 ...
 $('#organization').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/verify_data/get_all_organisation', type: "GET", data:{organization: $('#organization').val()},dataType: "json", success:function(data) 																																							   {
		 if (data == null) 
		 {
 ...
 $('#designation').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/verify_data/get_all_designation', type: "GET", data:{designation: $('#designation').val()},dataType: "json", success:function(data) {
     if (data == null) {
      $(".ui-autocomplete").hide();
     } else {
      response(data);
 ...
 $('#responsibility').autocomplete({ 
  ...
  source: function(request, response){ 
   ...
   if( previous_request ) {
    ...
    $element.data('jqXHR',$.ajax({url:'<?php echo $this->config->site_url();?>/verify_data/get_all_responsibility', type: "GET", data:{responsibility: $('#responsibility').val()},dataType: "json", success:function(data) {
     if (data == null) {
      $(".ui-autocomplete").hide();
     } else {
      response(data);
