    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          <div class="right-btns"> <a href="<?php echo base_url();?>index.php/company/add?<?php echo $query_string;?>" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> 
...
--> 
            ...
            <a href="<?php echo base_url(); ?>index.php/company" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a> </div>
          <form id="searchForm" action="<?php echo base_url(); ?>index.php/company" method="get" name="searchForm">
            <table width="47%" class="tool-table">
              <tbody>
                <tr>
                  <td width="17%"><input class="form-control" type="text" name="searchterm" id="search_term" placeholder="Company Name" value="<?php echo $searchterm != '' ? $searchterm: '' ;?>"     style="width: 200px;"></td>
...
if($records!=NULL)
{
	foreach($records as $result){ ?>
                <tr class="odd gradeX">
                  ...
                  <td><a href="<?php echo base_url();?>index.php/company/edit/<?php echo $result['company_id']?>" class="views" title="Edit This Company"><?php echo $result['company_name']?></a><br>
                    ...
                    Flp Date: <a href="javascript:void();" class="btn btn-success btn-xs"><?php echo $result['flp_date']?></a> ||  Next Date: <a href="javascript:void();" class="btn btn-warning btn-xs"><?php echo $result['flp_next_date'];?></a> || Upd By:
			...
			?>
                  ...
                  <td><a href="javascript:;" title="Make Calls" onclick="add_calls(<?php echo $result['company_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/company/add_calls/?company_id=<?php echo $result['company_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Calls</a> || <a href="<?php echo base_url(); ?>index.php/company/edit/<?php echo $result['company_id'];?>" title="Edit"   id="edit_company" class="btn btn-info btn-xs"> Edit</a> 
