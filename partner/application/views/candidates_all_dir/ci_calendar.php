 ...
 <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/candidates_all_dir/update_job_vacancy" id="job_assignment_form" name="assignment_form"> 
...
<input type="button" value="Submit" data-url="<?php echo $this->config->site_url();?>/candidates_all_dir/update_job_vacancy" id="save_job_app_button" >
</form>