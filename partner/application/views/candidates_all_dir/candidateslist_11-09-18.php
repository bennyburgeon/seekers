...
function connect_with_jobs(candidate_id)
{
	...
	$('#shift_data_holder').html('Loading..................');	
	 $.ajax({
			type: 'POST',
			url:"<?php echo $this->config->site_url()?>/candidates_all_dir/get_short_company",
...
$(document).on('click', '#edit_candidate_all_dir', function()
{ 
	 ...
	 $.ajax({	
	   ...
	   success: function (data) {
			...
			$('#location').val(data.location);			 
			 ...
			 $('#save_candidate_all_dir').val("Update Data");
   		 }			
	 }); 
});
