  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="table-tech specs">
        <div class="right-btns"> <a href="<?php echo base_url();?>index.php/candidates_all_dir/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> || <a href="<?php echo base_url(); ?>index.php/candidates_all_dir" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a> </div>
        
        <!-- 
<div class="actions">
<a href="<?php echo site_url('candidates_all_dir/import_csv');?>" class="btn btn-default btn-circle">
    ...
    ?>
              <tr class="odd gradeX">
                ...
                <td><?php if($result['photo']!=''){?>
                  ...
                  <?php } ?></td>
                <td><a href="<?php echo base_url();?>index.php/candidates_all_dir/summary/<?php echo $result['candidate_id']?>" target="_blank" class="views" title="View"> <strong><?php echo $result['first_name']?></strong></a> || <?php echo $result['username'];?> || <strong><?php echo $result['mobile'];?></strong> 
            ...
            --> 
                  ...
                  Notice Period: <b><?php echo $result['notice_period'];?> Days </b>&nbsp;<br>
                   Total Shortlists: <b><?php echo $result['total_shortlists'];?> </b>&nbsp;<br>
                  
                   <?php if($result['client_cv_file']==''){?>
                  <br>
                  <a href="<?php echo base_url();?>index.php/candidates_all_dir/summary/<?php echo $result['candidate_id']?>" target="_blank" title="Client CV not uploaded" id="open_candidate_profile" class="btn btn-danger btn-xs">Client CV not uploaded</a> <br>
                  <?php } ?>
                  
                  <?php if($result['reg_status']=='0'){?>
                  <br>
                  <strong>Dont Know</strong> || <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
                  <?php } ?>
                  <?php if($result['reg_status']=='1'){?>
                  <br>
                  <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <strong>Open For Job</strong> || <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
                  <?php } ?>
                  <?php if($result['reg_status']=='2'){?>
                  <br>
                  <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || <strong> Placed</strong>|| <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black List</a>
                  <?php } ?>
                  <?php if($result['reg_status']=='3'){?>
                  <br>
                  <a href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <a  href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open for Job</a> || <a  href="<?php echo $this->config->site_url()?>/candidates_all_dir/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <strong>Black Listed </strong>
                  <?php } ?>
                  <br>
                  <br>
           ...
           --> 
                  ...
                  <a href="javascript:;" title="Update & View Note" onclick="add_candidate_notes(<?php echo $result['candidate_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs/get_all_notes/?candidate_id=<?php echo $result['candidate_id'];?>"  id="add_candidate_notes" class="btn btn-<?php if($result['total_notes']>0)echo 'info';else echo 'danger';?> btn-xs"> Add Notes</a>
                   || <a href="javascript:;" title="Shortlist Candidates, see the list of jobs" onclick="connect_with_jobs(<?php echo $result['candidate_id'];?>);"  id="manage_shortlists" class="btn btn-info btn-xs">Shortlisted List</a>
                 ...
                 || <a href="<?php echo base_url(); ?>index.php/candidates_all_dir/candidate_delete/?candidate_id=<?php echo $result['candidate_id']?>" onClick=" return confirm('Are you sure ? Delete Candidate?');" class="btn btn-danger btn-xs">Delete Candidate</a>&nbsp;&nbsp;</span>
                  </td>
...
function connect_with_jobs(candidate_id)
{
	...
	$('#shift_data_holder').html('Loading..................');	
	 $.ajax({
			type: 'POST',
			url:"<?php echo $this->config->site_url()?>/candidates_all_dir/get_company_lists",
...
$(document).on('click', '#edit_shortlisted_lists', function()
{ 
	 ...
	 $.ajax({	
	   ...
	   success: function (data) {
			...
			$('#location').val(data.location);			 
			 ...
			 $('#save_company_updates').val("Update Data");
   		 }			
	 }); 
});
