...
<li id="tab_2btn">Send SMS & Email</li>
   ...
   <p id="emails"></p>
 <p id="emaildelete"></p>
    <form action="<?php echo $this->config->site_url();?>candidates_profile/email_sms/<?php echo $detail_list['candidate_id'];?>" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onsubmit="return email_validate();" >  
...
<script type="text/javascript">
		...
		$.ajax({
			type:"POST",
			url: '<?php echo site_url('candidates_profile/drop_email_sms_item'); ?>',
			data:{ 
