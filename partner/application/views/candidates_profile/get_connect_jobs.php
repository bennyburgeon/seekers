...
<table width="100%" border="1">
  <tbody>
    ...
    <tr>
      <td  width="60%" align="left" valign="top"><form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>candidates_profile/update_job_vacancy" id="job_assignment_form" name="assignment_form">
...
?>
          ...
          <?php } ?>
          <br>
          <input type="button" value="Add To These Jobs" data-url="<?php echo $this->config->site_url();?>candidates_profile/update_job_vacancy" id="save_job_app_button" >
        </form></td>
