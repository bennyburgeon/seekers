  ...
  <div class="col-md-12">
    <div class="profile_top">
      ...
      <div class="profile_top_right">
        <ul>
          <li><a href="<?php echo $this->config->site_url();?>candidates_profile/add" >Add New</a></li>
          <li><a href="<?php echo $this->config->site_url();?>candidates_profile" >List All</a></li>
              ...
              <div class="col-sm-16">
                ...
                <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    ...
                    <td>Current CTC</td>
                    <td><?php if(isset($job_search['current_ctc'])) echo  $this->config->item('currency_symbol');?>
                  ...
                  <tr>
                    ...
                    <td>Expeced CTC</td>
                    <td><?php if(isset($job_search['expected_ctc'])) echo  $this->config->item('currency_symbol');?>
                ...
                ?>
                  ...
                  <?php 				
                    ...
                    ?>
                     <?php if(is_array($qualification_level)){?>
          <tr>
            <td colspan="4">Qualifications: <?php echo implode(',',$qualification_level);?></td>
          </tr>
          <?php 				
                    }									
                    ?>
                ...
                <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  <tr>
                    <td width="22%"><?php if(file_exists('uploads/photos/'.$formdata['photo']) && $formdata['photo']!=''){?>
                      ...
                      <br />
                      <a href="<?php echo site_url().'candidates_profile/delete_photo/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Photo?');" style="color:#0033FF">Delete Photo</a>&nbsp;&nbsp;</span>
                      <?php }else{ ?>
                      <img src="<?php echo base_url().'uploads/no_photo.png';?>">
                      <?php } ?></td>
                    <td width="78%"><form class="form-horizontal form-bordered"  method="post" id="upload_cv_photo_frm" name="upload_cv_photo_frm" action="<?php echo $this->config->site_url();?>candidates_profile/upload_cv_photo/<?php echo $formdata['candidate_id'];?>" enctype="multipart/form-data">
                  ...
                  <tr>
                    <td colspan="2"><!-- 
                                <a href="<?php echo base_url().'index.phpcandidates_dir/print_cv/'.$candidate_id;?>" target="_blank" class="btn btn-info btn-sm">Print CV</a> -->
                      
                      <?php if($formdata['cv_file']!=''){?>
                      <a href="<?php echo base_url().'uploads/cvs/'.$formdata['cv_file'];?>" target="_blank" class="btn btn-success btn-sm">Download Candidate CV</a> <a href="<?php echo site_url().'candidates_profile/delete_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Candidate CV?');" class="btn btn-danger btn-sm">Delete Candidate CV</a>
                      <?php } ?>
                      <?php if($formdata['client_cv_file']!=''){?>
                      || <a href="<?php echo base_url().'uploads/client_cvs/'.$formdata['client_cv_file'];?>" target="_blank" class="btn btn-success btn-sm">Download Client CV</a> <a href="<?php echo site_url().'candidates_profile/delete_client_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Client CV?');" class="btn btn-danger btn-sm">Delete Client CV</a>
                      <?php } ?></td>
                  </tr>
                </table>
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'index.phpcandidates_dir/delete_candidate_prof/?id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
                  ...
                  <!--    
                    ...
                    update with editor
                    --> 
                  <a href="javascript:void();" data-url="<?php echo base_url().'index.phpcandidates_dir/loadEditJobhtml/?job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile" class="btn btn-info btn-xs">Edit Profession</a></td>
              </tr>
              <tr>
    ...
    <tr>
            ...
            <thead>
             	 ...
             	 <tbody>
                        ...
                        <td width="5%"><?php if($job['applied']==1) { echo "<span class='btn btn-success btn-xs disabled'>Applied</span>"; }else{?> <a href="<?php echo $this->config->site_url();?>candidates_profile/apply_job/<?php echo $candidate_id;?>/<?php  echo $job['job_id'];?>" title="Click here to apply job." class="btn btn-primary btn-xs"> Apply </a><?php } ?></td>
      ...
      <div class="notes">
        ...
        <div class="table-tech specs note">
          <div class="new_notes">
            ...
            <p id="emails"></p>
            <p id="emaildelete"></p>
            <form action="<?php echo $this->config->site_url();?>candidates_profile/manage_email/<?php echo $candidate_id;?>" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onsubmit="return email_validate();" >
    ...
    <div class="notes">
       <div class="alert alert-info"><strong>Info!</strong>&nbsp;Update Personal Details.</div>
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
                <form class="form-horizontal form-bordered"  method="post" id="update_candidate_profile" name="update_candidate_profile" action="<?php echo $this->config->site_url();?>candidates_profile/update_candidate_profile/<?php echo $candidate_id;?>" onSubmit="return validate_profile_form();">
                  ...
                  <table class="hori-form">
                    <tbody>
                      ...
                      <tr>
                        <td>DoB</td>
                        <td colspan="3"><input style="width:100%;" type="text" readonly name="date_of_birth" id="datepicker2" class="datepicker"                                 value="<?php echo $formdata['date_of_birth'];?>" placeholder="DoB"></td>
                      </tr>
                      <tr>
                        <td>Marital Status</td>
                        <td colspan="3"><?php 
                      ...
                      <tr>
                       <td>Qualification</td>
               <td colspan="3"><?php echo form_dropdown('level_id[]', $edu_level_list,array_keys($qualification_level),'class="js-example-basic-single" id="" multiple="multiple" style="height:150px; width: 100%;" ');?></td>
                  ...
                  <td><input type="radio" name="payment_status" value="1" <?php if($formdata['payment_status']==1) echo 'checked'; ?>>
                    ...
                    &nbsp; Unpaid </td>
                      ...
                      <tr>
                        ...
                        <td colspan="3"><?php //echo form_dropdown('pref_city_id', $current_location_list, array_keys($candidate_locations),'class="form-control" id="desig_id"');?>
						<?php echo form_dropdown('pref_city_id[]', $current_location_list,array_keys($candidate_locations),'class="js-example-basic-single" id="pref_city_id" multiple="multiple" style="height:150px; width: 100%;" ');?></td>
                      </tr>
                      <tr>
                        <td>Industry</td>
                      ...
                      <tr>
                        ...
                        <td colspan="3"><?php echo form_dropdown('func_id', $functional_list,$formdata['func_id'],'class="form-control" id="func_id"');?></td>
                      </tr>
                      <tr>
                        <td>Role/Designation</td>
                        <td colspan="3"><?php //echo form_dropdown('desig_id', $roles_list, array_keys($candidate_roles),'class="form-control" id="desig_id"');?><?php echo form_dropdown('desig_id[]', $roles_list,array_keys($candidate_roles),'class="js-example-basic-single" id="desig_id" multiple="multiple" style="height:150px; width: 100%;" ');?></td>
                      </tr>
                      <tr>
                        <td>Visa Type</td>
          ...
          <div class="notes">
            ...
            <div class="table-tech  note" style="border:none;">
              <div class="new_notes">
                <p id="result"></p>
                <p id="deletemessage"></p>
                <form class="form-horizontal form-bordered"  method="post" id="edu_history_frm" name="edu_history_frm" action="<?php echo $this->config->site_url();?>candidates_profile/edu_history_2/<?php echo $candidate_id;?>" onSubmit="return candidate_validate();">
                  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                  <table class="hori-form">
                    <tbody>
                      <tr>
          ...
          <div class="notes">
            ...
            <div class="table-tech  note" style="border:none;">
              <div class="new_notes">
                <p id="result"></p>
                <p id="deletemessage"></p>
                <form class="form-horizontal form-bordered"  method="post" id="job_history_frm" name="job_history_frm" action="<?php echo $this->config->site_url();?>candidates_profile/job_history_2/<?php echo $candidate_id;?>" onSubmit="return job_validate();" >
                  <table class="hori-form">
                    <tbody>
                    <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                    <tr>
          ...
          <div class="notes">
            ...
            <div class="table-tech  note" style="border:none;">
              <div class="new_notes">
                <p id="result"></p>
                <p id="deletemessage"></p>
                <form class="form-horizontal form-bordered"  method="post" id="candidate_validate" name="candidate_validate" action="<?php echo $this->config->site_url();?>candidates_profile/lang_history_2/<?php echo $candidate_id;?>">
                  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>" />
                  <table class="hori-form">
                    <tbody>
                      <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="skill_form" name="skill_form" action="<?php echo $this->config->site_url();?>candidates_profile/skills_2/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="cert_form" name="cert_form" action="<?php echo $this->config->site_url();?>candidates_profile/add_certification/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="cert_form" name="cert_form" action="<?php echo $this->config->site_url();?>candidates_profile/followup/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
                      <td>Enter Title</td>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="edit_category_frm" name="edit_category_frm" action="<?php echo $this->config->site_url();?>candidates_profile/editCategory/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
                      <td>&nbsp;</td>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="edit_skill_form" name="edit_skill_form" action="<?php echo $this->config->site_url();?>candidates_profile/editSkills/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr> </tr>
                    <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="add_contract_form" name="add_contract_form" action="<?php echo $this->config->site_url();?>candidates_profile/add_contract_details/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
                      <td>Company</td>
...
<!--SCRIPT FOR EDUCATION MODAL END-->
	...
	$('#multiple_category').change(function() 
	{
		...
		if($('#multiple_category').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>candidates_profile/getfunction_multiple/',
  ...
  if(window.confirm("Are You Sure to delete this data?")){  
	...
	{	
		...
		if($('#level_id').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>candidates_profile/getcourses/',
...
<script type="text/javascript">
	...
	if($('#job_cat_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_profile/get_functional_by_industry/',
	...
	if($('#func_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_profile/get_designation_by_functional/',
