  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="table-tech specs">
        <div class="right-btns"> <a href="<?php echo base_url();?>candidates_profile/import_csv" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Import CSV</a>|| <a href="<?php echo base_url();?>candidates_profile/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> || <a href="<?php echo base_url(); ?>candidates_profile" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a> </div>
        
        <!-- 
<div class="actions">
<a href="<?php echo site_url('candidates_profile/import_csv');?>" class="btn btn-default btn-circle">
...
--> 
        <br>
        <form id="searchForm" method="get" action="<?php echo $this->config->site_url()?>candidates_profile/">
          <!-- 
          ...
          <table class="tool-table" border="1">
            <tbody>
              <tr>
                <td><?php echo form_dropdown('job_cat_id', $industry_list, $job_cat_id,' id="job_cat_id" style="width:83px"');?></td>
                <td><?php echo form_dropdown('func_id', $department_list, $func_id,' id="func_id"  style="width:90px"');?></td>
                <td><?php echo form_dropdown('desig_id', $roles_list, $desig_id,' id="desig_id"  style="width:62px"');?></td>
                <td><?php echo form_dropdown('reg_status',  $reg_status_list, $reg_status,'  id="reg_status" style="width:100px"');?></td>
                <td><?php echo form_dropdown('expected_ctc_from',  $expected_ctc_from_array, $expected_ctc_from,' id="expected_ctc_from" style="width:95px"');?></td>
                ...
                <td><?php echo form_dropdown('total_experience_from',  $total_experience_from_array, $total_experience_from,' id="total_experience_from" style="width:95px"');?></td>
                <td><?php echo form_dropdown('level_id',  $edu_level_list, $level_id,' id="level_id" style="width:95px"');?></td>
                <td colspan="2">Payment Status:
                  <input type="radio" name="payment_status" value="1" <?php if($payment_status==1) echo 'checked'; ?>>
                  Paid
                  <input type="radio" name="payment_status" value="2" <?php if($payment_status==2) echo 'checked'; ?>>
                  Unpaid </td>
              </tr>
              <tr>
                <td><?php echo form_dropdown('job_folder_id',  $job_folders, $job_folder_id,' id="job_folder_id" style="width:83px"');?></td>
                <td><?php echo form_dropdown('cur_job_status',  $job_status_list, $cur_job_status,' id="cur_job_status" style="width:90px"');?></td>
                <td><?php echo form_dropdown('city_id', $city_list, $city_id,' id="city_id"  style="width:60px"');?></td>
                ...
                <td><?php echo form_dropdown('expected_ctc_to',  $expected_ctc_to_array, $expected_ctc_to,' id="expected_ctc_to" style="width:95px"');?></td>
                <td><?php echo form_dropdown('notice_period_to',  $notice_period_to_array, $notice_period_to,' id="notice_period_to" style="width:110px"');?></td>
                <td><?php echo form_dropdown('total_experience_to',  $total_experience_to_array, $total_experience_to,' id="total_experience_to" style="width:95px"');?></td>
                <td><?php echo form_dropdown('course_id',  $edu_course_list, $course_id,' id="course_id_edu" style="width:95px"');?></td>
          ...
          <table class="tool-table new">
            <thead>
              <tr role="row" class="heading">
                ...
                <th width="384"><a href="<?php echo $this->config->site_url()?>candidates_profile?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&limit=<?php echo $limit;?>&search_name=<?php echo $search_name;?>&search_email=<?php echo $search_email;?>&search_mobile=<?php echo $search_mobile;?>&rows=<?php echo $rows;?>"> Name</a></th>
              </tr>
            </thead>
            <tbody>
              <?php if($records!=NULL)
    ...
    ?>
              <tr class="odd gradeX">
                ...
                <td><?php if($result['photo']!=''){?>
                  ...
                  <?php } ?></td>
               <!-- <td><a href="<?php echo base_url();?>candidates_profile/summary/<?php echo $result['candidate_id']?>" target="_blank" class="views" title="View"> <strong><?php echo $result['first_name']?></strong></a> || <?php echo $result['username'];?> || <strong><?php echo $result['mobile'];?></strong> -->
                  
                 <td><strong style="color: #86a3d9;"><?php echo $result['first_name']?></strong></strong> 
                  <br>
                  Job Status:
                  <?php if($result['cur_job_status_name']!='')echo $result['cur_job_status_name'];else echo 'Not Updated';?>
                  <br>
                  Last CTC Udate: <?php echo ($result['ctc_updated_on']!='0000-00-00' && $result['ctc_updated_on']!='') ? date('d-m-Y', strtotime($result['ctc_updated_on'])) : ''; ?> <br>
                  Last Profile Udate: <?php echo ($result['status_updated_on']!='0000-00-00' && $result['status_updated_on']!='') ? date('d-m-Y', strtotime($result['status_updated_on'])) : '';?> <br>
                  <br>
                  Industry:
                  ...
                  <?php if($result['current_organization']!='')echo $result['current_organization'];else echo 'Not Updated';?>
                  <br>
                  Current CTC: <b><?php echo $this->config->item('currency_symbol');?>&nbsp;<?php echo number_format($result['current_ctc'],2);?></b>&nbsp; || &nbsp;
                  Expected CTC: <b><?php echo $this->config->item('currency_symbol');?>&nbsp;<?php echo number_format($result['expected_ctc'],2);?></b>&nbsp; || &nbsp;
                  ...
                  <br>
                  <a href="<?php echo base_url();?>candidates_profile/summary/<?php echo $result['candidate_id']?>" target="_blank" title="Client CV not uploaded" id="open_candidate_profile" class="btn btn-danger btn-xs">Client CV not uploaded</a> <br>
                  <?php } ?>
                  <?php if($result['reg_status']=='0'){?>
                  <br>
                  <strong>Dont Know</strong> || <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
                  <?php } ?>
                  <?php if($result['reg_status']=='1'){?>
                  <br>
                  <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <strong>Open For Job</strong> || <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
                  <?php } ?>
                  <?php if($result['reg_status']=='2'){?>
                  <br>
                  <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || <strong> Placed</strong>|| <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black List</a>
                  <?php } ?>
                  <?php if($result['reg_status']=='3'){?>
                  <br>
                  <a href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <a  href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open for Job</a> || <a  href="<?php echo $this->config->site_url()?>candidates_profile/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <strong>Black Listed </strong>
                  <?php } ?>
                  <br>
                  <br>
           ...
           --> 
                  ...
                  <a href="javascript:;" title="Update & View Note" onclick="add_candidate_notes(<?php echo $result['candidate_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs/get_all_notes/?candidate_id=<?php echo $result['candidate_id'];?>"  id="add_candidate_notes" class="btn btn-<?php if($result['total_notes']>0)echo 'info';else echo 'danger';?> btn-xs"> Add Notes</a> || <a href="javascript:;" title="Pre Screening Interview" onclick="pre_screening_interview(<?php echo $result['candidate_id'];?>);"  id="manage_shortlists" class="btn btn-info btn-xs">Pre Screening</a> || <a href="javascript:;" title="Shortlist Candidates, see the list of jobs" onclick="connect_with_jobs(<?php echo $result['candidate_id'];?>);"  id="manage_shortlists" class="btn btn-info btn-xs">Shortlist</a>
                  ...
                  <?php } ?>
                  || <a href="javascript:;" class="btn btn-warning btn-xs" title="View Profile" onclick="open_client_cv(<?php echo $result['candidate_id'];?>);">View Profile</a> || <a href="<?php echo base_url(); ?>candidates_profile/candidate_delete/?candidate_id=<?php echo $result['candidate_id']?>" onClick=" return confirm('Are you sure ? Delete Candidate?');" class="btn btn-danger btn-xs">Delete Candidate</a>&nbsp;&nbsp;</span></td>
              </tr>
              <?php
    }}else{?>
              <tr>
...
<div class="modal fade" id="pre_screening" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document" style="width:1058px;">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
$(document).ready(function()
{
	...
	$("#sel_limit1").change(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>candidates_profile?limit='+limits+'&search_name='+search_name+'&search_email='+search_email+'&search_mobile='+search_mobile+'&reg_status='+reg_status;
	});
	 ...
	 {  // triggred submit
		...
		if(count_checked >0) {
			if($('#job_id').val() == 0){
				...
				$.ajax({
					type:"POST",
					url: "<?php echo $this->config->site_url();?>candidates_profile/assign_job",
					data:{ 
					...
					success: function(msg) {
						if(msg>0){
							...
							window.location='<?php echo $this->config->site_url();?>candidates_profile';
						}
						else{
	...
	$("#btn_change_status").click(function()
	 {  // triggred submit
		...
		*/
		...
		$.ajax({
			type:"POST",
			url: "<?php echo $this->config->site_url();?>candidates_profile/change_status",
			data:{ 
					'selectedArr' : selectedArr,
...
function resetpwd($id)
{
	...
	$.ajax({
			...
			dataType: "json",		
			url: '<?php echo $this->config->site_url();?>candidates_profile/resetpassword/',
			success: function(data){
			 if(data.data =='1')
			 {
...
function add_consultant_feedback(candidate_id){
	...
	$('#show_consultant_feedback').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>candidates_profile/open_consultant_feedback/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
...
function add_candidate_notes(candidate_id){
	...
	$('#show_all_notes').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>candidates_profile/get_all_notes/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
...
function connect_with_jobs(candidate_id)
{
	...
	$('#shift_data_holder').html('Loading..................');	
	 $.ajax({
			type: 'POST',
			url:"<?php echo $this->config->site_url()?>candidates_profile/connect_with_jobs",
...
function open_client_cv_doc(candidate_id)
{
	$('#show_client_cv_doc').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>candidates_profile/client_cv_doc/?view="+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
...
function open_client_cv(candidate_id)
{
	...
	$('#show_client_cv').html('');	
	 $.ajax({
			type: 'POST',
			url:"<?php echo base_url(); ?>candidates_profile/client_cv/?view="+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
...
function pre_screening_interview(candidate_id)
{
	
	//$('#candidate_id').val(client_shift_id);
	$('#pre_screening_test').html('Loading..................');	
	 $.ajax({
			type: 'POST',
			url:"<?php echo $this->config->site_url()?>candidates_profile/pre_screening",
			data: $('#job_assignment_form').serialize(),
			method: "POST",
  			data: { candidate_id : candidate_id,},
		    dataType: "html",
