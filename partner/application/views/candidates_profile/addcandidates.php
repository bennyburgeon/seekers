        ...
        <div id ="step1">
          <div class="table-tech specs hor">
            <table class="hori-form">
              <tbody>
              <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" action="<?php echo $this->config->site_url();?>candidates_profile/addCandidate">
                ...
                <tr>
                <td>Qualification</td>
                    <td> Press control key to select more than one. <br>
                      <?php echo form_dropdown('level_id[]',  $edu_level_list, '','data-placeholder="Filter by Levels" multiple class="form-control input-sm" id="level_id" style="height:125px;"');?> </td>
                      </tr>
                ...
                <tr>
                  ...
                  <td><?php echo form_dropdown('city_id', $city_list, $formdata['city_id'],'class="js-example-basic-single" id="city_id" , style="width:100%"');?></td>
                </tr>
                <tr>
                  <td>Preferred Locations</td>
                  <td><?php echo form_dropdown('pref_city_id[]', $city_list, $formdata['pref_city_id'],'class="js-example-basic-single" id="pref_city_id" multiple="multiple" style="height:200px; width:100%"');?></td>
                </tr>
                <tr>
                  <td>Industry</td>
                  <td><?php echo form_dropdown('job_cat_id', $industry_list, $formdata['job_cat_id'],'class="js-example-basic-single" id="job_cat_id" , style="width:100%"');?></td>
                </tr>
                <tr>
                  <td>Function/Department</td>
                  <td><?php echo form_dropdown('func_id', $department_list, $formdata['func_id'],'class="js-example-basic-single" id="func_id" , style="width:100%"');?></td>
                </tr>
                <tr>
                  <td>Role/Designation</td>
                  <td><?php //echo form_dropdown('desig_id', $roles_list, $formdata['desig_id'],'class="js-example-basic-single" id="desig_id"');?>
                  <?php echo form_dropdown('desig_id[]',  $roles_list, '','data-placeholder="Filter by Designations" multiple class="form-control input-sm" id="desig_id" style="height:150px; width:100%;"');?>
                  </td>
                </tr>
                <tr>
                  <td>Job Folder</td>
                ...
                <tr>
                  <td colspan="2"><span class="click-icons">
                    <input type="submit" class="attach-subs" value="Save & Continue" id="save_candidate" style="width:180px;" 
                                            data-url="<?php echo $this->config->site_url();?>candidates_profile/addCandidate" />
                    <a href="<?php echo $this->config->site_url();?>candidates_profile" class="attach-subs subs">Back</a></span></td>
                    </span>
                    </td>
                </tr>
              </form>
...
function check_email()
{
	var pattern=/^([a-zA-Z0-9_.-])+@([a-zA-Z0-9_.-])+\.([a-zA-Z])+([a-zA-Z])+/;
		...
		if(!pattern.test($('#username').val())){
			...
			$.ajax({
				type: "post",
				url: "<?php echo $this->config->site_url();?>candidates_profile/check_email",
				cache: false,				
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) 
						{
                            ...
                            window.location.href = "<?php echo site_url('candidates_profile/summary'); ?>" +'/'+ id;
