...
<table width="100%" border="1">
  <tbody>
    ...
    <tr>
      ...
      <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>candidates_profile/update_job_vacancy" id="job_assignment_form" name="assignment_form">
...
?>
          ...
          <input style="margin-left: 30%;" type="button" value="Add To These Jobs" data-url="<?php echo $this->config->site_url();?>candidates_profile/update_job_vacancy" id="save_job_app_button" >
        </form>
      ...
      <form class="form-horizontal form-bordered"  method="post" id="pre_screening_form" name="pre_screening_form" action="<?php echo $this->config->site_url();?>candidates_profile/add_pre_screening">
          ...
          Follow up <br><br>
          <input type="submit" class="attach-subs" value="Add Pre Screening" id="save_pre_screening" style="width:180px; margin-left: 30%;"data-url="<?php echo $this->config->site_url();?>candidates_profile/add_pre_screening" />
          <br>
        </form></td>
    </tr>
  </tbody>
