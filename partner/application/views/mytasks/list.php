...
<a href="<?php echo base_url();?>mytasks/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
</div>
            ...
            <?php if($result['lead_opportunity']==0){echo '<p style="color:##000">';}?>
              ...
              <?php echo $result["task_title"]; ?>
                            ...
                            <td><a href="<?php  echo $this->config->site_url();?>mytasks/followup/<?php echo $result["task_id"]; ?>">Follow-up</a></td>
                               ...
                               <td>
                    <a href="<?php echo base_url();?>mytasks/edit/<?php echo $result['task_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                    <!--
                    <a href="<?php echo base_url();?>mytasks/delete/<?php echo $result['task_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
                   -->
