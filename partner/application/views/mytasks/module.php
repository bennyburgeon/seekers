...
<a href="<?php echo base_url();?>tasksmodule/add"><img src="<?php echo base_url('assets/images/new-order.png');?>"></a>
...
<tbody>
    ...
    <td><?php echo $result['task_module_name']?></td>
                                   ...
                                   <td> <a href="<?php echo base_url();?>tasksmodule/edit/<?php echo $result['task_module_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>

			<a href="<?php echo base_url();?>tasksmodule/delete/<?php echo $result['task_module_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
                  </td>
    </tr>
    <?php }
  }else{?>
