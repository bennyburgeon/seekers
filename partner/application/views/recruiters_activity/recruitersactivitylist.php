...
if($records!=NULL)
{
	foreach($records as $key => $result){ ?>
              <tr class="odd gradeX">
                ...
                <td <?php if($result['total_jobs']>0)echo 'bgcolor="#E3E3E3"';?>><?php echo $result['total_jobs']?></td>
                ...
                <td <?php if($result['total_offered_rejected']>0)echo 'bgcolor="#E3E3E3"';?>><?php echo $result['total_offered_rejected']?></td>
