...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/company_flp/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<tr>
    ...
    <a href="<?php echo $this->config->site_url();?>/company_flp" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
...
$('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_flp/getstate/',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_flp/getcity/',
