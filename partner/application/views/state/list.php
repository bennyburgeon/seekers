...
<a href="<?php echo base_url();?>state/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                <a href="<?php echo base_url();?>state/edit/<?php echo $result['state_id']?>" class="views" 
                title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                <a href="<?php echo base_url();?>state/delete/<?php echo $result['state_id']?>" class="views" title="Delete" 
