		...
		<div id="body">
					...
					<div class="row-fluid">
                     ...
                     <div class="tabbable tabbable-custom boxless">
                        <ul class="nav nav-tabs">
                           ...
                           <li><a href="<?php echo $this->config->site_url();?>tasks/addfile/?tsk=<?php echo $tskid; ?>" >Add Files</a></li>
                        </ul>
                        <div class="tab-content">
                          <div class="tab-pane active" id="tab_1">
                              <div>
                                    <!-- BEGIN FORM-->
						<form action="<?php echo $this->config->site_url();?>tasks/delete_file" method="post" name="actionfrm">
			...
			?>
                                 ...
                                 <tr class="">
                                    ...
                                    <td><a  href="<?php  echo $this->config->site_url();?>tasks/editfile/?fl_id=<?php echo $result['file_id']?>&tsk=<?php echo $tskid;  ?>">Edit</a></td>
                                 </tr>
            <?php  } ?>                   
