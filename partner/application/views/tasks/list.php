...
<a href="<?php echo base_url();?>tasks/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
foreach($records as $result){ ?>
                   ...
                   <td align="center"><input type="checkbox" name="checkbox[]" class="checkboxes" value="<?php echo $result['task_id']?>" ></td>
                            ...
                            <td><a href="<?php  echo $this->config->site_url();?>tasks/followup/<?php echo $result["task_id"]; ?>">Follow-up</a></td>
                               ...
                               <td>
                    <a href="<?php echo base_url();?>tasks/edit/<?php echo $result['task_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                    <!-- 
                    <a href="<?php echo base_url();?>tasks/delete/<?php echo $result['task_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
                    -->
