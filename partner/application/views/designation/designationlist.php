...
<a href="<?php echo base_url();?>designation/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<th><div class="checker"><span><input type="checkbox" class="group-checkable" id="selectall"></span></div></th>
                                        <th><a href="<?php echo $this->config->site_url()?>designation?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Designation</a></th>
                                        <th>Industry</th>
                                        <th>Function</th>
                                    <th>Edit	</th>
								</tr>
...
<tr class="odd gradeX">
                        ...
                        <td>
                        <a href="<?php echo base_url();?>designation/edit/<?php echo $result['desig_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                        
                        <a href="<?php echo base_url();?>designation/delete/<?php echo $result['desig_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
