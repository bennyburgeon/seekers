...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="update_education_frm" action="<?php echo $this->config->site_url();?>candidates_own/update_education/" name="update_education_frm" > 
...
<td><input type="text" name="mark_percentage" class="form-control" placeholder="Mark Percentage"  id="mark_percentage" value="<?php echo $formdata['mark_percentage']; ?>"></td>
</tr>
