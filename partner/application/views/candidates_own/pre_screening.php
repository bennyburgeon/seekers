...
?>
          ...
          <input style="margin-left: 30%;" type="button" value="Add To These Jobs" data-url="<?php echo $this->config->site_url();?>candidates_own/update_job_vacancy" id="save_job_app_button" >
        </form>
      ...
      <form class="form-horizontal form-bordered"  method="post" id="pre_screening_form" name="pre_screening_form" action="<?php echo $this->config->site_url();?>candidates_own/add_pre_screening">
          ...
          <br>
          Recruiter Name: <?php echo form_dropdown('vendor_id', $admin_list, $pre_screening['vendor_id'],'id="vendor_id",  style="margin-left: 7%; margin-bottom: 2%; width: 60%;" ');?> <br>
          ...
          Follow up <br><br>
          <input type="submit" class="attach-subs" value="Add Pre Screening" id="save_pre_screening" style="width:180px; margin-left: 30%;"data-url="<?php echo $this->config->site_url();?>candidates_own/add_pre_screening" />
          <br>
        </form></td>
    </tr>
  </tbody>
