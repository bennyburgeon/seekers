  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      ...
      <div class="table-tech specs">
        ...
        <div class="right-btns"> <!--<a href="<?php //echo base_url();?>candidates_own/import_csv" class="attach-subs tools"><img src="<?php //echo base_url('assets/images/plus.png');?>">Import CSV</a>||--> <a href="<?php echo base_url();?>candidates_own/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> || <a href="<?php echo base_url(); ?>candidates_own" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a> </div>
...
<a href="<?php echo site_url('candidates_own/import_csv');?>" class="btn btn-default btn-circle">
...
--> 
        ...
        <form id="searchForm" method="get" action="<?php echo $this->config->site_url()?>candidates_own/">
          ...
          <table class="tool-table new">
            ...
            <thead>
              ...
              <tr role="row" class="heading">
                ...
                <th width="384"><a href="<?php echo $this->config->site_url()?>candidates_own?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&limit=<?php echo $limit;?>&search_name=<?php echo $search_name;?>&search_email=<?php echo $search_email;?>&search_mobile=<?php echo $search_mobile;?>&rows=<?php echo $rows;?>"> Name</a></th>
    ...
    ?>
              ...
              <tr class="odd gradeX">
                ...
                <td><?php if($result['photo']!=''){?>
                  ...
                  <img height="31" width="31" src="<?php echo $this->config->item('file_upload_folder').'photos/'.$result['photo'];?>">

                  <?php }else{ ?>

                  <img height="31" width="31" src="<?php echo $this->config->item('file_upload_folder').'photos/no_photo.png'; ?>">

                  <?php } ?></td>

                <td><a href="<?php echo base_url();?>candidates_own/summary/<?php echo $result['candidate_id']?>" target="_blank" class="views" title="View"> <strong><?php echo $result['first_name']?></strong></a> || <?php echo $result['username'];?> || <strong><?php echo $result['mobile'];?></strong> 
            ...
            --> 
                  ...
                  <?php if($result['industry']!='')echo $result['industry'];else echo 'Not Updated';?>

                  <br>

                  Functional Area:&nbsp;&nbsp;&nbsp;&nbsp;

                  <?php if($result['dept']!='')echo $result['dept'];else echo 'Not Updated';?>

                  <br>

                  Role/Designation:&nbsp;&nbsp;

                  <?php if($result['desig']!='')echo $result['desig'];else echo 'Not Updated';?>
                  ...
                  Notice Period: <b><?php if(isset($result['notice_period']))
		  	{
				if($result['notice_period']=='Immediate' || $result['notice_period']=='7 Days')
				   echo $result['notice_period'];
				 else
				 	echo $result['notice_period'].' Days';
			}
		   ?>  </b>&nbsp;<br>
                  ...
                  <strong>Dont Know</strong> || <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
                  ...
                  <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <strong>Open For Job</strong> || <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
                  ...
                  <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || <strong> Placed</strong>|| <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black List</a>
                  ...
                  <a href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> || <a  href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open for Job</a> || <a  href="<?php echo $this->config->site_url()?>candidates_own/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || <strong>Black Listed </strong>
...
<!--
                  || <a href="<?php //echo $this->config->item('client_cv_preview');?><?php echo md5($result['candidate_id']); ?>" class="btn btn-warning btn-xs" title="View Profile" target="_blank">View Profile</a> &nbsp;&nbsp;</span></td>
-->
              </tr>
...

{
	...
	$("#sel_limit1").change(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>candidates_own?limit='+limits+'&search_name='+search_name+'&search_email='+search_email+'&search_mobile='+search_mobile+'&reg_status='+reg_status;
		...
		if(count_checked >0) {
			...
			if($('#job_id').val() == 0){
				...
				$.ajax({
					...
					url: "<?php echo $this->config->site_url();?>candidates_own/assign_job",
					...
					success: function(msg) {
						...
						if(msg>0){
							...
							window.location='<?php echo $this->config->site_url();?>candidates_own';
	 ...
	 {  // triggred submit
		...
		*/
		...
		$.ajax({
			...
			url: "<?php echo $this->config->site_url();?>candidates_own/change_status",
...

	{
		...
		if($('#level_id').val()=='')return;
			...
			$.ajax({
			  ...
			  url: '<?php echo $this->config->site_url();?>candidates_own/getcourses/',
...

{
	...
	$.ajax({
			...
			url: '<?php echo $this->config->site_url();?>candidates_own/resetpassword/',
...
function add_consultant_feedback(candidate_id){
	...
	$('#show_consultant_feedback').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>candidates_own/open_consultant_feedback/"+candidate_id,
...
function add_candidate_notes(candidate_id){
	...
	$('#show_all_notes').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>candidates_own/get_all_notes/"+candidate_id,
...

{
	...
	$('#shift_data_holder').html('Loading..................');	
	 ...
	 $.ajax({
			...
			url:"<?php echo $this->config->site_url()?>candidates_own/connect_with_jobs",
...

{
	...
	$('#show_client_cv_doc').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>candidates_own/client_cv_doc/?view="+candidate_id,
...

{
	...
	$('#show_client_cv').html('');	
	 ...
	 $.ajax({
			...
			url:"<?php echo base_url(); ?>candidates_own/client_cv/?view="+candidate_id,
...
<script type="text/javascript">
	...
	if($('#job_cat_id').val()=='')return;
		...
		$.ajax({
		  ...
		  url: '<?php echo $this->config->site_url();?>candidates_own/get_functional_by_industry/',
	...
	if($('#func_id').val()=='')return;
		...
		$.ajax({
		  ...
		  url: '<?php echo $this->config->site_url();?>candidates_own/get_designation_by_functional/',
...

{
	...
	$('#pre_screening_test').html('Loading..................');	
	 ...
	 $.ajax({
			...
			url:"<?php echo $this->config->site_url()?>candidates_own/pre_screening",
