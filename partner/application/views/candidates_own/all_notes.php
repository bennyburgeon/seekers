<form class="form-horizontal form-bordered"  method="post" id="add_consultant_feedback_frm"  action="<?php echo $this->config->site_url();?>candidates_own/add_candidates_notes/<?php echo $candidate_id;?>"  name="add_consultant_feedback_frm"> 
