<form class="form-horizontal form-bordered"  method="post" id="add_candidates_tasks"  action="<?php echo $this->config->site_url();?>candidates_own/add_candidates_tasks/<?php echo $candidate_id;?>"  name="add_candidates_tasks">
  ...
  <table class="hori-form">
    <tbody>
      ...
      <tr>
        <td>Admin user</td>
        <td><?php echo form_dropdown('vendor_id',  $admin_list,'','class="form-control" id="vendor_id"');?></td>
      </tr>
      <tr>
      <tr>
        <td colspan="2"><span class="click-icons">
          <input type="submit" class="attach-subs" value="Add Task" id="save_tasks" style="width:180px;" 
                  data-url="<?php echo $this->config->site_url();?>candidates_own/add_candidates_tasks" />
	...
	?>
              <tr>
               <td><?php echo $val["task_title"]; ?></td>
                  ...
                  <td><a href="javascript:;"  data-url="<?php echo base_url(); ?>candidates_own/edit_task/?task_id=<?php echo $val['task_id'];?>&candidate_id=<?php echo $val['candidate_id'];?>"  id="edit_task" class="btn btn-primary btn-xs">Edit</a>
                   <a href="<?php echo base_url();?>candidates_own/delete_task/<?php echo $val['task_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
