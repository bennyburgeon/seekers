  ...
  <div class="col-md-12">
    <div class="profile_top">
      ...
      <div class="profile_top_right">
        <ul>
          <li><a href="<?php echo $this->config->site_url();?>candidates_apps/add" >Add New</a></li>
          <li><a href="<?php echo $this->config->site_url();?>candidates_apps" >List All</a></li>
          <li><!-- <a href="<?php echo base_url();?>index.phpcandidates_apps/candidate_delete/<?php echo md5($detail_list['candidate_id']);?>">Delete this profile</a>--></li>
        </ul>
      </div>
    ...
    <div class="clearfix">
      <table width="100%" border="0" cellspacing="3" cellpadding="3" class="table">
        ...
        <tr>
          ...
          <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#eduModal">Add Education</a> || <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#jobModal">Add Profession</a> || 
          ...
          <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#langModal">Update Language</a>  || 
            <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#primaryModal">Add Skills[Primary & Secondary]</a> 
              <!--|| <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#skillModal">Add Skills</a>--> || <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#certModal">Add Certifications</a> </div></td>
        </tr>
        <tr>
          <td align="left" valign="top" colspan="2"><div class="row">
              <div class="col-sm-16">
                ...
                <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  <tr>
              <td width="18%">Father's Name</td>
            <td width="24%"><?php echo $formdata['father_name'];?></td>
           <td>Industry</td>
            <td><?php if($formdata['industry']=='0' || $formdata['industry']=='') { echo 'not updated'; }else { echo $formdata['industry']; }?></td>
          ...
          <tr>
            ...
            <td> <?php if($formdata['dept']=='0' || $formdata['dept']=='') { echo 'not updated'; }else { echo $formdata['dept']; }?></td>
          </tr>
          <tr>
        ...
        <td>Designation</td>
            <td><?php if($formdata['desig']=='0' || $formdata['desig']=='') { echo 'not updated'; }else { echo $formdata['desig']; }?></td>
             
           
          </tr>
          <tr>
              <td>DoB :</td>
            <td><?php echo ($formdata['date_of_birth']!='0000-00-00' && $formdata['date_of_birth']!='') ? date('d-m-Y',strtotime($formdata['date_of_birth'])) : 'Not Updated'; ?></td>
             
             <td width="20%">Current Location</td>
           <!--<td width="38%"><?php// echo $formdata['current_location_name'];?></td>-->
            <td width="38%"><?php if($formdata['curnt_loc']=='0' || $formdata['curnt_loc']=='' ) { echo 'not updated'; }else { echo $formdata['curnt_loc']; }?></td>  
           
          </tr>
          <tr>
               <td>Age : </td>
            <td><?php if($formdata['age']=='0') { echo 'not updated'; }else { echo $formdata['age']; }?></td>
            
            <td>Preferred Locations</td>
            <td><?php if($formdata['prfrd_loc']=='0' || $formdata['prfrd_loc']=='') { echo 'not updated'; }else { echo $formdata['prfrd_loc']; }?></td>
          </tr>
          <tr>
              <td>Gender :</td>
          ...
          <tr>
            ...
            <td><?php echo  $this->config->item('currency_symbol');?>
              <?php if(isset($job_search['current_ctc']))echo number_format($job_search['current_ctc'],2);?>
              &nbsp; / Year</td>
          ...
          <tr>
            ...
            <td><?php if($formdata['driving_license']==1) echo 'Yes'; if($formdata['driving_license']==0)echo 'No';?></td>
                 ...
                 <td>Expeced CTC</td>
            <td><?php echo  $this->config->item('currency_symbol');?>
              <?php if(isset($job_search['expected_ctc'])) echo number_format($job_search['expected_ctc'],2);?>
              &nbsp; / Year</td>
             ...
             <tr>
                 <td>License Type</td>
            <td> <?php if(is_array($candidate_license_type)){?>
                <?php echo implode(',',$candidate_license_type);?>
               <?php 				
                    }									
                    ?>
                 </td>
           ...
           <td>Registered On : </td>
            <td><?php echo ($formdata['reg_date']!='0000-00-00' && $formdata['reg_date']!='') ? date('d-m-Y', strtotime($formdata['reg_date'])) : 'Not Updated';?></td> 
          ...
          <tr>
            ...
            <td width="38%"><?php if($formdata['nationality']=='0' || $formdata['nationality']=='') { echo 'not updated'; }else { echo $formdata['nationality_name']; }?></td>
                ...
                <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  <tr>
                    <td width="22%"><?php if(file_exists('uploads/photos/'.$formdata['photo']) && $formdata['photo']!=''){?>
                      ...
                      <br />
                      <a href="<?php echo site_url().'candidates_apps/delete_photo/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Photo?');" style="color:#0033FF">Delete Photo</a>&nbsp;&nbsp;</span>
                      <?php }else{ ?>
                      <img src="<?php echo base_url().'uploads/no_photo.png';?>">
                      <?php } ?></td>
                    <td width="78%"><form class="form-horizontal form-bordered"  method="post" id="upload_cv_photo_frm" name="upload_cv_photo_frm" action="<?php echo $this->config->site_url();?>candidates_apps/upload_cv_photo/<?php echo $formdata['candidate_id'];?>" enctype="multipart/form-data">
                  ...
                  <tr>
                    <td colspan="2"><!-- 
                                <a href="<?php echo base_url().'index.phpcandidates_apps/print_cv/'.$candidate_id;?>" target="_blank" class="btn btn-info btn-sm">Print CV</a> -->
                      
                      <?php if($formdata['cv_file']!=''){?>
                      <a href="<?php echo base_url().'uploads/cvs/'.$formdata['cv_file'];?>" target="_blank" class="btn btn-success btn-sm">Download Candidate CV</a> <a href="<?php echo site_url().'candidates_apps/delete_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Candidate CV?');" class="btn btn-danger btn-sm">Delete Candidate CV</a>
                      <?php } ?>
                      <?php if($formdata['client_cv_file']!=''){?>
                      || <a href="<?php echo base_url().'uploads/client_cvs/'.$formdata['client_cv_file'];?>" target="_blank" class="btn btn-success btn-sm">Download Client CV</a> <a href="<?php echo site_url().'candidates_apps/delete_client_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Client CV?');" class="btn btn-danger btn-sm">Delete Client CV</a>
                      <?php } ?></td>
                  </tr>
                </table>
        ...
        <tr>
          <td colspan="2" align="center" valign="top"><table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'index.phpcandidates_apps/delete_candidate_prof/?id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
                  
                  <!--    
                       <a href="<?php echo base_url().'index.phpcandidates_apps/summary/'.$candidate_id.'/?edit_job=1&job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile_url" class="btn btn-info btn-xs">Edit</a>  
                    
                       
                    
                    update with editor
                    --> 
                  <a href="javascript:void();" data-url="<?php echo base_url().'candidates_apps/loadEditJobhtml/?job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile" class="btn btn-info btn-xs">Edit Profession</a></td>
              </tr>
              <tr>
        ...
        <tr>
          <td colspan="2" align="center" valign="top" class="borderTopNone"><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'index.phpcandidates_apps/delete_candidate_contract/?';?>candidate_id=<?php echo $candidate_id?>" id="delete_candidate_followup" >Delete</a></td>
              </tr>
            </table></td>
        </tr>
        <?php } ?>
    ...
    <tr>
            ...
            <thead>
             	 ...
             	 <tbody>
                        ...
                        <td width="5%"><?php if($job['applied']==1) { echo "<span class='btn btn-success btn-xs disabled'>Applied</span>"; }else{?> <a href="<?php echo $this->config->site_url();?>candidates_apps/apply_job/<?php echo $candidate_id;?>/<?php  echo $job['job_id'];?>" title="Click here to apply job." class="btn btn-primary btn-xs"> Apply </a><?php } ?></td>
      ...
      <div class="notes">
        ...
        <div class="table-tech specs note">
          <div class="new_notes">
            ...
            <p id="emails"></p>
            <p id="emaildelete"></p>
            <form action="<?php echo $this->config->site_url();?>candidates_apps/manage_email/<?php echo $candidate_id;?>" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onsubmit="return email_validate();" >
...
<div class="modal fade" id="personalModal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document" style="width:800px;">
    ...
    <div class="notes">
       <div class="alert alert-info"><strong>Info!</strong>&nbsp;Update Personal Details.</div>
       
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
                <form class="form-horizontal form-bordered"  method="post" id="update_candidate_profile" name="update_candidate_profile" action="<?php echo $this->config->site_url();?>candidates_apps/update_candidate_profile/<?php echo $candidate_id;?>" onSubmit="return validate_profile_form();">
                  ...
                  <table class="hori-form">
                    <tbody>
                      <tr>
                        ...
                        <td colspan="3"><input style="width:100%;" placeholder="First Name"  type="text"  name="first_name" value="<?php echo $formdata['first_name']?>" id="first_name"></td>
                      </tr>
                         <tr>
                        <td>Father's Name</td>
                        <td colspan="3"><input style="width:100%;" placeholder="Father's Name"  type="text"  name="father_name" value="<?php echo $formdata['father_name']?>" id="father_name"></td>
                      </tr>
                      <tr>
                        <td>Mobile</td>
                        <td colspan="3"><input style="width:100%;" placeholder="Mobile"  type="text"  name="mobile" value="<?php echo $formdata['mobile']?>" id="mobile"></td>
                      </tr>
                      <tr>
                        <td>Gender</td>
                        <td colspan="3"><?php 
                      ...
                      <tr>
                        <td>DoB</td>
                        <td colspan="3"><input style="width:100%;" type="text" readonly name="date_of_birth" id="date_of_birth" class="smallinput datepicker" value="<?php if($formdata['date_of_birth']!='0000-00-00' && $formdata['date_of_birth']!='')echo date('Y-m-d', strtotime($formdata['date_of_birth']));?>" placeholder="Date of Birth"></td>
                      </tr>
                      ...
                      <tr>
                       <td>Qualification</td>
               <td colspan="3"><input type="text" name="qualification" class="form-control input-sm" placeholder="Qualification"  id="qualification" value="<?php echo $formdata['qualification']; ?>"></td>
                  ...
                  <td><input type="radio" name="payment_status" value="1" <?php if($formdata['payment_status']==1) echo 'checked'; ?>>
                    ...
                    &nbsp; Unpaid </td>
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input type="text" name="curnt_loc" class="form-control input-sm" placeholder="Currently Located"  id="curnt_loc" value="<?php echo $formdata['curnt_loc']; ?>"></td>
                      </tr>
                      <tr>
                        <td>Preferred Locations</td>
                       
                        <td colspan="3"><input type="text" name="prfrd_loc" class="form-control input-sm" placeholder="Preferred Locations"  id="prfrd_loc" value="<?php echo $formdata['prfrd_loc']; ?>"></td>
                      </tr>
                      <tr>
                        <td>Industry</td>
                        <td colspan="3"><input type="text" name="industry" class="form-control input-sm" placeholder="Industry"  id="industry" value="<?php echo $formdata['industry']; ?>"></td>
                      </tr>
                      <tr>
                        <td>Function/Department</td>
                        <td colspan="3"><input type="text" name="dept" class="form-control input-sm" placeholder="Department"  id="dept" value="<?php echo $formdata['dept']; ?>"></td>
                      </tr>
                      <tr>
                        <td>Role/Designation</td>
                        <td colspan="3"><input type="text" name="desig" class="form-control input-sm" placeholder="Designation"  id="desig" value="<?php echo $formdata['desig']; ?>"></td>
                      </tr>
                      <tr>
                        <td>Visa Type</td>
          ...
          <div class="notes">
            ...
            <div class="table-tech  note" style="border:none;">
              <div class="new_notes">
                <p id="result"></p>
                <p id="deletemessage"></p>
                <form class="form-horizontal form-bordered"  method="post" id="edu_history_frm" name="edu_history_frm" action="<?php echo $this->config->site_url();?>candidates_apps/edu_history_2/<?php echo $candidate_id;?>" onSubmit="return candidate_validate();">
                  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                  <table class="hori-form">
                    <tbody>
                    ...
                    <tr>
                    <td>Course</td>
                     <td> <input type="text" name="course" class="form-control" placeholder="Course"  id="course"> </td>
                    </tr>
                    <tr>
                    <td>Specialization</td>
                     <td><input type="text" name="spcl" class="form-control" placeholder="Specialization"  id="spcl">  </td>
                    </tr>
                    <tr>
                    <td>University</td>
                     <td> <input type="text" name="univ" class="form-control" placeholder="University"  id="univ"></td>
                    </tr>
                    <tr>
                    <td>Year</td>
                     <td> <input type="text" name="edu_year" class="form-control" placeholder="Year"  id="edu_year"></td>
                    </tr>
                        <tr>
                    <td>Mark Percentage</td>
                     <td> <input type="text" name="mark_percentage" class="form-control" placeholder="Year"  id="mark_percentage"></td>
                    </tr>
                    <tr>
                    <td>Country</td>
                     <td><input type="text" name="edu_country" class="form-control" placeholder="Country"  id="edu_country"> </td>
                    </tr>
                    <tr>
                    <td>Course Type</td>
                     <td><input type="text" name="course_type" class="form-control" placeholder="Course Type"  id="course_type"> </td>
                    </tr>
                      <!--  
                    <tr>
                    <td>Arrears</td>
          ...
          <div class="notes">
            ...
            <div class="table-tech  note" style="border:none;">
              <div class="new_notes">
                <p id="result"></p>
                <p id="deletemessage"></p>
                <form class="form-horizontal form-bordered"  method="post" id="job_history_frm" name="job_history_frm" action="<?php echo $this->config->site_url();?>candidates_apps/job_history_2/<?php echo $candidate_id;?>" onSubmit="return job_validate();" >
                  <table class="hori-form">
                    <tbody>
                    <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                    <tr>
                      ...
                      <td><input class="form-control hori" type="text" name="organization" value="" id="organization"></td>
                        ...
                        <tr>
               <td>Job Location</td>
              <td><input class="form-control hori" type="text" name="job_location" value="" id="job_location"></td>
                       </tr>
                    <tr>
                      <td>Designation</td>
                      <td><?php echo form_dropdown('desig_id',  $designation_list, '','class="form-control"');?></td>
                    </tr>
                    
                    <tr>
                      <td>Industry</td>
                      <td><?php echo form_dropdown('job_cat_id',  $industries_list, '','class="form-control"');?></td>
                    </tr>
                    <tr>
                      <td>Function/Role</td>
                      <td><?php echo form_dropdown('func_id',  $functional_list, '','class="form-control" ');?></td>
                    </tr>
                        <tr>
                      <td>Technologies Used</td>
                      <td><input class="form-control hori" type="text" name="technology_used" value=""  id="technology_used"></td>
                    </tr>
                    <tr>
                      ...
                      <td><textarea name="responsibility" cols="" rows="" class="text_area" id="responsibility"></textarea></td>
                        ...
                        <tr>
                      <td>Montly Salary</td>
                      <td><input class="form-control" placeholder="Montly Salary" type="text" name="monthly_salary" value="" id="monthly_salary"></td>
                    </tr>
                        <tr>
                      <td>Verified ?</td>
                      <td><label class="radio-inline">
                          <input type="radio" name="salary_verified" id="salary_verified" value="1">
                          Yes</label>
                        <label class="radio-inline">
                          <input type="radio" name="salary_verified" id="salary_verified" value="2" checked>
                          No</label></td>
                    </tr>
                         <tr>
                    ...
                    <tr>
                      <td>From Date</td>
                      <td><input type="text" name="from_date" id="from_date" class="datepicker" placeholder="From Date"></td>
                    </tr>
                    <tr>
                      <td>To Date</td>
                      <td><input type="text" name="to_date" id="to_date" class="datepicker" placeholder="To Date"></td>
                    </tr>
                    <tr>
                      <td colspan="2"><span class="click-icons">
          ...
          <div class="notes">
            ...
            <div class="table-tech  note" style="border:none;">
              <div class="new_notes">
                <p id="result"></p>
                <p id="deletemessage"></p>
                <form class="form-horizontal form-bordered"  method="post" id="candidate_validate" name="candidate_validate" action="<?php echo $this->config->site_url();?>candidates_apps/lang_history_2/<?php echo $candidate_id;?>">
                  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>" />
                  <table class="hori-form">
                    <tbody>
                      <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="skill_form" name="skill_form" action="<?php echo $this->config->site_url();?>candidates_apps/skills_2/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="cert_form" name="cert_form" action="<?php echo $this->config->site_url();?>candidates_apps/add_certification/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="cert_form" name="cert_form" action="<?php echo $this->config->site_url();?>candidates_apps/followup/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
                      <td>Enter Title</td>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="edit_category_frm" name="edit_category_frm" action="<?php echo $this->config->site_url();?>candidates_apps/editCategory/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
                      <td>&nbsp;</td>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="edit_skill_form" name="edit_skill_form" action="<?php echo $this->config->site_url();?>candidates_apps/editSkills/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr> </tr>
                    <tr>
        ...
        <div class="modal-body">
          ...
          <div class="notess">
            ...
            <div class="table-tech  note" style="border:none;">
              ...
              <p id="result"></p>
              <p id="deletemessage"></p>
              <form class="form-horizontal form-bordered"  method="post" id="add_contract_form" name="add_contract_form" action="<?php echo $this->config->site_url();?>candidates_apps/add_contract_details/<?php echo $candidate_id;?>" enctype="multipart/form-data">
                <table class="hori-form">
                  <tbody>
                    <tr>
                      <td>Company</td>
...
<!--SCRIPT FOR EDUCATION MODAL END-->
	...
	$('#multiple_category').change(function() 
	{
		...
		if($('#multiple_category').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>candidates_apps/getfunction_multiple/',
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.phpcandidates_apps/download_cv_content/"+candidate_id,
			method: "POST",
...
<script type="text/javascript">
	...
	if($('#job_cat_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_apps/get_functional_by_industry/',
	...
	if($('#func_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>candidates_apps/get_designation_by_functional/',
