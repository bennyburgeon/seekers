          ...
          <table class="tool-table new">
            <thead>
              <tr role="row" class="heading">
                ...
                <th width="121">CTC /Lakhs</th>
                <th width="109">ECTC/Lakhs</th>
                <th width="80" class="head0">Exp./Yr</th>
                <th width="100" class="head0">Notice</th>
              </tr>
            </thead>
            <tbody>
              <?php if($records!=NULL)
...
<br>
           ...
           --> 
                  ...
                  <a href="javascript:;" title="Sent Messages" onclick="add_candidate_messages(<?php echo $result['candidate_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/jobs/get_all_messages/?candidate_id=<?php echo $result['candidate_id'];?>"  id="add_candidate_messages" class="btn btn-<?php if($result['total_messages']>0)echo 'info';else echo 'danger';?> btn-xs">Send Messages</a>
                  
                  
                   || <a href="javascript:;" title="Shortlist Candidates, see the list of jobs" onclick="connect_with_jobs(<?php echo $result['candidate_id'];?>);"  id="manage_shortlists" class="btn btn-info btn-xs">Change Interview</a> ||
                  ...
                  <a href="javascript:;" onclick="reject_interview_fn(<?php echo $result['candidate_id'];?>,<?php echo $result['job_app_id'];?>,<?php echo $result['interview_id'];?>);" id="reject_interview" class="btn btn-danger btn-xs">Reject </a> || <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/candidates_apps/edit_interview/?job_app_id=<?php echo $result['job_app_id'];?>&candidate_id=<?php echo $result['candidate_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a>
                  <?php }else{ ?>
