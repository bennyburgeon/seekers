    ...
    <div class="profile_top">
      ...
      <div class="profile_top_right">
        <ul>
          ...
          <li><!-- <a href="<?php echo base_url();?>candidates_apps/candidate_delete/<?php echo md5($detail_list['candidate_id']);?>">Delete this profile</a>--></li>
        </ul>
      </div>
          ...
          <td align="left" valign="top" colspan="2"><div class="row">
              ...
              <div class="col-sm-16">
                ...
                <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    <td colspan="2"><!-- 
                                <a href="<?php echo base_url().'candidates_apps/print_cv/'.$candidate_id;?>" target="_blank" class="btn btn-info btn-sm">Print CV</a> -->
        ...
        <tr>
          <td colspan="2" align="center" valign="top"><table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'candidates_apps/delete_candidate_prof/?id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
                  
                  <!--    
                       <a href="<?php echo base_url().'candidates_apps/summary/'.$candidate_id.'/?edit_job=1&job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile_url" class="btn btn-info btn-xs">Edit</a>  
        ...
        <tr>
          <td colspan="2" align="center" valign="top" class="borderTopNone"><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url().'candidates_apps/delete_candidate_contract/?';?>candidate_id=<?php echo $candidate_id?>" id="delete_candidate_followup" >Delete</a></td>
              </tr>
            </table></td>
        </tr>
        <?php } ?>
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>candidates_apps/download_cv_content/"+candidate_id,
			method: "POST",
