...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="update_education_frm" action="<?php echo $this->config->site_url();?>candidates_apps/update_education/" name="update_education_frm" > 
