...
<br>
           ...
           --> 
                  ...
                  <b>=></b> 
                   ...
                   <b> => </b> 
                    ...
                    <a href="javascript:;" title="Short List this candidate" onclick="add_to_shortlist(<?php echo $result['candidate_id'];?>,<?php echo $result['job_app_id'];?>,<?php echo $result['job_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/candidates_apps/add_to_shortlist/?job_app_id=<?php echo $result['job_app_id'];?>&candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $result['job_id'];?>"  id="add_to_shortlist" class="btn btn-info btn-xs"> Short List </a> &nbsp;||&nbsp;
                    
                    <a href="javascript:;" data-url="<?php echo base_url(); ?>index.php/candidates_apps/reject_from_application/?job_app_id=<?php echo $result['job_app_id'];?>&job_id=<?php echo $result['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $result['candidate_id'];?>,<?php echo $result['job_app_id'];?>,<?php echo $result['job_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>
 ...
 &nbsp;||&nbsp; <b>=></b> <?php echo 'Shortlisted'; ?>&nbsp;||&nbsp; <b>=></b> <?php echo 'Int. Scheduled'; ?>&nbsp;||&nbsp; <b>=></b> <?php echo 'Int. Selected'; ?>&nbsp; ||&nbsp; <b>=> </b> <?php echo 'Offer Issued'; ?>
            ...
            <?php }elseif($result['app_status_id']==9 ){ ?>
             ...
             &nbsp;||&nbsp; <b>=></b> <a href="javascript:;" onclick="create_invoice(<?php echo $result['job_id'].','.$result['job_app_id'].','.$result['candidate_id'].','. $result['placement_id']?>);" class="btn btn-primary btn-xs">Create Invoice</a>
...
<a href="javascript:;" title="Shortlist Candidates, see the list of jobs" onclick="connect_with_jobs(<?php echo $result['candidate_id'];?>);"  id="manage_shortlists" class="btn btn-info btn-xs">Swap Interview</a> ||
                    ...
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/candidates_apps/edit_interview/?job_app_id=<?php echo $result['job_app_id'];?>&candidate_id=<?php echo $result['candidate_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change Time</a>
                    <?php } ?>
                  </td>
...
function add_candidate_messages(candidate_id){
	...
	$('#show_all_messages').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/candidates_apps/get_all_messages/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
