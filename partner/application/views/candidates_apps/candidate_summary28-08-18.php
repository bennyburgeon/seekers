...
<ul>
    ...
    <li><!-- <a href="<?php echo base_url();?>index.php/candidates_apps/candidate_delete/<?php echo md5($detail_list['candidate_id']);?>">Delete this profile</a>--></li>
</ul>
...
<table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
        	...
        	<div id="success"></div>
                  ...
                  <tr>
                    <td colspan="2">
                    <!-- 
                                <a href="<?php echo base_url().'index.php/candidates_apps/print_cv/'.$candidate_id;?>" target="_blank" class="btn btn-info btn-sm">Print CV</a> -->
                ...
                <a href="<?php echo site_url().'/candidates_apps/delete_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Candidate CV?');" class="btn btn-danger btn-sm">Delete Candidate CV</a> 
                ...
                <a href="<?php echo site_url().'/candidates_apps/delete_client_cv/'.$candidate_id.'/';?>" onClick=" return confirm('Are you sure ? Delete Client CV?');" class="btn btn-danger btn-sm">Delete Client CV</a> <?php } ?> 
...
<td colspan="2" align="center" valign="top" class="borderTopNone"> 
				 ...
				 <?php foreach($education_details as $key => $val){?>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url().'index.php/candidates_apps/delete_candidate_edu/?id='.$val['eucation_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> || 
                     
                     <a href="javascript:void();" data-url="<?php echo base_url().'index.php/candidates_apps/loadEditEducationhtml/?edu_id='.$val['eucation_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_edu" class="btn btn-info btn-xs">Edit This</a>
                     </td>
         		 </tr>
        ...
        <td colspan="2" align="center" valign="top">
         ...
         <table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    ...
                    <a href="<?php echo base_url().'index.php/candidates_apps/delete_candidate_prof/?id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">Delete</a> ||
                    
                      <!--    
                       <a href="<?php echo base_url().'index.php/candidates_apps/summary/'.$candidate_id.'/?edit_job=1&job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile_url" class="btn btn-info btn-xs">Edit</a>  
                    
                       
                    
                    update with editor
                    -->
                       <a href="javascript:void();" data-url="<?php echo base_url().'index.php/candidates_apps/loadEditJobhtml/?job_profile_id='.$val['job_profile_id'];?>&candidate_id=<?php echo $candidate_id;?>" id="edit_job_profile" class="btn btn-info btn-xs">Edit Profession</a>  
        ...
        <td colspan="2" align="center" valign="top" class="borderTopNone">
            <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
                  ...
                  <tr>
                   ...
                   <td><a href="<?php echo base_url().'index.php/candidates_apps/delete_candidate_contract/?';?>candidate_id=<?php echo $candidate_id?>" id="delete_candidate_followup" >Delete</a></td>
                  </tr>
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/candidates_apps/download_cv_content/"+candidate_id,
			method: "POST",
