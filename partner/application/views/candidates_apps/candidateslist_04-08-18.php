...
<a href="<?php echo base_url();?>index.php/candidates_apps/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>

|| <a href="<?php echo base_url(); ?>index.php/candidates_apps" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a>
...
<table class="tool-table new">
    ...
    ?>
        ...
        <tr class="odd gradeX">
            ...
            <td>			
            <a href="<?php echo base_url();?>index.php/candidates_apps/summary/<?php echo $result['candidate_id']?>" target="_blank" class="views" title="View"> <strong><?php echo $result['first_name']?></strong></a> 
...
<br>
         ...
         <strong>Dont Know</strong>
            || 
             <a href="<?php echo $this->config->site_url()?>/candidates_apps/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=1">Open For Job</a> || 
             <a href="<?php echo $this->config->site_url()?>/candidates_apps/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=2">Placed</a> || 
             <a href="<?php echo $this->config->site_url()?>/candidates_apps/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black Listed</a>
            <?php } ?>

            <?php if($result['reg_status']=='1'){?>
               <br>
        <a href="<?php echo $this->config->site_url()?>/candidates_apps/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> 
            || 
...
<?php if($result['reg_status']=='2'){?>
        ...
        <a href="<?php echo $this->config->site_url()?>/candidates_apps/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=0">Dont Know</a> 
           ...
           <strong> Placed</strong>|| 
             <a href="<?php echo $this->config->site_url()?>/candidates_apps/change_profile_status/<?php echo $result['candidate_id'];?>?reg_status=3">Black List</a>
            <?php } ?>
