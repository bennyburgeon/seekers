...
<table width="100%" border="1">
  <tbody>
    ...
    <tr>
      <td  width="60%"><form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/candidates_apps/apply_for_interview" id="job_assignment_form" name="assignment_form">
