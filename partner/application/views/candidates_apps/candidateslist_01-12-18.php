  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="table-tech specs">
        <div class="right-btns"> <!--<a href="<?php //echo base_url();?>index.php/candidates_apps/add" class="attach-subs tools"><img src="<?php //echo base_url('assets/images/plus.png');?>">Add New</a> || -->
        <a href="<?php echo base_url(); ?>index.php/candidates_apps" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a>  </div>
...
<br>
           ...
           --> 
                  ...
                  <a href="javascript:;" title="Shortlist Candidates, see the list of jobs" onclick="connect_with_jobs(<?php echo $result['candidate_id'];?>);"  id="manage_shortlists" class="btn btn-info btn-xs">Swap Interview</a> || <a href="javascript:;"  data-url="<?php echo base_url(); ?>index.php/candidates_apps/edit_interview/?job_app_id=<?php echo $result['job_app_id'];?>&candidate_id=<?php echo $result['candidate_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change Time</a>
                  <?php } ?></td>
              </tr>
              <?php
    }}else{?>
