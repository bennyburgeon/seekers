...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/company_clients/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
    <tr>
    <td> Company Name</td>
