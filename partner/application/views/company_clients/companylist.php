...
<a href="<?php echo base_url(); ?>index.php/company_clients" id="clear_search" class="btn btn-primary btn-xs">Clear Search Filters</a>


</div>
<form id="searchForm" action="<?php echo base_url(); ?>index.php/company_clients" method="get" name="searchForm">
...
<form name="frm_assignment" method="post" id="frm_assignment" action="<?php  echo $this->config->site_url();?>/company_clients/multiple_assignment?rows=<?php echo $rows;?>" >
...
if($records!=NULL)
{
	foreach($records as $result){ ?>
		<tr class="odd gradeX">
			...
			<td>
				<a href="<?php echo base_url();?>index.php/company_clients/edit/<?php echo $result['company_id']?>" class="views" title="Edit This Company"><?php echo $result['company_name']?></a><br> 
        ...
        <br>
            ...
            <a href="javascript:;" title="Make Calls" onclick="add_calls(<?php echo $result['company_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/company_clients/add_calls/?company_id=<?php echo $result['company_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Calls</a>
			
            || 
            
            <a href="javascript:;" title="Add New Job" onclick="add_jobs(<?php echo $result['company_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/company_clients/add_calls/?company_id=<?php echo $result['company_id'];?>"  id="add_jobs" class="btn btn-info btn-xs"> Add Job</a> ||
            
   <a href="javascript:;" title="Upload Agreement" onclick="add_agreement(<?php echo $result['company_id'];?>);"  data-url="<?php echo base_url(); ?>index.php/company_clients/add_calls/?company_id=<?php echo $result['company_id'];?>"  id="add_agreement" class="btn btn-info btn-xs">Agreement</a><br><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/company_clients/add_calls" id="calls_form" name="calls_form"> 
                ...
                <tr>
                  <td>Lead Status</td>
                  <td>                   
                    <input id="status" type="radio" name="status" value="1" />Feed<br>                    
                    <input id="status" type="radio" name="status" value="2"/>Lead<br>                    
                    <input id="status" type="radio" name="status" value="3"/>Client<br>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/company_clients/add_calls" />
...
<div class="modal fade" id="jobs_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/company_clients/add_jobs" id="jobs_form" name="calls_form"> 
                ...
                <tr>
				 ...
				 <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/company_clients/add_jobs" />
...
<div class="modal fade" id="agreement_modal" role="dialog" aria-labelledby="enquiry-modal-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/company_clients/add_agreement" id="agreement_form" name="agreement_form" enctype="multipart/form-data"> 
                ...
                <tr>
				 ...
				 <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/company_clients/add_agreement" />
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/company_clients/save_assignment" id="assignment_form" name="assignment_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/company_clients/save_assignment" />
                  </span>
                  </td>
                </tr>
                </tbody>
...
function get_calls_history(company_id){
	...
	$('#show_followup_history').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/company_clients/get_calls_history/?company_id=<?php echo $result['company_id'];?>",
...
function get_agreement_history(company_id){
	...
	$('#show_agreement_history').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/company_clients/get_agreement_history/",
			data: "",
			method: "POST",
  			data: { company_id : company_id },
		    dataType: "html",
...
function assign_requirement(company_id)
{
	...
	$('#data_holder').html('Loading..................');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/company_clients/assign_requirement/?company_id="+company_id,
...
$('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_clients/getstate/',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/company_clients/getcity/',
