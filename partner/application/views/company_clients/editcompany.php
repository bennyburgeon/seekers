...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/company_clients/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
      										 <?php echo form_hidden('company_id', $formdata['company_id']);?> 

    <tr>
    <td> Company Name</td>
    <td colspan="2"> <input type="text" id="company_name" readonly name="company_name" value="<?php echo $formdata['company_name'];?>" placeholder=" Enter Company Name" class="form-control" /></td>
    </tr>
<tr>
    <td>Industry</td>
...
<tr>
    ...
    <a href="<?php echo $this->config->site_url();?>/company_clients" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
