...
<tbody>
   ...
   <form action="<?php echo $this->config->site_url();?>/accommodation/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
  <?php echo form_hidden('co_work_id', $formdata["co_work_id"]);?>
...
<tr>
  ...
  <td>
  <input type="radio" value="1" name="vacancy_status" <?php if($formdata["vacancy_status"]==1)echo 'checked';?>>Yes &nbsp;<input type="radio" value="0" name="vacancy_status"  <?php if($formdata["vacancy_status"]==0)echo 'checked';?>>No
...
<tr>
  ...
  <input type="text" class="form-control" placeholder="Enter text" value="<?php echo $formdata["monthly_rent"] ?>"  name="monthly_rent" id="monthly_rent">
...
<tr>
  ...
  <a href="<?php echo $this->config->site_url();?>/accommodation" class="attach-subs subs">Cancel</a>
  </span>
  </td>
</tr>
</form>
