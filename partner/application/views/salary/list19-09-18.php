    ...
    <div class="row">
      <div class="col-sm-12"> <span  >
        ...
        <div class="table-tech specs">
          ...
          <div class="right-btns"> <a href="<?php echo base_url();?>index.php/salary/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> 
...
$i=0;
			...
			?>
                <tr>
                  ...
                  <td class="center"><a href="<?php echo base_url();?>index.php/salary/edit/<?php echo $result['salary_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a></td>
                </tr>
                <?php
						}
						?>
