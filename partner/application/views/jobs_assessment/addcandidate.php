...
<div id="contentwrapper" class="contentwrapper widgetpage">
               ...
               <div class="tableoptions">
				 ...
				 <?php echo form_open_multipart('jobs_assessment/addcandidate/'.$postdata['job_id'], 'name="frmcandidate"');?>
...
var strURL="<?php echo base_url(); ?>index.php/jobs_assessment/add_candidate_to_job/?candidate_id="+candidate_id + "&job_id=" + document.frmcandidate.job_id.value ;
