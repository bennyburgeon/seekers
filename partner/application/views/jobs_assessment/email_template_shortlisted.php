                               ...
                               <?php  if(is_array($table_rows)) 
							   {
								   ...
								   ?>
									   <tr>
										  ...
										  <td>
										  <?php if($val['total_exp']!='')echo $val['total_exp'].' &nbsp; Years';else echo ' &nbsp; Not Updated';?>
                                          </td>
										  <td>
                                          
										  <?php if($val['current_ctc']>=1){?>
										  <?php echo  $this->config->item('currency_symbol');?>&nbsp;
										  <?php echo number_format((float)$val['current_ctc'],2);?>
										  ...
										  <?php echo  $this->config->item('currency_symbol');?>&nbsp;
										  <?php echo number_format((float)$val['expected_ctc'],2);?>
                                          <?php }else{?>Not Updated<?php } ?>
...
Manager<br>
Mobile : add mobile number here <br><br>
COmpany Name, Address : Lcoation etc.<br>
Tel: add mobile number here  <br>

E Mail : <font style="color:#000;"><strong>jenson@globespan.co.in</strong></font> , Website : <font style="color:#000;"><strong>www.globespan.co.in</strong></font>   <br><br>
						  ...
						  <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main">
							  ...
							  <tr>
                                ...
                                <p  style="color:#000;"><?php echo $powered_by_email;?></p><br>
                                <p  style="color:#000;"><?php echo $powered_by_web;?></p></p>
</td>
							  </tr>
							</table>
							<!--  Footer Part End-->
