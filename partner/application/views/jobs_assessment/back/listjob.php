...
<form id="searchForm" method="post" action="<?php  echo $this->config->site_url();?>/jobs_assessment/">
...
<form name="form1" method="post" id="form1" action="<?php  echo $this->config->site_url();?>/jobs_assessment/multidelete?rows=<?php echo $rows;?>" >
<table class="tool-table new">
 <thead>
	<tr role="row" class="heading">
		<th width="24"><div class="checker"><span>#<!-- <input type="checkbox" class="group-checkable" id="selectall">--></span></div></th>
		<th width="813"><a href="<?php echo $this->config->site_url()?>/jobs_assessment?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>
        &rows=<?php echo $rows;?>">Job Title</a></th>	
		<th width="79">Expires</th>
 ...
 <tbody>
	...
	if($records!=NULL)
	{
		...
		<tr class="odd gradeX">
			...
			<td><a href="<?php echo base_url();?>index.php/jobs_assessment/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job"><?php echo $result['job_title']?></a><br>
            ...
            <td>
              <a href="<?php echo base_url();?>index.php/jobs_assessment/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job">Manage</a>
            </td>
	</tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/jobs_assessment/save_assignment" id="assignment_form" name="assignment_form"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_assessment/save_assignment" />
                  </span>
                  </td>
                </tr>
                </tbody>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/jobs_assessment?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>/jobs_assessment?limit='+limits;
	});
...
function assign_requirement(job_id)
{
	...
	$('#data_holder').html('Loading..................');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>index.php/jobs_assessment/assign_requirement/?job_id="+job_id,
