...
<a href="<?php echo base_url();?>index.php/jobs_assessment/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobs_assessment/add_candidate/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">

<input type="hidden" name="job_id" value="<?php echo $formdata['job_id'];?>">

<table width="90%" border="1"  class="table table-bordered table-condensed" align="center">
  <tbody>
    <tr>
...
<form name="quick_form" action="<?php echo base_url().'index.php/jobs_assessment/import_from_other_jobs/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">

<input type="hidden" name="cur_job_id" value="<?php echo $formdata['job_id'];?>">

<table width="95%" border="1"  class="table table-bordered table-condensed" align="center" cellpadding="3" cellspacing="3">
  <tbody>
    <tr>
