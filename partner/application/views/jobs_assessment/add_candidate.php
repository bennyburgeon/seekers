...
<form name="quick_form" action="<?php echo base_url().'index.php/jobs_assessment/import_from_other_jobs/';?><?php echo $formdata['job_id'];?>" method="post" enctype="multipart/form-data">
