<form class="form-horizontal form-bordered"  method="post" id="add_consultant_feedback_frm"  action="<?php echo $this->config->site_url();?>/jobs_ov/add_consultant_feedback/<?php echo $candidate_id;?>"  name="add_consultant_feedback_frm"> 
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/jobs_ov/add_consultant_feedback" />
