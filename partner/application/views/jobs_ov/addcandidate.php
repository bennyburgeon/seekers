...
<div id="contentwrapper" class="contentwrapper widgetpage">
               ...
               <div class="tableoptions">
				 ...
				 <?php echo form_open_multipart('jobs_ov/addcandidate/'.$postdata['job_id'], 'name="frmcandidate"');?>
			...
			?>
                        <tr>
                    		...
                    		<a href="<?php echo $upload_root.'../ov_jobs_ov/uploads/cvs'.$result['cv_file'];?>" target="_blank">View</a>
                    		<?php } ?></td>
...
var strURL="<?php echo base_url(); ?>index.php/jobs_ov/add_candidate_to_job/?candidate_id="+candidate_id + "&job_id=" + document.frmcandidate.job_id.value ;
