                               ...
                               <?php  if(is_array($table_rows)) 
							   {
								   ...
								   ?>
									   <tr>
										  ...
										  <td>$ <?php echo number_format($val['current_ctc'],2);?></td>
										  <td>$ <?php echo number_format($val['expected_ctc'],2);?></td>
										  <td><?php if($val['notice_period']!='')echo $val['notice_period'].' &nbsp; Months';else echo ' &nbsp; Not Updated';?></td>
						  ...
						  <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="main">
							  ...
							  <tr>
                                ...
                                <?php echo $powered_by_email;?><br><?php echo $powered_by_web;?><br></p>
</td>
							  </tr>
							</table>
							<!--  Footer Part End-->
