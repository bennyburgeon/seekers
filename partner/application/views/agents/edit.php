...
<tbody>
   ...
   <form action="<?php echo $this->config->site_url();?>/agents/update" class="form-horizontal form-bordered" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
...
<tr>
  ...
  <a href="<?php echo $this->config->site_url();?>/agents" class="attach-subs subs">Cancel</a>
  </span>
  </td>
</tr>
</form>
