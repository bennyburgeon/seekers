...
<tbody>
   <form action="<?php echo $this->config->site_url();?>visatype/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
                            <?php echo form_hidden('visa_type_id', $formdata['visa_type_id']);?>

    <tr>
    <td>Visa Type</td>
    <td><input class="form-control hori" type="text" name="visa_type" id="visa_type" value="<?php echo $formdata['visa_type'];?>" placeholder="Enter Visa Type"></td>
    </tr>
