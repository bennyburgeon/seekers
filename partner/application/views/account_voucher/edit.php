      ...
      <div class="col-sm-12">
        ...
        <div class="table-tech specs hor">
          <table class="hori-form">
            <tbody>
            <form action="<?php echo $this->config->site_url();?>/account_voucher/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data">
              <?php echo form_hidden('voucher_id', $formdata['voucher_id']);?>
              <tr>
                <td>Voucher Code</td>
              ...
              <tr>
                <td>Debit</td>
                <td><?php echo form_dropdown('debit', $account_list, $formdata['debit'],'class="form-control hori" id="account_id"');?></td>
              </tr>
              <tr>
                <td>Amount</td>
              ...
              <tr>
                <td>Credit</td>
                <td><?php echo form_dropdown('credit', $account_list, $formdata['credit'],'class="form-control hori" id="account_id"');?></td>
              </tr>
              <tr>
                <td>Narration</td>
              ...
              <tr>
                <td>Approved by</td>
                <td><?php echo form_dropdown('approved_by', $admin_list, $formdata['approved_by'],'class="form-control hori" id="approved_by"');?></td>
              </tr>
              <tr>
                <td>Prepared by</td>
                <td><?php echo form_dropdown('prepared_by', $admin_list, $formdata['prepared_by'],'class="form-control hori" id="prepared_by"');?></td>
              </tr>
              <tr>
                <td colspan="2"><span class="click-icons">
                  <input type="submit" class="attach-subs" value="Submit">
                  <a href="<?php echo $this->config->site_url();?>/account_voucher" class="attach-subs subs">Cancel</a> </span></td>
              </tr>
            </form>
              </tbody>
