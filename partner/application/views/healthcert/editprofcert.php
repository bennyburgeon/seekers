...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/healthcert/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
    ...
    <td>
    <?php echo $this->ckeditor->editor('cert_desc',$formdata['cert_desc']);?>
    </td>
    </tr>
    ...
    <a href="<?php echo $this->config->site_url();?>/healthcert" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
