...
<form id="searchForm" method="get" action="<?php echo $this->config->site_url()?>/cv_parser/">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-15">
        <form class="form-horizontal form-bordered"  method="post" action="<?php echo $this->config->site_url();?>/cv_parser/add_follow_up" id="calls_form" name="calls_form"> 
...
<tr>
                ...
                <tr>
                  ...
                  data-url="<?php echo $this->config->site_url();?>/cv_parser/add_follow_up" />
...
function myFunction()
{
	alert('asdas');
	 ...
	 if(parnt!='')
	 {
		  ...
		  type: "get",
		  async: true,
		  url: "<?php echo site_url('cv_parser/get_all_skills'); ?>",
		  data: {'id':parnt},
		  dataType: "json",
