...
<a href="<?php echo base_url();?>city/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<table class="tool-table new">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="<?php echo base_url();?>city/edit/<?php echo $result['city_id']?>" class="views" title="Edit">
            <img src="<?php echo base_url('assets/images/edits.png');?>"></a>
            <a href="<?php echo base_url();?>city/delete/<?php echo $result['city_id']?>" class="views" title="Delete" 
