...
<div class="row">
<div class="col-sm-12 pages"><a href="<?php echo $this->config->site_url();?>city">City </a> / <span><?php echo $page_head;?></span></div>
</div>
<div class="row">
<div class="col-sm-12">
<div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3>city form</h3></div>
...
<table class="hori-form">
    <tbody>
      <form action="<?php echo $this->config->site_url();?>city/add" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
        <tr>
            <td>Country</td>
            <td>
        ...
        <tr>
            <td>City Name</td>
            <td>
            <input type="text" id="city_name" name="city_name" value="<?php echo $formdata['city_name'];?>" placeholder="" class="form-control hori" /></td>
            </tr>
            <tr>
            <td>Status</td>
            <td>
            ...
            <label><input type="radio" name="status" id="uniform-undefined" value="0" <?php if($formdata['status']==0)echo 'checked="checked"';?> class="hor-check"> Inactive </label></td>
        </tr>
            <td colspan="2">
