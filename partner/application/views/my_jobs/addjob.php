    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs hor">
                        <form action="<?php echo $this->config->site_url();?>my_jobs/add" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
          ...
          <table class="hori-form">
            ...
            <tr>
                ...
                <td width="60%"><?php echo form_dropdown('company_id', $company, $formdata['company_id'],'class="form-control hori" id="company_id"');?></td>
              </tr>
              ...
              <tr>
                ...
                <td><input type="text" id="vacancies" name="vacancies" value="<?php echo $formdata['vacancies'];?>" placeholder="Number of vacancies" class="form-control hori" /></td>
              </tr>
                <tr>
                <td>Country</td>
              ...
              <tr>
                <td>City</td>
                <td><?php echo form_dropdown('job_location', $city_list, $formdata['job_location'],'class="form-control hori"  id="city_id" ');?>
               </td>
              </tr>
                <tr>
                <td>Job location</td>
                ...
                <?php echo form_dropdown('level_id',  $education, '','data-placeholder="Filter by Levels"  class="form-control hori" id="level_id"');?></td>
              </tr>
                 <tr>
                <td>Course Name</td>
              ...
              <tr  id="skill-tr"  <?php if(empty($candidate_skills)){ ?> style="display:none" <?php }  ?>>
               ...
               <tr>
                ...
                <td><input type="text" id="max_notice_period" name="max_notice_period" value="<?php echo $formdata['max_notice_period'];?>" placeholder="Notice period (in days)" class="form-control hori" /></td>
              </tr>
             <!-- <tr>
                <td>Priority</td>
