...
<?php  if(!empty($applied_candidates)) { ?>
            ...
            <tr>
              <td colspan="2" align="center" valign="top">
                ...
                <p class="text-left" style="margin-top: 8px;"><a href="<?php echo $this->config->site_url();?>my_jobs/addcandidate/<?php echo $formdata['job_id'];?>" class="btn btn-primary">Add more candidates</a></p>
              </td>
</tr>
...
<tr id="candidate_applied">
  ...
  <tbody>
    <tr>
      ...
      <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/shortlist2/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="shortlisted_candidate" class="btn btn-info btn-xs"> Short List </a>
        
        <a href="<?php echo base_url(); ?>my_jobs/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>
         
        <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/delete_applied_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_applied_candidate" class="btn btn-danger btn-xs btn-icon"><i class="fa fa-trash" aria-hidden="true"></i></a>
        
            |  <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/send_jd/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default" title="Email"><i class="fa fa-envelope" aria-hidden="true"></i></span></a>&nbsp;
...
<tr>
              <td colspan="2" align="center" valign="top">
                ...
                <p class="text-left" style="margin-top: 8px;"><a href="<?php echo $this->config->site_url();?>my_jobs/all_rejected/<?php echo $formdata['job_id'];?>" class="btn btn-warning">View All Rejected</a></p>
              </td>
</tr>
    ...
    <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
      <tbody >
        ...
        <tr>
          ...
          <td width="8%"><?php /*?> <a href="<?php echo base_url(); ?>my_jobs/shortlist/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $candidate['job_app_id'];?>"> Short List </a> | <a href="<?php echo base_url(); ?>my_jobs/reovecandidate/<?php echo $candidate['job_app_id'];?>/?app_id=<?php echo $formdata['job_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>">Delete Application</a><?php */?> <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/delete_applied_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_applied_candidate" class="btn btn-danger btn-xs"> X</a></td>
...
<tr id="candidate_shortlisted"  <?php  if(empty($shortlisted)) { ?> class="hide" <?php } ?>>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody>
        ...
        <tr>
         ...
         <td width="13%"> <a href='javascript:;'  onclick="interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a><?php /*?><a href="<?php echo base_url(); ?>my_jobs/addinterview/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $postdata['job_id'];?>">Interview</a><?php */?> <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a></td>
          </tr>
   ...
   <p class="text-right" style="margin-top: 1px;"><a href="<?php echo $this->config->site_url();?>my_jobs/addcandidate/<?php echo $formdata['job_id'];?>" class="btn btn-primary">Send To Client</a></p></td>
...
<tr>
    ...
    <p style="margin-top: 8px;" class="text-left"><a href="<?php echo base_url(); ?>my_jobs/create_invoice/<?php echo $formdata['job_id'];?>" class="btn btn-primary">View All</a></p>      </td></tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/cert_attest" />
                              <?php /*?><input type="submit" class="attach-subs" value="Save" id="save_candidate3" style="width:180px;"><?php */?>
                              </span>
                          </td>
                	   </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/create_visa" />
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/create_doc" />
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/create_medical" />
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/create_ticket" />
                   ...
                   <tbody>
                        ...
                        <tr>
                          <td colspan="2">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/create_followup" />
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>my_jobs/get_candidate_contract/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>my_jobs/get_visa_details/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>my_jobs/get_cert_attest/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>my_jobs/get_visa_document/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>my_jobs/get_medical_details/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>my_jobs/get_ticket_details/',
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>my_jobs/get_ticket_followup/',
