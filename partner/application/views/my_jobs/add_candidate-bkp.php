...
<form name="quick_form" action="<?php echo base_url().'my_jobs/add_candidate/';?><?php echo $formdata['job_id'];?>" method="post" onSubmit="return validate();" enctype="multipart/form-data">
...
<form name="quick_form" action="<?php echo base_url().'my_jobs/import_from_other_my_jobs/';?><?php echo $formdata['job_id'];?>" method="post" enctype="multipart/form-data">
