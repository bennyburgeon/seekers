...
<li class="active"><a href="<?php echo $this->config->site_url();?>my_jobs/offer_letters/<?php echo $formdata['job_id'];?>"><span><img src="<?php echo base_url('assets/images/profile-icon-1.png');?>"></span><span><img src="<?php echo base_url('assets/images/profile-icon-1_hover.png');?>"></span>Offer Letters</a></li>
...
<form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="<?php echo $this->config->site_url();?>my_jobs/accept_offer/<?php echo $formdata['job_id'];?>" onSubmit="return candidate_validate();"> 
