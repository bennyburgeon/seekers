...
<div class="col-md-12">
    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="3" class="table">
              ...
              <tr>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="tab-head mar-spec"><h3>About</h3></div>
                    <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                      ...
                      <tr>
                        <td colspan="2">
                          ...
                          <?php if($detail_list['photo']!=''){?><span id="imgTab2"><img src="<?php echo base_url().'uploads/photos/'.$detail_list['photo'];?>" class="profile_img" style="width:158px;height:100px;"><?php }else{ ?> 
                   ...
                   <?php /* if($detail_list['marital_status']==1) { ?>
                    Number of Children: <?php echo $detail_list['children'];?>
                    <?php }*/ ?>
                    </td>
                      </tr>
          ...
          <div class="profile_box2" style="margin-top: 15px;">
                ...
                <?php if( isset($job_search['current_ctc']) && $job_search['current_ctc']!=''){?>
                   Current CTC: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INR <?php echo $job_search['current_ctc'];?><br />
                <?php }else{ ?>
                ...
                <?php if( isset($job_search['expected_ctc']) && $job_search['expected_ctc']!=''){?>
                   Expected CTC : &nbsp;&nbsp; INR <?php echo $job_search['expected_ctc'];?><br />
                <?php }else{ ?>
                
                Expected CTC  : &nbsp;&nbsp;&nbsp;Not Updated.<br />
                <?php } ?>
                <?php if(isset($job_search['notice_period']) && $job_search['notice_period']!=''){?>
                    Notice Period: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $job_search['notice_period'];?> Days<br />
                <?php }else{ ?>
               ...
               <?php if(isset($job_search['total_experience']) && $job_search['total_experience']!=''){?>
                   Total Experience : <?php echo $job_search['total_experience'];?> Years<br />
                <?php }else{ ?>
                ...
                <strong>Languages Known :</strong>&nbsp; Not Updated.<br />
                <?php } ?>
                
                <?php if(!empty($candidate_locations)){?>
                <?php if(is_array($candidate_locations)){?>
                 <strong> Preferred Locations: </strong><br />
				  <?php echo implode(',',$candidate_locations);?>
                  <?php } }else{ ?>
                <strong>Preferred Locations :</strong>Not Updated.
                <?php } ?>	<br />	
    ...
    <tr>
        ...
        <thead>
          ...
          <!--    <td width="25%"> <a href="<?php // echo base_url(); ?>my_jobs/shortlist/<?php //echo $formdata['job_id'];?>/?app_id=<?php //echo $candidate['job_app_id'];?>"> Short List </a> | <a href="<?php //echo base_url(); ?>my_jobs/reovecandidate/<?php // echo $candidate['job_app_id'];?>/?app_id=<?php //echo $formdata['job_id'];?>&candidate_id=<?php //echo $candidate['candidate_id'];?>">Delete Application</a></td>-->
  ...
  <?php if(count($all_messages)>0){?>
        ...
        <tr>
          <td colspan="2" align="center" valign="top" class="borderTopNone"><table width="100%" border="1" cellspacing="1" cellpadding="0" class="table table-bordered table-condensed">
              ...
              <tr>
                <td width="20%"><?php echo $main_message['message_date'];?>, <?php echo $main_message['admin_name'];?></td>
