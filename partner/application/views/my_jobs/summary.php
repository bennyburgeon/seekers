...
<a href="<?php echo base_url();?>my_jobs/search_candidate/<?php echo $formdata['job_id'];?>">Search Candidates</a> &nbsp;&nbsp;&nbsp;||	

<a href="<?php echo base_url();?>my_jobs/send_mass_mail/<?php echo $formdata['job_id'];?>">Mass Email</a>	&nbsp;&nbsp;&nbsp; || 

&nbsp;&nbsp;&nbsp; 

&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>my_jobs/add_candidate/<?php echo $formdata['job_id'];?>">Add From Other Jobs</a>
...
--> 
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2" align="center" valign="top"><div class="tab-head mar-spec">
              ...
              <h3>Job Details - <?php echo $formdata['company_name'];?></h3>
        ...
        <tr>
          ...
          <td colspan="2" align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php if(($formdata['min_salary']!='' && $formdata['min_salary']!=0) || ($formdata['max_salary']!='' && $formdata['max_salary']!=0)) {?>
                    INR
                    <?php if($formdata['min_salary']!='' && $formdata['min_salary']!=0){ ?>
                    <?php echo number_format($formdata['min_sal'],0); }?>
                    <?php if($formdata['max_salary']!='' && $formdata['max_salary']!=0){
                    echo " To ".number_format($formdata['max_sal'],0); }?>
                    <?php }else{ ?>
                    Not updated
                    <?php } ?>
                ...
                <tr>
                  ...
                  <td><strong>Designaton</strong></td>

                  <td><?php if($formdata['desig_name']!='' && $formdata['desig_name']!='0') { echo $formdata['desig_name']; } else { echo 'not updated'; }?></td>

                  <td><strong><span>Qualification</span></strong></td>

                  <td><span> <?php foreach($education_levels as $key => $val){?>
                ...
                <tr>
                  ...
                  <td><?php if($formdata['job_cat_name']!='' && $formdata['job_cat_name']!='0') { echo $formdata['job_cat_name']; } else { echo 'not updated'; }?></td> 

                    <td><strong>Experience</strong></td>

                 <td><span>
				 
				  From: <?php if($formdata['min_experience']>0) { echo $formdata['min_experience_val']; } else { echo 'not updated'; }?>
                    
                   To:  <?php if($formdata['max_experience']!='' && $formdata['max_experience']!='0') { echo $formdata['max_experience_val']; } else { echo 'not updated'; }?>
          ...
          <?php if($formdata['min_age']!='' && $formdata['min_age']!=0){ ?>
                ...
                <tr>
				  ...
				  if($formdata['max_notice_period']=='1')echo 'Less Than 7 Days';
				  if($formdata['max_notice_period']=='2')echo '7 Days';
				  if($formdata['max_notice_period']=='3')echo '15 Days';
				  if($formdata['max_notice_period']=='4')echo '30 Days';
				  if($formdata['max_notice_period']=='5')echo '45 Days';
				  if($formdata['max_notice_period']=='6')echo '60 Days';
				  if($formdata['max_notice_period']=='7')echo '90 Days';
				  if($formdata['max_notice_period']=='8')echo 'More than 90 Days';
              ...
              <tbody >
                ...
                <tr>
                  ...
                  <td width="8%"><strong>
                     ...
                     <?php if(isset($candidate['notice_period']))
			  	{
				if($candidate['notice_period']=='Immediate' || $candidate['notice_period']=='7 Days')
				   echo $candidate['notice_period'];
				 else
				 	echo $candidate['notice_period'].' Days';
				}
			   ?>
  ...
  <a href="javascript:;" onclick="candidate_cv(<?php echo $candidate['candidate_id'];?>);" id="download_cv" data-url="<?php echo base_url();?>my_jobs/download_cv/<?php echo $candidate['candidate_id']?>" title="View CV" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i> Candidate CV</a>
...
<!-- 
                            <a href="javascript:;" title="No Calls Made" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>my_jobs/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-danger btn-xs"> Add Notes [?] </a>
-->

                            <!--         

<a href="javascript:;" title="Add Notes" onclick="add_notes(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>my_jobs/add_notes/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_notes" class="btn btn-info btn-xs"> Notes </a>
...
<!--                          <a href="javascript:;" title="Short List this candidate" onclick="add_to_shortlist(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>my_jobs/add_to_shortlist/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_to_shortlist" class="btn btn-info btn-xs"> Short List </a> 
    ...
    -->                        
        ...
        <a href="javascript:;" title="Send Message" onclick="add_message(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>my_jobs/add_message/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_msg" class="btn btn-info btn-xs"> Msg to Mobile </a>



                   

        <a href="javascript:;" title="Update CTC" onclick="add_ctc(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>my_jobs/add_ctc/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="update_ctc" class="btn btn-info btn-xs"> CTC </a>



  <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>my_jobs/send_jd/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a> &nbsp; 
  ...
  --></td>
          ...
          <td colspan="2" align="center" valign="top"><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              ...
              <tbody >
                ...
                <tr>
                  ...
                  <td width="4%"><a href="javascript:;" data-url="<?php echo base_url(); ?>my_jobs/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Update</a></td>
        ...
        <tr id="candidate_shortlisted">
          ...
          <td colspan="2" align="center" valign="top"><a href='javascript:;'  onclick="send_shortlisted(<?php echo $formdata['job_id'];?>);" class="btn btn-warning btn-xs">Send This to Client</a><br>
            ...
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>my_jobs/send_shortlisted"  method="post" id="shortlisted_form" name="shortlisted_form">
              ...
              <div class="modal fade" id="shortlisted_modal" role="dialog" aria-labelledby="enquiry-modal-label">
                ...
                <div class="modal-dialog" role="document">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/send_shortlisted" />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="16%"><?php if($candidate['app_status_id']==3){?>
                      ...
                      <a href='javascript:;'  onclick="add_interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a> || <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a>
              ...
              <tbody >
                ...
                <tr>
                  ...
                  <td><?php if($interview['total_rejection']==0  && $interview['selected']==0){?>
                    ...
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a> <a href="javascript:;" onclick="select_candidate(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs"> Select </a> <a href="javascript:;" onclick="reject_interview_fn(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $interview['interview_id'];?>);"  data-url="<?php echo base_url(); ?>my_jobs/reject_interview/"  id="reject_interview" class="btn btn-danger btn-xs">Reject </a>
              ...
              <tbody >
                ...
                <tr>
                  ...
                  <td><?php if($selected['offered']==0){?>
                    ...
                    <a href='javascript:;' onclick="issue_offer(<?php echo $formdata['job_id'];?>,<?php echo $selected['app_id'];?>,<?php echo $selected['candidate_id'];?>);" id="issue_offer" class="btn btn-info btn-xs"> Issue Offer </a> &nbsp;<a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/delete_selectedcandidate/?job_app_id=<?php echo $selected['app_id'];?>&candidate_id=<?php echo $selected['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_selected_candidate" class="btn btn-danger btn-xs">X </a>
			...
			?>
                ...
                <tr>
                  ...
                  <td><?php if($offerletter['offer_status']==1){?>
                    ...
                    <a href="javascript:;" onclick="accept_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-success btn-xs"> Accept </a> <a href="javascript:;" onclick="reject_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-warning btn-xs"> Reject </a>&nbsp;<a href="javascript:;"  data-url="<?php echo base_url().'my_jobs/delete_offercandidate/?job_app_id='.$offerletter['app_id'].'&candidate_id='.$offerletter['candidate_id'].'&job_id='.$formdata['job_id'];?>"  id="delete_offer_candidate" class="btn btn-danger btn-xs">X </a>
          ...
          <td colspan="2" align="center" valign="top" <?php  if(empty($offer_accepted)) { ?> class="hide" <?php } ?>><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
			...
			?>
                ...
                <tr>
                  ...
                  <td><p> <a href="javascript:;" onclick="create_invoice(<?php echo $formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id']?>);" class="btn btn-primary btn-xs">Invoice</a>&nbsp;<a href="javascript:;" data-url="<?php echo base_url().'my_jobs/delete_acceptcandidate/?job_id='.$formdata['job_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id']?>" id="delete_accept_candidate" class="btn btn-danger btn-xs">X </a></p></td>
              ...
              <tbody >
                ...
                <tr>
                  ...
                  <a href="<?php echo base_url(); ?>my_jobs/create_invoice/?job_id=<?php echo $formdata['job_id'];?>/?placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>" class="btn btn-primary btn-xs">Edit</a> --> 
                      ...
                      <a href="javascript:;"  data-url="<?php echo base_url(); ?>my_jobs/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" class="btn btn-danger btn-xs">X</a> </p></td>
          ...
          <div class="modal-header">
            ...
            -->
                ...
                -->
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/add_calls" />
                ...
                <div class="notes">
                  ...
                  <div class="table-tech specs note">
                    ...
                    <div class="new_notes">
                      ...
                      <form class="form-horizontal form-bordered"  method="post" id="client_cv_form"  action="<?php echo $this->config->site_url();?>my_jobs/upload_client_cv"  name="client_cv_form" enctype="multipart/form-data">
                ...
                <div class="notes">
                  ...
                  <div class="table-tech specs note">
                    ...
                    <div class="new_notes">
                      ...
                      <form class="form-horizontal form-bordered"  method="post" id="add_to_shortlist_form"  action="<?php echo $this->config->site_url();?>my_jobs/add_to_shortlist"  name="add_to_shortlist_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/add_to_shortlist" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            -->
                      ...
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>my_jobs/manage_rejection"  method="post" id="rejection_form" name="rejection_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/manage_rejection" />
                ...
                <div class="rejection">
                  ...
                  <div class="table-tech specs note">
                    ...
                    <div class="new_notes">
                      ...
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>my_jobs/save_job_change"  method="post" id="change_form" name="change_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/save_job_change" />
                ...
                <div class="notes">
                  ...
                  <div class="table-tech specs note">
                    ...
                    <div class="new_notes">
                      ...
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>my_jobs/add_feedback"  method="post" id="feedback_form" name="feedback_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/add_feedback" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            -->
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/add_ctc" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            -->
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/add_notes" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            -->
                      ...
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>my_jobs/add_message"  method="post" id="message_form" name="message_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/add_message" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            -->
                      ...
                      <form class="form-horizontal form-bordered"  method="post" id="interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>my_jobs/addinterview">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/addinterview" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            -->
                      ...
                      <form class="form-horizontal form-bordered"  method="post" id="reject_interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>my_jobs/reject_interview">
                  ...
                  data-url="<?php echo $this->config->site_url();?>my_jobs/reject_interview"/>
                        ...
                        <table class="hori-form">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/issue_offer" />
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td colspan="2"><span class="click-icons">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/reject_offer" />
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td colspan="2"><span class="click-icons">
                              ...
                              data-url="<?php echo $this->config->site_url();?>my_jobs/create_invoice2" />
...
function candidate_profile(candidate_id){
	...
	$('#show_candidate_profile').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>my_jobs/candidate_profile/"+candidate_id,
...

{
	...
	$('#show_client_cv_doc').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>my_jobs/client_cv_doc/?view="+candidate_id,
...

{
	...
	$('#show_client_cv').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>my_jobs/client_cv/?view="+candidate_id,
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>my_jobs/download_cv/"+candidate_id,
...
function add_consultant_feedback(candidate_id,job_id){
	...
	$('#show_consultant_feedback').html('');	
	 ...
	 $.ajax({			
			...
			url:"<?php echo base_url(); ?>my_jobs/open_consultant_feedback/"+candidate_id,
