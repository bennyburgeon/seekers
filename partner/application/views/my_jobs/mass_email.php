...
Mass Email	&nbsp;&nbsp;&nbsp; ||&nbsp;&nbsp;&nbsp;
<a href="<?php echo base_url();?>my_jobs/add_candidate/<?php echo $formdata['job_id'];?>">Add New Candidate</a>	&nbsp;&nbsp;&nbsp; ||</div>  
...
<form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>my_jobs/send_mass_mail/<?php echo $postdata['job_id'];?>"> 
