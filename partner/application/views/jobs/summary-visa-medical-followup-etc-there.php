...
<tr id="candidate_applied">
  ...
  <tbody>
    <tr>
      <td valign="middle" align="left">   CTC:<strong><?php echo $candidate['current_ctc']; ?></strong> | ECTC: <?php echo $candidate['expected_ctc']; ?> | NP: <?php echo $candidate['notice_period']; ?> | Exp: <?php echo $candidate['total_experience']; ?></td>
      
      
      <td valign="middle" align="right">
      
      <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/shortlist2/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="shortlisted_candidate" class="btn btn-info btn-xs"> Short List </a>
        
        <a href="<?php echo base_url(); ?>jobs/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a>
         
        <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_applied_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_applied_candidate" class="btn btn-danger btn-xs btn-icon"><i class="fa fa-trash" aria-hidden="true"></i></a>
        
            |  <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/send_jd/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default" title="Email"><i class="fa fa-envelope" aria-hidden="true"></i></span></a>&nbsp;
            
<a href="<?php echo base_url(); ?>index.php/candidates_all/edit/<?php echo $candidate['candidate_id'];?>/" target="_blank"  id="view_cv" class="btn btn-danger btn-xs btn-icon"><i class="fa fa-edit" aria-hidden="true"></i></a>

<a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $candidate['candidate_id']?>" target="_blank" class="btn btn-xs btn-primary btn-icon"><i class="fa fa-eye" aria-hidden="true"></i></a>
...
<a href="<?php echo base_url();?>index.php/candidates_all/download_cv/<?php echo $candidate['candidate_id']?>" target="_blank" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i> CV</a>
<?php } ?>

<?php if($candidate['linkedin_url']!=''){?>
	<a href="<?php echo $candidate['linkedin_url']?>" target="_blank" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i>Lin</a>
<?php } ?>
    ...
    <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
      <tbody >
        ...
        <tr>
          ...
          <td width="8%"><?php /*?> <a href="<?php echo base_url(); ?>jobs/shortlist/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $candidate['job_app_id'];?>"> Short List </a> | <a href="<?php echo base_url(); ?>jobs/reovecandidate/<?php echo $candidate['job_app_id'];?>/?app_id=<?php echo $formdata['job_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>">Delete Application</a><?php */?> <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_applied_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_applied_candidate" class="btn btn-danger btn-xs"> X</a></td>
...
<div class="tab-head mar-spec">	Candidates Planning Job Change Between <?php echo date('d-m-Y',strtotime($start_date)); ?> and <?php echo date('d-m-Y',strtotime($end_date)); ?></div>
</td>
</tr>
...
<tr id="candidate_shortlisted"  <?php  if(empty($shortlisted)) { ?> class="hide" <?php } ?>>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody>
        ...
        <tr>
         ...
         <td width="13%"> <a href='javascript:;'  onclick="interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a><?php /*?><a href="<?php echo base_url(); ?>jobs/addinterview/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $postdata['job_id'];?>">Interview</a><?php */?> <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a></td>
          </tr>
   ...
   <p class="text-right" style="margin-top: 1px;"><a href="<?php echo $this->config->site_url();?>jobs/addcandidate/<?php echo $formdata['job_id'];?>" class="btn btn-primary">Send To Client</a></p></td>
              ...
              <?php foreach($interview_list as $interview){
                ...
                <tr>
                  ...
                  <p>
                    ...
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_interview_candidate/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_interview_candidate" class="btn btn-danger btn-xs">X </a>
                    ...
                    <a href="javascript:;"  <?php /*?>data-url="<?php echo base_url(); ?>jobs/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>"<?php */?>onclick="select_candidate(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs"> Select </a></td>
                </tr>
...
<tr>
    ...
    <p style="margin-top: 8px;" class="text-left"><a href="<?php echo base_url(); ?>jobs/create_invoice/<?php echo $formdata['job_id'];?>" class="btn btn-primary">View All</a></p>      </td></tr>
          ...
          <tbody >
              ...
              <?php foreach($invoice_generated as $invoice){?>                                                
                ...
                <tr>
                  ...
                  <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" class="btn btn-danger btn-xs">X</a> | <a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $invoice['candidate_id']?>" target="_blank" class="btn btn-info btn-xs">Profile</a>
                   </p>       
...
{ 
	$.ajax({
	   ...
	   url: '<?php echo base_url(); ?>jobs/get_candidate_contract/',
...
{ 
	alert('test from get_select_candidate');
	$.ajax({
...
$(document).on('click', '#send_jd', function(){
  ...
  if(window.confirm("Are sou sure want to email candidate with Job Description?")){
	 ...
	 $.ajax({
	   ...
	   success: function(data){
		   //alert(data.email); - how to access json array, data is object set and email is one of the keeys
