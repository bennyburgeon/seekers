...
<div style="border:solid;height:auto;">
        ...
        <table border="0" cellpadding="3" cellspacing="3" width="100%">
            <tbody>
                ...
                <tr>
                <td colspan="2" align="center" valign="top"><strong>Job Details</strong></td>
                </tr>
            ...
            <tr>
              <td colspan="2" align="center" valign="top"><br>
                <strong>Candidates Applied</strong> [<a href="<?php echo $this->config->site_url();?>jobs/addcandidate/<?php echo $formdata['job_id'];?>">Add more candidates</a>]
              </td>
</tr>
...
<a href="<?php echo base_url();?>index.php/candidates_all/print_cv/<?php echo $candidate['candidate_id']?>" target="_blank">CV</a>
          ...
          <td width="25%"><a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/shortlist2/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="shortlisted_candidate" class="btn btn-info btn-xs"> Short List </a> | <a href="<?php echo base_url(); ?>jobs/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" id="reject_from_application" > Reject</a> | <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_applied_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_applied_candidate" class="btn btn-danger btn-xs"> X</a></td>
...
<tr>
              <td colspan="2" align="center" valign="top"><br>
                <strong>Candidates Rejected</strong> [<a href="<?php echo $this->config->site_url();?>jobs/all_rejected/<?php echo $formdata['job_id'];?>">View All Rejected</a>]
              </td>
</tr>
...
<tr>
    <td colspan="2" align="center" valign="top" id="invoice" <?php  if(empty($invoice_generated)) { ?> class="hide" <?php } ?>><br>
      <strong>Invoice against this Job</strong> [<a href="<?php echo base_url(); ?>jobs/create_invoice/<?php echo $formdata['job_id'];?>"> &nbsp;View All&nbsp; </a>]</td></tr>
