<div class="col-md-12">
  <div class="profile_top">
    <div class="profile_top_left">Summary &nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp; 
      <!--
...
&nbsp;&nbsp;&nbsp; 
&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>jobs/add_candidate/<?php echo $formdata['job_id'];?>">Add From Other Jobs</a>
--> 
    </div>
      ...
      <tbody>
        <tr>
          <td colspan="2" align="center" valign="top"><div class="tab-head mar-spec">
              <h3>Job Details</h3>
              <div style="float:right;margin-right:20px;">Job ID: <?php echo $this->config->item('job_prefix'); ?> - <?php echo $formdata['job_id'];?></div>
            </div></td>
        </tr>
        <tr>
          <td colspan="2" align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
              <tbody>
                <tr>
                  <td width="19%"><span><strong>Job Title</strong></span></td>
                  <td width="27%"><span><?php echo $formdata['job_title'];?></span></td>
                     <td><strong>Salary</strong></td>
                  <td><?php if($formdata['min_salary']!='' && $formdata['min_salary']!=0 || $formdata['max_salary']!='' && $formdata['max_salary']!=0) {?>
                    INR
          <?php if($formdata['min_salary']!='' && $formdata['min_salary']!=0){ ?>
                   <?php echo $formdata['min_salary']; }?>
                     <?php if($formdata['max_salary']!='' && $formdata['max_salary']!=0){
                    echo " To ".$formdata['max_salary']; }?>
                      <?php }else{ ?>
                  Not updated
                  <?php } ?>              </td>
                ...
                <tr>
                  ...
                  <td><strong><span>Qualification</span></strong></td>
                  <td><span><?php if($formdata['job_level']!='' && $formdata['job_level']!='0') { echo $formdata['job_level']; } else { echo 'not updated'; }?></span></td>
                </tr>
                <tr>
                    <td><span><strong>Designaton</strong></span></td>
                  <td><span><?php if($formdata['desig_name']!='' && $formdata['desig_name']!='0') { echo $formdata['desig_name']; } else { echo 'not updated'; }?></span></td>
                     <td><strong><span>Course</span></strong></td>
                  <td><span><?php if($formdata['course_name']!='' && $formdata['course_name']!='0') { echo $formdata['course_name']; } else { echo 'not updated'; }?></span></td>
                 
                  
                </tr>
                <tr>
                    <td><strong>Department</strong></td>
                  <td><?php if($formdata['fun_area']!='' && $formdata['fun_area']!='0') { echo $formdata['fun_area']; } else { echo 'not updated'; }?></td> 
                    <td><strong>Experience</strong></td>
                 <td><span><?php if($formdata['exp_range']!='' && $formdata['exp_range']!='0') { echo $formdata['exp_range']; } else { echo 'not updated'; }?></span></td>
                ...
                <tr>
                  ...
                  <td><span><?php if($formdata['job_cat_name']!='' && $formdata['job_cat_name']!='0') { echo $formdata['job_cat_name']; } else { echo 'not updated'; }?></span></td>
                ...
                <tr>
                  ...
                  <td><?php if($formdata['country_name']!='' && $formdata['country_name']!='0') { echo $formdata['country_name']; } else { echo 'not updated'; }?></td>
                    
                  <td><strong>Age Limit</strong></td>
                  <td><?php if($formdata['min_age']!='' && $formdata['min_age']!=0 || $formdata['max_age']!='' && $formdata['max_age']!=0) {?>
          <?php if($formdata['min_age']!='' && $formdata['min_age']!=0){ ?>
                   <?php echo $formdata['min_age']; }?>
                     <?php if($formdata['max_age']!='' && $formdata['max_age']!=0){
                    echo " To ".$formdata['max_age']; }?>
                      <?php }else{ ?>
                  Not updated
                  <?php } ?>              </td>
                </tr>
                <tr>
                  ...
                  <td><?php if($formdata['state_name']!='' && $formdata['state_name']!='0') { echo $formdata['state_name']; } else { echo 'not updated'; }?></td>
                  
                  <td><strong>Notice Period</strong></td>
                  <td><?php if($formdata['max_notice_period']!='' && $formdata['max_notice_period']!='0') { echo $formdata['max_notice_period']." days"; } else { echo 'not updated'; }?></td>
                </tr>
                <tr>
                    <td><strong>City</strong></td>
                  <td><?php if($formdata['city_name']!='' && $formdata['city_name']!='0') { echo $formdata['city_name']; } else { echo 'not updated'; }?></td>
                   <td><strong>Job Posting Date</strong></td>
                  <td><?php echo ($formdata['job_post_date']!='0000-00-00' && $formdata['job_post_date']!='') ? date('d-m-Y', strtotime($formdata['job_post_date'])) : '';?></td>
                
                    
                </tr>
                  <tr>
                    <td><strong>Job Location</strong></td>
                  <td><?php if($formdata['job_loc']!='' && $formdata['job_loc']!='0') { echo $formdata['job_loc']; } else { echo 'not updated'; }?></td>
                
                  <td><strong>Download JD</strong></td>
                  ...
                  <td><?php if($formdata['vacancies']!='' && $formdata['vacancies']!='0') { echo $formdata['vacancies']; } else { echo 'not updated'; }?></td>
                
                    <td>&nbsp;&nbsp;</td>
                   <td> &nbsp;&nbsp;</td>  
                </tr>
                  
                <?php if($formdata['instructions']!='' && $formdata['instructions']!='0'){ ?>
                <tr>
                  <td><strong>Instructions to Recruiter</strong> </td>
                    <td><?php echo $formdata['instructions']; ?></td>
           ...
           <tr>
               ...
               <tbody>
                   <tr>
                   <td width="300px;"><strong>Job Description</strong></td>
                    <td><?php echo $formdata['job_desc']; ?></td>
                   </tr>
                    <tr>
                   <td><strong>Desired Candidate Profile</strong></td>
                    <td><?php echo $formdata['desired_profile']; ?></td>
                   </tr>
                   <tr>
                   <td><strong>Roles and Responsibilities</strong></td>
                    <td><?php echo $formdata['work_level']; ?></td>
                   </tr>
                   <tr>
                   <td><strong>Mandatory Skill</strong></td>
                    <td><?php echo $formdata['skill']; ?></td>
                   </tr>
                   <tr>
                   <td><strong>Prefered Skill</strong></td>
                    <td><?php echo $formdata['job_skill_name']; ?></td>
                   </tr>
                   </tbody>
                   </table>
               </td></tr>
        <?php if($formdata['desired_profile']!='' || $formdata['job_desc']!=''){?>
        <tr>
          <td colspan="2" align="center" valign="top"><div class="tab-head mar-spec">
              <h3>Job Description </h3>
              <div style="float:right;"><a id="toggle_jd" href="javascript:;" class="tab-head mar-spec">Show/Hide</a></div>
            </div></td>
        </tr>
        <tr id="jd_details" style="display:none;">
          <td colspan="2" align="center" valign="top"><table border="1" cellpadding="1" cellspacing="1" width="100%" class="table table-bordered table-condensed">
              <tbody>
                <?php if($formdata['desired_profile']!=''){?>
                <tr>
                  <td><?php echo $formdata['desired_profile'];?></td>
                </tr>
                <?php } ?>
                <?php if($formdata['job_desc']!=''){?>
                <tr>
                  <td><?php echo $formdata['job_desc'];?></td>
                </tr>
                <?php } ?>
        ...
        <tr>
          <td colspan="2" align="center" valign="top"><div class="tab-head mar-spec">
              <h3>Candidates Applied&nbsp;&nbsp;[<?php echo count($applied_candidates);?>]&nbsp;&nbsp; [Rejected and shortlisted will not be in this list.]</h3>
              <div style="float:right;"><a id="toggle_applied" href="javascript:;" class="tab-head mar-spec">Hide/Show</a></div>
            </div></td>
        </tr>
        <tr id="candidate_applied_list">
          <td colspan="2" align="center" valign="top"><table border="1" cellpadding="1" cellspacing="1" width="100%" class="table table-bordered table-condensed">
              <thead>
                <tr>
                  <th>Name</th>
              ...
              <tbody >
                ...
                <tr>
                  <td width="22%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($candidate['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a></td>
                  <td width="8%"><?php echo $candidate['mobile'];?></td>
                  <td width="16%"><?php echo $candidate['username'];?> <br></td>
                  <td width="7%"><?php echo ($candidate['applied_on']!='0000-00-00' && $candidate['applied_on']!='') ? date('d-m-Y', strtotime($candidate['applied_on'])) : '';?></td>
                  <td width="9%"><?php echo $candidate['firstname'];?></td>
                  <td width="13%"><strong> <?php echo  $this->config->item('currency_symbol');?>
                    <?php if($candidate['current_ctc']!='')echo number_format($candidate['current_ctc'],1);else echo 'Nil'; ?>
                    </strong></td>
                  <td width="11%"><strong> <?php echo  $this->config->item('currency_symbol');?>
                    <?php if($candidate['expected_ctc']!='')echo number_format($candidate['expected_ctc'],2);else echo 'Nil'; ?>
                    </strong></td>
                  <td width="6%"><strong>
                ...
                <tr>
                  <td colspan="9"><table width="100%" border="0">
                      <tbody>
                        <tr>
                          <td width="68%" align="right" valign="middle"><div style="float:left"> 
                              <!--       
      CV Source:     
     
      <a href="javascript:;" title="CV Source"  id="cv_source" class="btn btn-info btn-xs">
	  
      
	  
	  <?php if($candidate['lead_source']==1)echo 'Recruiter';if($candidate['lead_source']==2)echo 'Web/Social Media';if($candidate['lead_source']==3)echo 'Vendor';if($candidate['lead_source']==4)echo 'Mobile';if($candidate['lead_source']==5 || $candidate['lead_source']=='')echo 'Source not updated';?></a>
  ...
  <a href="javascript:;" onclick="candidate_cv(<?php echo $candidate['candidate_id'];?>);" id="download_cv" data-url="<?php echo base_url();?>jobs/download_cv/<?php echo $candidate['candidate_id']?>" title="View CV" class="btn btn-xs btn-info"><i class="fa fa-file-text" aria-hidden="true"></i> Candidate CV</a>
...
-->
                              ...
                              <?php if($candidate['client_cv_file']!=''){?>
                              <a href="javascript:;" class="btn btn-warning btn-xs" title="View Profile" onclick="open_client_cv_doc(<?php echo $candidate['candidate_id'];?>);"> Client CV</a>
                              <?php }else{ ?>
                              <a href="javascript:;" onclick="upload_cv(<?php echo $candidate['candidate_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-danger btn-xs" title="View Profile">Upload CVs & Photo</a>
                              <?php if($candidate['cv_file']!=''){?>
                              || <a href="<?php echo base_url().'uploads/cvs/'.$candidate['cv_file'];?>" class="btn btn-danger btn-xs" target="_blank" title="View Profile">Download CV</a>
                              <?php } ?>
                              <?php } ?>
                            <a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($candidate['candidate_id']); ?>" target="_blank" class="btn btn-warning btn-xs" title="View Profile" >Candidate Profile</a> || <a href="<?php echo base_url(); ?>candidates_dir/summary/<?php echo $candidate['candidate_id'];?>" target="_blank" title="Change Job"  class="btn btn-info btn-xs"> Edit/View Profile </a> </div>
                            <?php if($candidate['total_calls']>0){?>
                            <a href="javascript:;" title="<?php echo $candidate['last_call_date'];?> | <?php echo $candidate['last_call_note'];?> | <?php if($candidate['cur_job_status']==1)echo 'No Job';if($candidate['cur_job_status']==2)echo 'Working, But Need a Change';if($candidate['cur_job_status']==3)echo 'Not Interested';if($candidate['cur_job_status']==4)echo 'Seeking Good Opportunity';if($candidate['cur_job_status']==5)echo 'Need a change ';if($candidate['cur_job_status']==6)echo 'Call after 1 Year';if($candidate['cur_job_status']==7)echo 'Call after this month ';?>" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-info btn-xs"> Notes [<?php echo $candidate['total_calls'];?>] </a>
                            <?php }else{ ?>
                            <a href="javascript:;" title="No Calls Made" onclick="add_calls(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_calls/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_calls" class="btn btn-danger btn-xs"> Add Notes [?] </a>
                            <?php } ?>
                            
                            <!--         
<a href="javascript:;" title="Add Notes" onclick="add_notes(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_notes/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_notes" class="btn btn-info btn-xs"> Notes </a>
--> 
                            
                            <a href="javascript:;" title="Update Consultant's Feedback" onclick="add_consultant_feedback(<?php echo $candidate['candidate_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_consultant_feedback/?candidate_id=<?php echo $candidate['candidate_id'];?>"  id="add_consultant_feedback" class="btn btn-<?php if($candidate['consultant_feedback']!='')echo 'info';else echo 'danger';?> btn-xs"> Consultant's Feedback</a>
                            <?php if($candidate['app_status_id']==1){?>
                            <a href="javascript:;" title="Short List this candidate" onclick="add_to_shortlist(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_to_shortlist/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_to_shortlist" class="btn btn-info btn-xs"> Short List </a> <a href="javascript:;" data-url="<?php echo base_url(); ?>jobs/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Reject</a> <a href="javascript:;" title="Change Job"  data-url="<?php echo base_url(); ?>jobs/change_job/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>" onclick="manage_job_change(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" id="change_job" class="btn btn-info btn-xs"> Change Job </a>
                            <?php }else{ ?>
                            Application Processed
                            <?php } ?>
                            
                            <!-- 
        <a href="javascript:;" title="Send Message" onclick="add_message(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_message/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_msg" class="btn btn-info btn-xs"> Msg to Mobile </a>

                   
        <a href="javascript:;" title="Update CTC" onclick="add_ctc(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_ctc/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="update_ctc" class="btn btn-info btn-xs"> CTC </a>
  ...
  --></td>
        ...
        <tr>
          <td colspan="2" align="center" valign="top"><div class="tab-head mar-spec">
              <h3>Candidates Rejected &nbsp;&nbsp;[<?php echo count($rejected_candidates);?>]</h3>
              <div style="float:right;"><a id="toggle_rejected" href="javascript:;" class="tab-head mar-spec">View All</a></div>
            </div></td>
        </tr>
        <tr id="candidate_rejected" style="display:none;">
          <td colspan="2" align="center" valign="top"><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              ...
              <tbody >
                ...
                <tr>
                  <td width="25%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($candidate['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a></td>
                  <td width="15%"><?php echo $candidate['mobile'];?></a></td>
                  <td width="15%"><?php echo $candidate['username'];?></a></td>
                  <td width="15%"><?php echo ($candidate['rejected_on']!='0000-00-00' && $candidate['rejected_on']!='') ? date('d-m-Y', strtotime($candidate['rejected_on'])) : '';?></td>
                  <td width="10%"><?php echo $candidate['firstname'];?></td>
                  <td width="16%"><?php if($candidate['reason_for_reject']==1)echo 'Lack of Education';?>
                    ...
                    <?php if($candidate['reason_for_reject']==22)echo 'Call After 1 Year';?></td>
                  <td width="4%"><a href="javascript:;" data-url="<?php echo base_url(); ?>jobs/reject_from_application/?job_app_id=<?php echo $candidate['job_app_id'];?>&job_id=<?php echo $formdata['job_id'];?>" title="Reject this candidate" onclick="manage_rejection(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);"  id="reject_from_application" class="btn btn-warning btn-xs"> Update</a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table></td>
        ...
        <tr>
          <td colspan="2" align="center" valign="top" id="short" ><div class="tab-head mar-spec">
              <h3>Candidates Shortlisted&nbsp;&nbsp;[<?php echo count($shortlisted);?>]</h3>
              <div style="float:right;"><a id="toggle_shortlisted" href="javascript:;" class="tab-head mar-spec">Hide/Show</a></div>
            </div></td>
        </tr>
        <tr id="candidate_shortlisted">
          <td colspan="2" align="center" valign="top"><a href='javascript:;'  onclick="send_shortlisted(<?php echo $formdata['job_id'];?>);" class="btn btn-warning btn-xs">Send This to Client</a><br>
            <br>
            <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>jobs/send_shortlisted"  method="post" id="shortlisted_form" name="shortlisted_form">
              <div class="modal fade" id="shortlisted_modal" role="dialog" aria-labelledby="enquiry-modal-label">
                <div class="modal-dialog" role="document">
                              ...
                              <div class="new_notes11">
                                ...
                                <table class="hori-form">
                                  <tbody>
                                    <tr>
                                      <td>Contact Name</td>
                                      <td><input id="contact_name" type="text" name="contact_name" value="<?php echo $company_info['contact_name'];?>" placeholder="Contact Name" />
                                        [Phone: <?php echo $company_info['contact_phone'];?>]&nbsp;[Ext.: <?php echo $company_info['contact_phone_ext'];?>] </td>
                                    </tr>
                                    <tr>
                                      <td>Designation</td>
                                      <td><input id="contact_designation" type="text" name="contact_designation" value="<?php echo $company_info['designation'];?>" placeholder="Designation" /></td>
                                    </tr>
                                    <tr>
                                      <td>Email</td>
                                      <td><input id="contact_email" type="text" name="contact_email" value="<?php echo $company_info['contact_email'];?>" placeholder="Contact Email" /></td>
                                    </tr>
                                    <tr>
                                      <td>Subject</td>
                                      <td><input id="email_subject" type="text" name="email_subject" value="Short Listed Candidates for job- <?php echo $formdata['job_title'];?>" placeholder="Please enter subject here" /></td>
                                    </tr>
                                    <tr>
                                      <td>CC To</td>
                                      <td><input id="email_cc" type="text" name="email_cc" value="" placeholder="Please enter your email" /></td>
                                    </tr>
                                    <tr>
                                      <td>Email Content</td>
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/send_shortlisted" />
                                        </span></td>
                                    </tr>
                                  </tbody>
                                </table>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
                ...
                <tbody>
                  ...
                  <tr>
                    <td width="2%"><?php if($candidate['app_status_id']==3){?>
                      <input type="checkbox" name="short_id[]" id="short_id[]" value="<?php echo $candidate['short_id'];?>">
                      <?php }else{ ?>
                      #
                      <?php } ?></td>
                    <td width="20%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($candidate['candidate_id']); ?>" target="_blank" title="View Profile"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a><br>
                      [CTC:<?php echo $candidate['current_ctc'];?>||ECTC:<?php echo $candidate['expected_ctc'];?>||EXP:<?php echo $candidate['total_experience'];?>||NP:<?php echo $candidate['notice_period'];?>] <br>
                      <a href="<?php echo base_url(); ?>candidates_dir/summary/<?php echo $candidate['candidate_id'];?>" target="_blank" title="View CV"  class="btn btn-info btn-xs"> Edit/View </a>
                    ...
                    <td width="8%"><?php echo ($candidate['applied_on']!='0000-00-00' && $candidate['applied_on']!='') ? date('d-m-Y', strtotime($candidate['applied_on'])) : '';?></td>
                    <td width="11%"><?php echo ($candidate['short_date']!='0000-00-00' && $candidate['short_date']!='') ? date('d-m-Y', strtotime($candidate['short_date'])) : '';?></td>
                    <td width="16%"><?php if($candidate['client_feedback']<1)echo 'No Feedback';?>
                      ...
                      || <a href='javascript:;'  onclick="add_feedback(<?php echo $candidate['short_id'];?>,<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-warning btn-xs">Change</a> <br>
                      <?php if($candidate['client_feedback']>=1)echo $candidate['client_notes'];?></td>
                    <td width="15%"><?php if($candidate['client_feedback_status']==0) echo 'Shortlisted';?>
                      ...
                      <?php if($candidate['feedback_date']!='0000-00-00' && $candidate['client_feedback_status']==2)echo '['.$candidate['feedback_date'].']';?></td>
                    <td width="16%"><?php if($candidate['app_status_id']==3){?>
                      <a href='javascript:;'  onclick="add_interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a> || <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a>
                      <?php }else{?>
                      Scheduled
                      <?php } ?></td>
                  </tr>
        ...
        <?php } ?>
        <tr>
          <td colspan="2" align="center" valign="top" id="inter" <?php  if(empty($interview_list)) { ?> class="hide" <?php } ?>><div class="tab-head mar-spec">
              <h3>Interviews Scheduled</h3>
            </div></td>
        </tr>
        <tr id="candidate_interview"  <?php  if(empty($interview_list)) { ?> class="hide" <?php } ?>>
          <td colspan="2" align="center" valign="top"><a href='javascript:;'  class="btn btn-warning btn-xs">Interview List</a><br>
            <br>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
              <thead>
                <tr>
              ...
              <tbody >
                ...
                <tr>
                  <td width="11%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($interview['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $interview['first_name'].' '.$interview['last_name'];?></a></td>
                  <td width="16%"><?php echo ($interview['interview_date']!='0000-00-00' && $interview['interview_date']!='') ? date('d-m-Y', strtotime($interview['interview_date'])) : '';?></td>
                  ...
                  <td><?php if($interview['total_rejection']==0  && $interview['selected']==0){?>
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a> <a href="javascript:;" onclick="select_candidate(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs"> Select </a> <a href="javascript:;" onclick="reject_interview_fn(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $interview['interview_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/reject_interview/"  id="reject_interview" class="btn btn-danger btn-xs">Reject </a>
                    <?php }else{ ?>
        ...
        <tr id="candidate_interview_history"  <?php  if(empty($interview_history)) { ?> class="hide" <?php } ?>>
          <td colspan="2" align="center" valign="top"><a href='javascript:;'  class="btn btn-warning btn-xs">Interview History</a><br>
            <br>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
              <thead>
                <tr>
              ...
              <tbody >
                <?php foreach($interview_history as $interview){
                  $datetime = explode(" ",$interview['interview_date']);?>
                <tr>
                  <td width="12%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($interview['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $interview['first_name'].' '.$interview['last_name'];?></a></td>
                  <td width="16%"><?php echo ($interview['applied_on']!='0000-00-00' && $interview['applied_on']!='') ? date('d-m-Y', strtotime($interview['applied_on'])) : '';?></td>
                  <td width="15%"><?php echo ($interview['interview_date']!='0000-00-00' && $interview['interview_date']!='') ? date('d-m-Y', strtotime($interview['interview_date'])) : '';?></td>
        ...
        <tr id="candidate_interview_rejection"  <?php  if(empty($interview_rejection_list)) { ?> class="hide" <?php } ?>>
          <td colspan="2" align="center" valign="top"><a href='javascript:;'  class="btn btn-warning btn-xs">Rejected Candidates</a><br>
            <br>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
              <thead>
                <tr>
              ...
              <tbody >
                ...
                <tr>
                  <td width="11%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($interview['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $interview['first_name'].' '.$interview['last_name'];?></a></td>
                  <td width="11%"><?php echo ($interview['interview_date']!='0000-00-00' && $interview['interview_date']!='') ? date('d-m-Y', strtotime($interview['interview_date'])) : '';?></td>
                  <td width="11%"><?php echo ($interview['rejected_on']!='0000-00-00' && $interview['rejected_on']!='') ? date('d-m-Y', strtotime($interview['rejected_on'])) : '';?></td>
                  <td width="11%"><?php if($interview['reject_reason_id']==1)echo 'Poor Performance';?>
                    ...
                    <?php if($interview['reject_reason_id']==11)echo 'No-show';?></td>
        ...
        <tr>
          <td colspan="2" align="center" valign="top" id="sel" <?php  if(empty($candidates_selected)) { ?> class="hide" <?php } ?>><div class="tab-head mar-spec">
        ...
        <tr id="candidate_selected" <?php  if(empty($candidates_selected)) { ?> class="hide" <?php } ?>>
          <td colspan="2" align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
              ...
              <tbody >
                ...
                <tr>
                  <td width="19%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($selected['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $selected['first_name'].' '.$selected['last_name'];?></a></td>
                  <td width="19%"><?php echo ($selected['select_date']!='0000-00-00' && $selected['select_date']!='') ? date('d-m-Y', strtotime($selected['select_date'])) : '';?></td>
                  <td width="45%"><?php echo $selected['feedback'];?></td>
                  <td><?php if($selected['offered']==0){?>
                    <a href='javascript:;' onclick="issue_offer(<?php echo $formdata['job_id'];?>,<?php echo $selected['app_id'];?>,<?php echo $selected['candidate_id'];?>);" id="issue_offer" class="btn btn-info btn-xs"> Issue Offer </a> &nbsp;<a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_selectedcandidate/?job_app_id=<?php echo $selected['app_id'];?>&candidate_id=<?php echo $selected['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_selected_candidate" class="btn btn-danger btn-xs">X </a>
                    <?php }else{ ?>
                    Offered
                    <?php } ?></td>
                </tr>
        ...
        <tr id="candidate_offer1">
          <td colspan="2" align="center" valign="top" id="sel" <?php  if(empty($offer_letters_issued)) { ?> class="hide" <?php } ?>><div class="tab-head mar-spec">
              <h3>Offer Letters Issued for Candidates below </h3>
            </div></td>
        </tr>
        <tr id="candidate_offer2"  <?php  if(empty($offer_letters_issued)) { ?> class="hide" <?php } ?>>
          <td colspan="2" align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
			...
			?>
                <tr>
                  <td ><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($offerletter['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $offerletter['first_name'].' '.$offerletter['last_name'];?></a></td>
                  <td ><?php echo ($offerletter['offer_date']!='0000-00-00' && $offerletter['offer_date']!='') ? date('d-m-Y', strtotime($offerletter['offer_date'])) : '';?></td>
                  <td ><?php echo $offerletter['salary_offered']?></td>
                  <td ><?php if($offerletter['offer_status']==1){?>
                  ...
                  <td><?php if($offerletter['offer_status']==1){?>
                    <a href="javascript:;" onclick="accept_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-success btn-xs"> Accept </a> <a href="javascript:;" onclick="reject_offer(<?php echo $formdata['job_id'].','.$offerletter['app_id'].','.$offerletter['candidate_id']?>);" class="btn btn-warning btn-xs"> Reject </a>&nbsp;<a href="javascript:;"  data-url="<?php echo base_url().'jobs/delete_offercandidate/?job_app_id='.$offerletter['app_id'].'&candidate_id='.$offerletter['candidate_id'].'&job_id='.$formdata['job_id'];?>"  id="delete_offer_candidate" class="btn btn-danger btn-xs">X </a>
                    <?php }else{ ?>
                    Status Changed
                    <?php } ?></td>
                </tr>
        ...
        <tr id="offer_accepted1">
          <td colspan="2" align="center" valign="top" id="sel" <?php  if(empty($offer_accepted)) { ?> class="hide" <?php } ?>><div class="tab-head mar-spec">
              <h3>Offer Accepted</h3>
            </div></td>
        </tr>
        <tr id="offer_accepted2">
          <td colspan="2" align="center" valign="top" <?php  if(empty($offer_accepted)) { ?> class="hide" <?php } ?>><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              <tbody >
                <tr>
                  <td>Candidate</td>
                  <td>Accept Date</td>
			...
			?>
                <tr>
                  <td width="33%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($accepted['candidate_id']); ?>" title="View Profile" target="_blank"> <?php echo $accepted['first_name'].' '.$accepted['last_name'];?> </a></td>
                  <td width="14%"><?php echo ($accepted['offer_accepted_date']!='0000-00-00' && $accepted['offer_accepted_date']!='') ? date('d-m-Y', strtotime($accepted['offer_accepted_date'])) : '';?></td>
                  <td width="19%"><?php echo $accepted['monthly_salary_offered'];?></td>
                  <td width="16%"><?php echo $accepted['min_contract_months'];?></td>
                  <td><p> <a href="javascript:;" onclick="create_invoice(<?php echo $formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id']?>);" class="btn btn-primary btn-xs">Invoice</a>&nbsp;<a href="javascript:;" data-url="<?php echo base_url().'jobs/delete_acceptcandidate/?job_id='.$formdata['job_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id']?>" id="delete_accept_candidate" class="btn btn-danger btn-xs">X </a></p></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
        ...
        <tr>
          <td colspan="2" align="center" valign="top" id="invoice" <?php  if(empty($invoice_generated)) { ?> class="hide" <?php } ?>><div class="tab-head mar-spec">
              <h3>Invoice against this Job</h3>
            </div></td>
        </tr>
        <tr id="candidate_invoice" <?php  if(empty($invoice_generated)) { ?> class="hide" <?php } ?>>
          <td colspan="2" align="center" valign="top"><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
              ...
              <tbody >
                ...
                <tr>
                  <td width="17%"><a href="<?php echo $this->config->item('client_cv_preview');?><?php echo md5($invoice['candidate_id']); ?>" title="View Profile" target="_blank"><?php echo $invoice['first_name'].' '.$invoice['last_name'];?></a></td>
                  <td width="11%"><?php echo ($invoice['invoice_date']!='0000-00-00' && $invoice['invoice_date']!='') ? date('d-m-Y', strtotime($invoice['invoice_date'])) : '';?></td>
                  <td width="11%"><?php echo ($invoice['invoice_due_date']!='0000-00-00' && $invoice['invoice_due_date']!='') ? date('d-m-Y', strtotime($invoice['invoice_due_date'])) : '';?></td>
                  <td width="14%"><?php echo ($invoice['invoice_due_date']!='0000-00-00' && $invoice['invoice_due_date']!='') ? date('d-m-Y', strtotime($invoice['invoice_due_date'])) : '';?></td>
                  ...
                  <td><p><!--
                  <a href="<?php echo base_url(); ?>jobs/create_invoice/?job_id=<?php echo $formdata['job_id'];?>/?placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>" class="btn btn-primary btn-xs">Edit</a> --> 
                      <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" class="btn btn-danger btn-xs">X</a> </p></td>
                </tr>
                <?php } ?>
              </tbody>
            </table></td>
          ...
          <div class="modal-header">
            ...
            -->
                        ...
                        <table class="hori-form">
                          <tbody>
                            <tr>
                              ...
                              <td><input id="cur_job_status" type="radio" name="cur_job_status" value="1"  checked="checked" />
                                No Job <br>
                                <input id="cur_job_status" type="radio" name="cur_job_status" value="2"/>
                                Working, But Need a Change <br>
                                <input id="cur_job_status" type="radio" name="cur_job_status" value="3"/>
                                Not Interested <br>
                                <input id="cur_job_status" type="radio" name="cur_job_status" value="4"/>
                                Seeking Good Opportunity <br>
                                <input id="cur_job_status" type="radio" name="cur_job_status" value="5"/>
                                Need a change <br>
                                <input id="cur_job_status" type="radio" name="cur_job_status" value="6"/>
                                Call after 1 Year <br>
                                <input id="cur_job_status" type="radio" name="cur_job_status" value="7"/>
                                Call after this month </td>
                            </tr>
                            <tr>
                              <td>Call Date</td>
                ...
                -->
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/add_calls" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
    ...
    <div class="modal fade" id="upload_client_cv_modal" role="dialog" aria-labelledby="enquiry-modal-label">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
              <div class="col-md-15">
                <div class="notes">
                  <ul>
                    <li id="tab_2btn">Upload CVs</li>
                  </ul>
                  <!--Followup--><br>
                  <br>
                  <div class="table-tech specs note">
                    <div class="new_notes">
                      <div class="alert alert-info"><strong>Info!</strong>&nbsp;Brand candidate CV and upload from here. This will be sending to client.</div>
                      <form class="form-horizontal form-bordered"  method="post" id="client_cv_form"  action="<?php echo $this->config->site_url();?>jobs/upload_client_cv"  name="client_cv_form" enctype="multipart/form-data">
                        <input type="hidden" name="candidate_id" id="upload_cv_candidate_id" value="">
                        <input type="hidden" name="job_id"  id="upload_cv_job_id" value="<?php echo $formdata['job_id'];?>">
                        <table class="hori-form">
                          <tbody>
                            <tr>
                              <td colspan="2"><table class="hori-form">
                                  <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                      <td>Upload Candidate's Photo</td>
                                      <td><?php echo form_upload(array('name'=>'photo','class'=>'form-data'));?></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2"><span class="click-icons">
                                        <input type="submit" class="attach-subs" value="Upload" id="upload_client_cv_button"  style="width:180px;">
                                        </span></td>
                                    </tr>
                                  </tbody>
                                </table></td>
                ...
                <div class="notes">
                  ...
                  <div class="table-tech specs note">
                    <div class="new_notes">
                      ...
                      <form class="form-horizontal form-bordered"  method="post" id="add_to_shortlist_form"  action="<?php echo $this->config->site_url();?>jobs/add_to_shortlist"  name="add_to_shortlist_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/add_to_shortlist" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            -->
                      <p id="result"></p>
                      <p id="deletemessage"></p>
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>jobs/manage_rejection"  method="post" id="rejection_form" name="rejection_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/manage_rejection" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
            ...
            <div class="modal-body">
              <div class="col-md-15">
                <div class="rejection">
                  ...
                  <div class="table-tech specs note">
                    <div class="new_notes">
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>jobs/save_job_change"  method="post" id="change_form" name="change_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/save_job_change" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
                ...
                <div class="notes">
                  ...
                  <div class="table-tech specs note">
                    <div class="new_notes">
                      <p id="result"></p>
                      <p id="deletemessage"></p>
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>jobs/add_feedback"  method="post" id="feedback_form" name="feedback_form">
                        ...
                        <table class="hori-form">
                          <tbody>
                            <tr>
                              ...
                              <td><input id="client_feedback" type="radio" name="client_feedback" value="0" />
                                No Feedback<br>
                                <input id="client_feedback" type="radio" name="client_feedback" value="1" checked/>
                                Selected<br>
                                <input id="client_feedback" type="radio" name="client_feedback" value="2"/>
                                Not Skilled<br>
                                <input id="client_feedback" type="radio" name="client_feedback" value="3"/>
                                Not Qualified.<br>
                                <input id="client_feedback" type="radio" name="client_feedback" value="4"/>
                                No Exp.<br>
                                <input id="client_feedback" type="radio" name="client_feedback" value="5"/>
                                No Domain Exp<br>
                                <input id="client_feedback" type="radio" name="client_feedback" value="6"/>
                                Rejected </td>
                            </tr>
                            <tr>
                              <td>Date</td>
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/add_feedback" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            -->
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/add_ctc" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            -->
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/add_notes" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            -->
                      <p id="result"></p>
                      <p id="deletemessage"></p>
                      <form class="form-horizontal form-bordered" action="<?php echo $this->config->site_url();?>jobs/add_message"  method="post" id="message_form" name="message_form">
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/add_message" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            -->
                      <p id="result"></p>
                      <p id="deletemessage"></p>
                      <form class="form-horizontal form-bordered"  method="post" id="interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>jobs/addinterview">
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/addinterview" />
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            -->
                      <p id="result"></p>
                      <p id="deletemessage"></p>
                      <form class="form-horizontal form-bordered"  method="post" id="reject_interview_form" name="interview_form" action="<?php echo $this->config->site_url();?>jobs/reject_interview">
                        ...
                        <table class="hori-form">
                          <tbody>
                            <tr>
                              <td>Reason</td>
                               <td>
                                <input type="radio" name="reject_reason_id" value="11" checked>
                                No-show<br>
                                <input type="radio" name="reject_reason_id" value="1">
                                Poor Performance<br>
                  ...
                  data-url="<?php echo $this->config->site_url();?>jobs/reject_interview"/>
                                </span></td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <tr>
                        <td colspan="2"><span class="click-icons">
                          <input type="button" class="attach-subs" value="Save" id="select_candidate_btn"  
                             data-url="<?php echo base_url(); ?>jobs/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>" />
                          </span></td>
                      </tr>
                    </tbody>
                  </table>
...
{ 
	$.ajax({
	   type: 'POST',
		data: {job_id:job_id},
		dataType: "json",
	   url: '<?php echo base_url(); ?>jobs/get_select_candidate/',
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>jobs/get_offer_issued/',	
	   success: function(data){ 
...
{ 
	$.ajax({	
	   type: 'POST',		
		data: {job_id:job_id},
		dataType: "json",		
	   url: '<?php echo base_url(); ?>jobs/get_offer_accepted/',	
	   success: function(data){	
...
function upload_cv(candidate_id,job_id){
	$('#upload_cv_candidate_id').val(candidate_id);
	$('#upload_cv_job_id').val(job_id);
    $('#upload_client_cv_modal').modal();
}
...
function candidate_profile(candidate_id){
	...
	$('#show_candidate_profile').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>jobs/candidate_profile/"+candidate_id,
			method: "POST",
...
function open_client_cv_doc(candidate_id)
{
	$('#show_client_cv_doc').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>jobs/client_cv_doc/?view="+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id},
		    dataType: "html",
			success: function(data) 
...
function open_client_cv(candidate_id,job_id)
{
	$('#show_client_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>jobs/client_cv/?view="+candidate_id,
			method: "POST",
...
function candidate_cv(candidate_id){
	...
	$('#show_candidate_cv').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>jobs/download_cv/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id },
		    dataType: "html",
			success: function(data) 
...
function add_consultant_feedback(candidate_id,job_id){
	...
	$('#show_consultant_feedback').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>jobs/open_consultant_feedback/"+candidate_id,
			method: "POST",
  			data: { candidate_id : candidate_id,job_id : job_id },
		    dataType: "html",
			success: function(data) 
