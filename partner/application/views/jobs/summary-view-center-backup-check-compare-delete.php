    ...
    <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
      <tbody >
        ...
        <tr>
          ...
          <td width="8%"> <a href="<?php echo base_url(); ?>jobs/shortlist/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $candidate['job_app_id'];?>"> Short List </a> | <a href="<?php echo base_url(); ?>jobs/reovecandidate/<?php echo $candidate['job_app_id'];?>/?app_id=<?php echo $formdata['job_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>">Delete Application</a> <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_applied_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_applied_candidate" class="btn btn-danger btn-xs"> X</a></td>
    ...
    <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
      <tbody>
        ...
        <tr>
         ...
         <a href="<?php echo base_url(); ?>jobs/addinterview/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $candidate['job_id'];?>">asdasdasInterview</a>| 
         
         <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a>
