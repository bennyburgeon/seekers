...
<div style="border:solid;height:auto;">
                    ...
                    <table border="1" cellpadding="3" cellspacing="3" width="95%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="25%"> <a href='javascript:;'  onclick="interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" >Interview</a> |  <a href="<?php echo base_url(); ?>jobs/delete_shortlisted/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>" >Remove </a></td>
  ...
  <tr>
    <td align="center" valign="top"><br>
  <br>
  <form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>jobs/shortlist/<?php echo $postdata['job_id'];?>"> 
