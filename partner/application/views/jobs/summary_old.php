          ...
          <td colspan="2" align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo ($formdata['job_expiry_date']!='0000-00-00' && $formdata['job_expiry_date']!='') ? date('d-m-Y', strtotime($formdata['job_expiry_date'])) : '';?></td>
                  <td><strong>Exp. join date</strong></td>
                  <td><?php echo ($formdata['exp_join_date']!='0000-00-00' && $formdata['exp_join_date']!='') ? date('d-m-Y', strtotime($formdata['exp_join_date'])) : '';?></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="4"><strong>Instructions to Recruiter</strong> <?php echo $formdata['instructions'];?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table></td>
        ...
        <tr id="candidate_applied_list">
          <td colspan="2" align="center" valign="top"><table border="1" cellpadding="1" cellspacing="1" width="100%" class="table table-bordered table-condensed">
              ...
              <tbody >
                ...
                <tr>
                  <td width="22%"><a href="javascript:;" title="View Profile" onclick="candidate_profile(<?php echo $candidate['candidate_id'];?>);"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a></td>
...
-->
                              ...
                              <?php } ?>
                              <?php } ?>
                              <a href="javascript:;" class="btn btn-warning btn-xs" title="View Profile" onclick="open_client_cv(<?php echo $candidate['candidate_id'];?>,<?php echo $formdata['job_id'];?>);">Candidate Profile</a> || <a href="<?php echo base_url(); ?>candidates_dir/summary/<?php echo $candidate['candidate_id'];?>" target="_blank" title="Change Job"  class="btn btn-info btn-xs"> Edit/View Profile </a> </div>
...
--> 
                            ...
                            <a href="javascript:;" title="Update Consultant's Feedback" onclick="add_consultant_feedback(<?php echo $candidate['candidate_id'];?>,<?php echo $formdata['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/add_consultant_feedback/?candidate_id=<?php echo $candidate['candidate_id'];?>"  id="add_consultant_feedback" class="btn btn-<?php if($candidate['consultant_feedback']!='')echo 'info';else echo 'danger';?> btn-xs"> Consultant's Feedback</a>
  ...
  --></td>
                ...
                <tbody>
                  ...
                  <tr>
                    <td width="2%"><?php if($candidate['app_status_id']==3){?>
                      ...
                      #
                      <?php } ?></td>
                    <td width="20%"><a href="javascript:;" title="View Profile" onclick="candidate_profile(<?php echo $candidate['candidate_id'];?>);"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a><br>
        ...
        <tr id="offer_accepted2">
          <td colspan="2" align="center" valign="top" <?php  if(empty($offer_accepted)) { ?> class="hide" <?php } ?>><table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
			...
			?>
                <tr>
                  <td width="33%"><a href="javascript:;" title="View Profile" onclick="candidate_profile(<?php echo $accepted['candidate_id'];?>);"> <?php echo $accepted['first_name'].' '.$accepted['last_name'];?> </a></td>
...
function candidate_profile(candidate_profile){
	...
	$('#show_candidate_profile').html('');	
	 $.ajax({			
			type: 'POST',
			url:"<?php echo base_url(); ?>jobs/candidate_profile/"+candidate_profile,
			method: "POST",
