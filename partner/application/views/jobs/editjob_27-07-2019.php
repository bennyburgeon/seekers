            ...
            <form action="<?php echo $this->config->site_url();?>jobs/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
             ...
             <tr>
              ...
              <tr>
               ...
               <tr>
                <td>Work Duration (Daya)</td>
                <td><input type="text" id="work_duration" name="work_duration" value="<?php echo $formdata['work_duration'];?>" placeholder="Work Duration in Days" class="form-control hori" /></td>
              </tr>
              <tr>
                <td>Hourly Rate</td>
                <td><input type="text" id="hourly_rate" name="hourly_rate" value="<?php echo $formdata['hourly_rate'];?>" placeholder="Hourly Rate" class="form-control hori" /></td>
              </tr>             
...
$('#company_id').change(function() {
	...
	if($('#company_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>jobs/getproduct/',
