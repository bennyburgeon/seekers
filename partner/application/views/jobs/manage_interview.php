          ...
          <tbody >
              ...
              <?php foreach($interview_list as $interview){
                ...
                <tr>
                  ...
                  <td><a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" >Change</a> | <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_interview_candidate/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_interview_candidate" >Remove </a>| <a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $interview['candidate_id']?>">Profile </a> | <a href="javascript:;"  <?php /*?>data-url="<?php echo base_url(); ?>jobs/select_candidate/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>"<?php */?>onclick="select_candidate(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" > Select </a></td>
                </tr>
