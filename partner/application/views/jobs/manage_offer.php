            ...
            <table border="1" cellpadding="3" cellspacing="3" width="95%">
                  ...
                  <?php foreach($candidates_selected as $selected){?>
                    ...
                    <tr>
                      ...
                      <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_selectedcandidate/?job_app_id=<?php echo $selected['app_id'];?>&candidate_id=<?php echo $selected['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_selected_candidate" >Remove </a>| <a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $selected['candidate_id']?>" target="_blank"> Profile </a> | <a href="javascript:;" data-url="<?php echo base_url(); ?>jobs/issue_offer/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $selected['app_id'];?>&candidate_id=<?php echo $selected['candidate_id'];?>"id="issue_offer"> Issue Offer </a></td>
                    </tr>
        ...
        <table border="1" cellpadding="3" cellspacing="3" width="95%">
			  ...
			  <?php foreach($offer_letters_issued as $offerletter){?>
                ...
                <tr>
                   ...
                   <td></td>
                    <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_offercandidate/?job_app_id=<?php echo $offerletter['app_id'];?>&candidate_id=<?php echo $offerletter['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_offer_candidate" >Remove </a>| <a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $offerletter['candidate_id']?>" target="_blank"> Profile </a> | <a href='javascript:;' onclick="accept_offer(<?php echo $formdata['job_id'];?>,<?php echo $offerletter['app_id'];?>,<?php echo $offerletter['candidate_id'];?>);" <?php /*?>href="<?php echo base_url(); ?>jobs/accept_offer/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $offerletter['app_id'];?>&candidate_id=<?php echo $offerletter['candidate_id'];?>"<?php */?>> Accept Offer </a></td>
                </tr>
