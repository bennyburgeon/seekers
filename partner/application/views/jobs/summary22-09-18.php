...
<tr>
              <td colspan="2" align="center" valign="top">
                <div class="tab-head mar-spec">
                  <h3>Candidates Applied&nbsp;&nbsp;[<?php echo count($applied_candidates);?>]&nbsp;&nbsp; [Rejected and shortlisted will not be in this list.]</h3><div style="float:right;"><a id="toggle_applied" href="javascript:;" class="tab-head mar-spec">Hide/Show</a></div>
                </div>
    ...
    <table border="1" cellpadding="1" cellspacing="1" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody >
        ...
        <tr>
          ...
          <td width="13%"><strong>
            <?php echo  $this->config->item('currency_symbol');?><?php if($candidate['current_ctc']!='')echo number_format($candidate['current_ctc'],1);else echo 'Nil'; ?>
          </strong>
      
 	      </td>
          <td width="11%"><strong>
           <?php echo  $this->config->item('currency_symbol');?> <?php if($candidate['expected_ctc']!='')echo number_format($candidate['expected_ctc'],2);else echo 'Nil'; ?>
          </strong></td>
          <td width="6%"><strong>
            <?php if($candidate['total_experience']!='')echo $candidate['total_experience'];else echo 'Nil'; ?> Yrs
          </strong></td>
          <td width="8%"><strong>
            <?php if($candidate['notice_period']!='')echo $candidate['notice_period'];else echo 'Nil'; ?> Days
          </strong></td>
          </tr>
     	<tr>
         <td colspan="9">
...
<?php if($candidate['client_cv_file']!=''){?>
 ...
 <a href="javascript:;" class="btn btn-warning btn-xs" title="View Profile" onclick="open_client_cv(<?php echo $candidate['candidate_id'];?>,<?php echo $formdata['job_id'];?>);">Candidate Profile</a>
                 
   ||        

 <a href="<?php echo base_url(); ?>index.php/candidates_dir/summary/<?php echo $candidate['candidate_id'];?>" target="_blank" title="Change Job"  class="btn btn-info btn-xs"> Edit/View Profile </a>
...
<tr>
	<td colspan="2" align="center" valign="top" id="short" >
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
      ...
      <tbody>
        ...
        <tr>
           ...
           <td width="20%"><a href="javascript:;" title="View Profile" onclick="candidate_profile(<?php echo $candidate['candidate_id'];?>);"><?php echo $candidate['first_name'].' '.$candidate['last_name'];?></a><br> [CTC:<?php echo $candidate['current_ctc'];?>||ECTC:<?php echo $candidate['expected_ctc'];?>||EXP:<?php echo $candidate['total_experience'];?>||NP:<?php echo $candidate['notice_period'];?>]
           
           <br>
           
            <a href="<?php echo base_url(); ?>index.php/candidates_dir/summary/<?php echo $candidate['candidate_id'];?>" target="_blank" title="View CV"  class="btn btn-info btn-xs"> Edit/View </a>
...
<?php } ?>
         ...
         <td width="16%"><?php if($candidate['app_status_id']==3){?> <a href='javascript:;'  onclick="add_interview(<?php echo $candidate['candidate_id'];?>,<?php echo $candidate['job_app_id'];?>,<?php echo $formdata['job_id'];?>);" class="btn btn-primary btn-xs">Interview</a>  || <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_shortlisted_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="delete_shortlisted_candidate" class="btn btn-danger btn-xs">X</a> 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-condensed">
        <thead>
          ...
          <?php if($interview['total_rejection']==0  && $interview['selected']==0){?>       
                    <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/edit_interview/?job_app_id=<?php echo $interview['job_app_id'];?>&candidate_id=<?php echo $interview['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="edit_interview" class="btn btn-primary btn-xs">Change</a>
                    ...
                    <a href="javascript:;" onclick="reject_interview_fn(<?php echo $interview['candidate_id'];?>,<?php echo $interview['job_app_id'];?>,<?php echo $interview['interview_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/reject_interview/"  id="reject_interview" class="btn btn-danger btn-xs">Reject </a>
                    <?php }else{ ?>
        ...
        <?php 
			...
			?>
				<tr>
                 ...
                 <p> <a href="javascript:;" onclick="create_invoice(<?php echo $formdata['job_id'].','.$accepted['app_id'].','.$accepted['candidate_id'].','. $accepted['placement_id']?>);" class="btn btn-primary btn-xs">Invoice</a>&nbsp;<a href="javascript:;" data-url="<?php echo base_url().'jobs/delete_acceptcandidate/?job_id='.$formdata['job_id'].'&app_id='.$accepted['app_id'].'&candidate_id='.$accepted['candidate_id'].'&placement_id='.$accepted['placement_id']?>" id="delete_accept_candidate" class="btn btn-danger btn-xs">X </a></p></td>
          ...
          <tbody >
              ...
              <?php foreach($invoice_generated as $invoice){?>                                                
                ...
                <tr>
                  ...
                  <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" class="btn btn-danger btn-xs">X</a>
                   </p>       
...
<br>
            ...
            <form class="form-horizontal form-bordered"  method="post" id="client_cv_form"  action="<?php echo $this->config->site_url();?>jobs/upload_client_cv"  name="client_cv_form" enctype="multipart/form-data"> 
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2"><span class="click-icons"><input type="submit" class="attach-subs" value="Upload" id="upload_client_cv_button"  style="width:180px;"></span></td>
                    </tr>
