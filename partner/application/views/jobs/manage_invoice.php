          ...
          <tbody >
              ...
              <?php foreach($offer_accepted as $accepted){?>
                ...
                <tr>
                    ...
                    <td width="13%">&nbsp;</td>
                    <td><a href="#" data-reveal-id="interview" data-animation="fade">Change</a> | <a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_acceptcandidate/?job_id=<?php echo $formdata['job_id'];?>&app_id=<?php echo $accepted['app_id'];?>&candidate_id=<?php echo $accepted['candidate_id'];?>&placement_id=<?php echo $accepted['placement_id'];?>" id="delete_accept_candidate" >Remove </a>| <a href="<?php echo base_url();?>index.php/candidates_all/summary/<?php echo $accepted['candidate_id']?>" target="_blank">Profile </a> | <a href='javascript:;' onclick="create_invoice(<?php echo $formdata['job_id'];?>,<?php echo $accepted['app_id'];?>,<?php echo $accepted['candidate_id'];?>,<?php echo $accepted['placement_id'];?>);" <?php /*?><a href="<?php echo base_url(); ?>jobs/create_invoice/<?php echo $formdata['job_id'];?>/?app_id=<?php echo $accepted['app_id'];?>&candidate_id=<?php echo $accepted['candidate_id'];?>&placement_id=<?php echo $accepted['placement_id'];?>"<?php */?>> Create Invoice</a></td>
                </tr>
...
<tr>
    <td colspan="2" align="center" valign="top" id="invoice" <?php  if(empty($invoice_generated)) { ?> class="hide" <?php } ?>><br>
      Invoice against this Job  [<a href="<?php echo base_url(); ?>jobs/create_invoice/<?php echo $formdata['job_id'];?>"> &nbsp;View All&nbsp; </a>]</td></tr>
          ...
          <tbody >
              ...
              <?php foreach($invoice_generated as $invoice){?>                                                
                ...
                <tr>
                  ...
                  <a href="<?php echo base_url(); ?>jobs/create_invoice/?job_id=<?php echo $formdata['job_id'];?>/?placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"> &nbsp;Edit&nbsp;</a>
                  
                   |<a href="javascript:;"  data-url="<?php echo base_url(); ?>jobs/delete_invoice/?job_id=<?php echo $formdata['job_id'];?>&placement_id=<?php echo $invoice['placement_id'];?>&invoice_id=<?php echo $invoice['invoice_id'];?>"  id="delete_invoice_candidate" >Delete</a>
