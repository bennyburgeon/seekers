...
<form action="<?php echo $this->config->site_url();?>/jobs/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
 <?php echo form_hidden('job_id', $formdata['job_id']);?>
    ...
    <td>Package</td>
    <td> 
    <?php echo form_dropdown('package_id', $package_list, $formdata['package_id'],'class="form-control hori" id="package_id"');?>
    </td>
    </tr>
    ...
    <td>Business Type</td>
    <td> 
    <?php echo form_dropdown('business_type_id', $business_type, $formdata['business_type_id'],'class="form-control hori" id="business_type_id"');?>
    </td>
    </tr>
...
<tr>
    ...
    <td>Job location</td>
    <td>
     <?php echo form_dropdown('job_location', $city_list, $formdata['job_location'],'class="form-control hori"  id="city_id" ');?>
    </td>
    </tr>
    ...
    <td> <?php echo form_dropdown('total_exp_needed', $experience_list, $formdata['total_exp_needed'],'class="form-control hori"');?>
    </td>
    </tr>
    ...
    <td>
    <input type="text" name="instructions" id="instructions" class="form-control hori" style="height:100px;" value="<?php echo $formdata['instructions'];?>" maxlength="200">
    </td>
    </tr>
