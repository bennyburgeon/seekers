<form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="http://localhost/placement/adminjobs/create_invoice/4" onSubmit="return candidate_validate();"> 
