...
<a href="<?php echo base_url();?>jobs/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
<!-- 
...
<table class="tool-table new">
 <thead>
	<tr role="row" class="heading">
		...
		<th width="558"><a href="<?php echo $this->config->site_url()?>jobs?sort_by=<?php if($sort_by=='asc'){echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>
        &rows=<?php echo $rows;?>">Job Title</a></th>
		<th width="122">Posted On</th>	
		<th width="114">Expires</th>
		<th width="118">List/Unlist</th>
		<th width="207">Actions	</th>    			
	</tr>
 </thead>
 <tbody>
	...
	if($records!=NULL)
	{
		...
		<tr class="odd gradeX">
			...
			<td><a href="<?php echo base_url();?>jobs/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job"><?php echo $result['job_title']?></a><br>
			  <?php echo $result['company_name']?> || Openings =<a href="#" class="btn btn-info btn-xs"><?php echo $result['vacancies']?></a> | Total Apps=<a href="#" class="btn btn-primary btn-xs"><?php echo $result['total_apps']?></a>
              <br>
           ...
           <td>
             ...
             <!-- 
             <a href="<?php echo base_url();?>jobs/delete/<?php echo $result['job_id']?>" class="views" title="Delete" onclick="return false;confirm('Are you sure you want to delete?');"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a> -->
             || 
             <a href="<?php echo base_url();?>jobs/manage/<?php echo $result['job_id']?>" class="views" title="Manage Job">Manage</a>
            
             || <a href="javascript:;" title="Assign this to Recruiter or Vendor" onclick="assign_requirement(<?php echo $result['job_id'];?>);"  data-url="<?php echo base_url(); ?>jobs/assign_requirement/?job_id=<?php echo $result['company_id'];?>"  id="assign_requirement" class="btn btn-info btn-xs"> Assign</a> 
