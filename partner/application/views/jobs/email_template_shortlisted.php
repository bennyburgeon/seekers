                            ...
                            <td align="left" valign="middle" style="font:normal 12px Arial, Helvetica, sans-serif; color:#000; padding-top:30px; padding-bottom:30px;"><table width="1000" border="0" cellspacing="0" cellpadding="0" class="main">
                                ...
                                <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                                    ...
                                    <td align="left" valign="top" bgcolor="#67bd3c" style="background:#fff;  padding:12px 20px 12px 20px;" class="borter-inner-bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <td colspan="2" align="left" valign="top" style="font:Normal 15px Arial, Helvetica, sans-serif; color:#000; padding:8px 0px 6px 4px; line-height:22px;"><p><strong> Dear <?php echo $email_to_name;?>, </strong><br />
                                            <br />
                                            Kindly find the attached profiles as per your requirements. <br>
                                            <br>
                                            Please click on the "view" against each candidate to get the CV displayed. Our consultant's evaluation and interview report is given in detail in all the profiles. <br>
                                            <br>
                                            At the end of each CV there is option to write your comments. Kindly mention your feedback in the space given for us to improve our search or proceed further. <br>
                                            <br>
                                            <?php echo $text_before_table;?> <br />
                                                ...
                                                <?php  if(is_array($table_rows)) 
							   {
								   ...
								   ?>
                                            ...
                                            Website : <a href="http://<?php echo $website;?>" target="_blank" style="color:#000;"><strong><?php echo $website;?></strong></a> <br>
                                            <br>
                                            <br />
                                            <p> <?php echo $text_after_table;?> </p>
                            ...
                            <td align="center" valign="top"><!--  Footer Part Start-->
                                ...
                                <tr>
                                    <td align="center" valign="top" bgcolor="#67bd3c" style="font: normal 12px Arial, Helvetica, sans-serif;background:#fff; padding:16px 20px 14px 20px;border-bottom:#67bd3c solid 3px; line-height:22px;" class="borte-footer-inner-borter"><p><strong><?php echo $powered_by;?><br>
                                        ...
                                        <a href="http://www.seekersgulf.com" target="_blank" style="color:#00;"><?php echo $powered_by_web;?></a><br>
                                      </p></td>
                                  </tr>
                              </table>
