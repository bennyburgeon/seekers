...
<br>
<a href="<?php echo base_url();?>jobs/manage/<?php echo $postdata['job_id'];?>">Back to Summary</a>	&nbsp;&nbsp;&nbsp;
</div>
...
<table border="0" cellpadding="3" cellspacing="3" width="100%">
  ...
  <tbody>
    ...
    <table border="1" cellpadding="3" cellspacing="3" width="100%" class="table table-bordered table-condensed">
     ...
     <a href="javascript:;" title="Short List this candidate"  data-url="<?php echo base_url(); ?>jobs/shortlist2/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="shortlisted_candidate" class="btn btn-info btn-xs"> Short List </a>
   ...
   <a href="javascript:;" title="Delete this application"  data-url="<?php echo base_url(); ?>jobs/delete_applied_candidate/?job_app_id=<?php echo $candidate['job_app_id'];?>&candidate_id=<?php echo $candidate['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"   id="delete_applied_candidate" class="btn btn-danger btn-xs btn-icon"><i class="fa fa-trash" aria-hidden="true"></i></a>
      ...
      <tr>
        ...
        <?php echo $pagination; ?> &nbsp;&nbsp;
      	<br>
      	<form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>jobs/addcandidate/<?php echo $postdata['job_id'];?>"> 
