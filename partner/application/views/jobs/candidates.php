...
-->
&nbsp;&nbsp;&nbsp;
<a href="<?php echo base_url();?>jobs/add_candidate/<?php echo $formdata['job_id'];?>">Add From Other Jobs</a></div>  
      ...
      <tr>
        ...
        <tr>
          <td align="center" valign="middle">
           <?php echo form_open_multipart('jobs/search_candidate/'.$postdata['job_id'], 'name="frmcandidate"');?> <input type="hidden" name="skills" id="skills"/>
...
<select name="ctc_min"  style="width:100px;">
      ...
      <tr>
        ...
        <?php echo $pagination; ?> &nbsp;&nbsp;
      	<br>
      	<form class="form-horizontal form-bordered" method="post" id="summary" name="summary" action="<?php echo base_url(); ?>jobs/search_candidate/<?php echo $postdata['job_id'];?>"> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="center">
          ...
          <a href="javascript:;" title="Add to Applications"  data-url="<?php echo base_url(); ?>jobs/add_candidate_to_job/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="add_candidate_to_job" class="btn btn-info btn-xs"> Add to Job </a>
          
          |  
          
  <!--             
            <a href="javascript:;" title="Send Job Description by Email"  data-url="<?php echo base_url(); ?>jobs/send_jd/?candidate_id=<?php echo $result['candidate_id'];?>&job_id=<?php echo $formdata['job_id'];?>"  id="send_jd"><span class="label label-default"><i class="fa fa-envelope" aria-hidden="true"></i></span></a>&nbsp;
