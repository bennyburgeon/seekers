    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-tech specs">
          <form name="form1" method="post" id="form1" action="<?php  echo $this->config->site_url();?>seminars/multidelete?rows=<?php echo $rows;?>" >
          <div class="right-btns"> <a href="<?php echo base_url();?>seminars/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a> <a href="#" id="deleteall" class="attach-subs tools"><img src="<?php echo base_url('assets/images/deletes_new.png');?>">Delete</a> </div>
...
foreach($records as $result){ ?>
                <tr class="odd gradeX">
                  ...
                  <td><?php if($result['int_status']=='1'){?>
                    <a href="<?php  echo $this->config->site_url();?>seminars/changestat/<?php echo $result['interview_id']?>?int_status=0"> <span class="label label-sm label-success">Active</span></a>
                    <?php }elseif($result['int_status']=='0'){?>
                    <a href="<?php  echo $this->config->site_url();?>seminars/changestat/<?php echo $result['interview_id']?>?int_status=1" ><span class="label label-sm label-danger">Blocked </span></a>
                    <?php } ?></td>
                  <td><a href="<?php echo base_url();?>seminars/edit/<?php echo $result['interview_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a></td>
                </tr>
                <?php
		}}else{?>
                <tr>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>seminars?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>seminars?limit='+limits;
	});
