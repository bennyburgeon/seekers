 ...
 <tbody>
	...
	if($records!=NULL)
	{
		...
		<tr class="odd gradeX">
            ...
            <td><a href="<?php echo $this->config->site_url()?>/candidates_all/summary/<?php echo $result['candidate_id']?>" target="_blank"><?php echo $result['first_name'].' '.$result['last_name']?></a> [<?php echo $result['mobile']?>]</td>           
			<td><a href="<?php echo $this->config->site_url()?>/jobs/manage/<?php echo $result['job_id']?>" target="_blank"><?php echo $result['job_title']?></a></td>
