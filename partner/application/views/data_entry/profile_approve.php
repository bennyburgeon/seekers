...
<?php } ?> 
     ...
     <a href="<?php echo $this->config->site_url();?>/data_entry/" class="attach-subs subs pull-right">Listing </a>
    <a href="<?php echo $this->config->site_url();?>/data_entry/profile_entry/<?php echo $candidate_id; ?>" class="attach-subs subs pull-right">Raw Data</a>
        <a href="<?php echo $this->config->site_url();?>/data_entry/edit/<?php echo $candidate_id; ?>" class="attach-subs subs pull-right">Update</a>
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="frm_profile_status" name="frm_profile_status"   action="<?php echo site_url('data_entry/update_profile_status'); ?>/<?php echo $candidate_id ?>" > 
  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id ?>">
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="frm_profile_assessment" name="frm_profile_assessment"   action="<?php echo site_url('data_entry/update_profile_assessment'); ?>/<?php echo $candidate_id ?>" > 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="" name=""   action="<?php echo site_url('data_entry/process_completed'); ?>/<?php echo $candidate_id ?>" > 
  <input type="hidden" name="candidate_id" value="<?php echo $candidate_id ?>">
...
//BEGIN category and functional area
   $('#edit_category').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_entry/editCategory'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
...
//BEGIN SKILLS AND CERTIFICATE
   $('#edit_skills').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_entry/editSkills'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
...
$('#update_contract').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_entry/add_contract_details'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
$('#update_lang').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('data_entry/add_lang_details'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
