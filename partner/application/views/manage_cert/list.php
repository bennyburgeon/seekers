...
<form name="form1" method="post" id="form1" action="<?php  echo $this->config->site_url();?>/manage_cert/multidelete?rows=<?php echo $rows;?>" >

<div class="right-btns">
<a href="<?php echo base_url();?>index.php/manage_cert/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
...
<form id="searchForm">
<tr>
<td><input class="form-control" type="text" name="searchterm" id="search_term" placeholder="Search Your Certification " value="<?php echo $searchterm != '' ? $searchterm: '' ;?>"  style="width: 185px;"></td>
    ...
    <table class="tool-table new">
        <thead>
            <tr>
                ...
                <th>
                <a href="<?php echo $this->config->site_url()?>/manage_cert?sort_by=<?php if($sort_by=='asc')
                {echo 'desc';}else{echo 'asc';};?>&searchterm=<?php echo $searchterm;?>&rows=<?php echo $rows;?>">Certification Name </a>
                </th>
        ...
        <?php foreach($records as $result){ ?>
            ...
            <tr class="odd gradeX">
                ...
                <td>
                <a href="<?php echo base_url();?>index.php/manage_cert/edit/<?php echo $result['cert_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
                <a href="<?php echo base_url();?>index.php/manage_cert/delete/<?php echo $result['cert_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>/manage_cert?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>/manage_cert?limit='+limits;
	});
