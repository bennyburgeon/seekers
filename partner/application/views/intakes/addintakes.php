...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li><a href="<?php echo $this->config->site_url();?>/jobs">Intakes</a>
                            ...
                            <li><a href="#">Add Intakes</a></li>
      </ul>
</div>

<div class="row">
<div class="col-sm-12">
<div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3>Add Intakes</h3></div>
...
<div class="table-tech specs hor">
    <table class="hori-form">
        ...
        <form action="<?php echo $this->config->site_url();?>/intakes/add" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
            <tr>
            
                <td>Intake Start Date</td>
                <td><input style="width:250px;" type="text" readonly name="intake_start" id="intake_start" value="" 
            ...
            <tr>
                ...
                <td> 
                <input style="width:250px;" type="text" readonly name="intake_end" id="intake_end" value="" 
            ...
            <tr>
                <td>Join Date</td>
                <td>
                <input style="width:250px;" type="text" readonly name="join_date" id="join_date" value="" 
                placeholder="Join Date" class="form-control"></td>
                </td>
            </tr>
           ...
           <tr>
                <td>University</td>
                <td> <?php echo form_dropdown('univ_id', $university, '','class="form-control hori" id="univ_id" style="width:700px;"');?></td>
