...
<tbody>
      ...
      <form action="<?php echo $this->config->site_url();?>/company_feeds/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<tr>
    ...
    <a href="<?php echo $this->config->site_url();?>/company_feeds" class="attach-subs subs">Cancel</a>
    </span>
    </td>
    </tr>
    </form>
