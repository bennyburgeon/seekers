...
<form name="form1" method="post" id="form1" action="<?php  echo $this->config->site_url();?>co_working/multidelete?rows=<?php echo $rows;?>" >


<div class="right-btns">
<a href="<?php echo base_url();?>co_working/add" class="attach-subs tools"><img src="<?php echo base_url('assets/images/plus.png');?>">Add New</a>
    	...
    	<span>
    		<input type="checkbox" name="checkbox[]" class="checkboxes" value="<?php echo $result['co_work_id']?>" >
								...
								<td>                    
                                    ...
                                    <a href="<?php  echo $this->config->site_url();?>co_working/changestat/<?php echo $result['co_work_id']?>?list_status=0"> <span class="label label-sm label-success">Active</span></a>
                                     <?php }elseif($result['list_status']=='0'){?>
									<a href="<?php  echo $this->config->site_url();?>co_working/changestat/<?php echo $result['co_work_id']?>?list_status=1" ><span class="label label-sm label-danger">Blocked </span></a>
                                     <?php } ?>
			...
			<a href="<?php echo base_url();?>co_working/edit/<?php echo $result['co_work_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>
...
$(document).ready(function()
{
	...
	$("#search").click(function(){
		...
		window.location.href = '<?php echo $this->config->site_url();?>co_working?searchterm='+searchterm;
	});
	$("#sel_limit1").change(function(){
		var limits = $(this).find(":selected").val();
		window.location.href = '<?php echo $this->config->site_url();?>co_working?limit='+limits;
	});
