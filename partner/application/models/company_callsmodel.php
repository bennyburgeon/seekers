...
class Company_callsmodel extends CI_Model {
	...
	$cond = " a.status =2 and company_id in (select company_id from pms_company_to_recruiter where admin_id=".$_SESSION['vendor_session'].") ";
	...
	if($_SESSION['vendor_session']!='')
	{
		if($cond!=''){
			$cond.=" and a.company_id in (select company_id from pms_company_to_recruiter where admin_id=" . $_SESSION['vendor_session'].") ";
		} 
		else{
			$cond.=" a.company_id in (select company_id from pms_company_to_recruiter where admin_id=" .$_SESSION['vendor_session'].") ";
		}  
	} 
