<?php
class Seminarsmodel extends CI_Model{
	...
	{
			$sql="select count(*)as total_count from pms_walkins where event_type=2";
	...
	{		
		$sql="SELECT a.*,b.job_title,c.company_name FROM pms_walkins a left join pms_jobs b on a.job_id=b.job_id left join pms_company c on b.company_id=c.company_id where a.event_type=2 ";
