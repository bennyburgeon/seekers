<?php 
class Shortlistedmodel extends CI_Model {
	var $table_name='';
    ...
    {
		$this->table_name='pms_job_apps_shortlisted';
	...
	function record_count($searchterm) 
	{
		$sql = "SELECT count(*)as job_id 
				FROM pms_job_apps_shortlisted
				INNER JOIN pms_job_apps
					on pms_job_apps.job_app_id = pms_job_apps_shortlisted.app_id
				INNER JOIN pms_jobs 
				...
				INNER JOIN pms_candidate
					on pms_candidate.candidate_id=pms_job_apps_shortlisted.candidate_id";
		$cond = '';
	...
	{
		$sql="SELECT pms_job_apps_shortlisted.*
					,pms_job_apps.job_id
					,pms_jobs.company_id
					,pms_jobs.job_title
					,pms_candidate.candidate_id
					, pms_candidate.first_name
					,pms_candidate.last_name
					,pms_candidate.mobile
