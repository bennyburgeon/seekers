    	...
    	<span>
    		<input type="checkbox" name="checkbox[]" class="checkboxes" value="<?php echo $result['candidate_id']?>" >
								...
								<td>
                                    ...
                                    <?php if($_SESSION['candidate_session']!=$result["candidate_id"]){?>
                                    <?php if($result['status']=='1'){?>
                                    <a href="<?php  echo $this->config->site_url();?>/admin/changestat/<?php echo $result['candidate_id']?>?status=0"> <span class="label label-sm label-success">Active</span></a>
                                     <?php }elseif($result['status']=='0'){?>
									<a href="<?php  echo $this->config->site_url();?>/admin/changestat/<?php echo $result['candidate_id']?>?status=1" ><span class="label label-sm label-danger">Blocked </span></a>
                                     <?php } ?>
                                ...
                                <td>
                                  <?php if($_SESSION['candidate_session']!=$result["candidate_id"]){?>
			<a href="<?php echo base_url();?>index.php/admin/edit/<?php echo $result['candidate_id']?>" class="views" title="Edit"><img src="<?php echo base_url('assets/images/edits.png');?>"></a>

			<a href="<?php echo base_url();?>index.php/admin/delete/<?php echo $result['candidate_id']?>" class="views" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><img src="<?php echo base_url('assets/images/deletes.png');?>"></a>
                                <?php }else { echo 'Cannot modify';} ?>
