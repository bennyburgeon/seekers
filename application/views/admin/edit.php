...
<tbody>
  ...
  <?php echo form_hidden('candidate_id', $formdata["candidate_id"]);?>
<tr>
<td>First Name</td>
<td><input type="text" class="form-control" placeholder="Enter text" value="<?php echo $formdata["first_name"] ?>"  name="first_name" id="first_name"></td>
</tr>
<tr>
<td>Last name</td>
<td><input type="text" class="form-control" placeholder="Enter text" value="<?php echo $formdata["last_name"] ?>"  name="last_name" id="last_name"></td>
</tr>
<tr>
<td>Email address</td>
