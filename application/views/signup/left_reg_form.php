...
<br>
Please go to 'My Profile' after Job Application, make sure that your profile updated.</label><br />
        <br />
  ...
  <?php echo form_dropdown('mobile_prefix',  $country_intl_code, '','data-placeholder="Filter by status" class="form-control input-sm" ');?>
                ...
                <br />
                 <input type="text" class="form-control input-sm" placeholder="Release / NOC" name="release_noc" id="release_noc">
                            ...
                            <label class="radio-inline"><input type="radio" value="Yes" id="driving_license" name="driving_license">Yes</label>
							<label class="radio-inline"><input type="radio" value="No" id="driving_license" name="driving_license" checked>No</label><br />
