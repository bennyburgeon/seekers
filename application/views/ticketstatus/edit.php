...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/ticketstatus/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
