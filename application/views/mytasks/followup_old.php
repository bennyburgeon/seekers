				...
				<div class="widget">
                   ...
                   <div class="widget">
								...
								<div class="widget-body" id="followup-<?php echo $followup["task_fl_id"]; ?>">
									<div class="well">
									<span class="span9"><h4 class="text-info"><?php echo $followup["task_fl_title"]; ?></h4></span><span class="span3"><a href="<?php echo $this->config->site_url();?>/mytasks/followup/<?php echo $task["task_id"]; ?>?edit=1&fid=<?php echo $followup["task_fl_id"]; ?>" class="btn btn-primary"><i class="icon-pencil icon-white"></i> Edit</a>&nbsp;<button id="<?php echo $followup["task_fl_id"]; ?>" class="btn btn-danger" onclick="DeleteFollowup(this.id);"><i class="icon-remove icon-white"></i> Delete</button></span>
                                    <p>&nbsp;</p>
                                   <p> <i class="icon-comment"></i> by <i class="icon-user"></i><span class="text-info"> <?php echo ($followup["first_name"]);?></span> <i class="icon-calendar"></i> <?php echo $followup["task_fl_date_time"]; ?></p>
                            ...
                            <div class="widget" id="editformdiv">
								...
								<div class="widget-body form">
									<form action="<?php echo $this->config->site_url();?>/mytasks/<?php echo $actionURL; ?>" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();"> 
...
function DeleteFollowup(id)
{
	...
	$.ajax({
					url: "<?php echo $this->config->site_url();?>/mytasks/delete_followup",	
					type: "POST",	
					data: "id="+id,	
					cache: false,
