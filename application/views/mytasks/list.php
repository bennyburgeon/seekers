    ...
    <td>
            ...
            <?php if($result['lead_opportunity']==0){echo '<p style="color:##000">';}?>
              ...
              <?php echo $result["task_title"]; ?>
                            ...
                            <a class="label label-sm label-success" href="<?php echo $this->config->site_url();?>/mytasks/changestat/<?php echo $result['task_id']?>?stat=0&searchterm=<?php echo $searchterm;?>&date_range=<?php echo $date_range;?>">Open</a>
                            <?php } ?>
                            
                            <?php if($result['status']==0){?>
                            <a class="label label-sm label-danger" href="<?php echo $this->config->site_url();?>/mytasks/changestat/<?php echo $result['task_id']?>?stat=1&searchterm=<?php echo $searchterm;?>&date_range=<?php echo $date_range;?>">Closed</a>
                            <?php } ?>                            </td>
