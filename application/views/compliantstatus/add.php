            ...
            <div class="col-md-3"></div>
	          ...
	          <!-- BEGIN SAMPLE FORM PORTLET-->
					<div class="portlet light">
						...
						<form action="<?php echo $this->config->site_url();?>/compliantstatus/add" enctype="multipart/form-data" method="post" id="frmentry" name="frmentry" onSubmit="return validate();">
							 ...
							 <?php if(validation_errors()!=''){?> 
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="radio-list">
                                        ...
                                        <label class="radio-inline">
                                        <div class="radio" id="uniform-optionsRadios5"><span><input type="radio" value="0" id="optionsRadios5" name="status"></span></div> Inactive </label>
