...
<div class="row">
<div class="col-sm-12">
<div class="tab-head mar-spec"><img src="<?php echo base_url(); ?>assets/images/head-icon-7.png" alt=""/><h3>Edit Testimonials</h3></div>
...
<form action="<?php echo $this->config->site_url();?>/testimonials/update" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmctype" name="frmentry" onSubmit="return validate();">
 <?php echo form_hidden('test_id', $formdata['test_id']);?>
    <tr>
