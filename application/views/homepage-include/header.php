...
<link rel="stylesheet" href="<?php echo base_url('assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.css');?>"> <!-- Bootstrap CSS -->
...
<div class="top-header">
    ...
    <div class="container">
       ...
       <div class="col-md-6 col-sm-12">
           ...
           <a href="<?php echo $this->config->base_url();?>index.php/home"><i class="fa fa-envelope "></i>  jobs@logis.ae  </a> <a href="<?php echo $this->config->base_url();?>index.php/home"> <i class="fa fa-mobile"></i> WhatsApp : +971 50 3860610</a>  </div>        
...
<div class="btn-group">
       ...
       <?php } ?>
                  ...
                  <a href="<?php echo $this->config->base_url();?>index.php/home"> <i class="fab fa-rocketchat"> </i> </a>
                  ...
                  <li class="submenu-right"><a href="<?php echo $this->config->base_url();?>index.php/homepage">Home</a>
                     ...
                     <li class="submenu-left">
                        ...
                        <ul>
                           ...
                           <li><a href="<?php echo $this->config->base_url();?>index.php/empsignup">Employer Registration</a></li>
                ...
                <div class="col-lg-12 flx-just">
                    ...
                    <div class="search-withbtn">
                        ...
                        <div class="Search-bx">
                            ...
                            <input name="search_text" type="text" class="form-control search-slt" value="" placeholder="Enter Keyword">
        ...
        <div class="row">
               ...
               <div class="col-md-12">
                  ...
                  <ul class="intro-stats margin-top-45 hide-under-992px">
					...
					<li><a href="<?php echo $this->config->base_url();?>/index.php/home"><strong class="counter">All Jobs</strong></a> </li>
           			<li><a href="<?php echo $this->config->base_url();?>/index.php/home?func_id=41"><strong class="counter">Sales Jobs</strong></a> </li>
					<li><a href="<?php echo $this->config->base_url();?>/index.php/home?func_id=59"><strong class="counter">Operations Jobs</strong></a> </li>
                     <li><a href="<?php echo $this->config->base_url();?>index.php/home?func_id=22"><strong class="counter">Customer Service Jobs</strong></a> </li>
