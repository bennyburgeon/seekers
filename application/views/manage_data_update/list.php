...
<form id="candidate_form" class="formular" name="candidate_form" method="post" >
  ...
  <table class="enqTbl"  border="0" cellspacing="2" cellpadding="2" width="100%">
    ...
    <tr>
      ...
      <input type="text" class="txtFeild"  name="first_name" value="<?php echo $formdata['first_name'];?>" id="first_name" placeholder="Enter Full Name" readonly>      </td>
    </tr>
    <tr>
      <td height="17" class="style1">e-Mail*</td>
      <td>:</td>
      <td align="left"><label>
      <input class="txtFeild" type="text" name="username" value="<?php echo $formdata['username'];?>" id="username" placeholder="Enter your Email" readonly>
      </label></td>
    </tr>
    <tr>
      ...
      <td>:</td>
      <td align="left"><label>
      <input class="txtFeild" type="password" name="pass" value="<?php echo $formdata['password'];?>" id="pass" placeholder="Password" readonly>
      </label></td>
    </tr>
    <tr>
      ...
      <td align="left"><label>
        ...
        <input class="txtFeild" style="width:100px;"  type="text"  name="mobile" maxlength="13" placeholder="Mobile Phone" value="<?php echo $formdata['mobile'];?>" id="mobile" readonly>
    ...
    <tr>
	  ...
	  <input type="hidden" name="cand" id="cand" value="<?php echo $formdata['id']; ?>">
	  
<!--
        <input name="Register" type="button" class="btn" id="save_candidate" value="Register" />
-->
<!--
        <input name="Register" type="submit" class="btn" id="" value="Register" />
-->
      </label></td>
    </tr>
  </table>
...
function myFunction()
	{
      ...
      type: "get",
      async: true,
      url: "<?php echo site_url('manage_data_update/child_skill'); ?>",
      data: {'id':parnt},
      dataType: "json",
...
{ 
	...
	{   
		i+=1;
		j=i%3;
		var z=skillset[k]['skill_id'];
		var checks="<td><input type='checkbox' name='skills[]' value="+z+"/>"+skillset[k]['skill_name']+"</td>";
...
<h2 class="srevHd">Update CV &amp; Photo</h2>
 <form class="form-horizontal form-bordered"  method="post" id="candidate_form_file" name="candidate_form_file" action="<?php echo $this->config->site_url();?>/manage_data_update/addfiles?id='$candidate_id'" enctype="multipart/form-data"> 
	...
	$( document ).ready(function() 
{
	...
	//all hidden boxes
	 ...
	 document.getElementById('candidate_id1').value=document.getElementById('cand').value;
	 document.getElementById('candidate_id2').value=document.getElementById('cand').value;
	 document.getElementById('candidate_id3').value=document.getElementById('cand').value;
	 document.getElementById('candidate_id4').value=document.getElementById('cand').value;
	 document.getElementById('candidate_id5').value=document.getElementById('cand').value;
	 document.getElementById('candidate_id6').value=document.getElementById('cand').value;
	 document.getElementById('candidate_id7').value=document.getElementById('cand').value;
	 document.getElementById('candidate_id8').value=document.getElementById('cand').value;
 ...
 $('#save_candidate').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('/manage_data_update/addCandidate'); ?>",
				cache: false,				
				data: dataStringprop,
   ...
   $('#level_id').change(function() 
	{
		...
		if($('#level_id').val()=='')return;
			$.ajax({
			  type: 'POST',
			  url: '<?php echo $this->config->site_url();?>/manage_data_update/getcourses/',
   ...
   $('#save_candidate3').click(function(){
		...
		if(isContactValid) {
			var candidateId = document.getElementById('candidate_id1').value;
			 ...
			 $.ajax({
				 type: "post",
				 url: "<?php echo site_url('manage_data_update/addEducationDetail'); ?>"+'/'+candidateId,
				 cache: false,				
				 data: dataStringprop,
				  success: function(json) {
   ...
   $('#save_candidate2').click(function(){
		...
		var candidateId = document.getElementById('candidate_id2').value;
			$.ajax({
				type: "post",
				url: "<?php echo site_url('manage_data_update/addPassportDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
   ...
   $("#radio2").click(function(){
      ...
      $('#save_questionnaire').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('manage_data_update/addQuestionnaire'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
   ...
   $('#save_candidate_skill1').click(function(){
		...
		var candidateId = document.getElementById('candidate_id4').value;
			$.ajax({
				...
				url: "<?php echo site_url('manage_data_update/addSkillDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
   ...
   $('#candidate_form_cert1').click(function(){
		...
		var candidateId = document.getElementById('candidate_id5').value;
			$.ajax({
				type: "post",
				url: "<?php echo site_url('manage_data_update/addcertificationDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
   ...
   $('#candidate_form_job1').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('manage_data_update/addJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
   ...
   $('#country_id').change(function() {
	...
	if($('#country_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/manage_data_update/getstate',
...
$('#state_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/manage_data_update/getcity',
...
$('#city_id').change(function() {
	...
	if($('#state_id').val()=='')return;
		...
		$.ajax({
		  type: 'POST',
		  url: '<?php echo $this->config->site_url();?>/manage_data_update/getlocation',
   ...
   $('#candidate_form_contact1').click(function(){
		...
		if(isContactValid) {
			$.ajax({
				type: "post",
				url: "<?php echo site_url('manage_data_update/addCandidateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
