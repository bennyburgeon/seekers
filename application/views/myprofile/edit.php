...
<?php echo form_hidden('candidate_id', $_SESSION['candidate_session']);?>
<tbody>
<tr>
<td>First name</td>
<td>
<input type="text" placeholder="Enter First Name" value="<?php echo $formdata["first_name"] ?>"  name="first_name" id="first_name" class="form-control hori">
</td>
</tr>
<tr>
<td>Last name</td>
<td><input type="text" placeholder="Enter Last Name" value="<?php echo $formdata["last_name"] ?>"  name="last_name" id="last_name" class="form-control hori"></td>
</tr>
<tr>
<td>Address</td>
...
<tr>
<td>User name</td>
<td><input type="text" placeholder="Enter Username" value="<?php echo $formdata["username"];?>" readonly  name="username" id="username" class="form-control hori"></td>
</tr>
<tr>
<td>Image file</td>
<td>
<input type="file" name="admin_img" value="">
</td>
</tr>
