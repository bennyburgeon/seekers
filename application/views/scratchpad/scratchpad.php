...
<textarea  data-provide="markdown" id="scratch_content"   name="scratch_content" rows="5" class="form-control horiz"><?php if(!empty($formdata['scratch_content'])){echo $formdata['scratch_content']; }?></textarea>
<br />
...
<table width="100%" border="0">
  ...
  <tr>
    <td><input type="radio" name="task_priority_id" value="1" <?php if($taskinfo['task_priority_id']==1)echo 'checked="checked"';?>/>
      High <br />
      <input type="radio" name="task_priority_id" readonly="readonly" value="2"  <?php if($taskinfo['task_priority_id']==2)echo 'checked="checked"';?> />
      Medium <br />
...
<tr>
    ...
    Open
    <br />
      <input type="radio" name="task_status_id" readonly="readonly" value="2"  <?php if($taskinfo['task_status_id']==2)echo 'checked="checked"';?> />
      Dropped
      <br />
  ...
  <tr>
    <td><input style="width:200px;" type="text" name="due_date" maxlength="20" readonly="readonly" id="datepicker1" value="<?php echo $taskinfo['due_date'];?>" placeholder="Due On" /></td>
  </tr>
  
  <tr>
    <td><?php echo form_dropdown('candidate_id',  $admin_list, $taskinfo['candidate_id'],'class="form-control" id="candidate_id"');?></td>
  </tr>
  <tr>
