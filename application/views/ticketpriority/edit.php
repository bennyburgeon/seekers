...
<tbody>
<form action="<?php echo $this->config->site_url();?>/ticketpriority/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
  <?php echo form_hidden('ticket_priority_id', $formdata["ticket_priority_id"]);?>

<tr>
<td>Priority Name</td>
<td>
<input type="text" placeholder="" class="form-control input-large" id="ticket_priority_name" name="ticket_priority_name" value="<?php echo $formdata['ticket_priority_name'];?>">
</td>
</tr>
<tr>
<td>Status</td>
...
<a href="<?php echo $this->config->site_url();?>/ticketpriority" class="attach-subs subs">Cancel</a>
</span>
</td>
</tr>
</form>
...
function validate()
{
	...
	{
		alert('Please enter ticket priority name');
