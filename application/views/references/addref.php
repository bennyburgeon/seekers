...
<ul class="page-breadcrumb breadcrumb">
        ...
        <li class="active">Add References  </li>
      </ul>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
   <form action="<?php echo $this->config->site_url();?>/references/add" class="form-horizontal form-bordered"  method="post" id="frmcert" name="frmcert" onSubmit="return validate();" enctype="multipart/form-data"> 
<tr>
