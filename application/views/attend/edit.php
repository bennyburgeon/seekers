...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/attend/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
	 ...
	 foreach($admins as $admin)
{
	...
	<option value="<?php echo $admin->candidate_id; ?>" <?php if($formdata['candidate_id']==$admin->candidate_id) { ?> selected<?php } ?> > <?php echo  $admin->first_name; echo $admin->last_name;?></option>
