...
<span>
<a href="<?php echo $this->config->site_url()?>/specialisation">Specialisation</a></span> / <span>Edit Course</span></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/specialisation/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
<?php echo form_hidden('spcl_id', $formdata['spcl_id']);?>
