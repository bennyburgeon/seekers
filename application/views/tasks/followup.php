...
<div class="tab-content">
				 ...
				 <form action="<?php echo $this->config->site_url()?>/tasks/addfllowup/<?php echo $task_details['task_id'];?>" class="form-horizontal" enctype="multipart/form-data" method="post" id="frmadd" name="frmadd" onSubmit="return validate();">
   ...
   <div id="deletemessage"></div>	
				 			  ...
				 			  <div class="form-group">
								...
								<div class="form-group">
                                  ...
                                  <div class="col-md-4">
                                    <?php echo form_dropdown('task_priority_id',  $task_priority_list,'','id="task_priority_id"  class="table-group-action-input form-control input-medium"');?>
                                  </div>
                                 </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-4">
                                    <?php echo form_dropdown('task_status_id',  $task_status_list,'','id="task_status_id"  class="table-group-action-input form-control input-medium"');?>
                                  </div>
                                 </div>
                                  <div class="form-group">
                                  ...
                                  <div class="col-md-4">
								  	<div class="input-icon">
															...
															<input type="text" readonly="readonly" id="date" name="date" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="<?php echo date("Y-m-d"); ?>" value="<?php echo date("Y-m-d"); ?>" size="16" class="form-control date-picker">
														</div>
								...
								<div class="form-group">
                                  ...
                                  <div class="col-md-4">
								  	<div class="input-icon">
															<i class="fa fa-calendar"></i>
															<input type="text" readonly="readonly" id="due_date" name="due_date" value="" placeholder="yyyy-mm-dd" size="16" class="form-control date-picker">
														</div>
                                  </div>
                                 </div>
...
$(document).ready(function()
{
	...
	function del(id){
		...
		var row = "#tr_"+id;
		 $.ajax({
        type:"POST",
        url: '<?php echo $this->config->site_url()?>/tasks/delfllowup',
        data:{ 
        task_fl_id:id,
        },
        success: function(msg) {
								...
								<tbody>
								 <tr>
                                  ...
                                  <tr>
                                    ...
                                    <a href="<?php echo base_url();?>index.php/candidates/summary/<?php echo $task_details['candidate_id'];?>" target="_blank">Open Candidate Profile</a><?php } ?>
