...
<div class="container hidden-print">
  <div class="panel panel-primary">
    ...
    <div class="panel-body ">
      <div class="radio">
        <label>
          <input type="radio" name="client_feedback" value="1" id="schedule_interview">
          Short List<i class="fa fa-check-circle" aria-hidden="true"></i></label>
         
                <input type="hidden" name="title" value="Interview scheduled by client">
                <input type="hidden" name="interview_type_id" value="3">
                <input type="hidden" name="interview_time" value="">   
                [Schedule an Interview - On <input type="text" name="interview_date" placeholder="Interview Date" id="interview_date">]<br />
		
        
     </div>
      <div class="radio">
        <label>
          <input type="radio" name="client_feedback" value="2">
          Not Skilled <i class="fa fa-exclamation-circle" aria-hidden="true"></i></label>
      </div>
      <div class="radio ">
        <label>
          <input type="radio" name="client_feedback"  value="3" >
          Not Qualified <i class="fa fa-exclamation-triangle" aria-hidden="true"></i></label>
      </div>
      <div class="radio ">
        <label>
          <input type="radio" name="client_feedback"  value="4"  >
          No Experiance <i class="fa fa-calendar-times-o" aria-hidden="true"></i></label>
      </div>
      <div class="radio ">
        <label>
          <input type="radio" name="client_feedback"  value="5">
          No Domain Experiance <i class="fa fa-window-close-o" aria-hidden="true"></i></label>
      </div>
      <div class="radio ">
        <label>
          <input type="radio" name="client_feedback"  value="6">
          Rejected <i class="fa fa-window-close" aria-hidden="true"></i></label>
      </div>
      <br />
<br />
<br />
<br />
        ...
        <div class="input-group"> 
          ...
          <input id="client_notes" type="text" class="form-control" name="client_notes" placeholder="Enter Here..">
        </div>
      
      <br>
      <button type="submit" class="btn btn-primary btn-block btn-lg"><strong><i class="fa fa-paper-plane" aria-hidden="true"></i> Send Feedback</strong></button>
    </div>
  </div>
  <button type="button" onClick="myFunction()" class="btn btn-danger btn-lg hidden-print"><strong><i class="fa fa-print" aria-hidden="true"></i> Print CV</strong></button>
</div>
</form>
