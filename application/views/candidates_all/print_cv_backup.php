...
<div>
 ...
 <table width="100%" border="0"  border="0" cellpadding="4" cellspacing="4">
    <tr>
        <td><img src="<?php echo $this->config->item('logo_url');?>" /></td>
        <td align="right"><?php echo $this->config->item('powered_by');?>
        <br /><?php echo $this->config->item('powered_by_address');?>
        <br /><?php echo $this->config->item('powered_by_phone');?>
        <br /><?php echo $this->config->item('powered_by_email');?>
        <br /><?php echo $this->config->item('powered_by_web');?>        
        </td>
    </tr>
 </table>
 <br />
 <h3 class="srevHd">Consultant’s Feedback on Candidate’s Competency</h3>
 <table width="100%" border="0">

    <tr>
        <td width="12%">General Feedback</td>
        <td width="88%"><?php echo $short_lists['feedback_general'];?></td>
    </tr>

	<tr>
        <td>Education</td>
        <td><?php echo $short_lists['feedback_education'];?></td>
    </tr>
    
    <tr>
        <td>Salary</td>
        <td><?php echo $short_lists['feedback_salary'];?></td>
    </tr>
    <tr>
        <td>Skills</td>
        <td><?php echo $short_lists['feedback_skills'];?></td>
    </tr>

    <tr>
        <td>Domain Experience</td>
        <td><?php echo $short_lists['feedback_domain'];?></td>
    </tr>

    <tr>
        <td>Industry Experience</td>
        <td><?php echo $short_lists['feedback_industry'];?></td>
    </tr>
    
 </table>
  <br />
 <h3 class="srevHd">Candidate's Self Evaluation</h3>
  <table width="100%" border="0" cellpadding="4" cellspacing="4">
     
    <tr>
        <td width="100%" > <br />Give a brief description about your exposure in the Marketing and sales or Fashion Industry? <br /></td>
    </tr>
    <tr>
        <td width="100%"> <br /><?php echo $short_lists['feedback_general'];?> <br /></td>
    </tr>
    
    <tr>
        <td> <br />What are the main brands you are familiar with / handled? <br /></td>
    </tr>

    <tr>
        <td> <br /><?php echo $short_lists['feedback_general'];?> <br /></td>
    </tr>
    
    <tr>
        <td> <br />What are the marketing strategies you were adopting / aware of, for Fashion Industry <br /></td>
    </tr>
    ...
    <tr>
        <td> <br />What was your involvement in purchasing / operations areas?  <br /></td>
    </tr>    
    <tr>
        <td> <br /><?php echo $short_lists['feedback_general'];?> <br /></td>
    </tr>
    ...
    <tr>
        <td> <br />Describe your major achievements in the career. <br /></td>
    </tr>
...
<div class="notes hidden-print">
            <ul>
            	<li id="tab_2btn" class="active">Feedback</li>            
            </ul>
            <!--Followup-->
            ...
            <p id="deletemessage"></p>
                ...
                <table class="hori-form" width="50%">
                <tbody>
				<tr>
                   <td> Feedback</td>
                   <td>
                    <input id="client_feedback" type="radio" name="client_feedback" value="1" >Selected<br>                    
                ...
                <td>Notes</td>
                 <td><input type="text" name="client_notes" value="" id="client_notes" class="smallinput form-control"> </td>
                </tr>
                
                <tr>
                  <td colspan="2">
                  <span class="click-icons">
                  <input type="submit" class="attach-subs" value="Save Feedback" id="save_feedback" style="width:180px;" data-url="<?php echo $this->config->site_url();?>/select_applicant/add_feedback">
        ...
        <table align="center">
            <tr>
                <td >    
                <input type="button" onClick="myFunction()" class="attach-subs hidden-print" value="Print CV" />
