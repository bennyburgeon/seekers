...
<div class="clearfix"><br>
    ...
    <p class="btn btn-success btn-xs"> <?php echo $applied_msg;?></p>
<br>
<br>
        ...
        <?php } ?> </div></td>
          ...
          <tr>
              ...
              <div class="tab-head mar-spec"><h3>Personal Details</h3></div>
                <table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    ...
                    <td width="24%"><?php echo $formdata['mobile_prefix'].' '.$formdata['mobile'];?><?php if($formdata['mobile1']!='')echo ', '.$formdata['mobile_prefix1'].' '.$formdata['mobile1'];?></td>
            ...
            <?php } ?> </td>
             ...
             <tr>
             <td colspan="4">
           	Linkedin Profile Link: <?php echo $formdata['linkedin_url'];?>
	          </td>
    	      </tr>
...
<table width="95%" border="0" cellspacing="1" cellpadding="1" class="table table-bordered table-condensed">
                  ...
                  <tr>
                    <td width="22%">
                      ...
                      <span id="imgTab2"><img src="<?php echo $this->config->item('photo_path').$detail_list['photo'];?>" style="width:158px;height:100px;"><br /><br /><a href="<?php echo site_url().'/candidates_all/delete_photo/'.$candidate_id.'/';?>" style="color:#0033FF">Delete Photo</a>&nbsp;&nbsp;</span> 
      ...
      <input type="hidden" name="candidate_id" value="<?php echo $formdata['candidate_id'];?>" />
        	...
        	<div id="success"></div>
                ...
                <a href="<?php echo$this->config->item('cv_path').$detail_list['cv_file'];?>" target="_blank" class="btn btn-success btn-sm">Download CV</a> <a href="<?php echo site_url().'/candidates_all/delete_cv/'.$candidate_id.'/';?>" class="btn btn-danger btn-sm">Delete CV</a> <?php } ?> </td>
                    <td>&nbsp;</td>
                  </tr>
				 ...
				 <?php foreach($education_details as $key => $val){?>
                  <tr>
                    ...
                    <td><?php echo $val['country_name'];?></td>                    
                     ...
                     <a href="<?php echo base_url().'index.php/candidates_all/delete_candidate_edu/?eucation_id='.$val['eucation_id'];?>&candidate_id=<?php echo $val['candidate_id'];?>" onClick="return confirm('Are you sure ? want to delete?');" class="btn btn-danger btn-xs">X</a> || 
        ...
        <td colspan="2" align="center" valign="top">
           <table width="100%" border="1" cellspacing="3" cellpadding="3" class="table table-bordered table-condensed">
                  ...
                  <tr>
					...
					--> 
                       <a href="<?php echo base_url().'index.php/candidates_all/summary/?edit_job=1&job_profile_id='.$val['job_profile_id'];?>" id="edit_job_profile_url" class="btn btn-info btn-xs">Edit</a>  
			...
			<tbody>
               ...
               <input type="hidden" name="candidate_id" value="<?php echo $candidate_id;?>">
                ...
                <tr>
                    <td>Skills</td>
                    <td>
                    <?php echo $this->ckeditor->editor('feedback_projects', ''); //$this->ckeditor->editor('feedback_projects',$feedback_projects) ?>
                    </td>
                </tr>
    ...
    <div class="notes">
        ...
        <div class="table-tech  note" style="border:none;">
        	<div class="new_notes">
               ...
               <form class="form-horizontal form-bordered"  method="post" id="candidate_form4" name="candidate_form4" action="<?php echo $this->config->site_url();?>/candidates_all/update_candidate_profile/"  onSubmit="return validate_profile_form();"> 
...
<tr>
                    ...
                    <td>Confirm Password</td>
                     <td>  <input style="width:300px;"  type="password"  name="c_password" value="" id="c_password"> </td>
                    </tr>
                    <tr>
                ...
                <tr>
                    ...
                    <tr>
                    <td>Skills</td>
                     <td><input style="width:400px;" placeholder="Skills"  type="text"  name="skills" value="<?php if(isset($formdata['skills'])) echo $formdata['skills']?>" id="skills"></td>
                    </tr>
                    

                    <tr>
                    <td>Other Details</td>
                     <td><input style="width:400px;" placeholder="Other Details"  type="text"  name="fee_comments" value="<?php if(isset($formdata['fee_comments'])) echo $formdata['fee_comments']?>" id="fee_comments"></td>
                    </tr>
                    
                                        <tr>
                     <td>Reason to Leave</td>
                     <td colspan="3"><input style="width:400px;" placeholder="Reason to Leave."  type="text"  name="reason_to_leave" value="" id="reason_to_leave"></td>
                    </tr>
...
<!-- 
                    ...
                    <tr>
                    <td>Issued From</td>
                     <td><?php echo form_dropdown('passport_nationality',  $nationality_list,$formdata['passport_nationality'],'class="form-control" id="passport_nationality"');?>
</td>
                    </tr>
...
-->                    
                    ...
                    <tr>
                    <td>Nationality</td>
                     <td><?php echo form_dropdown('nationality',  $nationality_list,$formdata['nationality'],'class="form-control" id="visa_type_id"');?></td>
                    </tr>
...
<tr>
                    ...
                    <tr>
                    <td>City</td>
                     <td><?php echo form_dropdown('city_id',  $city_list,$formdata['city_id'],'class="form-control" id="city_id_profile"');?></td>
                    </tr>
					...
					<tr id="driving_license_row" style="display:<?php if($formdata['driving_license']=='0')echo 'none';?>;">
                      <td>License Issued From</td>
	                 <td colspan="2"><?php echo form_dropdown('driving_license_country',  $nationality_list,$formdata['driving_license_country'],'class="form-control" id="driving_license_country"');?></td>
                    </tr>
