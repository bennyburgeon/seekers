                            ...
                            <table class="hori-form">
                                <tbody>
                                    <form class="form-horizontal form-bordered"  method="post" id="candidate_form" name="candidate_form" > 
                                        ...
                                        <tr>
                                        	<td>Email</td>
                                            <td><input class="form-control hori " type="text" name="username"  value="<?php echo $formdata['username'];?>" 
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control hori " type="text" name="alternate_email"  value="<?php echo $formdata['alternate_email'];?>" 
                                            id="username" placeholder="Secondary Email"></td>
                                            
                                        </tr>
                                        
                                        <tr>
                                            <td>Password</td>
                                            <td><input class="form-control hori " type="password" name="password" value="<?php echo $formdata['password'];?>" 
				...
				success: function(json){
					try{		
						...
						if(ret['STATUS']==1) 
						{
                            ...
                            window.location.href = "<?php echo site_url('candidates_all/edit'); ?>" +'/'+ id;
