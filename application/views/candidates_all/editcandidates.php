          ...
          <h2 class="srevHd">Personal Details</h2>
                ...
                <?php */?>
                 ...
                 <tr>
                   ...
                   <td>
<input id="cur_job_status" type="radio" name="cur_job_status" value="1"  <?php if($formdata['cur_job_status']==1)echo 'checked="checked"';?>  />No Job

<input id="cur_job_status" type="radio" name="cur_job_status" value="2"  <?php if($formdata['cur_job_status']==1)echo 'checked="checked"';?>  />Working, But Need a Change

<input id="cur_job_status" type="radio" name="cur_job_status" value="3"  <?php if($formdata['cur_job_status']==1)echo 'checked="checked"';?>  />Not Interested

<input id="cur_job_status" type="radio" name="cur_job_status" value="4"  <?php if($formdata['cur_job_status']==1)echo 'checked="checked"';?>  />Seeking Good Opportunity

<input id="cur_job_status" type="radio" name="cur_job_status" value="5"  <?php if($formdata['cur_job_status']==1)echo 'checked="checked"';?>  />Need a change

<input id="cur_job_status" type="radio" name="cur_job_status" value="6"  <?php if($formdata['cur_job_status']==1)echo 'checked="checked"';?>  />Call after 1 Year
    <input id="cur_job_status" type="radio" name="cur_job_status" value="7"  <?php if($formdata['cur_job_status']==1)echo 'checked="checked"';?>  />Call after this month             
                   </td>
                 </tr>
        ...
        <table class="hori-form">
        	<tbody>
                <tr>
                        ...
                        <td> 
                            <input class="form-control datepicker hori" type="text" readonly value="<?php echo $formdata['job_date'];?>" name="job_date" 
                            id="datepickfrom1"  placeholder="Enter From Date YYYY-MM-DD"> 
                ...
                <tr>
                        <td>Current CTC</td>
                        <td><input class="form-control hori" value="<?php echo $formdata['current_ctc'];?>" type="text" name="current_ctc" id="current_ctc"> 
                        </td>
                </tr>
        ...
        <table class="hori-form">
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                    <select class="js-example-basic-multiple-cert" name="skills[]" multiple="multiple" id="multiple_skill" style="width:100%;">
...
<h2>Education Details</h2> 
    ...
    <table class="hori-form">
        <tbody>
            ...
            <tr>
                 <td>Course</td>
                 <td> <?php echo form_dropdown('course_id',  $edu_course_list, '','class="form-control edu-field" id="course_id_edu"');?> </td>
            </tr>
            <tr>
            ...
            <tr>
                 <td>College</td>
                 <td> <?php echo form_dropdown('college_id',  $edu_coll_list, '','class="form-control edu-field" id="coll_id"');?> </td>
            </tr>
...
<h2>Job Details</h2>
    <table class="hori-form">    
        <tbody>
                ...
                <tr>
                    <td>From Date</td>
                    <td><input class="form-control hori datepicker job-field" type="text" readonly name="from_date" id="datepickfrom" 
...
<div class="table-tech specs hor">
  ...
  <form class="form-horizontal form-bordered"  method="post" id="candidate_form5" name="candidate_form5" action="<?php echo $this->config->site_url();?>/candidates_all/editfiles" enctype="multipart/form-data"> 
    ...
    <table class="hori-form">
        <tbody>
                ...
                <tr>
                    <td colspan="2">
                    <span class="click-icons">
                    <input type="submit" class="attach-subs" value="Save & Done" id=""  style="width:180px;">
...
//CONTACT DETAILS VALIDATION AND SUBMIT
   ...
   $('#edit_candidate1').click(function(){
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_all/editCandidateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN SKILLS AND CERTIFICATE
   $('#edit_candidate7').click(function(){ 
		...
		var candidateId = '<?php echo $candidate_id ?>';
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_all/editSkillCertificateDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){ 
					try{		
...
*/	    return true;
   ...
   $('#save_candidate3').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_all/addEducationDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN PANNING JOB DEATILS
   ...
   $('#edit_candidate8').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_all/editJobChangeDetail'); ?>"+'/'+candidateId,
				cache: false,
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE EDUCATION
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('candidates_all/deleteEducationDetail'); ?>"+'/'+candidateId,
			cache: false,				
			data: { edu_id:edu_id},
			success: function(json){
				try{		
...
//BEGIN JOB DETAILS
   ...
   $('#edit_candidate4').click(function(){
		...
		if(isContactValid) {
			...
			$.ajax({
				type: "post",
				url: "<?php echo site_url('candidates_all/addJobDetail'); ?>"+'/'+candidateId,
				cache: false,				
				data: dataStringprop,
				success: function(json){
					try{		
...
//BEGIN DELETE JOB
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('candidates_all/deleteJobDetail'); ?>"+'/'+candidateId,
			cache: false,				
			data: { job_id:job_id},
			success: function(json){
				try{		
...
$('#candidate_form5').on('submit', function(e){
		...
		$(this).ajaxSubmit({success:function(data){ 
			...
			if(($.trim(data)=='Add title')||($.trim(data) == 'Invalid file format')||($.trim(data) == 'Choose file')||($.trim(data) == 'Image file size max 1 MB')||($.trim(data) == 'failed')){
				...
				window.location.href = '<?php echo $this->config->site_url();?>/candidates_all/';
			}	
		}
		});
});
...
//BEGIN DELETE PHOTO
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('candidates_all/photo_delete'); ?>"+'/'+candidateId,
			cache: false,				
...
//BEGIN DELETE CV
	...
	{ 
		...
		$.ajax({
			type: "post",
			url: "<?php echo site_url('candidates_all/cv_delete'); ?>"+'/'+candidateId,
			cache: false,				
