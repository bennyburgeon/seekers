...
<span>
<a href="<?php echo $this->config->site_url()?>/campus">Campus</a></span> / <span>Edit Course</span></div>
</div>
<div class="row">
<div class="col-sm-12">
...
<tbody>
  <form action="<?php echo $this->config->site_url();?>/campus/update" class="form-horizontal form-bordered"  method="post" id="frmentry" name="frmentry" onSubmit="return validate();" enctype="multipart/form-data"> 
...
<a href="<?php echo $this->config->site_url();?>/campus" class="attach-subs subs">Cancel</a></span></td>
</tr>
</form>
</tbody>
</table>
