...
class Scratchpad extends CI_Controller {
	...
	{	
		...
		$query = $this->db->query("SELECT scratch_id,scratch_content, UNIX_TIMESTAMP(datetime)as datetime,status,user_id from  pms_scratchpad where user_id=".$_SESSION['candidate_session']." order by UNIX_TIMESTAMP(datetime) desc");
