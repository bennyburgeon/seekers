...
class Finalverificationmodel extends CI_Model {
	...
	{
		$sql="select *  from pms_candidate a LEFT JOIN pms_candidate_to_skills c on a.candidate_id=c.candidate_id LEFT JOIN pms_candidate_education d on a.candidate_id=d.candidate_id ";
		$cond='';
/*		
		if($reg_status!='')
		{
...
*/
	...
	{
		$sql="SELECT a.*,c.skill_id FROM ".$this->table_name." a LEFT JOIN pms_candidate_to_skills c on a.candidate_id=c.candidate_id  ";
		$cond='';
/*
		if($exp_years!='')
		{ 
...
function select_aplication_visa($candidate_id)
    ...
    {
        $query=$this->db->query("select a.*,b.*,c.*,d.* from pms_candidate_job_profile a left join pms_job_category b on a.job_cat_id=b.job_cat_id left join pms_job_functional_area c on a.func_id=c.func_id left join pms_job_industries d on a.job_ind_id=d.job_ind_id where a.candidate_id=".$candidate_id);
		return $query->result_array();
	}	

	 function all_counselor($candidate_id)
    {
		$query=$this->db->query("select candidate_id, username, first_name from pms_candidate where candidate_id not in (select a.candidate_id from pms_candidate a inner join pms_admin_candidates b on a.candidate_id=b.candidate_id where b.candidate_id=".$candidate_id.") order by first_name");
		return $query->result_array();
	}	
	
	 function candidate_counselor($candidate_id)
    {
        $query=$this->db->query("select a.candidate_id, a.username, a.first_name from pms_candidate a inner join pms_admin_candidates b on a.candidate_id=b.candidate_id where b.candidate_id=".$candidate_id);
		return $query->result_array();
	}		
...
//invoice generated jobs
	...
	function update_contract_detail($candidateId){//updating while adding
		...
		$data = array(
				...
				'job_change_date' => $this->input->post('job_change_date'),
...
//INSERT PRIMARY AND SECONDARY SKILLS
	...
	/*----------------START------------------*/
	function drop_personal_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	}
	
	function drop_contact_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_education_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_jobs_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_language_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_address_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_skill_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_cert_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_domain_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_game_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
	...
	function drop_social_item($cat_id,$candidateId)
    {
		$this->db->where('cv_category_id',$cat_id);
		$this->db->where('candidate_id',$candidateId);
		$this->db->delete('pms_candidate_cvfile');
