<?php
class Client_invoice_model extends CI_Model{
	var $table_name	= "";
	var $insert_id 	= "";
	...
	function get_list($start,$limit,$company_id,$sort_by)
	{
